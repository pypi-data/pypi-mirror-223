...
from mastapy.system_model.analyses_and_results.modal_analyses import _4634, _4633, _4537
...
class StraightBevelDiffGearSetModalAnalysis(_4537.BevelGearSetModalAnalysis):
    ...
    @property
    def straight_bevel_diff_gears_modal_analysis(self) -> 'List[_4634.StraightBevelDiffGearModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_modal_analysis(self) -> 'List[_4633.StraightBevelDiffGearMeshModalAnalysis]':
