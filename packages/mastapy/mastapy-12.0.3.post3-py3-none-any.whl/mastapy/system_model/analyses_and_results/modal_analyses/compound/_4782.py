...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4780, _4781, _4690
...
class StraightBevelGearSetCompoundModalAnalysis(_4690.BevelGearSetCompoundModalAnalysis):
    """StraightBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4638.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gears_compound_modal_analysis(self) -> 'List[_4780.StraightBevelGearCompoundModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_compound_modal_analysis(self) -> 'List[_4781.StraightBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4638.StraightBevelGearSetModalAnalysis]':
