...
class PulleyCompoundModalAnalysis(_4711.CouplingHalfCompoundModalAnalysis):
    """PulleyCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4615.PulleyModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4615.PulleyModalAnalysis]':
