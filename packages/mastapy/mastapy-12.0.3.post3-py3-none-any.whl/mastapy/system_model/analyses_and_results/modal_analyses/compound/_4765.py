...
class RollingRingConnectionCompoundModalAnalysis(_4737.InterMountableComponentConnectionCompoundModalAnalysis):
    """RollingRingConnectionCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4619.RollingRingConnectionModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4619.RollingRingConnectionModalAnalysis]':
