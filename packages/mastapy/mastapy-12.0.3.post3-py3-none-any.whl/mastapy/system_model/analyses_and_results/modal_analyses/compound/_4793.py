...
class UnbalancedMassCompoundModalAnalysis(_4794.VirtualComponentCompoundModalAnalysis):
    """UnbalancedMassCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4649.UnbalancedMassModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4649.UnbalancedMassModalAnalysis]':
