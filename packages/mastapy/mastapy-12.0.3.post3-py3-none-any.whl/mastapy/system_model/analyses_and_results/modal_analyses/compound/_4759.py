...
class PowerLoadCompoundModalAnalysis(_4794.VirtualComponentCompoundModalAnalysis):
    """PowerLoadCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4614.PowerLoadModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4614.PowerLoadModalAnalysis]':
