...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4771, _4772, _4690
...
class SpiralBevelGearSetCompoundModalAnalysis(_4690.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4629.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spiral_bevel_gears_compound_modal_analysis(self) -> 'List[_4771.SpiralBevelGearCompoundModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_compound_modal_analysis(self) -> 'List[_4772.SpiralBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4629.SpiralBevelGearSetModalAnalysis]':
