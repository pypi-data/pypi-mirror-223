...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4701, _4702, _4732
...
class ConceptGearSetCompoundModalAnalysis(_4732.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    @property
    def concept_gears_compound_modal_analysis(self) -> 'List[_4701.ConceptGearCompoundModalAnalysis]':
    ...
    @property
    def concept_meshes_compound_modal_analysis(self) -> 'List[_4702.ConceptGearMeshCompoundModalAnalysis]':
