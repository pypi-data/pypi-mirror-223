...
class SynchroniserCompoundModalAnalysis(_4770.SpecialisedAssemblyCompoundModalAnalysis):
    """SynchroniserCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4642.SynchroniserModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4642.SynchroniserModalAnalysis]':
