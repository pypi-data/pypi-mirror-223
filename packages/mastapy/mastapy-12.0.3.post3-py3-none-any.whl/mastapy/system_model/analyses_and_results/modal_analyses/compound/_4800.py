...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4798, _4799, _4690
...
class ZerolBevelGearSetCompoundModalAnalysis(_4690.BevelGearSetCompoundModalAnalysis):
    """ZerolBevelGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4659.ZerolBevelGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gears_compound_modal_analysis(self) -> 'List[_4798.ZerolBevelGearCompoundModalAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_compound_modal_analysis(self) -> 'List[_4799.ZerolBevelGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4659.ZerolBevelGearSetModalAnalysis]':
