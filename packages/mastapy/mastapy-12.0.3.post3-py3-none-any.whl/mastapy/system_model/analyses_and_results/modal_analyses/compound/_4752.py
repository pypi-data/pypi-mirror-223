...
class PartToPartShearCouplingCompoundModalAnalysis(_4709.CouplingCompoundModalAnalysis):
    """PartToPartShearCouplingCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4609.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4609.PartToPartShearCouplingModalAnalysis]':
