...
from mastapy.system_model.analyses_and_results.modal_analyses import _4628, _4627, _4537
...
class SpiralBevelGearSetModalAnalysis(_4537.BevelGearSetModalAnalysis):
    ...
    @property
    def spiral_bevel_gears_modal_analysis(self) -> 'List[_4628.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def spiral_bevel_meshes_modal_analysis(self) -> 'List[_4627.SpiralBevelGearMeshModalAnalysis]':
