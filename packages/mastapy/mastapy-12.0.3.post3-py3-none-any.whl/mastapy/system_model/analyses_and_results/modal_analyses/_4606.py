...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4670, _4668, _4671
...
class PartModalAnalysis(_7477.PartStaticLoadAnalysisCase):
    """PartModalAnalysis
    ...
    @property
    def excited_modes_summary(self) -> 'List[_4670.SingleExcitationResultsModalAnalysis]':
    ...
    @property
    def gear_mesh_excitation_details(self) -> 'List[_4668.RigidlyConnectedDesignEntityGroupModalAnalysis]':
    ...
    @property
    def results_for_modes(self) -> 'List[_4671.SingleModeResults]':
    ...
    @property
    def shaft_excitation_details(self) -> 'List[_4668.RigidlyConnectedDesignEntityGroupModalAnalysis]':
