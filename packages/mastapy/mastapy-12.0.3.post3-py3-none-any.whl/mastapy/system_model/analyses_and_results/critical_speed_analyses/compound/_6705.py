...
class SpiralBevelGearCompoundCriticalSpeedAnalysis(_6622.BevelGearCompoundCriticalSpeedAnalysis):
    """SpiralBevelGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6576.SpiralBevelGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6576.SpiralBevelGearCriticalSpeedAnalysis]':
