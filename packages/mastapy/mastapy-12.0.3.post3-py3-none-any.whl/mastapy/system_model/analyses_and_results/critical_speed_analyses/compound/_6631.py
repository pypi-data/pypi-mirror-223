...
class ComponentCompoundCriticalSpeedAnalysis(_6685.PartCompoundCriticalSpeedAnalysis):
    """ComponentCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6500.ComponentCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6500.ComponentCriticalSpeedAnalysis]':
