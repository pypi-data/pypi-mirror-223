...
class TorqueConverterPumpCompoundCriticalSpeedAnalysis(_6645.CouplingHalfCompoundCriticalSpeedAnalysis):
    """TorqueConverterPumpCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6596.TorqueConverterPumpCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6596.TorqueConverterPumpCriticalSpeedAnalysis]':
