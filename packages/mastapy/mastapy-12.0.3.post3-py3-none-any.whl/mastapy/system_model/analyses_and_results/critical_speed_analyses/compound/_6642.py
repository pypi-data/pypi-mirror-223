...
class ConnectorCompoundCriticalSpeedAnalysis(_6683.MountableComponentCompoundCriticalSpeedAnalysis):
    """ConnectorCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6511.ConnectorCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6511.ConnectorCriticalSpeedAnalysis]':
