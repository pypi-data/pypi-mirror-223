...
class WormGearCompoundCriticalSpeedAnalysis(_6664.GearCompoundCriticalSpeedAnalysis):
    """WormGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6600.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6600.WormGearCriticalSpeedAnalysis]':
