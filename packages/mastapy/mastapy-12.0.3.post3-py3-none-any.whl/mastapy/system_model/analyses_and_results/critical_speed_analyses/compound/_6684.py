...
class OilSealCompoundCriticalSpeedAnalysis(_6642.ConnectorCompoundCriticalSpeedAnalysis):
    """OilSealCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6555.OilSealCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6555.OilSealCriticalSpeedAnalysis]':
