...
class ShaftHubConnectionCompoundCriticalSpeedAnalysis(_6642.ConnectorCompoundCriticalSpeedAnalysis):
    """ShaftHubConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6573.ShaftHubConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6573.ShaftHubConnectionCriticalSpeedAnalysis]':
