...
class ConceptGearCompoundCriticalSpeedAnalysis(_6664.GearCompoundCriticalSpeedAnalysis):
    """ConceptGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6504.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6504.ConceptGearCriticalSpeedAnalysis]':
