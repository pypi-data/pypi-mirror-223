...
class BeltDriveCompoundCriticalSpeedAnalysis(_6704.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """BeltDriveCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6485.BeltDriveCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6485.BeltDriveCriticalSpeedAnalysis]':
