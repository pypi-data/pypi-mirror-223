...
class ClutchConnectionCompoundCriticalSpeedAnalysis(_6644.CouplingConnectionCompoundCriticalSpeedAnalysis):
    """ClutchConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6496.ClutchConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6496.ClutchConnectionCriticalSpeedAnalysis]':
