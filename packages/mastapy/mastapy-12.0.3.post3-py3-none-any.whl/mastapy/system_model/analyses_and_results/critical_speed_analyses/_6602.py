...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6600, _6601, _6537
...
class WormGearSetCriticalSpeedAnalysis(_6537.GearSetCriticalSpeedAnalysis):
    """WormGearSetCriticalSpeedAnalysis
    ...
    @property
    def worm_gears_critical_speed_analysis(self) -> 'List[_6600.WormGearCriticalSpeedAnalysis]':
    ...
    @property
    def worm_meshes_critical_speed_analysis(self) -> 'List[_6601.WormGearMeshCriticalSpeedAnalysis]':
