...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6524, _6525, _6537
...
class CylindricalGearSetCriticalSpeedAnalysis(_6537.GearSetCriticalSpeedAnalysis):
    """CylindricalGearSetCriticalSpeedAnalysis
    ...
    @property
    def cylindrical_gears_critical_speed_analysis(self) -> 'List[_6524.CylindricalGearCriticalSpeedAnalysis]':
    ...
    @property
    def cylindrical_meshes_critical_speed_analysis(self) -> 'List[_6525.CylindricalGearMeshCriticalSpeedAnalysis]':
