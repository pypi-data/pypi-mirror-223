...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6316, _6317, _6228
...
class StraightBevelDiffGearSetDynamicAnalysis(_6228.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    @property
    def straight_bevel_diff_gears_dynamic_analysis(self) -> 'List[_6316.StraightBevelDiffGearDynamicAnalysis]':
    ...
    @property
    def straight_bevel_diff_meshes_dynamic_analysis(self) -> 'List[_6317.StraightBevelDiffGearMeshDynamicAnalysis]':
