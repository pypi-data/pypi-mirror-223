...
class SynchroniserHalfCompoundDynamicAnalysis(_6455.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6325.SynchroniserHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6325.SynchroniserHalfDynamicAnalysis]':
