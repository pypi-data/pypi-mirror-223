...
class FEPartCompoundDynamicAnalysis(_6342.AbstractShaftOrHousingCompoundDynamicAnalysis):
    """FEPartCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6267.FEPartDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6267.FEPartDynamicAnalysis]':
