...
class TorqueConverterPumpCompoundDynamicAnalysis(_6379.CouplingHalfCompoundDynamicAnalysis):
    """TorqueConverterPumpCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6330.TorqueConverterPumpDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6330.TorqueConverterPumpDynamicAnalysis]':
