...
class ShaftHubConnectionCompoundDynamicAnalysis(_6376.ConnectorCompoundDynamicAnalysis):
    """ShaftHubConnectionCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6307.ShaftHubConnectionDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6307.ShaftHubConnectionDynamicAnalysis]':
