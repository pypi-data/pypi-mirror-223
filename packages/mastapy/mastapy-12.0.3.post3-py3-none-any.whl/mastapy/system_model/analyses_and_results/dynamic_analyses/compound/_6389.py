...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6387, _6388, _6400
...
class CylindricalGearSetCompoundDynamicAnalysis(_6400.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6259.CylindricalGearSetDynamicAnalysis]':
    ...
    @property
    def cylindrical_gears_compound_dynamic_analysis(self) -> 'List[_6387.CylindricalGearCompoundDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_compound_dynamic_analysis(self) -> 'List[_6388.CylindricalGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6259.CylindricalGearSetDynamicAnalysis]':
