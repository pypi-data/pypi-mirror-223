...
class StraightBevelGearMeshCompoundDynamicAnalysis(_6357.BevelGearMeshCompoundDynamicAnalysis):
    """StraightBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6320.StraightBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6320.StraightBevelGearMeshDynamicAnalysis]':
