...
class ClutchConnectionCompoundDynamicAnalysis(_6378.CouplingConnectionCompoundDynamicAnalysis):
    """ClutchConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6231.ClutchConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6231.ClutchConnectionDynamicAnalysis]':
