...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6463, _6464, _6400
...
class WormGearSetCompoundDynamicAnalysis(_6400.GearSetCompoundDynamicAnalysis):
    """WormGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6336.WormGearSetDynamicAnalysis]':
    ...
    @property
    def worm_gears_compound_dynamic_analysis(self) -> 'List[_6463.WormGearCompoundDynamicAnalysis]':
    ...
    @property
    def worm_meshes_compound_dynamic_analysis(self) -> 'List[_6464.WormGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6336.WormGearSetDynamicAnalysis]':
