...
class PartToPartShearCouplingHalfCompoundDynamicAnalysis(_6379.CouplingHalfCompoundDynamicAnalysis):
    """PartToPartShearCouplingHalfCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6293.PartToPartShearCouplingHalfDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6293.PartToPartShearCouplingHalfDynamicAnalysis]':
