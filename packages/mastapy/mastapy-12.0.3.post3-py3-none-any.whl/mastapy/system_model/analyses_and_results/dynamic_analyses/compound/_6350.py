...
class BeltDriveCompoundDynamicAnalysis(_6438.SpecialisedAssemblyCompoundDynamicAnalysis):
    """BeltDriveCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6220.BeltDriveDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6220.BeltDriveDynamicAnalysis]':
