...
class ShaftCompoundDynamicAnalysis(_6341.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6306.ShaftDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6306.ShaftDynamicAnalysis]':
