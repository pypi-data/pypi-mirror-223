...
class MountableComponentCompoundDynamicAnalysis(_6365.ComponentCompoundDynamicAnalysis):
    """MountableComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6288.MountableComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6288.MountableComponentDynamicAnalysis]':
