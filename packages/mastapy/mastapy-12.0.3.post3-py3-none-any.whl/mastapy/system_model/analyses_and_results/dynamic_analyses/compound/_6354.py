...
class BevelDifferentialPlanetGearCompoundDynamicAnalysis(_6351.BevelDifferentialGearCompoundDynamicAnalysis):
    """BevelDifferentialPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6224.BevelDifferentialPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6224.BevelDifferentialPlanetGearDynamicAnalysis]':
