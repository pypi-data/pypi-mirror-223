...
class PartToPartShearCouplingCompoundDynamicAnalysis(_6377.CouplingCompoundDynamicAnalysis):
    """PartToPartShearCouplingCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6292.PartToPartShearCouplingDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6292.PartToPartShearCouplingDynamicAnalysis]':
