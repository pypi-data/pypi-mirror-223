...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6257, _6258, _6271
...
class CylindricalGearSetDynamicAnalysis(_6271.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    @property
    def cylindrical_gears_dynamic_analysis(self) -> 'List[_6257.CylindricalGearDynamicAnalysis]':
    ...
    @property
    def cylindrical_meshes_dynamic_analysis(self) -> 'List[_6258.CylindricalGearMeshDynamicAnalysis]':
