...
class OilSealCompoundMultibodyDynamicsAnalysis(_5506.ConnectorCompoundMultibodyDynamicsAnalysis):
    """OilSealCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5407.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5407.OilSealMultibodyDynamicsAnalysis]':
