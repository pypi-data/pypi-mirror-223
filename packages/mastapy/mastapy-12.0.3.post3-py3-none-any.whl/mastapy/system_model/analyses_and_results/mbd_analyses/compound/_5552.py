...
class PartToPartShearCouplingHalfCompoundMultibodyDynamicsAnalysis(_5509.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """PartToPartShearCouplingHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5410.PartToPartShearCouplingHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5410.PartToPartShearCouplingHalfMultibodyDynamicsAnalysis]':
