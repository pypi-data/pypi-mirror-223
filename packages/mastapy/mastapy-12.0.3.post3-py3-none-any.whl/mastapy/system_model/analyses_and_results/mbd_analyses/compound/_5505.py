...
class ConnectionCompoundMultibodyDynamicsAnalysis(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5356.ConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5356.ConnectionMultibodyDynamicsAnalysis]':
