...
class PlanetaryConnectionCompoundMultibodyDynamicsAnalysis(_5567.ShaftToMountableComponentConnectionCompoundMultibodyDynamicsAnalysis):
    """PlanetaryConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5412.PlanetaryConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5412.PlanetaryConnectionMultibodyDynamicsAnalysis]':
