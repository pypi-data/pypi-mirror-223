...
class SpringDamperHalfCompoundMultibodyDynamicsAnalysis(_5509.CouplingHalfCompoundMultibodyDynamicsAnalysis):
    """SpringDamperHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5435.SpringDamperHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5435.SpringDamperHalfMultibodyDynamicsAnalysis]':
