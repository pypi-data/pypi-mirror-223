...
class ZerolBevelGearCompoundMultibodyDynamicsAnalysis(_5486.BevelGearCompoundMultibodyDynamicsAnalysis):
    """ZerolBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5462.ZerolBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5462.ZerolBevelGearMultibodyDynamicsAnalysis]':
