...
class SynchroniserHalfCompoundMultibodyDynamicsAnalysis(_5585.SynchroniserPartCompoundMultibodyDynamicsAnalysis):
    """SynchroniserHalfCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5445.SynchroniserHalfMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5445.SynchroniserHalfMultibodyDynamicsAnalysis]':
