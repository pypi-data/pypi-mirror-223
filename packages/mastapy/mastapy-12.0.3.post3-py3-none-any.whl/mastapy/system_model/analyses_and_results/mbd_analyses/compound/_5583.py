...
class SynchroniserCompoundMultibodyDynamicsAnalysis(_5568.SpecialisedAssemblyCompoundMultibodyDynamicsAnalysis):
    """SynchroniserCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5446.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5446.SynchroniserMultibodyDynamicsAnalysis]':
