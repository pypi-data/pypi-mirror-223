...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5381, _5379, _5430
...
class GearSetMultibodyDynamicsAnalysis(_5430.SpecialisedAssemblyMultibodyDynamicsAnalysis):
    """GearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5381.GearMultibodyDynamicsAnalysis]':
    ...
    @property
    def meshes(self) -> 'List[_5379.GearMeshMultibodyDynamicsAnalysis]':
