...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5332, _5331, _5338
...
class BevelDifferentialGearSetMultibodyDynamicsAnalysis(_5338.BevelGearSetMultibodyDynamicsAnalysis):
    """BevelDifferentialGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5332.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gears_multibody_dynamics_analysis(self) -> 'List[_5332.BevelDifferentialGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_meshes_multibody_dynamics_analysis(self) -> 'List[_5331.BevelDifferentialGearMeshMultibodyDynamicsAnalysis]':
