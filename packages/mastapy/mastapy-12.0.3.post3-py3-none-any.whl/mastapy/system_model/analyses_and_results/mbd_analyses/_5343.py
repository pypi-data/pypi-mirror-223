...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5341, _5360
...
class ClutchMultibodyDynamicsAnalysis(_5360.CouplingMultibodyDynamicsAnalysis):
    """ClutchMultibodyDynamicsAnalysis
    ...
    @property
    def assembly_load_case(self) -> '_6766.ClutchLoadCase':
    ...
    @property
    def clutch_connection(self) -> '_5341.ClutchConnectionMultibodyDynamicsAnalysis':
