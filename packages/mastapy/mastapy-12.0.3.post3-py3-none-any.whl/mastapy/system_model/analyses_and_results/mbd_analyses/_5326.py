...
from mastapy.system_model.analyses_and_results.mbd_analyses import (
    _5327, _5330, _5333, _5339,
    _5340, _5362, _5343, _5349,
    _5352, _5391, _5364, _5366,
    _5370, _5377, _5376, _5378,
    _5382, _5386, _5397, _5400,
    _5401, _5405, _5407, _5411,
    _5414, _5415, _5416, _5418,
    _5420, _5426, _5427, _5320,
    _5433, _5436, _5439, _5442,
    _5446, _5451, _5455, _5460,
    _5463, _5318
)
...
class AssemblyMultibodyDynamicsAnalysis(_5318.AbstractAssemblyMultibodyDynamicsAnalysis):
    """AssemblyMultibodyDynamicsAnalysis
    ...
    @property
    def bearings(self) -> 'List[_5327.BearingMultibodyDynamicsAnalysis]':
    ...
    @property
    def belt_drives(self) -> 'List[_5330.BeltDriveMultibodyDynamicsAnalysis]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_5333.BevelDifferentialGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolted_joints(self) -> 'List[_5339.BoltedJointMultibodyDynamicsAnalysis]':
    ...
    @property
    def bolts(self) -> 'List[_5340.BoltMultibodyDynamicsAnalysis]':
    ...
    @property
    def cv_ts(self) -> 'List[_5362.CVTMultibodyDynamicsAnalysis]':
    ...
    @property
    def clutches(self) -> 'List[_5343.ClutchMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_couplings(self) -> 'List[_5349.ConceptCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_5352.ConceptGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def connections(self) -> 'List[_5391.InterMountableComponentConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_5364.CycloidalAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_5366.CycloidalDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_5370.CylindricalGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def fe_parts(self) -> 'List[_5377.FEPartMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_5376.FaceGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_5378.FlexiblePinAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def gear_sets(self) -> 'List[_5382.GearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_5386.HypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5397.KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5400.KlingelnbergCycloPalloidSpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def mass_discs(self) -> 'List[_5401.MassDiscMultibodyDynamicsAnalysis]':
    ...
    @property
    def measurement_components(self) -> 'List[_5405.MeasurementComponentMultibodyDynamicsAnalysis]':
    ...
    @property
    def oil_seals(self) -> 'List[_5407.OilSealMultibodyDynamicsAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5411.PartToPartShearCouplingMultibodyDynamicsAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5414.PlanetCarrierMultibodyDynamicsAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_5415.PointLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_5416.PowerLoadMultibodyDynamicsAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_5418.RingPinsMultibodyDynamicsAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5420.RollingRingAssemblyMultibodyDynamicsAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5426.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_5427.ShaftMultibodyDynamicsAnalysis]':
    ...
    @property
    def shafts_and_housings(self) -> 'List[_5320.AbstractShaftOrHousingMultibodyDynamicsAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5433.SpiralBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5436.SpringDamperMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5439.StraightBevelDiffGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5442.StraightBevelGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_5446.SynchroniserMultibodyDynamicsAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_5451.TorqueConverterMultibodyDynamicsAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5455.UnbalancedMassMultibodyDynamicsAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5460.WormGearSetMultibodyDynamicsAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5463.ZerolBevelGearSetMultibodyDynamicsAnalysis]':
