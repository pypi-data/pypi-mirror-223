...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5123, _5122, _5066
...
class HypoidGearSetModalAnalysisAtASpeed(_5066.AGMAGleasonConicalGearSetModalAnalysisAtASpeed):
    """HypoidGearSetModalAnalysisAtASpeed
    ...
    @property
    def hypoid_gears_modal_analysis_at_a_speed(self) -> 'List[_5123.HypoidGearModalAnalysisAtASpeed]':
    ...
    @property
    def hypoid_meshes_modal_analysis_at_a_speed(self) -> 'List[_5122.HypoidGearMeshModalAnalysisAtASpeed]':
