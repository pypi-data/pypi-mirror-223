...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5184, _5183, _5120
...
class WormGearSetModalAnalysisAtASpeed(_5120.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    @property
    def worm_gears_modal_analysis_at_a_speed(self) -> 'List[_5184.WormGearModalAnalysisAtASpeed]':
    ...
    @property
    def worm_meshes_modal_analysis_at_a_speed(self) -> 'List[_5183.WormGearMeshModalAnalysisAtASpeed]':
