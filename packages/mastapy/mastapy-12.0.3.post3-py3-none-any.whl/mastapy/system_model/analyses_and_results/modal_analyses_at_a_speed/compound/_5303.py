...
class SynchroniserHalfCompoundModalAnalysisAtASpeed(_5304.SynchroniserPartCompoundModalAnalysisAtASpeed):
    """SynchroniserHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5173.SynchroniserHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5173.SynchroniserHalfModalAnalysisAtASpeed]':
