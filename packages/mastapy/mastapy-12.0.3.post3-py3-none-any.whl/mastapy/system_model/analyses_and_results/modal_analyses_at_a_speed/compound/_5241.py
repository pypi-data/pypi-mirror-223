...
class ExternalCADModelCompoundModalAnalysisAtASpeed(_5214.ComponentCompoundModalAnalysisAtASpeed):
    """ExternalCADModelCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5112.ExternalCADModelModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5112.ExternalCADModelModalAnalysisAtASpeed]':
