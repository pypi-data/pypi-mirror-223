...
class OilSealCompoundModalAnalysisAtASpeed(_5225.ConnectorCompoundModalAnalysisAtASpeed):
    """OilSealCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5138.OilSealModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5138.OilSealModalAnalysisAtASpeed]':
