...
class MassDiscCompoundModalAnalysisAtASpeed(_5311.VirtualComponentCompoundModalAnalysisAtASpeed):
    """MassDiscCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5135.MassDiscModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5135.MassDiscModalAnalysisAtASpeed]':
