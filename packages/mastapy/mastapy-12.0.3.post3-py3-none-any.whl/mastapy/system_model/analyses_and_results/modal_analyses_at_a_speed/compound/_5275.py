...
class PointLoadCompoundModalAnalysisAtASpeed(_5311.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PointLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5146.PointLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5146.PointLoadModalAnalysisAtASpeed]':
