...
class BoltedJointCompoundModalAnalysisAtASpeed(_5287.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """BoltedJointCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5079.BoltedJointModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5079.BoltedJointModalAnalysisAtASpeed]':
