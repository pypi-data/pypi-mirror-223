...
class SynchroniserCompoundModalAnalysisAtAStiffness(_5029.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """SynchroniserCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4916.SynchroniserModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4916.SynchroniserModalAnalysisAtAStiffness]':
