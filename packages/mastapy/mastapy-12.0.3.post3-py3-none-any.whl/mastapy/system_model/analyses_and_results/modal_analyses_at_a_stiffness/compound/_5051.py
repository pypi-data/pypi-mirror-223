...
class TorqueConverterTurbineCompoundModalAnalysisAtAStiffness(_4970.CouplingHalfCompoundModalAnalysisAtAStiffness):
    """TorqueConverterTurbineCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4922.TorqueConverterTurbineModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4922.TorqueConverterTurbineModalAnalysisAtAStiffness]':
