...
class CycloidalAssemblyCompoundModalAnalysisAtAStiffness(_5029.SpecialisedAssemblyCompoundModalAnalysisAtAStiffness):
    """CycloidalAssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4844.CycloidalAssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4844.CycloidalAssemblyModalAnalysisAtAStiffness]':
