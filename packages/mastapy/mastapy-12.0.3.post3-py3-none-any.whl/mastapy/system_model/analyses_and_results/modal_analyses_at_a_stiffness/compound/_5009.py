...
class OilSealCompoundModalAnalysisAtAStiffness(_4967.ConnectorCompoundModalAnalysisAtAStiffness):
    """OilSealCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4880.OilSealModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4880.OilSealModalAnalysisAtAStiffness]':
