...
class TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation(_7109.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterPumpCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7060.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7060.TorqueConverterPumpAdvancedTimeSteppingAnalysisForModulation]':
