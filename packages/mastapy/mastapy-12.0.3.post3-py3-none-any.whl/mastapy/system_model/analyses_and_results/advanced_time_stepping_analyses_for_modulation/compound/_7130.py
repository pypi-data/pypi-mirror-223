...
class GearSetCompoundAdvancedTimeSteppingAnalysisForModulation(_7168.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """GearSetCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7000.GearSetAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7000.GearSetAdvancedTimeSteppingAnalysisForModulation]':
