...
class TorqueConverterAdvancedTimeSteppingAnalysisForModulation(_6977.CouplingAdvancedTimeSteppingAnalysisForModulation):
    """TorqueConverterAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6904.TorqueConverterLoadCase':
