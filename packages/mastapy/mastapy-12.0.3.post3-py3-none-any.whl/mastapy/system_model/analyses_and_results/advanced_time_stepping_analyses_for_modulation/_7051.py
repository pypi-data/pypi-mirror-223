...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7049, _7050, _6958
...
class StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation(_6958.BevelGearSetAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6895.StraightBevelGearSetLoadCase':
    ...
    @property
    def straight_bevel_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7049.StraightBevelGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def straight_bevel_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7050.StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation]':
