...
class RollingRingAdvancedTimeSteppingAnalysisForModulation(_6979.CouplingHalfAdvancedTimeSteppingAnalysisForModulation):
    """RollingRingAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6878.RollingRingLoadCase':
