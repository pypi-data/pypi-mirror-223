...
class StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6894.StraightBevelGearMeshLoadCase':
