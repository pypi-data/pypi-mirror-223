...
from mastapy.system_model.analyses_and_results.advanced_time_stepping_analyses_for_modulation import _7064, _7065, _7000
...
class WormGearSetAdvancedTimeSteppingAnalysisForModulation(_7000.GearSetAdvancedTimeSteppingAnalysisForModulation):
    """WormGearSetAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_load_case(self) -> '_6915.WormGearSetLoadCase':
    ...
    @property
    def worm_gears_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7064.WormGearAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def worm_meshes_advanced_time_stepping_analysis_for_modulation(self) -> 'List[_7065.WormGearMeshAdvancedTimeSteppingAnalysisForModulation]':
