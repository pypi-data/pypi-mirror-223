...
class StraightBevelGearAdvancedTimeSteppingAnalysisForModulation(_6956.BevelGearAdvancedTimeSteppingAnalysisForModulation):
    """StraightBevelGearAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6893.StraightBevelGearLoadCase':
