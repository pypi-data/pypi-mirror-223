...
class SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation(_6957.BevelGearMeshAdvancedTimeSteppingAnalysisForModulation):
    """SpiralBevelGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6885.SpiralBevelGearMeshLoadCase':
