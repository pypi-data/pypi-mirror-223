...
class GearSetSystemDeflection(_2757.SpecialisedAssemblySystemDeflection):
    ...
    def perform_implementation_detail_analysis_with_progress(self, imp_detail: '_1221.GearSetImplementationDetail', gear_set_mode: '_323.GearSetModes', progress: '_7488.TaskProgress', run_all_planetary_meshes: Optional['bool'] = True):
