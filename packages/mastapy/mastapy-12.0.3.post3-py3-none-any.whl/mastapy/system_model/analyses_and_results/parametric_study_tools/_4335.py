...
from mastapy.system_model.analyses_and_results.static_loads import _6736, _6743, _6737
...
class ParametricStudyTool(_7464.AnalysisCase):
    """ParametricStudyTool
    ...
    @property
    def load_case(self) -> '_6736.StaticLoadCase':
    ...
    @property
    def time_series_load_case(self) -> '_6737.TimeSeriesLoadCase':
