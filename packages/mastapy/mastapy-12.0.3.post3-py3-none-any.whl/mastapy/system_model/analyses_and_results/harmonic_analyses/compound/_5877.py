...
from mastapy.system_model.analyses_and_results.harmonic_analyses.compound import _5875, _5876, _5819
...
class HypoidGearSetCompoundHarmonicAnalysis(_5819.AGMAGleasonConicalGearSetCompoundHarmonicAnalysis):
    """HypoidGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5708.HypoidGearSetHarmonicAnalysis]':
    ...
    @property
    def hypoid_gears_compound_harmonic_analysis(self) -> 'List[_5875.HypoidGearCompoundHarmonicAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_harmonic_analysis(self) -> 'List[_5876.HypoidGearMeshCompoundHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5708.HypoidGearSetHarmonicAnalysis]':
