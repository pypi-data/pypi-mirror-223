...
class CycloidalDiscCompoundHarmonicAnalysis(_5814.AbstractShaftCompoundHarmonicAnalysis):
    """CycloidalDiscCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5666.CycloidalDiscHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5666.CycloidalDiscHarmonicAnalysis]':
