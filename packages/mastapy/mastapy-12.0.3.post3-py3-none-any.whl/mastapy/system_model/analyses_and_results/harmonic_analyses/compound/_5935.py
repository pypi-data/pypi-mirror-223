...
class VirtualComponentCompoundHarmonicAnalysis(_5890.MountableComponentCompoundHarmonicAnalysis):
    """VirtualComponentCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5771.VirtualComponentHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5771.VirtualComponentHarmonicAnalysis]':
