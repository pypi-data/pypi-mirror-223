...
class TorqueConverterCompoundHarmonicAnalysis(_5850.CouplingCompoundHarmonicAnalysis):
    """TorqueConverterCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5766.TorqueConverterHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5766.TorqueConverterHarmonicAnalysis]':
