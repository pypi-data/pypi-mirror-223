...
class ExternalCADModelCompoundHarmonicAnalysis(_5838.ComponentCompoundHarmonicAnalysis):
    """ExternalCADModelCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5685.ExternalCADModelHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5685.ExternalCADModelHarmonicAnalysis]':
