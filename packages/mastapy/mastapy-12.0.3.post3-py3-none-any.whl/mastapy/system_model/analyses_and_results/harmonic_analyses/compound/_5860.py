...
class CylindricalGearCompoundHarmonicAnalysis(_5871.GearCompoundHarmonicAnalysis):
    """CylindricalGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5668.CylindricalGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5668.CylindricalGearHarmonicAnalysis]':
