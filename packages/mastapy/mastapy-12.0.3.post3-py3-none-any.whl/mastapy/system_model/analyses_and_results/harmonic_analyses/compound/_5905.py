...
class RollingRingCompoundHarmonicAnalysis(_5852.CouplingHalfCompoundHarmonicAnalysis):
    """RollingRingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5739.RollingRingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5739.RollingRingHarmonicAnalysis]':
