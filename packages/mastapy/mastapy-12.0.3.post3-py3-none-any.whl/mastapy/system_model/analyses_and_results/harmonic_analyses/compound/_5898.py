...
class PlanetCarrierCompoundHarmonicAnalysis(_5890.MountableComponentCompoundHarmonicAnalysis):
    """PlanetCarrierCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5730.PlanetCarrierHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5730.PlanetCarrierHarmonicAnalysis]':
