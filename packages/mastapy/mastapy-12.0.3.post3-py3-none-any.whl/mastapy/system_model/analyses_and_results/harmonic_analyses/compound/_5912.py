...
class SpiralBevelGearCompoundHarmonicAnalysis(_5829.BevelGearCompoundHarmonicAnalysis):
    """SpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5747.SpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5747.SpiralBevelGearHarmonicAnalysis]':
