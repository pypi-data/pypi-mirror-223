...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5713, _5714, _5712
...
class KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis(_5712.KlingelnbergCycloPalloidConicalGearSetHarmonicAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis
    ...
    @property
    def gears_harmonic_analysis(self) -> 'List[_5713.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_harmonic_analysis(self) -> 'List[_5713.KlingelnbergCycloPalloidHypoidGearHarmonicAnalysis]':
    ...
    @property
    def meshes_harmonic_analysis(self) -> 'List[_5714.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_harmonic_analysis(self) -> 'List[_5714.KlingelnbergCycloPalloidHypoidGearMeshHarmonicAnalysis]':
