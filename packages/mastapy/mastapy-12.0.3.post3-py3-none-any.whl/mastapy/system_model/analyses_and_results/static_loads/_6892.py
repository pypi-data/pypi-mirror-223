...
from mastapy.system_model.analyses_and_results.static_loads import _6890, _6891, _6761
...
class StraightBevelDiffGearSetLoadCase(_6761.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6890.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_gears_load_case(self) -> 'List[_6890.StraightBevelDiffGearLoadCase]':
    ...
    @property
    def straight_bevel_diff_meshes_load_case(self) -> 'List[_6891.StraightBevelDiffGearMeshLoadCase]':
