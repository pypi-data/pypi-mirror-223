...
from mastapy.system_model.analyses_and_results.static_loads import _6884, _6885, _6761
...
class SpiralBevelGearSetLoadCase(_6761.BevelGearSetLoadCase):
    """SpiralBevelGearSetLoadCase
    ...
    @property
    def gears(self) -> 'List[_6884.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_gears_load_case(self) -> 'List[_6884.SpiralBevelGearLoadCase]':
    ...
    @property
    def spiral_bevel_meshes_load_case(self) -> 'List[_6885.SpiralBevelGearMeshLoadCase]':
