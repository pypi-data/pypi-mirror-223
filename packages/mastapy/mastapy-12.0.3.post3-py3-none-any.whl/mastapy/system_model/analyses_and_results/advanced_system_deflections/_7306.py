...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7304, _7305, _7220
...
class SpiralBevelGearSetAdvancedSystemDeflection(_7220.BevelGearSetAdvancedSystemDeflection):
    """SpiralBevelGearSetAdvancedSystemDeflection
    ...
    @property
    def spiral_bevel_gears_advanced_system_deflection(self) -> 'List[_7304.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def spiral_bevel_meshes_advanced_system_deflection(self) -> 'List[_7305.SpiralBevelGearMeshAdvancedSystemDeflection]':
