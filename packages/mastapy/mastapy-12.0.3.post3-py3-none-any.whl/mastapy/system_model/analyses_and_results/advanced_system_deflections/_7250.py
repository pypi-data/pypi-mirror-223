...
from mastapy.system_model.analyses_and_results.static_loads import _6792, _6797
from mastapy.gears.gear_designs.cylindrical import _1005, _1034
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7251, _7253, _7262
...
class CylindricalGearAdvancedSystemDeflection(_7262.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6792.CylindricalGearLoadCase':
        ...
        if _6792.CylindricalGearLoadCase.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_advanced_system_deflection_meshes(self) -> 'List[_7251.CylindricalGearMeshAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_gear_advanced_system_deflections_in_meshes(self) -> 'List[_7253.CylindricalMeshedGearAdvancedSystemDeflection]':
    ...
    @property
    def cylindrical_meshed_gear_advanced_system_deflections(self) -> 'List[_7253.CylindricalMeshedGearAdvancedSystemDeflection]':
