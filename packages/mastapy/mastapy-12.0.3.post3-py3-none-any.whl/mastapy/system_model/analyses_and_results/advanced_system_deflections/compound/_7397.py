...
class HypoidGearCompoundAdvancedSystemDeflection(_7339.AGMAGleasonConicalGearCompoundAdvancedSystemDeflection):
    """HypoidGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7266.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7266.HypoidGearAdvancedSystemDeflection]':
