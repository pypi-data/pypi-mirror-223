...
class TorqueConverterCompoundAdvancedSystemDeflection(_7372.CouplingCompoundAdvancedSystemDeflection):
    """TorqueConverterCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7322.TorqueConverterAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7322.TorqueConverterAdvancedSystemDeflection]':
