...
class BeltConnectionCompoundAdvancedSystemDeflection(_7400.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """BeltConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7211.BeltConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7211.BeltConnectionAdvancedSystemDeflection]':
