...
class SynchroniserCompoundAdvancedSystemDeflection(_7433.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """SynchroniserCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7318.SynchroniserAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7318.SynchroniserAdvancedSystemDeflection]':
