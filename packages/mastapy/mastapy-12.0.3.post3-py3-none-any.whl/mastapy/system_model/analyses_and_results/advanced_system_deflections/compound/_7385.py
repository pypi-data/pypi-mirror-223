...
class CylindricalPlanetGearCompoundAdvancedSystemDeflection(_7382.CylindricalGearCompoundAdvancedSystemDeflection):
    """CylindricalPlanetGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7254.CylindricalPlanetGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7254.CylindricalPlanetGearAdvancedSystemDeflection]':
