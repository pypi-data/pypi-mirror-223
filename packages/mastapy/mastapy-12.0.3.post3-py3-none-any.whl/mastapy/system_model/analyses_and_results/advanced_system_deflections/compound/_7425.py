...
class RingPinsToDiscConnectionCompoundAdvancedSystemDeflection(_7400.InterMountableComponentConnectionCompoundAdvancedSystemDeflection):
    """RingPinsToDiscConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7295.RingPinsToDiscConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7295.RingPinsToDiscConnectionAdvancedSystemDeflection]':
