...
class MassDiscCompoundAdvancedSystemDeflection(_7457.VirtualComponentCompoundAdvancedSystemDeflection):
    """MassDiscCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7280.MassDiscAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7280.MassDiscAdvancedSystemDeflection]':
