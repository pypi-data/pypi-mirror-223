...
class BoltedJointCompoundAdvancedSystemDeflection(_7433.SpecialisedAssemblyCompoundAdvancedSystemDeflection):
    """BoltedJointCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7222.BoltedJointAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7222.BoltedJointAdvancedSystemDeflection]':
