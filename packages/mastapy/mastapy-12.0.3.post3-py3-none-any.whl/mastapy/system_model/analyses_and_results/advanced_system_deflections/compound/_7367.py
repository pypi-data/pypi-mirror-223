...
class ConicalGearCompoundAdvancedSystemDeflection(_7393.GearCompoundAdvancedSystemDeflection):
    """ConicalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7234.ConicalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7234.ConicalGearAdvancedSystemDeflection]':
