...
class CylindricalGearCompoundAdvancedSystemDeflection(_7393.GearCompoundAdvancedSystemDeflection):
    """CylindricalGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7250.CylindricalGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7250.CylindricalGearAdvancedSystemDeflection]':
