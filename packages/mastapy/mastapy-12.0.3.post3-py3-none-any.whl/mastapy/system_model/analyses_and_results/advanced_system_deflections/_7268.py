...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7266, _7267, _7208
...
class HypoidGearSetAdvancedSystemDeflection(_7208.AGMAGleasonConicalGearSetAdvancedSystemDeflection):
    """HypoidGearSetAdvancedSystemDeflection
    ...
    @property
    def hypoid_gears_advanced_system_deflection(self) -> 'List[_7266.HypoidGearAdvancedSystemDeflection]':
    ...
    @property
    def hypoid_meshes_advanced_system_deflection(self) -> 'List[_7267.HypoidGearMeshAdvancedSystemDeflection]':
