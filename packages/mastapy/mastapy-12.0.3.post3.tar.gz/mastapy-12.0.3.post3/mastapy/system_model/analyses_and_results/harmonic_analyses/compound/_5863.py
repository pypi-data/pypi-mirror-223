...
class CylindricalPlanetGearCompoundHarmonicAnalysis(_5860.CylindricalGearCompoundHarmonicAnalysis):
    """CylindricalPlanetGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5671.CylindricalPlanetGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5671.CylindricalPlanetGearHarmonicAnalysis]':
