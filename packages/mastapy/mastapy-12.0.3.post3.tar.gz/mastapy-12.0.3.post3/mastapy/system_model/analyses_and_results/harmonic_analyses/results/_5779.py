...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5782, _5780
...
class ExcitationSourceSelection(_5780.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self) -> 'List[_5782.HarmonicSelection]':
