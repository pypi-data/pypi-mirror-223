...
class BearingCompoundHarmonicAnalysis(_5849.ConnectorCompoundHarmonicAnalysis):
    """BearingCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5628.BearingHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5628.BearingHarmonicAnalysis]':
