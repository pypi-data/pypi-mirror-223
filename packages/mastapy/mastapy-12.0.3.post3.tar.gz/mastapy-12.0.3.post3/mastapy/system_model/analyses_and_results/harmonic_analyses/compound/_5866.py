...
class FaceGearCompoundHarmonicAnalysis(_5871.GearCompoundHarmonicAnalysis):
    """FaceGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5686.FaceGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5686.FaceGearHarmonicAnalysis]':
