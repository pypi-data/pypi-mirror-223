...
class ZerolBevelGearCompoundHarmonicAnalysis(_5829.BevelGearCompoundHarmonicAnalysis):
    """ZerolBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5775.ZerolBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5775.ZerolBevelGearHarmonicAnalysis]':
