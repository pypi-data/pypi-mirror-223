...
class KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis(_5879.KlingelnbergCycloPalloidConicalGearCompoundHarmonicAnalysis):
    """KlingelnbergCycloPalloidSpiralBevelGearCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5716.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5716.KlingelnbergCycloPalloidSpiralBevelGearHarmonicAnalysis]':
