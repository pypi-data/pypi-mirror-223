...
class PointLoadCompoundHarmonicAnalysis(_5935.VirtualComponentCompoundHarmonicAnalysis):
    """PointLoadCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5731.PointLoadHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5731.PointLoadHarmonicAnalysis]':
