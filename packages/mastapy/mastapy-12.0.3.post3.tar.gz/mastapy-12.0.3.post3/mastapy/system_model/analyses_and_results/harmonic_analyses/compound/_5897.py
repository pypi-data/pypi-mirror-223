...
class PlanetaryGearSetCompoundHarmonicAnalysis(_5862.CylindricalGearSetCompoundHarmonicAnalysis):
    """PlanetaryGearSetCompoundHarmonicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5729.PlanetaryGearSetHarmonicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5729.PlanetaryGearSetHarmonicAnalysis]':
