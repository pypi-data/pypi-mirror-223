...
class DatumCompoundHarmonicAnalysis(_5838.ComponentCompoundHarmonicAnalysis):
    """DatumCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5672.DatumHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5672.DatumHarmonicAnalysis]':
