...
class CouplingHalfCompoundHarmonicAnalysis(_5890.MountableComponentCompoundHarmonicAnalysis):
    """CouplingHalfCompoundHarmonicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5659.CouplingHalfHarmonicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5659.CouplingHalfHarmonicAnalysis]':
