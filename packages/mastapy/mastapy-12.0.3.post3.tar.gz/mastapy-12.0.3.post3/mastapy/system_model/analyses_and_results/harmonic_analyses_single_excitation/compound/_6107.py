...
class ConnectionCompoundHarmonicAnalysisOfSingleExcitation(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5977.ConnectionHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5977.ConnectionHarmonicAnalysisOfSingleExcitation]':
