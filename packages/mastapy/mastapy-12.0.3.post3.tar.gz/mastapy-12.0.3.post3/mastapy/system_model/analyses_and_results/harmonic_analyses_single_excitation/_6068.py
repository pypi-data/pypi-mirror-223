...
from mastapy.system_model.analyses_and_results.harmonic_analyses_single_excitation import _6066, _6067, _6002
...
class WormGearSetHarmonicAnalysisOfSingleExcitation(_6002.GearSetHarmonicAnalysisOfSingleExcitation):
    """WormGearSetHarmonicAnalysisOfSingleExcitation
    ...
    @property
    def worm_gears_harmonic_analysis_of_single_excitation(self) -> 'List[_6066.WormGearHarmonicAnalysisOfSingleExcitation]':
    ...
    @property
    def worm_meshes_harmonic_analysis_of_single_excitation(self) -> 'List[_6067.WormGearMeshHarmonicAnalysisOfSingleExcitation]':
