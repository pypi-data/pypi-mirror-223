...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5385, _5384, _5324
...
class HypoidGearSetMultibodyDynamicsAnalysis(_5324.AGMAGleasonConicalGearSetMultibodyDynamicsAnalysis):
    """HypoidGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5385.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_gears_multibody_dynamics_analysis(self) -> 'List[_5385.HypoidGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def hypoid_meshes_multibody_dynamics_analysis(self) -> 'List[_5384.HypoidGearMeshMultibodyDynamicsAnalysis]':
