...
class ShaftHubConnectionCompoundMultibodyDynamicsAnalysis(_5506.ConnectorCompoundMultibodyDynamicsAnalysis):
    """ShaftHubConnectionCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5426.ShaftHubConnectionMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5426.ShaftHubConnectionMultibodyDynamicsAnalysis]':
