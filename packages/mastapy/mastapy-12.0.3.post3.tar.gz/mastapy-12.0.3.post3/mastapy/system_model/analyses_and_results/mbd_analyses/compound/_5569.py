...
class SpiralBevelGearCompoundMultibodyDynamicsAnalysis(_5486.BevelGearCompoundMultibodyDynamicsAnalysis):
    """SpiralBevelGearCompoundMultibodyDynamicsAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5432.SpiralBevelGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5432.SpiralBevelGearMultibodyDynamicsAnalysis]':
