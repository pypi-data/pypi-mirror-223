...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5369, _5368, _5382
...
class CylindricalGearSetMultibodyDynamicsAnalysis(_5382.GearSetMultibodyDynamicsAnalysis):
    """CylindricalGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5369.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_gears_multibody_dynamics_analysis(self) -> 'List[_5369.CylindricalGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def cylindrical_meshes_multibody_dynamics_analysis(self) -> 'List[_5368.CylindricalGearMeshMultibodyDynamicsAnalysis]':
