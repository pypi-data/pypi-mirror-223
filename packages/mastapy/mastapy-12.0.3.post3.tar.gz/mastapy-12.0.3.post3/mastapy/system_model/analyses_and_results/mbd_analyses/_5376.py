...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5375, _5374, _5382
...
class FaceGearSetMultibodyDynamicsAnalysis(_5382.GearSetMultibodyDynamicsAnalysis):
    """FaceGearSetMultibodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5375.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_gears_multibody_dynamics_analysis(self) -> 'List[_5375.FaceGearMultibodyDynamicsAnalysis]':
    ...
    @property
    def face_meshes_multibody_dynamics_analysis(self) -> 'List[_5374.FaceGearMeshMultibodyDynamicsAnalysis]':
