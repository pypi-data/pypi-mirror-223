...
class ConnectionCompoundModalAnalysisAtAStiffness(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtAStiffness
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4836.ConnectionModalAnalysisAtAStiffness]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4836.ConnectionModalAnalysisAtAStiffness]':
