...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness.compound import (
    _4939, _4941, _4944, _4951,
    _4950, _4972, _4952, _4957,
    _4962, _4974, _4976, _4980,
    _4987, _4986, _4988, _4995,
    _5002, _5005, _5006, _5007,
    _5009, _5011, _5016, _5017,
    _5018, _5020, _5022, _5027,
    _5026, _5032, _5033, _5038,
    _5041, _5044, _5048, _5052,
    _5056, _5059, _4931
)
...
class AssemblyCompoundModalAnalysisAtAStiffness(_4931.AbstractAssemblyCompoundModalAnalysisAtAStiffness):
    """AssemblyCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4808.AssemblyModalAnalysisAtAStiffness]':
    ...
    @property
    def bearings(self) -> 'List[_4939.BearingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def belt_drives(self) -> 'List[_4941.BeltDriveCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bevel_differential_gear_sets(self) -> 'List[_4944.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolted_joints(self) -> 'List[_4951.BoltedJointCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def bolts(self) -> 'List[_4950.BoltCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cv_ts(self) -> 'List[_4972.CVTCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def clutches(self) -> 'List[_4952.ClutchCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_couplings(self) -> 'List[_4957.ConceptCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_gear_sets(self) -> 'List[_4962.ConceptGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_assemblies(self) -> 'List[_4974.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cycloidal_discs(self) -> 'List[_4976.CycloidalDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def cylindrical_gear_sets(self) -> 'List[_4980.CylindricalGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def fe_parts(self) -> 'List[_4987.FEPartCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def face_gear_sets(self) -> 'List[_4986.FaceGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def flexible_pin_assemblies(self) -> 'List[_4988.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def hypoid_gear_sets(self) -> 'List[_4995.HypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(self) -> 'List[_5002.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(self) -> 'List[_5005.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def mass_discs(self) -> 'List[_5006.MassDiscCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def measurement_components(self) -> 'List[_5007.MeasurementComponentCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def oil_seals(self) -> 'List[_5009.OilSealCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_5011.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def planet_carriers(self) -> 'List[_5016.PlanetCarrierCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def point_loads(self) -> 'List[_5017.PointLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def power_loads(self) -> 'List[_5018.PowerLoadCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def ring_pins(self) -> 'List[_5020.RingPinsCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_5022.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_5027.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def shafts(self) -> 'List[_5026.ShaftCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_5032.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def spring_dampers(self) -> 'List[_5033.SpringDamperCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_5038.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_5041.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def synchronisers(self) -> 'List[_5044.SynchroniserCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def torque_converters(self) -> 'List[_5048.TorqueConverterCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_5052.UnbalancedMassCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_5056.WormGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_5059.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4808.AssemblyModalAnalysisAtAStiffness]':
