...
class ConicalGearSetCompoundModalAnalysisAtAStiffness(_4991.GearSetCompoundModalAnalysisAtAStiffness):
    """ConicalGearSetCompoundModalAnalysisAtAStiffness
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4835.ConicalGearSetModalAnalysisAtAStiffness]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4835.ConicalGearSetModalAnalysisAtAStiffness]':
