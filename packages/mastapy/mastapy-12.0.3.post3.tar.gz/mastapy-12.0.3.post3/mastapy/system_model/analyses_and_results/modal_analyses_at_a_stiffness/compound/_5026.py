...
class ShaftCompoundModalAnalysisAtAStiffness(_4932.AbstractShaftCompoundModalAnalysisAtAStiffness):
    """ShaftCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4898.ShaftModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4898.ShaftModalAnalysisAtAStiffness]':
