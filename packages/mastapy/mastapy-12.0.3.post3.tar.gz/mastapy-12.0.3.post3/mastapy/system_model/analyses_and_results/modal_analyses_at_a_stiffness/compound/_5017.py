...
class PointLoadCompoundModalAnalysisAtAStiffness(_5053.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PointLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4888.PointLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4888.PointLoadModalAnalysisAtAStiffness]':
