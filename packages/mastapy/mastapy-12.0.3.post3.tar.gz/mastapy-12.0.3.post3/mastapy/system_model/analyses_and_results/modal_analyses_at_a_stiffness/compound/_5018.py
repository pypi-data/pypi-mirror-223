...
class PowerLoadCompoundModalAnalysisAtAStiffness(_5053.VirtualComponentCompoundModalAnalysisAtAStiffness):
    """PowerLoadCompoundModalAnalysisAtAStiffness
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4889.PowerLoadModalAnalysisAtAStiffness]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4889.PowerLoadModalAnalysisAtAStiffness]':
