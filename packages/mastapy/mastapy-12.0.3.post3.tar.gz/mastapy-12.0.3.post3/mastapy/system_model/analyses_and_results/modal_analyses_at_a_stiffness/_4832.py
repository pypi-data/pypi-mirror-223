...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4831, _4830, _4862
...
class ConceptGearSetModalAnalysisAtAStiffness(_4862.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    @property
    def concept_gears_modal_analysis_at_a_stiffness(self) -> 'List[_4831.ConceptGearModalAnalysisAtAStiffness]':
    ...
    @property
    def concept_meshes_modal_analysis_at_a_stiffness(self) -> 'List[_4830.ConceptGearMeshModalAnalysisAtAStiffness]':
