...
class GearLoadCase(_6855.MountableComponentLoadCase):
    """GearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6822.GearManufactureError':
        ...
        if _6822.GearManufactureError.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_conical_gear_manufacture_error(self) -> '_6776.ConicalGearManufactureError':
        ...
        if _6776.ConicalGearManufactureError.TYPE not in temp.__class__.__mro__:
    ...
    @property
    def gear_manufacture_errors_of_type_cylindrical_gear_manufacture_error(self) -> '_6793.CylindricalGearManufactureError':
        ...
        if _6793.CylindricalGearManufactureError.TYPE not in temp.__class__.__mro__:
