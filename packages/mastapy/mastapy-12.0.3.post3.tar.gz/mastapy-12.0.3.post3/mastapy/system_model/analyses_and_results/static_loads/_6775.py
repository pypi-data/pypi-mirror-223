...
from mastapy.system_model.analyses_and_results.static_loads import _6776, _6821
...
class ConicalGearLoadCase(_6821.GearLoadCase):
    """ConicalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6776.ConicalGearManufactureError':
