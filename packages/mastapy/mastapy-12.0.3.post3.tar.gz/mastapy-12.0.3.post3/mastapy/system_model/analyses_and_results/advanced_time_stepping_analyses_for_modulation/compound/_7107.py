...
class CouplingCompoundAdvancedTimeSteppingAnalysisForModulation(_7168.SpecialisedAssemblyCompoundAdvancedTimeSteppingAnalysisForModulation):
    """CouplingCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6977.CouplingAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6977.CouplingAdvancedTimeSteppingAnalysisForModulation]':
