...
class PulleyCompoundAdvancedTimeSteppingAnalysisForModulation(_7109.CouplingHalfCompoundAdvancedTimeSteppingAnalysisForModulation):
    """PulleyCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7029.PulleyAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7029.PulleyAdvancedTimeSteppingAnalysisForModulation]':
