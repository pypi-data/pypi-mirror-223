...
class ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation(_6999.GearMeshAdvancedTimeSteppingAnalysisForModulation):
    """ConceptGearMeshAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6773.ConceptGearMeshLoadCase':
