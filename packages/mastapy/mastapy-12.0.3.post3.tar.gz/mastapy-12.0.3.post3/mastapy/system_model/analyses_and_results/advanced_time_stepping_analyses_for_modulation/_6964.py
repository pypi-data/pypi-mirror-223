...
from mastapy.system_model.analyses_and_results.static_loads import _6767, _6789
...
class CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation(_7038.ShaftToMountableComponentConnectionAdvancedTimeSteppingAnalysisForModulation):
    """CoaxialConnectionAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def connection_load_case(self) -> '_6767.CoaxialConnectionLoadCase':
        ...
        if _6767.CoaxialConnectionLoadCase.TYPE not in temp.__class__.__mro__:
