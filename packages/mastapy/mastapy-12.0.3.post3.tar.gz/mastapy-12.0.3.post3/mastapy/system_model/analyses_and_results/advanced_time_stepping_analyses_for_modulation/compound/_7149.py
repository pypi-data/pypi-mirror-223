...
class PartCompoundAdvancedTimeSteppingAnalysisForModulation(_7475.PartCompoundAnalysis):
    """PartCompoundAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7020.PartAdvancedTimeSteppingAnalysisForModulation]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7020.PartAdvancedTimeSteppingAnalysisForModulation]':
