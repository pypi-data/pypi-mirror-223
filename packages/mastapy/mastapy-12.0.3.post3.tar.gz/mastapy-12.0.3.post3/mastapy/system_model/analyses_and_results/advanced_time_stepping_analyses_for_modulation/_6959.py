...
class BoltAdvancedTimeSteppingAnalysisForModulation(_6965.ComponentAdvancedTimeSteppingAnalysisForModulation):
    """BoltAdvancedTimeSteppingAnalysisForModulation
    ...
    @property
    def component_load_case(self) -> '_6763.BoltLoadCase':
