...
class ZerolBevelGearMeshCompoundModalAnalysis(_4689.BevelGearMeshCompoundModalAnalysis):
    """ZerolBevelGearMeshCompoundModalAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_4657.ZerolBevelGearMeshModalAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_4657.ZerolBevelGearMeshModalAnalysis]':
