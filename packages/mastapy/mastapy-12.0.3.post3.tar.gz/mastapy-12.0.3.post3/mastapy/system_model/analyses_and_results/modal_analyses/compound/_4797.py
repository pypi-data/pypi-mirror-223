...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4795, _4796, _4732
...
class WormGearSetCompoundModalAnalysis(_4732.GearSetCompoundModalAnalysis):
    """WormGearSetCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4656.WormGearSetModalAnalysis]':
    ...
    @property
    def worm_gears_compound_modal_analysis(self) -> 'List[_4795.WormGearCompoundModalAnalysis]':
    ...
    @property
    def worm_meshes_compound_modal_analysis(self) -> 'List[_4796.WormGearMeshCompoundModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4656.WormGearSetModalAnalysis]':
