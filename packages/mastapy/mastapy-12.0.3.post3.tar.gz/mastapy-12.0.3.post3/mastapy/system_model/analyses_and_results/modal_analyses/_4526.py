...
from mastapy.system_model.analyses_and_results.modal_analyses import (
    ...
    _4604, _4609, _4612, _4613,
    _4614, _4616, _4618, _4622,
    _4623, _4629, _4632, _4635,
    _4638, _4642, _4646, _4649,
    _4656, _4659, _4519
)
...
class AssemblyModalAnalysis(_4519.AbstractAssemblyModalAnalysis):
    ...
    @property
    def calculate_full_fe_results_by_mode(self) -> 'List[_4660.CalculateFullFEResultsForMode]':
    ...
    @property
    def oil_seals(self) -> 'List[_4604.OilSealModalAnalysis]':
    ...
    @property
    def part_to_part_shear_couplings(self) -> 'List[_4609.PartToPartShearCouplingModalAnalysis]':
    ...
    @property
    def planet_carriers(self) -> 'List[_4612.PlanetCarrierModalAnalysis]':
    ...
    @property
    def point_loads(self) -> 'List[_4613.PointLoadModalAnalysis]':
    ...
    @property
    def power_loads(self) -> 'List[_4614.PowerLoadModalAnalysis]':
    ...
    @property
    def ring_pins(self) -> 'List[_4616.RingPinsModalAnalysis]':
    ...
    @property
    def rolling_ring_assemblies(self) -> 'List[_4618.RollingRingAssemblyModalAnalysis]':
    ...
    @property
    def shaft_hub_connections(self) -> 'List[_4622.ShaftHubConnectionModalAnalysis]':
    ...
    @property
    def shafts(self) -> 'List[_4623.ShaftModalAnalysis]':
    ...
    @property
    def spiral_bevel_gear_sets(self) -> 'List[_4629.SpiralBevelGearSetModalAnalysis]':
    ...
    @property
    def spring_dampers(self) -> 'List[_4632.SpringDamperModalAnalysis]':
    ...
    @property
    def straight_bevel_diff_gear_sets(self) -> 'List[_4635.StraightBevelDiffGearSetModalAnalysis]':
    ...
    @property
    def straight_bevel_gear_sets(self) -> 'List[_4638.StraightBevelGearSetModalAnalysis]':
    ...
    @property
    def synchronisers(self) -> 'List[_4642.SynchroniserModalAnalysis]':
    ...
    @property
    def torque_converters(self) -> 'List[_4646.TorqueConverterModalAnalysis]':
    ...
    @property
    def unbalanced_masses(self) -> 'List[_4649.UnbalancedMassModalAnalysis]':
    ...
    @property
    def worm_gear_sets(self) -> 'List[_4656.WormGearSetModalAnalysis]':
    ...
    @property
    def zerol_bevel_gear_sets(self) -> 'List[_4659.ZerolBevelGearSetModalAnalysis]':
