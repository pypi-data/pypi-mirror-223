...
class TorqueConverterTurbineCompoundModalAnalysis(_4711.CouplingHalfCompoundModalAnalysis):
    """TorqueConverterTurbineCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4648.TorqueConverterTurbineModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4648.TorqueConverterTurbineModalAnalysis]':
