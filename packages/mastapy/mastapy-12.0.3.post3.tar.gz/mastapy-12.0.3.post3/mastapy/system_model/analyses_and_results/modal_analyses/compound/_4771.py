...
class SpiralBevelGearCompoundModalAnalysis(_4688.BevelGearCompoundModalAnalysis):
    """SpiralBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4628.SpiralBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4628.SpiralBevelGearModalAnalysis]':
