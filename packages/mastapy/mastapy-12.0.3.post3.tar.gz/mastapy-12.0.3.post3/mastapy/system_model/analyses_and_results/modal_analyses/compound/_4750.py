...
class OilSealCompoundModalAnalysis(_4708.ConnectorCompoundModalAnalysis):
    """OilSealCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4604.OilSealModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4604.OilSealModalAnalysis]':
