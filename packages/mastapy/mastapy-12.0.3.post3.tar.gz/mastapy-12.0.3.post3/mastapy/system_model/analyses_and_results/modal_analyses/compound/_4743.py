...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4741, _4742, _4740
...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis(_4740.KlingelnbergCycloPalloidConicalGearSetCompoundModalAnalysis):
    """KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis(self) -> 'List[_4741.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysis]':
    ...
    @property
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis(self) -> 'List[_4742.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysis]':
