...
class StraightBevelGearCompoundModalAnalysis(_4688.BevelGearCompoundModalAnalysis):
    """StraightBevelGearCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_4637.StraightBevelGearModalAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_4637.StraightBevelGearModalAnalysis]':
