...
class SpecialisedAssemblyCompoundModalAnalysis(_4672.AbstractAssemblyCompoundModalAnalysis):
    """SpecialisedAssemblyCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_4626.SpecialisedAssemblyModalAnalysis]':
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_4626.SpecialisedAssemblyModalAnalysis]':
