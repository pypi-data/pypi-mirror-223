...
from mastapy.system_model.analyses_and_results.modal_analyses.compound import _4734, _4735, _4678
...
class HypoidGearSetCompoundModalAnalysis(_4678.AGMAGleasonConicalGearSetCompoundModalAnalysis):
    """HypoidGearSetCompoundModalAnalysis
    ...
    @property
    def hypoid_gears_compound_modal_analysis(self) -> 'List[_4734.HypoidGearCompoundModalAnalysis]':
    ...
    @property
    def hypoid_meshes_compound_modal_analysis(self) -> 'List[_4735.HypoidGearMeshCompoundModalAnalysis]':
