...
from mastapy.system_model.analyses_and_results.modal_analyses import _4637, _4636, _4537
...
class StraightBevelGearSetModalAnalysis(_4537.BevelGearSetModalAnalysis):
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4637.StraightBevelGearModalAnalysis]':
    ...
    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4636.StraightBevelGearMeshModalAnalysis]':
