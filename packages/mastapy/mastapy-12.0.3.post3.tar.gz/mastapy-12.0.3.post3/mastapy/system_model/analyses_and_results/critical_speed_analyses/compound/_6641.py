...
class ConnectionCompoundCriticalSpeedAnalysis(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6510.ConnectionCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6510.ConnectionCriticalSpeedAnalysis]':
