...
class PointLoadCompoundCriticalSpeedAnalysis(_6728.VirtualComponentCompoundCriticalSpeedAnalysis):
    """PointLoadCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6563.PointLoadCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6563.PointLoadCriticalSpeedAnalysis]':
