...
class ConceptGearMeshCompoundCriticalSpeedAnalysis(_6665.GearMeshCompoundCriticalSpeedAnalysis):
    """ConceptGearMeshCompoundCriticalSpeedAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6505.ConceptGearMeshCriticalSpeedAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6505.ConceptGearMeshCriticalSpeedAnalysis]':
