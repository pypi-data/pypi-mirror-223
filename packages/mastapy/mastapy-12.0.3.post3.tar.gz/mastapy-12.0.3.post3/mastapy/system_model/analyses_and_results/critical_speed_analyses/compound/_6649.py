...
class CycloidalAssemblyCompoundCriticalSpeedAnalysis(_6704.SpecialisedAssemblyCompoundCriticalSpeedAnalysis):
    """CycloidalAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6520.CycloidalAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6520.CycloidalAssemblyCriticalSpeedAnalysis]':
