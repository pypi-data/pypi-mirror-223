...
class FaceGearCompoundCriticalSpeedAnalysis(_6664.GearCompoundCriticalSpeedAnalysis):
    """FaceGearCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6530.FaceGearCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6530.FaceGearCriticalSpeedAnalysis]':
