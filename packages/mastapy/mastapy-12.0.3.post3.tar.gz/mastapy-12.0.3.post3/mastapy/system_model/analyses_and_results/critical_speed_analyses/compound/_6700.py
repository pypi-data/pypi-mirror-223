...
class RootAssemblyCompoundCriticalSpeedAnalysis(_6613.AssemblyCompoundCriticalSpeedAnalysis):
    """RootAssemblyCompoundCriticalSpeedAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6571.RootAssemblyCriticalSpeedAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6571.RootAssemblyCriticalSpeedAnalysis]':
