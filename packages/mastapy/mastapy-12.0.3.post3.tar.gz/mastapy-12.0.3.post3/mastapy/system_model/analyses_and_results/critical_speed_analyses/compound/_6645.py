...
class CouplingHalfCompoundCriticalSpeedAnalysis(_6683.MountableComponentCompoundCriticalSpeedAnalysis):
    """CouplingHalfCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6514.CouplingHalfCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6514.CouplingHalfCriticalSpeedAnalysis]':
