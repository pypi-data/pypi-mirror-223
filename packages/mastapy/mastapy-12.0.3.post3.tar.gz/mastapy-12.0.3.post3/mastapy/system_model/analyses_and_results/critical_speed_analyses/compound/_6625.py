...
class BoltCompoundCriticalSpeedAnalysis(_6631.ComponentCompoundCriticalSpeedAnalysis):
    """BoltCompoundCriticalSpeedAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6494.BoltCriticalSpeedAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6494.BoltCriticalSpeedAnalysis]':
