...
from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6504, _6505, _6537
...
class ConceptGearSetCriticalSpeedAnalysis(_6537.GearSetCriticalSpeedAnalysis):
    """ConceptGearSetCriticalSpeedAnalysis
    ...
    @property
    def concept_gears_critical_speed_analysis(self) -> 'List[_6504.ConceptGearCriticalSpeedAnalysis]':
    ...
    @property
    def concept_meshes_critical_speed_analysis(self) -> 'List[_6505.ConceptGearMeshCriticalSpeedAnalysis]':
