...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed import _5114, _5113, _5120
...
class FaceGearSetModalAnalysisAtASpeed(_5120.GearSetModalAnalysisAtASpeed):
    """FaceGearSetModalAnalysisAtASpeed
    ...
    @property
    def face_gears_modal_analysis_at_a_speed(self) -> 'List[_5114.FaceGearModalAnalysisAtASpeed]':
    ...
    @property
    def face_meshes_modal_analysis_at_a_speed(self) -> 'List[_5113.FaceGearMeshModalAnalysisAtASpeed]':
