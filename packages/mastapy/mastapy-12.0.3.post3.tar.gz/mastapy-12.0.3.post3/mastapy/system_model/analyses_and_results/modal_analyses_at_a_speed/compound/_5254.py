...
class InterMountableComponentConnectionCompoundModalAnalysisAtASpeed(_5224.ConnectionCompoundModalAnalysisAtASpeed):
    """InterMountableComponentConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5125.InterMountableComponentConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5125.InterMountableComponentConnectionModalAnalysisAtASpeed]':
