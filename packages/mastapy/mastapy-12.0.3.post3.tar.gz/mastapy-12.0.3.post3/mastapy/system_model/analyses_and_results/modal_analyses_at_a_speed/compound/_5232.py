...
class CycloidalAssemblyCompoundModalAnalysisAtASpeed(_5287.SpecialisedAssemblyCompoundModalAnalysisAtASpeed):
    """CycloidalAssemblyCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5103.CycloidalAssemblyModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5103.CycloidalAssemblyModalAnalysisAtASpeed]':
