...
class ConnectionCompoundModalAnalysisAtASpeed(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5095.ConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5095.ConnectionModalAnalysisAtASpeed]':
