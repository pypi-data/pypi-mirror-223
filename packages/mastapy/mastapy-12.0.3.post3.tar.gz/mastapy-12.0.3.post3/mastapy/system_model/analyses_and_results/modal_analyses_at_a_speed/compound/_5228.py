...
class CouplingHalfCompoundModalAnalysisAtASpeed(_5266.MountableComponentCompoundModalAnalysisAtASpeed):
    """CouplingHalfCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5098.CouplingHalfModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5098.CouplingHalfModalAnalysisAtASpeed]':
