...
class PowerLoadCompoundModalAnalysisAtASpeed(_5311.VirtualComponentCompoundModalAnalysisAtASpeed):
    """PowerLoadCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_5147.PowerLoadModalAnalysisAtASpeed]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_5147.PowerLoadModalAnalysisAtASpeed]':
