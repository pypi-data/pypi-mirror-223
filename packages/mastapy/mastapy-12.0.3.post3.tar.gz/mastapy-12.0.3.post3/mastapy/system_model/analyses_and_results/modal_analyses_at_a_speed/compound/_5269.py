...
class PartToPartShearCouplingCompoundModalAnalysisAtASpeed(_5226.CouplingCompoundModalAnalysisAtASpeed):
    """PartToPartShearCouplingCompoundModalAnalysisAtASpeed
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_5142.PartToPartShearCouplingModalAnalysisAtASpeed]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_5142.PartToPartShearCouplingModalAnalysisAtASpeed]':
