...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.compound import _5198
...
class CVTBeltConnectionCompoundModalAnalysisAtASpeed(_5198.BeltConnectionCompoundModalAnalysisAtASpeed):
    """CVTBeltConnectionCompoundModalAnalysisAtASpeed
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_5100.CVTBeltConnectionModalAnalysisAtASpeed]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_5100.CVTBeltConnectionModalAnalysisAtASpeed]':
