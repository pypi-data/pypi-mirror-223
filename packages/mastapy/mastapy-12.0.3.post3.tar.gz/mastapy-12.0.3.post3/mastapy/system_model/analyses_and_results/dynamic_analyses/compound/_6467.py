...
class ZerolBevelGearMeshCompoundDynamicAnalysis(_6357.BevelGearMeshCompoundDynamicAnalysis):
    """ZerolBevelGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6338.ZerolBevelGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6338.ZerolBevelGearMeshDynamicAnalysis]':
