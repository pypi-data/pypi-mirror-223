...
class ConnectionCompoundDynamicAnalysis(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6245.ConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6245.ConnectionDynamicAnalysis]':
