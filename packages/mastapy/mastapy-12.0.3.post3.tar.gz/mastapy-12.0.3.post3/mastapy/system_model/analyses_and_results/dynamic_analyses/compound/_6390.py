...
class CylindricalPlanetGearCompoundDynamicAnalysis(_6387.CylindricalGearCompoundDynamicAnalysis):
    """CylindricalPlanetGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6260.CylindricalPlanetGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6260.CylindricalPlanetGearDynamicAnalysis]':
