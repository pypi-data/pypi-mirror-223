...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6337, _6338, _6228
...
class ZerolBevelGearSetDynamicAnalysis(_6228.BevelGearSetDynamicAnalysis):
    """ZerolBevelGearSetDynamicAnalysis
    ...
    @property
    def zerol_bevel_gears_dynamic_analysis(self) -> 'List[_6337.ZerolBevelGearDynamicAnalysis]':
    ...
    @property
    def zerol_bevel_meshes_dynamic_analysis(self) -> 'List[_6338.ZerolBevelGearMeshDynamicAnalysis]':
