...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6369, _6370, _6400
...
class ConceptGearSetCompoundDynamicAnalysis(_6400.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6241.ConceptGearSetDynamicAnalysis]':
    ...
    @property
    def concept_gears_compound_dynamic_analysis(self) -> 'List[_6369.ConceptGearCompoundDynamicAnalysis]':
    ...
    @property
    def concept_meshes_compound_dynamic_analysis(self) -> 'List[_6370.ConceptGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6241.ConceptGearSetDynamicAnalysis]':
