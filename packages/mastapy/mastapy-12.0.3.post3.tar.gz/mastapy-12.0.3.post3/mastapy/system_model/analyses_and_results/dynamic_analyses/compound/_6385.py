...
class CycloidalDiscCompoundDynamicAnalysis(_6341.AbstractShaftCompoundDynamicAnalysis):
    """CycloidalDiscCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6255.CycloidalDiscDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6255.CycloidalDiscDynamicAnalysis]':
