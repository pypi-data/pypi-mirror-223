...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6273, _6274, _6216
...
class HypoidGearSetDynamicAnalysis(_6216.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    @property
    def hypoid_gears_dynamic_analysis(self) -> 'List[_6273.HypoidGearDynamicAnalysis]':
    ...
    @property
    def hypoid_meshes_dynamic_analysis(self) -> 'List[_6274.HypoidGearMeshDynamicAnalysis]':
