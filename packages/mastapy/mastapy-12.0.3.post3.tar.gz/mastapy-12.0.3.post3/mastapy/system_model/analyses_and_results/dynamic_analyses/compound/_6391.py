...
class DatumCompoundDynamicAnalysis(_6365.ComponentCompoundDynamicAnalysis):
    """DatumCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6261.DatumDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6261.DatumDynamicAnalysis]':
