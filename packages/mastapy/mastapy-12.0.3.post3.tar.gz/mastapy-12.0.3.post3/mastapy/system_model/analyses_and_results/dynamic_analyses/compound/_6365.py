...
class ComponentCompoundDynamicAnalysis(_6419.PartCompoundDynamicAnalysis):
    """ComponentCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6235.ComponentDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6235.ComponentDynamicAnalysis]':
