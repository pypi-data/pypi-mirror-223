...
class ConceptGearMeshCompoundDynamicAnalysis(_6399.GearMeshCompoundDynamicAnalysis):
    """ConceptGearMeshCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6240.ConceptGearMeshDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6240.ConceptGearMeshDynamicAnalysis]':
