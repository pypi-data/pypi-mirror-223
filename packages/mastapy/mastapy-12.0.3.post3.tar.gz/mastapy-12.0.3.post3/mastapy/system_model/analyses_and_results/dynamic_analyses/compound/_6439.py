...
class SpiralBevelGearCompoundDynamicAnalysis(_6356.BevelGearCompoundDynamicAnalysis):
    """SpiralBevelGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6310.SpiralBevelGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6310.SpiralBevelGearDynamicAnalysis]':
