...
class RollingRingConnectionCompoundDynamicAnalysis(_6405.InterMountableComponentConnectionCompoundDynamicAnalysis):
    """RollingRingConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6303.RollingRingConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6303.RollingRingConnectionDynamicAnalysis]':
