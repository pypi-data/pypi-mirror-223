...
class PointLoadCompoundDynamicAnalysis(_6462.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6297.PointLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6297.PointLoadDynamicAnalysis]':
