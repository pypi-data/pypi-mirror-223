...
class SynchroniserSleeveCompoundDynamicAnalysis(_6455.SynchroniserPartCompoundDynamicAnalysis):
    """SynchroniserSleeveCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6327.SynchroniserSleeveDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6327.SynchroniserSleeveDynamicAnalysis]':
