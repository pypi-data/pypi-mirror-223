...
class PowerLoadCompoundDynamicAnalysis(_6462.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6298.PowerLoadDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6298.PowerLoadDynamicAnalysis]':
