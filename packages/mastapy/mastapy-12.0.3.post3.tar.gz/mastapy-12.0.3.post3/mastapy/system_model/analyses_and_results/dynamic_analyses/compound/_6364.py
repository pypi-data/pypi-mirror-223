...
class CoaxialConnectionCompoundDynamicAnalysis(_6437.ShaftToMountableComponentConnectionCompoundDynamicAnalysis):
    """CoaxialConnectionCompoundDynamicAnalysis
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_6234.CoaxialConnectionDynamicAnalysis]':
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_6234.CoaxialConnectionDynamicAnalysis]':
