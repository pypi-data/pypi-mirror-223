...
class ConnectorCompoundDynamicAnalysis(_6417.MountableComponentCompoundDynamicAnalysis):
    """ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6246.ConnectorDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6246.ConnectorDynamicAnalysis]':
