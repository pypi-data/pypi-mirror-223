...
class PlanetCarrierCompoundDynamicAnalysis(_6417.MountableComponentCompoundDynamicAnalysis):
    """PlanetCarrierCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6296.PlanetCarrierDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6296.PlanetCarrierDynamicAnalysis]':
