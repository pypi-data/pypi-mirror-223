...
class HypoidGearCompoundDynamicAnalysis(_6344.AGMAGleasonConicalGearCompoundDynamicAnalysis):
    """HypoidGearCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_6273.HypoidGearDynamicAnalysis]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_6273.HypoidGearDynamicAnalysis]':
