...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6393, _6394, _6400
...
class FaceGearSetCompoundDynamicAnalysis(_6400.GearSetCompoundDynamicAnalysis):
    """FaceGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6266.FaceGearSetDynamicAnalysis]':
    ...
    @property
    def face_gears_compound_dynamic_analysis(self) -> 'List[_6393.FaceGearCompoundDynamicAnalysis]':
    ...
    @property
    def face_meshes_compound_dynamic_analysis(self) -> 'List[_6394.FaceGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6266.FaceGearSetDynamicAnalysis]':
