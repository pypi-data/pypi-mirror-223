...
from mastapy.system_model.analyses_and_results.dynamic_analyses.compound import _6351, _6352, _6358
...
class BevelDifferentialGearSetCompoundDynamicAnalysis(_6358.BevelGearSetCompoundDynamicAnalysis):
    """BevelDifferentialGearSetCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_6223.BevelDifferentialGearSetDynamicAnalysis]':
    ...
    @property
    def bevel_differential_gears_compound_dynamic_analysis(self) -> 'List[_6351.BevelDifferentialGearCompoundDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_compound_dynamic_analysis(self) -> 'List[_6352.BevelDifferentialGearMeshCompoundDynamicAnalysis]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_6223.BevelDifferentialGearSetDynamicAnalysis]':
