...
from mastapy.system_model.analyses_and_results.dynamic_analyses import _6221, _6222, _6228
...
class BevelDifferentialGearSetDynamicAnalysis(_6228.BevelGearSetDynamicAnalysis):
    """BevelDifferentialGearSetDynamicAnalysis
    ...
    @property
    def bevel_differential_gears_dynamic_analysis(self) -> 'List[_6221.BevelDifferentialGearDynamicAnalysis]':
    ...
    @property
    def bevel_differential_meshes_dynamic_analysis(self) -> 'List[_6222.BevelDifferentialGearMeshDynamicAnalysis]':
