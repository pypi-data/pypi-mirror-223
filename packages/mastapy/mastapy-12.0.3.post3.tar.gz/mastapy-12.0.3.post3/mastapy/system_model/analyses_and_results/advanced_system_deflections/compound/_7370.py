...
class ConnectionCompoundAdvancedSystemDeflection(_7468.ConnectionCompoundAnalysis):
    """ConnectionCompoundAdvancedSystemDeflection
    ...
    @property
    def connection_analysis_cases(self) -> 'List[_7237.ConnectionAdvancedSystemDeflection]':
    ...
    @property
    def connection_analysis_cases_ready(self) -> 'List[_7237.ConnectionAdvancedSystemDeflection]':
