...
class PlanetaryGearSetCompoundAdvancedSystemDeflection(_7384.CylindricalGearSetCompoundAdvancedSystemDeflection):
    """PlanetaryGearSetCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7289.PlanetaryGearSetAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7289.PlanetaryGearSetAdvancedSystemDeflection]':
