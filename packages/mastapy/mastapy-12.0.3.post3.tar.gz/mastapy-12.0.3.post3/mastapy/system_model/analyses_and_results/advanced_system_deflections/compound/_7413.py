...
class OilSealCompoundAdvancedSystemDeflection(_7371.ConnectorCompoundAdvancedSystemDeflection):
    """OilSealCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7283.OilSealAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7283.OilSealAdvancedSystemDeflection]':
