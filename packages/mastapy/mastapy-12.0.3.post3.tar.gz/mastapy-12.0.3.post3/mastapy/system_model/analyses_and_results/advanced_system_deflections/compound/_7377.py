...
class CVTPulleyCompoundAdvancedSystemDeflection(_7423.PulleyCompoundAdvancedSystemDeflection):
    """CVTPulleyCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7245.CVTPulleyAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7245.CVTPulleyAdvancedSystemDeflection]':
