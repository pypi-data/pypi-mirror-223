...
class ClutchCompoundAdvancedSystemDeflection(_7372.CouplingCompoundAdvancedSystemDeflection):
    """ClutchCompoundAdvancedSystemDeflection
    ...
    @property
    def assembly_analysis_cases_ready(self) -> 'List[_7223.ClutchAdvancedSystemDeflection]':
    ...
    @property
    def assembly_analysis_cases(self) -> 'List[_7223.ClutchAdvancedSystemDeflection]':
