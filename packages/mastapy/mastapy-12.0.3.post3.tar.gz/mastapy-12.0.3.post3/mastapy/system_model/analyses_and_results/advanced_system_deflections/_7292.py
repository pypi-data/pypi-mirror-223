...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _7326, _7328
...
class PowerLoadAdvancedSystemDeflection(_7328.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6870.PowerLoadLoadCase':
    ...
    @property
    def transmission_error_to_other_power_loads(self) -> 'List[_7326.TransmissionErrorToOtherPowerLoad]':
