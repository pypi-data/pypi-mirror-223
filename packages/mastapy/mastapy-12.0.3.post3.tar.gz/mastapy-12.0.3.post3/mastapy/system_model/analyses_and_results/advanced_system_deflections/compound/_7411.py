...
class MeasurementComponentCompoundAdvancedSystemDeflection(_7457.VirtualComponentCompoundAdvancedSystemDeflection):
    """MeasurementComponentCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7281.MeasurementComponentAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7281.MeasurementComponentAdvancedSystemDeflection]':
