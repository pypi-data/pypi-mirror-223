...
class SpiralBevelGearCompoundAdvancedSystemDeflection(_7351.BevelGearCompoundAdvancedSystemDeflection):
    """SpiralBevelGearCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7304.SpiralBevelGearAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7304.SpiralBevelGearAdvancedSystemDeflection]':
