...
class ConceptCouplingHalfCompoundAdvancedSystemDeflection(_7374.CouplingHalfCompoundAdvancedSystemDeflection):
    """ConceptCouplingHalfCompoundAdvancedSystemDeflection
    ...
    @property
    def component_analysis_cases_ready(self) -> 'List[_7230.ConceptCouplingHalfAdvancedSystemDeflection]':
    ...
    @property
    def component_analysis_cases(self) -> 'List[_7230.ConceptCouplingHalfAdvancedSystemDeflection]':
