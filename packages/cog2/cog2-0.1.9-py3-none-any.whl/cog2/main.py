...
def config():
    ...
    gpt_prompt = 'generate a new yaml file, ' + prompt + ', just output code block, do not include any explanations in your responses,Respond with only the yaml without explanation'
    chat_completion = openai.ChatCompletion.create(model="gpt-3.5-turbo", messages=[
        {"role": "user",
         "content": "Help me write yaml code, given a base template yaml file, this file contont is: {},{}".format(
