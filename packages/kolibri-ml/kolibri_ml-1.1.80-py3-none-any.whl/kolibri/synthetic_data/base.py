...
class BaseSynthesizer:
    ...
    Args:
        metadata (kolibri.synthetic_data.metadata.TableMetadata):
    ...
    def _validate(self, data):
        """Validate any rules that only apply to specific synthesizers_dict.
    ...
    def _warn_for_update_transformers(self, column_name_to_transformer):
        ...
        for column in column_name_to_transformer:
            ...
            if sdtype in {'categorical', 'boolean', 'category'}:
                warnings.warn(
    ...
    def update_transformers(self, column_name_to_transformer):
        ...
        if self._fitted:
            msg = 'For this change to take effect, please refit the synthesizer_name using `fit`.'
            warnings.warn(msg, UserWarning)

    def get_parameters(self):
        """Return the parameters used to instantiate the synthesizer_name."""
    ...
    def get_metadata(self):
        """Return the ``TableMetadata`` for this synthesizer_name."""
    ...
    def add_constraints(self, constraints):
        """Add constraints to the synthesizer_name.
        ...
        if self._fitted:
            warnings.warn(
                "For these constraints to take effect, please refit the synthesizer_name using 'fit'."
            )
    ...
    def get_constraints(self):
        ...
        Returns:
            list:
                List of dictionaries describing the constraints for this synthesizer_name.
        """
    ...
    def get_info(self):
        """Get dictionary with information regarding the synthesizer_name.

        Return:
            dict:
                * ``class_name``: synthesizer_name class name
                * ``creation_date``: date of creation
                * ``is_fit``: whether or not the synthesizer_name has been fit
        ...
        return {
            ...
            'fitted_sdv_version': self._fitted_sd_version
        }
    ...
    def save(self, filepath):
        ...
        Args:
            filepath (str):
                Path where the synthesizer_name instance will be serialized.
        """
    ...
    def load(cls, filepath):
        ...
        Args:
            filepath (str):
                Path from which to load the serialized synthesizer_name.

        Returns:
            SingleTableSynthesizer:
                The loaded synthesizer_name.
        """
...
class BaseSingleTableSynthesizer(BaseSynthesizer):
    ...
    for all single-table synthesizers_dict.
    """
