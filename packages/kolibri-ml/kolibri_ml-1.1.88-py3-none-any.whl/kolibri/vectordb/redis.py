...
from kolibri.vectordb.base import VectorStore, VectorDBSimilarity
...
class Redis(VectorStore):
    ...
    def as_retriever(self, **kwargs: Any) -> RedisVectorStoreSimilarity:
        return RedisVectorStoreSimilarity(vectorstore=self, **kwargs)


class RedisVectorStoreSimilarity(VectorDBSimilarity, BaseModel):
    vectorstore: Redis
    ...
    async def aget_relevant_documents(self, query: str) -> List[Document]:
        raise NotImplementedError("RedisVectorStoreSimilarity does not support async")
