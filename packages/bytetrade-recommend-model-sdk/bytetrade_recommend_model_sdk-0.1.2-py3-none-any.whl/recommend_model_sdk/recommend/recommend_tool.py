...
class RecommendTool:
    ...
    def recommend(self,candidate_document_id_to_document_info,rank_limit=100,
        ...
        """
        return self.__recall_content_similar(candidate_document_id_to_document_info,rank_limit,package_range_list,start_time,end_time,major_language,category_list)
