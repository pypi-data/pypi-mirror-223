...
sys.path.insert(0, r"F:\StudyContent\PythonPro\PiPyPro\file_operations")
...
if __name__ == '__main__':
    a = ImageMidOperation('640.jpg')
    a.cut_image('to_dir', col=3, row=4, )
    a.compose_image('to_dir', 'b.png', col=3, row=4, )
