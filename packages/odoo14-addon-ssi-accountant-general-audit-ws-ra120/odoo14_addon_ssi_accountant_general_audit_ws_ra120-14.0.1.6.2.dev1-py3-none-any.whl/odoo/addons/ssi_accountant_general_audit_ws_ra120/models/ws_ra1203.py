...
class WSAuditRA1203(models.Model):
    _name = "ws_ra1203"
    _description = "General Audit WS RA.120.3"
    _inherit = [
        "accountant.general_audit_worksheet_mixin",
    ]
    _type_xml_id = "ssi_accountant_general_audit_ws_ra120.worksheet_type_ra1203"

    balance_diff_ids = fields.One2many(
        string="Balance Diff.",
        comodel_name="ws_ra1203.balance_diff",
