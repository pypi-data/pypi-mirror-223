...
@dataclass
class TransformerPerplexityArgumentsConfig:
    """Configuration for the TransformerPerplexity algorithm arguments."""
...
@dataclass
class TransformerPerplexityAlgorithmConfig(AlgorithmConfig):
    """Configuration for the TransformerPerplexity algorithm."""

    name: str = desert.field(
        fields.String(
            validate=validate.Equal(AlgorithmType.TransformerPerplexity.value)
        )
    )

    arguments: Optional[TransformerPerplexityArgumentsConfig] = desert.field(
        fields.Nested(desert.schema_class(TransformerPerplexityArgumentsConfig))
    )


@dataclass
class TransformerTextGenerationArgumentsConfig:
    """Configuration for the TransformerTextGeneration algorithm arguments."""
...
@dataclass
class TransformerTextGenerationAlgorithmConfig(AlgorithmConfig):
    """Configuration for the TransformerTextGeneration algorithm."""

    name: str = desert.field(
        fields.String(
            validate=validate.Equal(AlgorithmType.TransformerTextGeneration.value)
        )
    )

    arguments: Optional[TransformerTextGenerationArgumentsConfig] = desert.field(
        fields.Nested(desert.schema_class(TransformerTextGenerationArgumentsConfig))
    )
