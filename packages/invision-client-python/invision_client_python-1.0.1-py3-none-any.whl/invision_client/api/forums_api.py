...
class ForumsApi(object):
    ...
    def forums_forums_get(
        ...
        **kwargs
        ...
        Keyword Args:
            clubs (int): Include club forums. 0: No, 1: Yes (default). [optional] if omitted the server will use the default value of 1
            page (int): Page number. [optional]
            per_page (int): Number of results per page. Defaults to 25. [optional] if omitted the server will use the default value of 25
