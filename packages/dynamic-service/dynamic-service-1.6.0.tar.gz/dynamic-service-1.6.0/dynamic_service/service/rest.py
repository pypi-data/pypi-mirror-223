...
class RESTClient:
    ...
    def post_request(
        self,
        endpoint: str, parameters: Optional[Dict[str, Any]] = None
    ) -> Any:
        """
        Returns the response for the request.
        ...
        return self.process(
            requests.post(f"{self.url}{endpoint}", params=parameters)
        )
    # end post_request
    ...
    def put_request(
        ...
        return self.process(
            requests.put(f"{self.url}{endpoint}", params=parameters)
        )
    # end put_request
