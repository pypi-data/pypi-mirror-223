...
def autoProfiling(
    ...
    while create_profiles:
        ...
        # calculate the badrate (we skip the previous br)

        ##########################################################################################
        # NEW ORDER IN THE CODE
    ...
    if not isinstance(search_br, list):
        ...
        print("\n")
        while True:
            print(f"Reaching the best br 4 U", end="\r")
            if (
                idx == len(search_br)
