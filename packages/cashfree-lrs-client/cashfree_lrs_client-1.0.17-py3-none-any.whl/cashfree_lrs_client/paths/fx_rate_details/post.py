...
# body param
SchemaForRequestBodyApplicationJson = FetchForexRateRequest


request_body_fetch_forex_rate_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _fetch_forex_rate_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_fetch_forex_rate_request.serialize(body, content_type)
...
class FetchForexRate(BaseApi):
    ...
    def fetch_forex_rate(
        ...
        return self._fetch_forex_rate_oapg(
            body=body,
