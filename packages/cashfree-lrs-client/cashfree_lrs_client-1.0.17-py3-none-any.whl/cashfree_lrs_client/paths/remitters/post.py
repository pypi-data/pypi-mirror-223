...
# body param
SchemaForRequestBodyApplicationJson = CreateRemitterRequest


request_body_create_remitter_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_remitter_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_remitter_request.serialize(body, content_type)
...
class CreateRemitter(BaseApi):
    ...
    def create_remitter(
        ...
        return self._create_remitter_oapg(
            body=body,
