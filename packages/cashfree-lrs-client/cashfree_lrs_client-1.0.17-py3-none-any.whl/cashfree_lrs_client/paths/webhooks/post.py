...
# body param
SchemaForRequestBodyApplicationJson = SetupWebhooksRequest


request_body_setup_webhooks_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _setup_webhooks_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_setup_webhooks_request.serialize(body, content_type)
...
class SetupWebhooks(BaseApi):
    ...
    def setup_webhooks(
        ...
        return self._setup_webhooks_oapg(
            body=body,
