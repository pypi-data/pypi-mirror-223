...
# body param
SchemaForRequestBodyApplicationJson = CreateBeneficiaryRequest


request_body_create_beneficiary_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = SuccessMessage
...
class BaseApi(api_client.Api):
    ...
    def _create_beneficiary_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_beneficiary_request.serialize(body, content_type)
...
class CreateBeneficiary(BaseApi):
    ...
    def create_beneficiary(
        ...
        return self._create_beneficiary_oapg(
            body=body,
