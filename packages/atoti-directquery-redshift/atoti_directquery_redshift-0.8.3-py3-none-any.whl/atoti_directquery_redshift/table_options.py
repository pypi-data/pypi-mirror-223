    ...
    def __init__(
        ...
        *,
        ...
        Example:
            ...
            Transform the table to get arrays from values stored on multiple columns.
            Here, the prefix ``"QUANTITY"`` will match the columns ``"QUANTITY_0"``...``"QUANTITY_4"`` and make it into a 5-element array named ``"QUANTITY"``.
