...
class AssertsCommonUserpointsmanage(SqlsCommonUserpointsmanage):
    ...
    def assert_common_userpointsmanage_userpointsexport(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["logIds", "endTime", "mobile", "nickName", "beginTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_common_userpointsmanage_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["mobile", "nickName", "endTime", "beginTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_common_userpointsmanage_manualchangeuserpoints(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["userId", "operatePoint", "operateType", "taskName", "operateMark", "pointChangType"])
        # assert flag, "数据比较不一致"
