...
class AssertsOrderMainorder(SqlsOrderMainorder):
    ...
    def assert_order_mainorder_download(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["createEndTime", "orderTypeToSort", "createTimeToSort", "payTimeToSort", "createStartTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_order_mainorder_syncscrmextorder(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["VIN", "deliveryData", "phone", "ossId", "potentialName", "optionCode", "orderId", "updateTime", "orderAllAmount", "syncMsg", "modelCode", "isArrived", "orderNo", "unitInvoiceTitle", "isTestDrive", "scUname", "syncStatus", "customerCtCode", "dealerCode", "seriesCode", "colorCode", "trimCode", "custCertNo", "isLifetimeWarranty", "createTime", "lifetimeWarrantyPrice", "customerId", "customerType", "soNo", "unitTaxNo", "soStatus", "chargePointEquity", "unitName", "configCode", "scUid"])
        # assert flag, "数据比较不一致"
    ...
    def assert_order_mainorder_informorder(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["systemCode", "sourceInfo"])
        # assert flag, "数据比较不一致"
