...
def goods_carmodel_getmanagecarmodel(modelCode=None, size=None, carName=None, operator=None, version=None, carCode=None, brandName=None, modelName=None, status=None, current=None, headers=None, **kwargs):
    """
    车型列表-Y
    up_time=1675661996
