...
def radarpoints_pointsconfig_page(code=None, pointsBegin=None, size=None, name=None, pointsExpiration=None, Current=None, pointsEnd=None, status=None, businessSceneType=None, headers=None, **kwargs):
    """
    积分配置 - 分页查询
    up_time=1680142594
...
def radarpoints_pointsconfig_insert(remark=None, name=None, points=None, rulesPointsDayMax=None, pointsExpiration=None, bpmId=None, userPointsDayMax=None, toast=None, businessSceneType=None, headers=None, **kwargs):
    """
    积分配置 -新增积分配置
    up_time=1680142659
...
def radarpoints_pointsconfig_update(remark=None, code=None, name=None, points=None, rulesPointsDayMax=None, pointsExpiration=None, userPointsDayMax=None, bpmId=None, id=None, toast=None, businessSceneType=None, headers=None, **kwargs):
    """
    积分配置 -修改积分配置
    up_time=1680142897
