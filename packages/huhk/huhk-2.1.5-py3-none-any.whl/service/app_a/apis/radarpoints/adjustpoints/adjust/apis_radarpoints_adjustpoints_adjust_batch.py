...
def radarpoints_adjustpoints_adjust_batch_save(file=None, clientNotes=None, adjustNotes=None, redisKey=None, optAbility=None, optAbilityName=None, headers=None, **kwargs):
    """
    积分调整 - 批量调整
    up_time=1677216489
...
def radarpoints_adjustpoints_adjust_batch_import(file=None, clientNotes=None, adjustNotes=None, field_35=None, list=None, field_34=None, headers=None, **kwargs):
    """
    积分调整 - 批量调整 - 导入excel
    up_time=1677216494
