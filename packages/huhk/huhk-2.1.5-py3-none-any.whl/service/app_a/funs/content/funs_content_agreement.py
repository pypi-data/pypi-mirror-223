...
class FunsContentAgreement(AssertsContentAgreement):
    ...
    def content_agreement_updatestatus(self, code="$None$", agreementId="$None$", status="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_agreement_list(self, size=10, current=1, _assert=True,  **kwargs):
        """
    ...
    def content_agreement_save(self, code="$None$", content="$None$", name="$None$", version="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
