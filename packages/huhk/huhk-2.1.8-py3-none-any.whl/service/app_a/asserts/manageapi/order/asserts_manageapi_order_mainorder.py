...
class AssertsManageapiOrderMainorder(SqlsManageapiOrderMainorder):
    ...
    def assert_manageapi_order_mainorder_pagelist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["createEndTime", "orderStatus", "extOrderStatus", "mainOrderId", "userName", "extNum", "channel", "dealerCode", "cityId", "mobile", "provinceId", "orderId", "createStartTime", "orderType", "modelId"])
        # assert flag, "数据比较不一致"
