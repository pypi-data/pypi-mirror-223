...
class FunsContentComment(AssertsContentComment):
    ...
    def content_comment_updatestatus(self, fromStatus="$None$", commentId="$None$", toStatus="$None$", commentType="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_comment_download(self, nickName="$None$", keyWord="$None$", contentCommentIds="$None$", endTime="$None$", EssayCommentIds="$None$", status="$None$", mobile="$None$", downloadType="$None$", startTime="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_comment_list(self, size=10, nickName="$None$", keyWord="$None$", endTime="$None$", commentType="$None$", checkedStatus="$None$", mobile="$None$", essayId="$None$", startTime="$None$", current=1, _assert=True,  **kwargs):
        """
