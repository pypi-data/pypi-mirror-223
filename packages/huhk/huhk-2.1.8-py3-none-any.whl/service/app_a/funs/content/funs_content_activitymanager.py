...
class FunsContentActivitymanager(AssertsContentActivitymanager):
    ...
    def content_activitymanager_updateperson(self, needLimitPeople="$None$", limitPeople="$None$", activityId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_updateenrolltime(self, enrollStartTime="$None$", enrollTime="$None$", activityId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_page(self, target="$None$", city="$None$", activityId="$None$", province="$None$", endTime="$None$", pushTimeSort="$None$", title="$None$", status="$None$", activityTimeSort="$None$", beginTime="$None$", createTimeSort="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_activitymanager_activitytop_(self, topFlag="$None$", activityId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_save(self, reason="$None$", endTime="$None$", enrollStartTime="$None$", county="$None$", content="$None$", limitPeople="$None$", beginTime="$None$", activityAddr="$None$", agreementId="$None$", coordinate="$None$", publishType="$None$", title="$None$", status="$None$", customerGroup="$None$", activityPicUrl="$None$", needLimitPeople="$None$", activityId="$None$", province="$None$", activityPicURL="$None$", enrollTime="$None$", needArea="$None$", city="$None$", authId="$None$", publishTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_update(self, reason="$None$", endTime="$None$", enrollStartTime="$None$", county="$None$", content="$None$", limitPeople="$None$", beginTime="$None$", activityAddr="$None$", coordinate="$None$", publishType="$None$", title="$None$", status="$None$", customerGroup="$None$", activityPicUrl="$None$", needLimitPeople="$None$", activityId="$None$", province="$None$", activityPicURL="$None$", enrollTime="$None$", city="$None$", needArea="$None$", authId="$None$", publishTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_publishupdate(self, activityId="$None$", status="$None$", publishStatus="$None$", activityIds="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_activitymanager_activityexport(self, target="$None$", city="$None$", activityId="$None$", province="$None$", endTime="$None$", pushTimeSort="$None$", title="$None$", status="$None$", activityTimeSort="$None$", beginTime="$None$", createTimeSort="$None$", _assert=True,  **kwargs):
        """
