...
class FunsContentCampmanager(AssertsContentCampmanager):
    ...
    def content_campmanager_page(self, sortBody="$None$", name="$None$", id="$None$", sortord="$None$", createBy="$None$", status="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_campmanager_soldout(self, id="$None$", campId="$None$", _assert=True,  **kwargs):
        """
    ...
    def content_campmanager_insert(self, city="$None$", campDetail="$None$", name="$None$", url="$None$", province="$None$", discountExpEndTime="$None$", discountExpBeginTime="$None$", id="$None$", campTradeTime="$None$", county="$None$", ownerDiscount="$None$", content="$None$", address="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_campmanager_update(self, phone="$None$", discountExpEndTime="$None$", discountExpBeginTime="$None$", ownerDiscount="$None$", areaCode="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
