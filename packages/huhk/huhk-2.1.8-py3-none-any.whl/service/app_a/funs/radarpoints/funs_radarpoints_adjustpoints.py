...
class FunsRadarpointsAdjustpoints(AssertsRadarpointsAdjustpoints, FunsRadarpointsAdjustpointsAdjust):
    ...
    def radarpoints_adjustpoints_pagelist(self, userId="$None$", current=1, adjustTimeBefore="$None$", size=10, adjustNotes="$None$", mobile="$None$", adjustTimeEnd="$None$", nickName="$None$", optAbility="$None$", optAbilityName="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_adjustpoints_export(self, userId="$None$", current=1, adjustTimeBefore="$None$", size=10, adjustNotes="$None$", mobile="$None$", adjustTimeEnd="$None$", nickName="$None$", optAbility="$None$", optAbilityName="$None$", _assert=True,  **kwargs):
        """
