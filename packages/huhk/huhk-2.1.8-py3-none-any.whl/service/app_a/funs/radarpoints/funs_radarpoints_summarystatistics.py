...
class FunsRadarpointsSummarystatistics(AssertsRadarpointsSummarystatistics):
    ...
    def radarpoints_summarystatistics_pagelist(self, flowTimeEnd="$None$", size=10, current=1, flowTimeBefore="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_summarystatistics_export(self, flowTimebefore="$None$", flowTimeEnd="$None$", size=10, current=1, _assert=True,  **kwargs):
        """
