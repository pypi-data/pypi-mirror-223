...
def order_rights_rightsmanager_page(rightsName=None, modelCode=None, size=None, effectiveEndDate=None, status=None, current=None, headers=None, **kwargs):
    """
    权益 - 分页查询-Y
    up_time=1675409025
...
def order_rights_rightsmanager_getrightslist(rightsName=None, effectiveStartDate=None, modelId=None, status=None, headers=None, **kwargs):
    """
    权益订单 - 查询-Y
    up_time=1675669230
...
def order_rights_rightsmanager_insert(rightsId=None, modelCode=None, rightsName=None, rightsType=None, orderType=None, effectiveStartDate=None, headers=None, **kwargs):
    """
    权益-新增权益-Y
    up_time=1675669334
...
def order_rights_rightsmanager_update(rightsName=None, rightsId=None, Content=None, effectiveStartDate=None, effectiveEndDate=None, Relation=None, headers=None, **kwargs):
    """
    权益-修改权益-Y
    up_time=1675669374
