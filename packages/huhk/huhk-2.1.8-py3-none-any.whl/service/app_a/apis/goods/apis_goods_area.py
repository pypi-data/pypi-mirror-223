...
def goods_area_getparentarea(country=None, parentId=None, headers=None, **kwargs):
    """
    订单管理-地区下拉（930版本）-Y
    up_time=1675385800
...
def goods_area_getcitylist(size=None, cType=None, cName=None, pName=None, current=None, headers=None, **kwargs):
    """
    城市禁行列表查询-Y
    up_time=1675388494
...
def goods_area_updatecitytype(cId=None, cType=None, headers=None, **kwargs):
    """
    城市禁行状态变更-？
    up_time=1675388620
