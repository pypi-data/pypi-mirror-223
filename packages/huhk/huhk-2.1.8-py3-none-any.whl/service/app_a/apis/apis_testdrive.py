...
def testdrive_subscribe(appointmentTime=None, shopName=None, phoneNumber=None, channel=None, leadSourceCode=None, model=None, shopId=None, activityCode=None, customerName=None, modelId=None, leadSanSourceCode=None, headers=None, **kwargs):
    """
    预约试驾
    up_time=1689560965
