...
def radarpoints_userpoints_pagelist(cumulativeConsumptionMost=None, userId=None, physicalIntegralLeast=None, registrationTimeEnd=None, freezeQtyLeast=None, current=None, registrationTimeBegin=None, size=None, cumulativeAcquisitionMost=None, mobile=None, cumulativeAcquisitionLeast=None, cumulativeConsumptionLeast=None, freezeQtyMost=None, physicalIntegralMost=None, nickName=None, conversionFrequencyLeast=None, conversionFrequencyMost=None, headers=None, **kwargs):
    """
    用户积分 - 分页查询
    up_time=1677209132
...
def radarpoints_userpoints_export(cumulativeConsumptionMost=None, physicalIntegralLeast=None, registrationTimeEnd=None, currentPage=None, registrationTimeBegin=None, cumulativeAcquisitionMost=None, pageSize=None, cumulativeAcquisitionLeast=None, cumulativeConsumptionLeast=None, physicalIntegralMost=None, nickName=None, conversionFrequencyLeast=None, conversionFrequencyMost=None, headers=None, **kwargs):
    """
    用户积分 - 导出excel
    up_time=1677216441
