...
class AssertsContentCampmanager(SqlsContentCampmanager):
    ...
    def assert_content_campmanager_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["sortBody", "name", "id", "sortord", "createBy", "status"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_campmanager_insert(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["city", "campDetail", "name", "url", "province", "discountExpEndTime", "discountExpBeginTime", "id", "campTradeTime", "county", "ownerDiscount", "content", "address"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_campmanager_update(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["phone", "discountExpEndTime", "discountExpBeginTime", "ownerDiscount", "areaCode"])
        # assert flag, "数据比较不一致"
