...
class FunsGoodsCarmodel(AssertsGoodsCarmodel):
    ...
    def goods_carmodel_savemanagecarmodel(self, carDetailType="$None$", preToDepositEndTime="$None$", prePrice="$None$", sharePosters="$None$", price="$None$", preEndTime="$None$", carCode="$None$", brandName="$None$", modelName="$None$", modelId="$None$", modelCode="$None$", carName="$None$", depositStartTime="$None$", depositPriceContent="$None$", depositEndTime="$None$", carSimpleName="$None$", prePriceContent="$None$", status="$None$", promptDesc="$None$", preToDepositStartTime="$None$", preStartTime="$None$", version="$None$", carDetailPics="$None$", carDetailUrl="$None$", prePricePosters="$None$", sort="$None$", configCode="$None$", depositPrice="$None$", posters="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def goods_carmodel_getmanagecarmodel(self, modelCode="$None$", size=10, carName="$None$", operator="$None$", version="$None$", carCode="$None$", brandName="$None$", modelName="$None$", status="$None$", current=1, _assert=True,  **kwargs):
        """
