...
class FunsContentSubjectweb(AssertsContentSubjectweb):
    ...
    def content_subjectweb_add(self, siftPicUrl="$None$", siftFlag="$None$", level="$None$", parentId="$None$", subPicUrl="$None$", isService="$None$", explain="$None$", recommend="$None$", isSearch="$None$", web="$None$", subjectRank="$None$", subjectName="$None$", serial="$None$", status="$None$", type="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subjectweb_save(self, subjectId="$None$", siftFlag="$None$", delFlag="$None$", parentId="$None$", subPicUrl="$None$", isService="$None$", explain="$None$", isSearch="$None$", subjectName="$None$", status="$None$", type="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
