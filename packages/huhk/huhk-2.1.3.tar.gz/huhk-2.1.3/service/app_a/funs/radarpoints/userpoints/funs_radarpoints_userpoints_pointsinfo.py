...
class FunsRadarpointsUserpointsPointsinfo(AssertsRadarpointsUserpointsPointsinfo):
    ...
    def radarpoints_userpoints_pointsinfo_pagelist(self, userId="$None$", current=1, size=10, name="$None$", changeTimeBegin="$None$", businessSceneType="$None$", changeTimeEnd="$None$", _assert=True,  **kwargs):
        """
