...
class FunsRadarpointsAdjustpointsAdjustSingle(AssertsRadarpointsAdjustpointsAdjustSingle):
    ...
    def radarpoints_adjustpoints_adjust_single_save(self, userId="$None$", clientNotes="$None$", adjustNotes="$None$", pointsExpiration="$None$", qty="$None$", optAbility="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
