...
class FunsRadarpointsAdjustpointsAdjustBatch(AssertsRadarpointsAdjustpointsAdjustBatch):
    ...
    def radarpoints_adjustpoints_adjust_batch_save(self, file="$None$", clientNotes="$None$", adjustNotes="$None$", redisKey="$None$", optAbility="$None$", optAbilityName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def radarpoints_adjustpoints_adjust_batch_import(self, file="$None$", clientNotes="$None$", adjustNotes="$None$", field_35="$None$", list="$None$", field_34="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
