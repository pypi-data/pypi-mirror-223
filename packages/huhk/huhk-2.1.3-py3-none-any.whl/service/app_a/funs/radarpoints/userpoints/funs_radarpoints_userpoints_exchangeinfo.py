...
class FunsRadarpointsUserpointsExchangeinfo(AssertsRadarpointsUserpointsExchangeinfo):
    ...
    def radarpoints_userpoints_exchangeinfo_pagelist(self, consigneeName="$None$", userId="$None$", size=10, orderStartTime="$None$", mobile="$None$", orderEndTime="$None$", goodsOrderId="$None$", current=1, _assert=True,  **kwargs):
        """
