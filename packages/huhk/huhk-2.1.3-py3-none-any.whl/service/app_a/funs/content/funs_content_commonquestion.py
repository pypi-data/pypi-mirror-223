...
class FunsContentCommonquestion(AssertsContentCommonquestion):
    ...
    def content_commonquestion_updatestatus(self, status="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_commonquestion_update(self, title="$None$", content="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_commonquestion_updaterank(self, rank="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_commonquestion_list(self, size=10, current=1, _assert=True,  **kwargs):
        """
    ...
    def content_commonquestion_publishlist(self, size=10, current=1, _assert=True,  **kwargs):
        """
    ...
    def content_commonquestion_add(self, title="$None$", content="$None$", essayId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
