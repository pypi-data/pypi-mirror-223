...
class FunsCommonUserpointsmanage(AssertsCommonUserpointsmanage):
    ...
    def common_userpointsmanage_userpointsexport(self, logIds="$None$", endTime="$None$", mobile="$None$", nickName="$None$", beginTime="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_userpointsmanage_page(self, mobile="$None$", nickName="$None$", endTime="$None$", beginTime="$None$", _assert=True,  **kwargs):
        """
    ...
    def common_userpointsmanage_manualchangeuserpoints(self, userId="$None$", operatePoint="$None$", operateType="$None$", taskName="$None$", operateMark="$None$", pointChangType="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def common_userpointsmanage_beforepointsexport(self, logIds="$None$", endTime="$None$", mobile="$None$", nickName="$None$", beginTime="$None$", _assert=True,  **kwargs):
        """
