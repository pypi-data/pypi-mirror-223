...
class FunsOrderFreeorder(AssertsOrderFreeorder):
    ...
    def order_freeorder_download(self, userPolicyCode="$None$", createTime="$None$", regisTimeBegin="$None$", avatarUrl="$None$", userName="$None$", privacyPolicyCode="$None$", regisTimeEnd="$None$", channel="$None$", freeOrderId="$None$", cityId="$None$", mobile="$None$", provinceId="$None$", cityName="$None$", modelId="$None$", channelName="$None$", nickName="$None$", provinceName="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
