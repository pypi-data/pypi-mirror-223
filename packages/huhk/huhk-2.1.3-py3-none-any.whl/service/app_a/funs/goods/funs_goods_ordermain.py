...
class FunsGoodsOrdermain(AssertsGoodsOrdermain):
    ...
    def goods_ordermain_orderexports(self, billStatus="$None$", exportType="$None$", shopName="$None$", userName="$None$", endTime="$None$", testDriveIdStr="$None$", modelName="$None$", userMobile="$None$", startTime="$None$", _assert=True,  **kwargs):
        """
    ...
    def goods_ordermain_getordermainpage(self, shopName="$None$", userName="$None$", orderStatus="$None$", endTime="$None$", modelName="$None$", userMobile="$None$", startTime="$None$", _assert=True,  **kwargs):
        """
