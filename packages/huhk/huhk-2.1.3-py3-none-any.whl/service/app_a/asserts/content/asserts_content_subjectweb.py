...
class AssertsContentSubjectweb(SqlsContentSubjectweb):
    ...
    def assert_content_subjectweb_add(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["siftPicUrl", "siftFlag", "level", "parentId", "subPicUrl", "isService", "explain", "recommend", "isSearch", "web", "subjectRank", "subjectName", "serial", "status", "type"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_subjectweb_save(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["subjectId", "siftFlag", "delFlag", "parentId", "subPicUrl", "isService", "explain", "isSearch", "subjectName", "status", "type"])
        # assert flag, "数据比较不一致"
