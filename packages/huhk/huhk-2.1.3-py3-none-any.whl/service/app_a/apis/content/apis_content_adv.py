...
def content_adv_save(jumpContent=None, advPicUrl=None, advText=None, jumpType=None, advId=None, advLinkUrl=None, bindingFlag=None, version=None, advSerial=None, advPlaceId=None, pictureList=None, headers=None, **kwargs):
    """
...
def content_adv_saveall(jumpType=None, advPlaceId=None, headers=None, **kwargs):
    """
    点位内容-新增广告位（点位）-Y
    up_time=1675674158
...
def content_adv_detailcontentadmin(size=None, current=None, orderByCommentCnt=None, essayKeyWords=None, headers=None, **kwargs):
    """
    点位内容-查询推荐页内容-Y
    up_time=1675673291
