...
def content_question_revoke(operaType=None, questionId=None, headers=None, **kwargs):
    """
    问答-回答撤回归档-Y
    up_time=1675740174
...
def content_question_getmanegequestionlist(size=None, keyWord=None, endTime=None, startTime=None, mobile=None, status=None, current=None, headers=None, **kwargs):
    """
    问答-搜索问题列表-Y
    up_time=1675740163
