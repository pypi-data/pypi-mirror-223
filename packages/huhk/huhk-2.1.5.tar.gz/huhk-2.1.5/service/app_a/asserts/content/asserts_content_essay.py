...
class AssertsContentEssay(SqlsContentEssay):
    ...
    def assert_content_essay_checklist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["subjectId", "keyWord", "CreateTimeSortType", "endTime", "recommend", "PublishTimeSortType", "status", "author", "essayId", "StatusSortType", "startTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_essay_add(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["subjectId", "videoUrl", "essayType", "recommend", "essPicUrl", "publishType", "author", "essayId", "title", "content", "status", "publishTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_essay_getcommentlist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["parentId", "keyWord", "commentId", "endTime", "checkedStatus", "essayId", "startTime"])
        # assert flag, "数据比较不一致"
