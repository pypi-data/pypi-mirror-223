...
class AssertsOrderRightsRightsmanager(SqlsOrderRightsRightsmanager):
    ...
    def assert_order_rights_rightsmanager_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["rightsName", "modelCode", "effectiveEndDate", "status"])
        # assert flag, "数据比较不一致"
    ...
    def assert_order_rights_rightsmanager_getrightslist(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["rightsName", "effectiveStartDate", "modelId", "status"])
        # assert flag, "数据比较不一致"
    ...
    def assert_order_rights_rightsmanager_insert(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["rightsId", "modelCode", "rightsName", "rightsType", "orderType", "effectiveStartDate"])
        # assert flag, "数据比较不一致"
    ...
    def assert_order_rights_rightsmanager_update(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["rightsName", "rightsId", "Content", "effectiveStartDate", "effectiveEndDate", "Relation"])
        # assert flag, "数据比较不一致"
