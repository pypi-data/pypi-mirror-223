...
class AssertsGoodsOrdermain(SqlsGoodsOrdermain):
    ...
    def assert_goods_ordermain_orderexports(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["billStatus", "exportType", "shopName", "userName", "endTime", "testDriveIdStr", "modelName", "userMobile", "startTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_goods_ordermain_getordermainpage(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["shopName", "userName", "orderStatus", "endTime", "modelName", "userMobile", "startTime"])
        # assert flag, "数据比较不一致"
