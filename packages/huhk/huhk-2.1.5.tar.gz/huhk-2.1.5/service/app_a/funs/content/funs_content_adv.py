...
class FunsContentAdv(AssertsContentAdv):
    ...
    def content_adv_save(self, jumpContent="$None$", advPicUrl="$None$", advText="$None$", jumpType="$None$", advId="$None$", advLinkUrl="$None$", bindingFlag="$None$", version="$None$", advSerial="$None$", advPlaceId="$None$", pictureList="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_adv_saveall(self, jumpType="$None$", advPlaceId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_adv_detailcontentadmin(self, size=10, current=1, orderByCommentCnt="$None$", essayKeyWords="$None$", _assert=True,  **kwargs):
        """
