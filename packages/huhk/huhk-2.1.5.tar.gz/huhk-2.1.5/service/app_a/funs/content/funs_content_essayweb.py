...
class FunsContentEssayweb(AssertsContentEssayweb):
    ...
    def content_essayweb_add(self, publishChannel="$None$", essPicUrl="$None$", publishType="$None$", author="$None$", essayId="$None$", title="$None$", content="$None$", status="$None$", publishTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_essayweb_getbyid(self, subjectId="$None$", essayId="$None$", _assert=True,  **kwargs):
        """
