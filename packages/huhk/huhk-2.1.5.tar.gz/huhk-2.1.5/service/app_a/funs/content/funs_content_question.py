...
class FunsContentQuestion(AssertsContentQuestion):
    ...
    def content_question_revoke(self, operaType="$None$", questionId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_question_getmanegequestionlist(self, size=10, keyWord="$None$", endTime="$None$", startTime="$None$", mobile="$None$", status="$None$", current=1, _assert=True,  **kwargs):
        """
