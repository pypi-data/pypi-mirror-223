...
class FunsOrderRightsorder(AssertsOrderRightsorder, FunsOrderRightsorderReceive):
    ...
    def order_rightsorder_export(self, rightsType="$None$", userId="$None$", receiveDateEnd="$None$", orderMainId="$None$", payDateBegin="$None$", receiveDateBegin="$None$", mobile="$None$", payDateEnd="$None$", rightsOrderId="$None$", useStatus="$None$", _assert=True,  **kwargs):
        """
    ...
    def order_rightsorder_insert(self, rightsId="$None$", rightsName="$None$", rightsType="$None$", userId="$None$", refundDate="$None$", createTime="$None$", receiveDate="$None$", refundBillNo="$None$", updateId="$None$", payBillNo="$None$", payDate="$None$", mobile="$None$", payAmount="$None$", createBy="$None$", rightsOrderId="$None$", updateTime="$None$", orderMainId="$None$", useStatus="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rightsorder_page(self, rightsType="$None$", userId="$None$", current=1, size=10, receiveDateEnd="$None$", orderMainId="$None$", payDateBegin="$None$", receiveDateBegin="$None$", mobile="$None$", payDateEnd="$None$", rightsOrderId="$None$", useStatus="$None$", _assert=True,  **kwargs):
        """
    ...
    def order_rightsorder_getorderlist(self, rightsType="$None$", receiveDate="$None$", rightsNameList="$None$", useStatusList="$None$", mobile="$None$", orderMainId="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rightsorder_statusupdate(self, soNo="$None$", workStatus="$None$", _assert=True,  **kwargs):
        """
