...
class FunsGoodsArea(AssertsGoodsArea):
    ...
    def goods_area_getparentarea(self, country="$None$", parentId="$None$", _assert=True,  **kwargs):
        """
    ...
    def goods_area_getcitylist(self, size=10, cType="$None$", cName="$None$", pName="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def goods_area_updatecitytype(self, cId="$None$", cType="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
