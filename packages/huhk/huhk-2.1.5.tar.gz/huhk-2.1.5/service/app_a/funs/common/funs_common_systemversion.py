...
class FunsCommonSystemversion(AssertsCommonSystemversion):
    ...
    def common_systemversion_save(self, remark="$None$", size=10, name="$None$", force="$None$", version="$None$", downloadUrl="$None$", versionId="$None$", content="$None$", publishStatus="$None$", classify="$None$", _assert=True,  **kwargs):
        """
