...
class FunsTestdrive(AssertsTestdrive):
    ...
    def testdrive_subscribe(self, appointmentTime="$None$", shopName="$None$", phoneNumber="$None$", channel="$None$", leadSourceCode="$None$", model="$None$", shopId="$None$", activityCode="$None$", customerName="$None$", modelId="$None$", leadSanSourceCode="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
