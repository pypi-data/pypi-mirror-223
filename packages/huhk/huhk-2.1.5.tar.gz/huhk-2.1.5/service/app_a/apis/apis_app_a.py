...
def page(shopBusinessType=None, city=None, size=None, cityNameSort=None, provinceNameSort=None, province=None, districtNameSort=None, dealerCode=None, dealerAddress=None, dealerName=None, district=None, current=None, headers=None, **kwargs):
    """
    网点列表-获取经销商
    up_time=1675233719
