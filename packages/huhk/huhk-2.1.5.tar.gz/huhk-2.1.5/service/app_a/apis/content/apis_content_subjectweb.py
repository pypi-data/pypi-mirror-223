...
def content_subjectweb_add(siftPicUrl=None, siftFlag=None, level=None, parentId=None, subPicUrl=None, isService=None, explain=None, recommend=None, isSearch=None, web=None, subjectRank=None, subjectName=None, serial=None, status=None, type=None, headers=None, **kwargs):
    """
    专题-后台官网专题新增-Y
    up_time=1675754357
...
def content_subjectweb_save(subjectId=None, siftFlag=None, delFlag=None, parentId=None, subPicUrl=None, isService=None, explain=None, isSearch=None, subjectName=None, status=None, type=None, headers=None, **kwargs):
    """
    专题-后台官网保存/更新-Y
    up_time=1675754842
