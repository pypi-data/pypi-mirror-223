...
def content_activitymanager_updateperson(needLimitPeople=None, limitPeople=None, activityId=None, headers=None, **kwargs):
    """
    活动 -修改报名人数(930)-Y
    up_time=1675238032
...
def content_activitymanager_updateenrolltime(enrollStartTime=None, enrollTime=None, activityId=None, headers=None, **kwargs):
    """
    活动 -修改报名时间-Y
    up_time=1675238090
...
def content_activitymanager_page(target=None, city=None, activityId=None, province=None, endTime=None, pushTimeSort=None, title=None, status=None, activityTimeSort=None, beginTime=None, createTimeSort=None, headers=None, **kwargs):
    """
    活动列表查询（930版本）-Y
    up_time=1675147665
...
def content_activitymanager_activitytop_(topFlag=None, activityId=None, headers=None, **kwargs):
    """
    活动置顶/取消置顶-Y
    up_time=1675238359
...
def content_activitymanager_publishupdate(activityId=None, status=None, publishStatus=None, activityIds=None, headers=None, **kwargs):
    """
    活动发布状态修改(930)-Y
    up_time=1675392693
...
def content_activitymanager_activityexport(target=None, city=None, activityId=None, province=None, endTime=None, pushTimeSort=None, title=None, status=None, activityTimeSort=None, beginTime=None, createTimeSort=None, headers=None, **kwargs):
    """
    活动数据导出-Y
    up_time=1675149098
