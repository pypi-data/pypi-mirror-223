...
def common_remoteinterfacelog_getlogpage(size=None, userName=None, endTime=None, interfaceType=None, mobile=None, startTime=None, current=None, headers=None, **kwargs):
    """
    查询三方日志接口-Y
    up_time=1675324564
