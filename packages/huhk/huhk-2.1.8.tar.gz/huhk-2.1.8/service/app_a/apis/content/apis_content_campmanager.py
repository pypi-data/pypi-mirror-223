...
def content_campmanager_page(sortBody=None, name=None, id=None, sortord=None, createBy=None, status=None, headers=None, **kwargs):
    """
    营地服务列表 - 分页查询
    up_time=1681969132
...
def content_campmanager_soldout(id=None, campId=None, headers=None, **kwargs):
    """
    营地列表 - 下架/批量下架
    up_time=1681959868
...
def content_campmanager_insert(city=None, campDetail=None, name=None, url=None, province=None, discountExpEndTime=None, discountExpBeginTime=None, id=None, campTradeTime=None, county=None, ownerDiscount=None, content=None, address=None, headers=None, **kwargs):
    """
    新增营地
    up_time=1681967827
...
def content_campmanager_update(phone=None, discountExpEndTime=None, discountExpBeginTime=None, ownerDiscount=None, areaCode=None, headers=None, **kwargs):
    """
    编辑营地
    up_time=1681969876
