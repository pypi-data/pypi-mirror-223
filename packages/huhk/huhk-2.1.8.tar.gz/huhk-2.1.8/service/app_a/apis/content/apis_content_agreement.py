...
def content_agreement_updatestatus(code=None, agreementId=None, status=None, headers=None, **kwargs):
    """
    协议-停用启用协议-Y
    up_time=1675680241
...
def content_agreement_list(size=None, current=None, headers=None, **kwargs):
    """
    协议-协议列表-Y
    up_time=1678246318
...
def content_agreement_save(code=None, content=None, name=None, version=None, headers=None, **kwargs):
    """
    协议-新增协议-Y
    up_time=1675675877
