...
class AssertsGoodsTestdrive(SqlsGoodsTestdrive):
    ...
    def assert_goods_testdrive_driveexports(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["exportType", "shopName", "userName", "channel", "endTime", "mobile", "testDriveIdStr", "startTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_goods_testdrive_page(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["shopName", "userName", "pageNum", "channel", "endTime", "mobile", "startTime"])
        # assert flag, "数据比较不一致"
