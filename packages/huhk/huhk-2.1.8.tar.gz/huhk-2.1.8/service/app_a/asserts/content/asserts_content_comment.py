...
class AssertsContentComment(SqlsContentComment):
    ...
    def assert_content_comment_updatestatus(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["fromStatus", "commentId", "toStatus", "commentType"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_comment_download(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["nickName", "keyWord", "contentCommentIds", "endTime", "EssayCommentIds", "status", "mobile", "downloadType", "startTime"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_comment_list(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["nickName", "keyWord", "endTime", "commentType", "checkedStatus", "mobile", "essayId", "startTime"])
        # assert flag, "数据比较不一致"
