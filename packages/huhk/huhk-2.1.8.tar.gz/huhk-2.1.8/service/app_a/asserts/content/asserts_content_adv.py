...
class AssertsContentAdv(SqlsContentAdv):
    ...
    def assert_content_adv_save(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["jumpContent", "advPicUrl", "advText", "jumpType", "advId", "advLinkUrl", "bindingFlag", "version", "advSerial", "advPlaceId", "pictureList"])
        # assert flag, "数据比较不一致"
    ...
    def assert_content_adv_saveall(self, _assert=True, **kwargs):
        ...
        # flag = self.compare_json_list(self.res, out, ["jumpType", "advPlaceId"])
        # assert flag, "数据比较不一致"
