...
class FunsContentSubject(AssertsContentSubject):
    ...
    def content_subject_detailessay(self, subjectId="$None$", size=10, subjectName="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def content_subject_add(self, level="$None$", parentId="$None$", subPicUrl="$None$", explain="$None$", subjectName="$None$", status="$None$", type="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def content_subject_save(self, subjectId="$None$", siftFlag="$None$", delFlag="$None$", level="$None$", parentId="$None$", subPicUrl="$None$", isService="$None$", explain="$None$", isSearch="$None$", subjectName="$None$", status="$None$", type="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
