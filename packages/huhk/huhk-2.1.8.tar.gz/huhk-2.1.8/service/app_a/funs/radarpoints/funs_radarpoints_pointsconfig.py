...
class FunsRadarpointsPointsconfig(AssertsRadarpointsPointsconfig):
    ...
    def radarpoints_pointsconfig_page(self, code="$None$", pointsBegin="$None$", size=10, name="$None$", pointsExpiration="$None$", Current="$None$", pointsEnd="$None$", status="$None$", businessSceneType="$None$", _assert=True,  **kwargs):
        """
    ...
    def radarpoints_pointsconfig_insert(self, remark="$None$", name="$None$", points="$None$", rulesPointsDayMax="$None$", pointsExpiration="$None$", bpmId="$None$", userPointsDayMax="$None$", toast="$None$", businessSceneType="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def radarpoints_pointsconfig_update(self, remark="$None$", code="$None$", name="$None$", points="$None$", rulesPointsDayMax="$None$", pointsExpiration="$None$", userPointsDayMax="$None$", bpmId="$None$", id="$None$", toast="$None$", businessSceneType="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
