...
class FunsOrderRightsRightsmanager(AssertsOrderRightsRightsmanager):
    ...
    def order_rights_rightsmanager_page(self, rightsName="$None$", modelCode="$None$", size=10, effectiveEndDate="$None$", status="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_getrightslist(self, rightsName="$None$", effectiveStartDate="$None$", modelId="$None$", status="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_insert(self, rightsId="$None$", modelCode="$None$", rightsName="$None$", rightsType="$None$", orderType="$None$", effectiveStartDate="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_rights_rightsmanager_update(self, rightsName="$None$", rightsId="$None$", Content="$None$", effectiveStartDate="$None$", effectiveEndDate="$None$", Relation="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
