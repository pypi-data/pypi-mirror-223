...
class FunsOrderMainorder(AssertsOrderMainorder, FunsOrderMainorderScrm2App):
    ...
    def order_mainorder_pagelist(self, createEndTime="$None$", size=10, sortItems="$None$", createStartTime="$None$", current=1, _assert=True,  **kwargs):
        """
    ...
    def order_mainorder_download(self, createEndTime="$None$", orderTypeToSort="$None$", createTimeToSort="$None$", payTimeToSort="$None$", createStartTime="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_mainorder_syncscrmextorder(self, VIN="$None$", deliveryData="$None$", phone="$None$", ossId="$None$", potentialName="$None$", optionCode="$None$", orderId="$None$", updateTime="$None$", orderAllAmount="$None$", syncMsg="$None$", modelCode="$None$", isArrived="$None$", orderNo="$None$", unitInvoiceTitle="$None$", isTestDrive="$None$", scUname="$None$", syncStatus="$None$", customerCtCode="$None$", dealerCode="$None$", seriesCode="$None$", colorCode="$None$", trimCode="$None$", custCertNo="$None$", isLifetimeWarranty="$None$", createTime="$None$", lifetimeWarrantyPrice="$None$", customerId="$None$", customerType="$None$", soNo="$None$", unitTaxNo="$None$", soStatus="$None$", chargePointEquity="$None$", unitName="$None$", configCode="$None$", scUid="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
    ...
    def order_mainorder_informorder(self, systemCode="$None$", sourceInfo="$None$", _assert=True, _all_is_None=False,  **kwargs):
        """
