...
from snaptrade_client.model.delete_user_response import DeleteUserResponse as DeleteUserResponseSchema
...
from snaptrade_client.type.delete_user_response import DeleteUserResponse
...
SchemaFor200ResponseBodyApplicationJson = DeleteUserResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_snap_trade_user_mapped_args(
        self,
    ...
    async def _adelete_snap_trade_user_oapg(
        self,
        query_params: typing.Optional[dict] = {},
    ...
    def _delete_snap_trade_user_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
...
class DeleteSnapTradeUser(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_snap_trade_user(
        self,
        user_id: typing.Optional[str] = None,
        query_params: typing.Optional[dict] = {},
    ) -> typing.Union[
    ...
    def delete_snap_trade_user(
        ...
        return self._delete_snap_trade_user_oapg(
            query_params=args.query,
        )
