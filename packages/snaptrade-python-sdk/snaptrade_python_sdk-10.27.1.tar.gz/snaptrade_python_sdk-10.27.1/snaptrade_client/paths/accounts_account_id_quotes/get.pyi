...
request_query_use_ticker = api_client.QueryParameter(
    name="use_ticker",
    style=api_client.ParameterStyle.FORM,
    schema=UseTickerSchema,
    explode=True,
)
# Path params
...
SchemaFor200ResponseBodyApplicationJson = SymbolsQuotesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_user_account_quotes_mapped_args(
        self,
        ...
        if symbols is not None:
            _query_params["symbols"] = symbols
        if use_ticker is not None:
            _query_params["use_ticker"] = use_ticker
    ...
    async def _aget_user_account_quotes_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
    ...
    def _get_user_account_quotes_oapg(
        self,
        query_params: typing.Optional[dict] = {},
        path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUserAccountQuotes(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_account_quotes(
        self,
        user_id: typing.Optional[str] = None,
        user_secret: typing.Optional[str] = None,
        symbols: typing.Optional[str] = None,
    ...
    def get_user_account_quotes(
        ...
        return self._get_user_account_quotes_oapg(
            query_params=args.query,
            path_params=args.path,
        )
