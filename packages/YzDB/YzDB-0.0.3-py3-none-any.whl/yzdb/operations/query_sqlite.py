...
class QueryTableSQLite:
    ...
    def query_table_columns(self,
        ...
        table_columns = self.sql_base.execute(sql)
        return [table_column[1] for table_column in table_columns]
    ...
    def query_table_comment(self,
        ...
        table_comment = self.sql_base.execute(sql)
        return table_comment[0][0].split("\n")[1].strip()        
