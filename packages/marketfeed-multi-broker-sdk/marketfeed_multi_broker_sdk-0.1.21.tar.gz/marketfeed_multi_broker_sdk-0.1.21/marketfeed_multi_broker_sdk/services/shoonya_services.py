...
import time
import urllib.parse
from marketfeed_multi_broker_sdk.models import Login, Order, HoldingData, HoldingResponse, PositionData, PositionResponse
...
class _ShoonyaAPIService:
    ...
    def _holding(self, token, client_code):
        try:
            ...
            holdings_data = response_json['exch_tsym']
            holdings_list = []
...
class ShoonyaAPIServices(_ShoonyaAPIService):
    ...
    def ShoonyaPlaceOrder(self, token, client_code, order_details: Order):
...
#     shoonyaAPI = ShoonyaAPIServices()
    ...
    # token = "a976ef8712ce0fe86c895ce8a704c7f6646b15f114ba4d78d9f99f550c385c78"
...
#     order_number, message = shoonyaAPI.ShoonyaPlaceOrder(
#         token=token,
#         client_code=client_code,
#         order_details=Order(
