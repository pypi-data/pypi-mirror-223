...
from marketfeed_multi_broker_sdk.models import Login, Order, MarginData, MarginResponse, HoldingData, HoldingResponse, PositionData, PositionResponse
...
class FyersAPIServices(_FyersAPIService):
    ...
    def FyersPlaceOrder(self, token, client_code, order_details: Order):
...
# if __name__ == '__main__':
    ...
    # order_number, message = fyers_api_service.FyersPlaceOrder(
    #     token=token,
    #     client_code=client_code,
    #     order_details=Order(
