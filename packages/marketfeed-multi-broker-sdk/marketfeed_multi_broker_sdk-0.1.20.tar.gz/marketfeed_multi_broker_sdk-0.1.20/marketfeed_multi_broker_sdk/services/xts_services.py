...
from marketfeed_multi_broker_sdk.models import Login, MarginData, MarginResponse, Order, HoldingData, HoldingResponse, PositionData, PositionResponse
...
class XtsAPIServices(_XtsAPIService):
    ...
    def XtsPlaceOrder(self, token, client_code, order_details: Order):
...
#     print("MARGIN", margin_response.margin, margin_response.message)
    ...
    # order_number, message = xtsAPI.XtsPlaceOrder(
    #     token=token,
    #     client_code=client_code,
    #     order_details=Order(
