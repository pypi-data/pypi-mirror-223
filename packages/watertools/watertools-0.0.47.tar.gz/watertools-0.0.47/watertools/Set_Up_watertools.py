...
def set_up_account(account="ALL"):
    ...
    if account == "ALL":
        Servers = ["NASA", "NASA_BEARER", "GLEAM", "FTP_WA", "MSWEP", "Copernicus", "VITO", "WAPOR", "VIIRS_BEARER"]
    else:
        Servers = [account]
    
    for Server in Servers:
        
        if Server != "WAPOR" and Server != "NASA_BEARER" and Server != "VIIRS_BEARER":
        ...
        if  Server == "WAPOR" or Server == "NASA_BEARER" or Server == "VIIRS_BEARER":
