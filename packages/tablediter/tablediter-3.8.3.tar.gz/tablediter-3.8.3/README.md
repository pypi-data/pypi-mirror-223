...
By default, tablediter produces ASCII tables that look like the ones used in SQL
...
tablediter will also print your tables in JSON, as a list of fields and an array of
