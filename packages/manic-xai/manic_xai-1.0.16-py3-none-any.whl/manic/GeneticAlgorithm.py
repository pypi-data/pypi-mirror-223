...
class GeneticAlgorithm:
    def __init__(self, num_generations, early_stopping, predict_fn, evaluation, selection, crossover, mutate, verbose, target_class, max_time, utils, replacement, population, base_counterfactuals, data_instance, disagreement):
