...
def edit_mesh_extrude_individual_move(alt_navigation: bool = False) -> None:
...
def edit_mesh_extrude_manifold_normal(alt_navigation: bool = False) -> None:
...
def edit_mesh_extrude_move_normal(dissolve_and_intersect: bool = False, alt_navigation: bool = False) -> None:
...
def edit_mesh_extrude_move_shrink_fatten(alt_navigation: bool = False) -> None:
...
def interactive_add(primitive_type: str = 'CUBE', plane_origin_base: str = 'EDGE', plane_origin_depth: str = 'EDGE', plane_aspect_base: str = 'FREE', plane_aspect_depth: str = 'FREE', wait_for_input: bool = True) -> None:
