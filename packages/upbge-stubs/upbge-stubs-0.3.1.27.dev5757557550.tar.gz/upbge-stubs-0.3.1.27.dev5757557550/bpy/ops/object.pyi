...
def grease_pencil_add(type: str = 'EMPTY', radius: float = 1.0, align: str = 'WORLD', location: mathutils.Vector = (0.0, 0.0, 0.0), rotation: mathutils.Euler = (0.0, 0.0, 0.0), scale: mathutils.Vector = (0.0, 0.0, 0.0)) -> None:
...
def light_linking_blockers_link(link_state: str = 'INCLUDE') -> None:
...
def light_linking_receivers_link(link_state: str = 'INCLUDE') -> None:
...
def lightprobe_cache_bake(delay: int = 0, subset: str = 'ALL') -> None:
...
def lightprobe_cache_free(subset: str = 'SELECTED') -> None:
...
def parent_no_inverse_set(confirm: bool = True, keep_transform: bool = False) -> None:
...
def simulation_nodes_cache_bake(selected: bool = False) -> None:
...
def simulation_nodes_cache_calculate_to_frame(selected: bool = False) -> None:
...
def simulation_nodes_cache_delete(selected: bool = False) -> None:
...
def vertex_parent_set(confirm: bool = True) -> None:
