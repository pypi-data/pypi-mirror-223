...
class AggregatedLidarsAndCamerasSequence(CreateableIOResource):
    ...
    def create(
        self,
        aggregated_lidars_and_cameras_seq: InputModel.AggregatedLidarsAndCamerasSequence,
        ...
        """
        Upload files and create an input of type ``AggregatedLidarsAndCamerasSequence``.

        :param aggregated_lidars_and_cameras_seq: class containing 2D and 3D resources that constitute the input
        ...
        """
        if not isinstance(aggregated_lidars_and_cameras_seq, InputModel.AggregatedLidarsAndCamerasSequence):
