...
class TestDuplicateInputsValidation:
    ...
    def test_sync_validation(self, client: IOC.KognicIOClient):
        ...
        wait_for_input_creation(client=client, input_uuid=resp.input_uuid)
    ...
    def test_async_validation(self, client: IOC.KognicIOClient):
        ...
        # Wait
        input1 = wait_for_input_job(client=client, input_uuid=resp1.input_uuid)
        input2 = wait_for_input_job(client=client, input_uuid=resp2.input_uuid)
