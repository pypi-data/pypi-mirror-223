...
import kognic.io.model.input.cameras as C
import kognic.io.model.input.cameras_sequence as CS
import kognic.io.model.input.lidars_and_cameras as LC
import kognic.io.model.input.lidars_and_cameras_sequence as LCS
import pytest
from kognic.io.model import Project, PointCloud, Image
...
class TestCreateInputWithFileData:
    ...
    def _test_create_lidars_and_cameras(self, client: IOC.KognicIOClient, calibration, img, pc):
        ...
        resp = client.lidar_and_cameras.create(scene, project=project, annotation_types=anno_types, dryrun=False)
        assert resp is not None
