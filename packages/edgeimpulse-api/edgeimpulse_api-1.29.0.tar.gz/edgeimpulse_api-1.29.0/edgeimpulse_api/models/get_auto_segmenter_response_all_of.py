...
class GetAutoSegmenterResponseAllOf(BaseModel):
    ...
    __properties = ["hasResults", "clusters", "simThreshold", "minObjectSizePx", "whichItemsToInclude"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAutoSegmenterResponseAllOf:
        """Create an instance of GetAutoSegmenterResponseAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAutoSegmenterResponseAllOf:
        """Create an instance of GetAutoSegmenterResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAutoSegmenterResponseAllOf.construct(**obj)

        _obj = GetAutoSegmenterResponseAllOf.construct(**{
