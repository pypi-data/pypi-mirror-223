...
class SymphonyVega(symphony_ui.SymphonyWidget):
    ...
    name = 'SymphonyVega'
    description = "The vega widget provides an overview of the data distribution. It can be used to get a general idea of what data a dataset contains."
