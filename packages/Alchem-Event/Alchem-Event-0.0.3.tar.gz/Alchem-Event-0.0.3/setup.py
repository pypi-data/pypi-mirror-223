...
from alchemevent import __version__

PACKAGE = "alchemevent"
NAME = "Alchem-Event"
VERSION = __version__
DESCRIPTION = "FinAlchem " + VERSION
AUTHOR = "flaght"
...
class version_build(Command):
    ...
    def run(self):
        ...
        configFile = 'alchemevent/__init__.py'
...
ext_modules = [
    'alchemevent/event/base.pyx', 'alchemevent/kdutils/base.pyx',
    'alchemevent/kdutils/create_id.pyx', 'alchemevent/kdutils/lazy.pyx'
]
