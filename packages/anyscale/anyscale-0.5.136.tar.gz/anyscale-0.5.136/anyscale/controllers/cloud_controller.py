...
from anyscale.utils.cloud_utils import CloudEventProducer, verify_anyscale_access
        ...
        *,
        ...
        if cloud.provider == "AWS":
            ...
            if not self.verify_aws_cloud_resources(
                ...
                # TODO (congding): cloud provider error
                self.cloud_event_producer.produce(
                    CloudAnalyticsEventName.RESOURCES_VERIFIED, succeeded=False
                )
                return False
    ...
    def register_aws_cloud(  # noqa: PLR0913
        ...
        *,
        ...
        try:
            ...
            # TODO (congding): cloud provider error
            self.cloud_event_producer.produce(
                CloudAnalyticsEventName.PREPROCESS_COMPLETE, succeeded=False,
            )
