            ...
            if "dataset" in str(child) and self.aggregated_dataset == True:
                ...
                if self.collection_id_tuples is not None:
                    collection_id = next(
                        (
                            i
                            for i, v in enumerate(self.collection_id_tuples)
                            if v[0] == collection_id
                        ),
                        collection_id,
                    )
...
class Catalog_summary(object):
    ...
    def __init__(
        ...
        self.logger.info("Getting infos is started")
        ...
        self.logger.info("Getting infos is finished")
