...
if not _RELEASE:
    ...
    st.set_page_config(page_title="Demo for streamlit-calendar-semver", page_icon="📆")

    st.markdown("## Demo for [streamlit-calendar-semver](https://github.com/im-perativa/streamlit-calendar-semver)")
