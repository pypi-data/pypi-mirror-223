...
class BlobConnector:
    ...
    def get_blob_list(self,folder_path:str=None)->list[str]:
        ...
        Args:
            folder_path (str, optional): path of a specific folder. Defaults to None.
    ...
    def check_blob_existance(self, blob_name:str):
    ...
    def add_folder(self,folder_path:str)->None:
        ...
        Args:
            folder_path (str): full path of intended virtual folder
        """
