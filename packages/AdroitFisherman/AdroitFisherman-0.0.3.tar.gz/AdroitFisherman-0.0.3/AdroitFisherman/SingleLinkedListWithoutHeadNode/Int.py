import ctypes
class SingledLinkedListWithoutHeadNode_int():
    def __init__(self):
        self.__list=ctypes.cdll.LoadLibrary("./Libraries/SingleLinkedListWithoutHeadNode_int.dll")
