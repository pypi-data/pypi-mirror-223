import ctypes
class SingledLinkedListWithoutHeadNode_char():
    def __init__(self):
        self.__list=ctypes.cdll.LoadLibrary("./Libraries/SingleLinkedListWithoutHeadNode_char.dll")
