...
*AuthenticationApi* | [**post_authentication_sso**](docs/AuthenticationApi.md#post_authentication_sso) | **POST** /authentication/workspaceId&#x3D;{id} | Creates a new Koverse Authentication Token for Single Sign-On (SSO) users
