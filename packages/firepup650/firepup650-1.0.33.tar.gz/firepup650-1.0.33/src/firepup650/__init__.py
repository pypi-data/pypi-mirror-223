...
import random as r
import fkeycapture as fkey  # type: ignore[import]
import fpsql as fql  # type: ignore[import]
from warnings import warn as ww
from typing import TypeVar, Type, Optional, List, Any, Union
...
@alias(sys.exit)
def e(code: Union[str, int, None] = 0) -> None:
    """# Function: e
      Exits with the provided code
    # Inputs:
      code: Union[str, int, None] - The status code to exit with, defaults to 0
