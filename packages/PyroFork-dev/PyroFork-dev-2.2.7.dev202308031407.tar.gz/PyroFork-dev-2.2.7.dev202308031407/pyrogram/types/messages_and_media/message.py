...
class Message(Object, Update):
    ...
    Parameters:
        ...
        channel_shared (:obj:`~pyrogram.types.PeerChannel, *optional*):
            Service message: channel shared

        chat_shared (:obj:`~pyrogram.types.PeerChat, *optional*):
            Service message: chat shared

        user_shared (:obj:`~pyrogram.types.PeerUser, *optional*):
    ...
    def __init__(
        ...
        *,
        ...
        channel_shared: "types.PeerChannel" = None,
        chat_shared: "types.PeerChat" = None,
        user_shared: "types.PeerUser" = None,
