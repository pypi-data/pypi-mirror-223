...
class Message(Object, Update):
    ...
    Parameters:
        ...
        channel_shared (:obj:`~pyrogram.types.Chat, *optional*):
            Service message: channel shared

        chat_shared (:obj:`~pyrogram.types.Chat, *optional*):
            Service message: chat shared

        user_shared (:obj:`~pyrogram.types.User, *optional*):
    ...
    def __init__(
        ...
        *,
        ...
        channel_shared: "types.Chat" = None,
        chat_shared: "types.Chat" = None,
        user_shared: "types.User" = None,
