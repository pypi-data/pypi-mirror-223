...
class DocCompareLogic:
    ...
    def calculate_total_work_for_progress_bar(
        ...
        if origin_dds_topics_types_xml != "" and new_dds_topics_types_xml != "":
            ...
            origin_chapter_list = self.origin_engine_handler.GetTypesBasicInfo()
            new_chapter_list = self.new_engine_handler.GetTypesBasicInfo()
    ...
    def generate_type_based_comp_structure(self, order_alphabetically, engine) -> Dict:
        """
    ...
    def run_engine_and_generate_comparison(self,
        ...
        try:
            ...
            self.origin_engine_handler = OmniconEngineHandler(origin_dds_types_files)
            self.new_engine_handler = OmniconEngineHandler(new_dds_types_files)
            ...
            if origin_dds_topics_types_xml != "" and new_dds_topics_types_xml != "":
                ...
                ErrorListHandler.update_current_module_name(f"Parsing {origin_version}")
                origin_comp_structure = \
                    self.generate_type_based_comp_structure(order_alphabetically, self.origin_engine_handler.engine)
                ErrorListHandler.update_current_module_name(f"Parsing {new_version}")
                new_comp_structure = \
                    self.generate_type_based_comp_structure(order_alphabetically, self.new_engine_handler.engine)
        ...
        for i, output_format in enumerate(output_formats):
            ...
            with tempfile.TemporaryDirectory() as temp_folder:
                try:
                    ...
                    document_handler.create_ICD_from_structured_doc_data(
    ...
    def run_doc_compare(self,
                        ...
                        output_folder: str = "",
                        output_formats=None,
                        is_ignore_id: bool = False) -> (bool, List[str]):
        """
