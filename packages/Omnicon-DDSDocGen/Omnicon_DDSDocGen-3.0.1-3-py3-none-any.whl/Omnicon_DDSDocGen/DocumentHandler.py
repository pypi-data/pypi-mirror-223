...
class DocumentHandler:
    ...
    def reconstruct_chapter_header_from_structured_doc_data(self, chapter_name: str, root_element: CompElement):
        ...
        self.current_table = self.create_new_chapter_with_table(
            chapter_name, type_name, element, topic_level_comment, parent_change_status)
    ...
    def create_ICD_from_structured_doc_data(self, structured_doc_data, output_file_name: str,
                                            output_folder: str, temp_folder: str, output_format: str,
        ...
        self.update_progress_bar(i , "Saving", progress_factor, is_save=True)
