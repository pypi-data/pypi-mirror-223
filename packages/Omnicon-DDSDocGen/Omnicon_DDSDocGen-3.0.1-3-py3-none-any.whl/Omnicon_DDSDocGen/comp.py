...
class CompElement:
    ...
    def __init__(self, introspection_element: Element = None, is_discriminator=False):
    ...
    def extract_numbers_from_union_options(self):
        return set(map(int, self.full_description.replace("Union discriminator options: ", "").split(", ")))
