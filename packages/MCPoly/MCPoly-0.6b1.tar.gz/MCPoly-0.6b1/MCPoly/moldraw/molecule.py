...
def sub_selection(substitution, atoms, i, state=1,\
...
class molecule:
    ...
    def sub(self, substitution, i, state=1, place=0,\
        ...
        '''
        self.atoms = sub_selection(substitution, self.atoms,\
    ...
    def bind(self, ring_size, bond, state=[1, 1], place=0, strict={1:'X'},\
        ...
        '''
        self.atoms = bind_selection(ring_size, self.atoms, bond, state,\
