...
class IOSMapAdvancedBehavior(Interface):
    """ Marker interface for OSMap Advanced Behavior
    """
...
class IOSMapAdvancedWidget(ITextWidget):
    """ Marker interface for OSMap Advanced Widget
    """
...
class IOSMapAdvancedField(ITextLine):
    """ Marker interface for OSMap Advanced Field
    """
