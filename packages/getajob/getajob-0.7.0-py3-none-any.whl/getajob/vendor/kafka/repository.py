...
from getajob.vendor.kafka.models import KafkaTopic, BaseKafkaMessage, APILogMessage, SearchImpressionData
...
class KafkaProducerRepository:
    ...
    # TODO this message paramter is now gross
    def publish(self, topic: KafkaTopic, message: BaseKafkaMessage | APILogMessage | SearchImpressionData) -> None:
        message_token = generate_jwt(
