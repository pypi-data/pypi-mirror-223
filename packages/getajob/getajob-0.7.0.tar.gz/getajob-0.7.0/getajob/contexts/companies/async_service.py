...
class AsyncronousCompanyService:
    ...
    async def company_is_created(self, processed_message: ProcessedKafkaMessage):
    ...
    async def company_is_updated(self, processed_message: ProcessedKafkaMessage):
        data = cast(Company, processed_message.data)
    ...
    async def company_is_deleted(self, processed_message: ProcessedKafkaMessage):
        original_data = CompanySearch(
    ...
    async def company_details_are_set(self, processed_message: ProcessedKafkaMessage):
