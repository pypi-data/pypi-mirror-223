...
class SymphonyScatterplot(symphony_ui.SymphonyWidget):
    ...
    description = "A scatterplot component based on Fritz Leschkas regl-scatterplot. Needs a projection column."
    ...
    def __init__(self,
        ...
        """A scatterplot component based on Fritz Leschkas regl-scatterplot. Needs a projection column.
