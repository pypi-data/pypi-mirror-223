...
from server_packets.server import StatWindow
from server_packets.server import ConfigWindow
from server_packets.server import RegisterUser
from server_packets.server import DelUserDialog
