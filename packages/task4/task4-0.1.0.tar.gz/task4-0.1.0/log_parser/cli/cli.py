...
from log_parser.cli.patterns import SearchPatterns
from log_parser.log_parser import packet_version, logger, LogHandler, Functions
...
class CommandCLI(Command):
    ...
    @staticmethod
    def __print_output__(output) -> None:
    ...
    def execute(self) -> None:
        ...
        self.__print_output__(handler.output)
