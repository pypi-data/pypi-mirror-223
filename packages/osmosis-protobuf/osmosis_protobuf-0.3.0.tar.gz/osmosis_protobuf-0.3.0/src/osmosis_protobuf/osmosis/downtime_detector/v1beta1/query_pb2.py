...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZIgithub.com/osmosis-labs/osmosis/v16/x/downtime-detector/client/queryproto'
