def make_game_html(uname, uid, hash):
    ...
    with open('src\\ladderbot\\assets\\index.html', 'w') as f:
        f.write(game_html)

# game_html = make_game_html(hash="fe5d5690adf9c4b71f73a331ab32b14a", uid=1417864, uname="chparmley")
