...
class Client:
    ...
    def __init__(self, spell_id: str, spell_token: str, spellz_domain: Optional[str] = None) -> None:
        """
        Args:
            spellz_id: it coresponds to their bot ID (shoudl be same as the clustaar bot ID in the future)
            spellz_token: it corresponds to their x-api-key
            spellz_domain: the domaine (prod/staging)
        """
        self._spellz_id = spell_id
        self._spellz_token = spell_token
