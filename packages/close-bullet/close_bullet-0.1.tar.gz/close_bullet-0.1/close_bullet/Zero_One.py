...
class Options:
    ...
    def names(sex:str=None) -> dir():
        ...
        return {'title': title, 'full_name': full_name, 'first_name': first_name, 'last_name': last_name, 'sex': str(sex)}
    @staticmethod
    ...
    def random_user_agent(self) -> str:
        ...
        return ua
    @staticmethod
    def header_parse(headers_: str) -> dir():
        headers = {}
        ...
        return headers
    @staticmethod
    def payload_parse(payloads_: str) -> dir():
