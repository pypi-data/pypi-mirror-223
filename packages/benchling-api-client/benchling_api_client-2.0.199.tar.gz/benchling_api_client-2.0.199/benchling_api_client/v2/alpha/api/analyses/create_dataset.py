...
from ...models.dataset_create_from_file import DatasetCreateFromFile
...
def _get_kwargs(
    *,
    client: Client,
    json_body: DatasetCreateFromFile,
) -> Dict[str, Any]:
...
def sync(
    *,
    ...
    """Create a Dataset from a previously uploaded `File`.
    The source `File` must have an extension of `.csv`.
    """
