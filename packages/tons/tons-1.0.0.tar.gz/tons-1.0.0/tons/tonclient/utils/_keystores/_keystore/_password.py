...
from ..._exceptions import KeyStoreInvalidPasswordError, KeyStoreAccessDeniedError
...
class PasswordKeyStore(BaseKeyStore):
    ...
    def __init__(self, filepath, version, records: List[Record], contacts: List[WhitelistContact],
                 connections: List[TonconnectConnection], public_key, salt):
    ...
    def validate_password(password: str):
        if len(password) < 6:
            raise KeyStoreInvalidPasswordError("Password must be at least 6 characters long")
