...
class KeystoresSet(KeystoreBaseSet):
    ...
    def _handle_restore_keystore(self):
        ans = self._prompt([
            ...
            inquirer.Text(
                "backup_file_path", message=f'Backup file path (relative to {getcwd_pretty()})'),
        ])
        ...
        ans = self._prompt([
            ...
            inquirer.List(
                "keystore_type", message='New keystore type', choices=[KeyStoreTypeEnum.password],
