...
Traits that are concerned with describing aspects of the lifecycle of an
entity, such as versioning.
"""
...
class StableTrait:
    ...
    query with this trait should be devoid of any dynamic behaviour.
    This includes concepts such as meta-versioning or context-specific
...
class VersionTrait:
    ...
    def setStableTag(self, stableTag: str):
        ...
        the most recent, then this should be set to the tag of that
        version. When referencing some other semantic state (eg.
        approval), this should be set to the tag of the concrete version
