...
# ----------------------------------------------------------------------
def FrameworkServer(class_, *args, **kwargs):
    ...
    python_tools = [
        [os.path.join(os.path.dirname(os.path.abspath(__file__)), 'python_tools', 'python_logger.py'), 'logging', '/python_logger'],
        [os.path.join(os.path.dirname(os.path.abspath(__file__)), 'python_tools', 'python_swarm.py'), 'swarm', '/python_swarm'],
    ]
