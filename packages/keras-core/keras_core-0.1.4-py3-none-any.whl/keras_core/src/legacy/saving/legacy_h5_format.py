...
from keras_core.src.legacy.saving import json_utils
from keras_core.src.legacy.saving import saving_options
from keras_core.src.legacy.saving import saving_utils
...
def save_weights_to_hdf5_group(f, model):
    ...
    """
    from keras_core.src import __version__ as keras_version
