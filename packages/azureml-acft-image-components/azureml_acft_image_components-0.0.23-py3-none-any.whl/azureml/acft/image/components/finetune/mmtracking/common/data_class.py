...
class AzmlMMTImageDataClass(AzmlDataInterface):
    ...
    def _get_model_preprocessing_dict(self, model_name_or_path: str) -> Dict:
        ...
        :rtype: Dict
        """
        config = TrackingConfigBuilder(model_name_or_path).build()
        return config.data
    ...
    def _set_dataset_classes(
        ...
        self.validation_ds = MmTrackingDataset(valid_images_df, is_train=False, load_as_video=False)
    ...
    def get_collation_function(
        ...
        def tracking_collate_func(
            ...
            output['dummy_labels'] = torch.asarray([0.])
            return output
