...
class PIH:
    ...
    class EXECUTOR:
        ...
        def get_executor_path(executor_name: str) -> str:
            return PIH.PATH.for_windows(PIH.PATH.join(
        ...
        def create_command_for_psexec(command: list[str], host: str | None = None, login: str | None = None, password: str | None = None, interactive: bool | None = False, run_from_system_account: bool = False, run_with_elevetion: bool = False) -> list[str]:
            ...
            if not local:
                login = login or PIH.DATA.variable_value(CONST.ADMINISTRATOR_LOGIN_ALIAS)
    ...
    class SERVICE:
        ...
        class ADMIN:
            ...
            @staticmethod
            def restart(role_or_information: ServiceRoles | ServiceInformationBase, check_if_started: bool = True, show_output: bool = True) -> bool | None:
                PIH.SERVICE.ADMIN.stop(role_or_information, check_if_started)
                return PIH.SERVICE.ADMIN.start(role_or_information, check_if_started, show_output)
    ...
    class CHECK:
        ...
        class RESOURCE:
            ...
            def accessibility_by_ping(address_or_ip: str, host: str | None = None, count: int | None = None, check_for_all: bool = True) -> bool:
                ...
                process_result: CompletedProcess = PIH.EXECUTOR.execute(if_else(DataTool.is_none(host), ping_command,
                    lambda: PIH.EXECUTOR.create_command_for_psexec(ping_command, host,  
                    PIH.DATA.variable_value(CONST.ADMINISTRATOR_LOGIN_ALIAS),
                    PIH.DATA.variable_value(CONST.ADMINISTRATOR_PASSOWORD_ALIAS), True)), True, True)
