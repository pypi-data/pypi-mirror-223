# -*- coding: utf-8 -*-
"""
Interface for opening Nanoscope curve files.

"""

from .base import File
from ..channels import CurveChannel


class CurveFile(File):
    """Curve file interface

    Regroup one or several CurveChannel.
    """
    ...
    def _get_channel(self, i_chan):
        ...
        if i_chan not in self._channels.keys():
            ...
            self._channels[i_chan] = CurveChannel(self, i_chan)
