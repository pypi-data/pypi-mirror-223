...
root.render(_jsx(Jupyter, { children: _jsx(Notebook, { path: "renderer.ipynb", renderers: [
            geojsonRenderer,
            //        vega3Renderer,
        ], CellSidebar: CellSidebarNew, Toolbar: NotebookToolbar, height: 'calc(100vh - 2.6rem)' // (Height - Toolbar Height).
        , uid: "notebook-uid" }) }));
//# sourceMappingURL=NotebookRenderer.js.map