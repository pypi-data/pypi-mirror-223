...
class VideoData (SpireObject) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().VideoData_get_ContentType(self.Ptr))
        return ret
...
#        intPtrArray = GetDllLibPpt().VideoData_get_Data(self.Ptr)
...
#        GetDllLibPpt().VideoData_set_Data(self.Ptr, vArray, vCount)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().VideoData_get_Stream(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().VideoData_GetStream(self.Ptr)
        ret = None if intPtr==None else Stream(intPtr)
        return ret
    ...
    <param name="fileName"></param>
        ...
        GetDllLibPpt().VideoData_SaveToFile.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().VideoData_SaveToFile(self.Ptr, fileName)
