...
class ActiveSlide (  PptObject, IActiveSlide) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_Shapes(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ActiveSlide_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().ActiveSlide_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ActiveSlide_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        slidId = GetDllLibPpt().ActiveSlide_get_SlideID(self.Ptr)
        return slidId
    ...
    #    GetDllLibPpt().ActiveSlide_set_SlideID(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_Theme(self.Ptr)
    ...
    <param name="scheme"></param>
        ...
        GetDllLibPpt().ActiveSlide_ApplyTheme(self.Ptr, intPtrscheme)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_Timeline(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_SlideShowTransition(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_SlideBackground(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_DisplaySlideBackground(self.Ptr)
        ret = None if intPtr==None else SlideBackground(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ActiveSlide_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().ActiveSlide_get_Presentation(self.Ptr)
