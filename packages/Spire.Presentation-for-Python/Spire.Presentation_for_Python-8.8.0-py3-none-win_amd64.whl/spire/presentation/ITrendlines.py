...
class ITrendlines (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_backward(self.Ptr)
        return ret

    @backward.setter
    def backward(self, value:float):
        GetDllLibPpt().ITrendlines_set_backward.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITrendlines_set_backward(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_forward(self.Ptr)
        return ret

    @forward.setter
    def forward(self, value:float):
        GetDllLibPpt().ITrendlines_set_forward.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITrendlines_set_forward(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_intercept(self.Ptr)
        return ret

    @intercept.setter
    def intercept(self, value:float):
        GetDllLibPpt().ITrendlines_set_intercept.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITrendlines_set_intercept(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_displayEquation(self.Ptr)
        return ret
    ...
    def displayEquation(self, value:bool):
        ...
        GetDllLibPpt().ITrendlines_set_displayEquation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_displayRSquaredValue(self.Ptr)
        return ret
    ...
    def displayRSquaredValue(self, value:bool):
        ...
        GetDllLibPpt().ITrendlines_set_displayRSquaredValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_polynomialTrendlineOrder(self.Ptr)
        return ret
    ...
    def polynomialTrendlineOrder(self, value:int):
        ...
        GetDllLibPpt().ITrendlines_set_polynomialTrendlineOrder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_period(self.Ptr)
        return ret

    @period.setter
    def period(self, value:int):
        GetDllLibPpt().ITrendlines_set_period.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ITrendlines_set_period(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITrendlines_get_type(self.Ptr)
    ...
    def type(self, value:'TrendlinesType'):
        ...
        GetDllLibPpt().ITrendlines_set_type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ITrendlines_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().ITrendlines_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ITrendlines_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITrendlines_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITrendlines_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITrendlines_get_TrendLineLabel(self.Ptr)
