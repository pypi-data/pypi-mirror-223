...
class ChartData (SpireObject) :
    ...
    def __getitem__(self, row,column):
        ...
        intPtr = GetDllLibPpt().ChartData_get_Item(self.Ptr, row,column)
    ...
    def __getitem__(self, startRow,startColumn,endRow,endColumn):
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemRCLL(self.Ptr, startRow,startColumn,endRow,endColumn)
    ...
    def __getitem__(self, name:str):
        ...
        GetDllLibPpt().ChartData_get_ItemN.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ChartData_get_ItemN.restype=c_void_p
        intPtr = GetDllLibPpt().ChartData_get_ItemN(self.Ptr, name)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartData_Clear(self.Ptr, row,column,lastRow,lastColumn)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartData_get_ItemRCLL.argtypes=[c_void_p ,c_int,c_int,c_int,c_int]
        GetDllLibPpt().ChartData_get_ItemRCLL.restype=c_void_p
        intPtr = GetDllLibPpt().ChartData_get_ItemRCLL(self.Ptr, row,column,lastRow,lastColumn)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ChartData_get_ItemWRCLL(self.Ptr, worksheetIndex,row,column,lastRow,lastColumn)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartData_get_ItemNE.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().ChartData_get_ItemNE.restype=c_void_p
        intPtr = GetDllLibPpt().ChartData_get_ItemNE(self.Ptr, name,endCellName)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartData_get_ItemWN.argtypes=[c_void_p ,c_int,c_wchar_p]
        GetDllLibPpt().ChartData_get_ItemWN.restype=c_void_p
        intPtr = GetDllLibPpt().ChartData_get_ItemWN(self.Ptr, worksheetIndex,name)
        ret = None if intPtr==None else CellRange(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartData_get_ItemWNE.argtypes=[c_void_p ,c_int,c_wchar_p,c_wchar_p]
        GetDllLibPpt().ChartData_get_ItemWNE.restype=c_void_p
        intPtr = GetDllLibPpt().ChartData_get_ItemWNE(self.Ptr, worksheetIndex,name,endCellName)
        ret = None if intPtr==None else CellRanges(intPtr)
        return ret
