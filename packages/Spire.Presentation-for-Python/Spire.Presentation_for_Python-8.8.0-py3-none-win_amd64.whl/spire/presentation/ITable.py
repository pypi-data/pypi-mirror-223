...
class ITable (IShape) :
    ...
    def __getitem__(self, index):
        ...
        if(len(index) ==2):
            ...
            intPtr = GetDllLibPpt().ITable_get_Item(self.Ptr, column,row)
    ...
    <param name="allowSplitting">True to allow cells splitting.</param>
        ...
        GetDllLibPpt().ITable_MergeCells(self.Ptr, intPtrcell1,intPtrcell2,allowSplitting)
    ...
    <param name="borderColor">border color.</param>
        ...
        GetDllLibPpt().ITable_SetTableBorder(self.Ptr, enumborderType,borderWidth,intPtrborderColor)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_StylePreset(self.Ptr)
    ...
    def StylePreset(self, value:'TableStylePreset'):
        ...
        GetDllLibPpt().ITable_set_StylePreset(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_TableRows(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_ColumnsList(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_RightToLeft(self.Ptr)
        return ret

    @RightToLeft.setter
    def RightToLeft(self, value:bool):
        GetDllLibPpt().ITable_set_RightToLeft.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_RightToLeft(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_FirstRow(self.Ptr)
        return ret

    @FirstRow.setter
    def FirstRow(self, value:bool):
        GetDllLibPpt().ITable_set_FirstRow.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_FirstRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_FirstCol(self.Ptr)
        return ret

    @FirstCol.setter
    def FirstCol(self, value:bool):
        GetDllLibPpt().ITable_set_FirstCol.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_FirstCol(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_LastRow(self.Ptr)
        return ret

    @LastRow.setter
    def LastRow(self, value:bool):
        GetDllLibPpt().ITable_set_LastRow.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_LastRow(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_LastCol(self.Ptr)
        return ret

    @LastCol.setter
    def LastCol(self, value:bool):
        GetDllLibPpt().ITable_set_LastCol.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_LastCol(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_HorizontalBanding(self.Ptr)
        return ret
    ...
    def HorizontalBanding(self, value:bool):
        ...
        GetDllLibPpt().ITable_set_HorizontalBanding(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_VerticalBanding(self.Ptr)
        return ret
    ...
    def VerticalBanding(self, value:bool):
        ...
        GetDllLibPpt().ITable_set_VerticalBanding(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().ITable_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().ITable_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().ITable_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().ITable_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITable_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().ITable_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITable_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().ITable_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITable_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().ITable_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITable_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().ITable_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITable_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITable_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().ITable_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITable_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ITable_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().ITable_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ITable_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ITable_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().ITable_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ITable_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITable_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().ITable_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().ITable_get_Item.argtypes=[c_void_p ,c_int,c_int]
        GetDllLibPpt().ITable_get_Item.restype=c_void_p
        intPtr = GetDllLibPpt().ITable_get_Item(self.Ptr, columnIndex,rowIndex)
        ret = None if intPtr==None else Cell(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().ITable_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().ITable_Dispose(self.Ptr)
    ...
    <param name="endRowIndex">end row index.</param>
        ...
        GetDllLibPpt().ITable_DistributeRows(self.Ptr, startRowIndex,endRowIndex)
    ...
    <param name="endColumnIndex">end column index.</param>
        ...
        GetDllLibPpt().ITable_DistributeColumns(self.Ptr, startColumnIndex,endColumnIndex)
