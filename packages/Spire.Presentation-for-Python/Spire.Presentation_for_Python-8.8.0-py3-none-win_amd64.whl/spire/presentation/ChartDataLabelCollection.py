...
class ChartDataLabelCollection (  SpireObject ) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartDataLabelCollection_get_NumberFormat(self.Ptr))
        return ret


    @NumberFormat.setter
    def NumberFormat(self, value:str):
        GetDllLibPpt().ChartDataLabelCollection_set_NumberFormat.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ChartDataLabelCollection_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_HasDataSource(self.Ptr)
        return ret
    ...
    def HasDataSource(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_HasDataSource(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_IsDelete(self.Ptr)
        return ret

    @IsDelete.setter
    def IsDelete(self, value:bool):
        GetDllLibPpt().ChartDataLabelCollection_set_IsDelete.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartDataLabelCollection_set_IsDelete(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_TextProperties(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_Position(self.Ptr)
    ...
    def Position(self, value:'ChartDataLabelPosition'):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_Position(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_LegendKeyVisible(self.Ptr)
        return ret
    ...
    def LegendKeyVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_LegendKeyVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_LeaderLinesVisible(self.Ptr)
        return ret
    ...
    def LeaderLinesVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_LeaderLinesVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_CategoryNameVisible(self.Ptr)
        return ret
    ...
    def CategoryNameVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_CategoryNameVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_LabelValueVisible(self.Ptr)
        return ret
    ...
    def LabelValueVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_LabelValueVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_PercentValueVisible(self.Ptr)
        return ret
    ...
    def PercentValueVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_PercentValueVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_SeriesNameVisible(self.Ptr)
        return ret
    ...
    def SeriesNameVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_SeriesNameVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_BubbleSizeVisible(self.Ptr)
        return ret
    ...
    def BubbleSizeVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_BubbleSizeVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartDataLabelCollection_get_Separator(self.Ptr))
        return ret


    @Separator.setter
    def Separator(self, value:str):
        GetDllLibPpt().ChartDataLabelCollection_set_Separator.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ChartDataLabelCollection_set_Separator(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_get_DataLabelShapeType(self.Ptr)
    ...
    def DataLabelShapeType(self, value:'DataLabelShapeType'):
        ...
        GetDllLibPpt().ChartDataLabelCollection_set_DataLabelShapeType(self.Ptr, value.value)
    ...
    def Add(self)->'ChartDataLabel':
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_Add(self.Ptr)
    ...
    <param name="value">The DataLabel to remove from the collection.</param>
        ...
        GetDllLibPpt().ChartDataLabelCollection_Remove(self.Ptr, intPtrvalue)
    ...
    <returns>Index of a DataLabel or -1 if DataLabel not from this collection.</returns>
        ...
        ret = GetDllLibPpt().ChartDataLabelCollection_IndexOf(self.Ptr, intPtrvalue)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_Item(self.Ptr, index)
        ret = None if intPtr==None else ChartDataLabel(intPtr)
        return ret
    ...
    def LeaderLines(self)->'IChartGridLine':
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_get_LeaderLines(self.Ptr)
        ret = None if intPtr==None else IChartGridLine(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabelCollection_GetEnumerator(self.Ptr)
