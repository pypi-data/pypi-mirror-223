...
class ChartCategoryCollection (SpireObject) :
    ...
    <returns>
        ...
        intPtr = GetDllLibPpt().ChartCategoryCollection_get_Item(self.Ptr, index)
    ...
    def CategoryLabels(self)->'CellRanges':
        ...
        intPtr = GetDllLibPpt().ChartCategoryCollection_get_CategoryLabels(self.Ptr)
    ...
    def CategoryLabels(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartCategoryCollection_set_CategoryLabels(self.Ptr, value.Ptr)
    ...
    <returns>Index of new chart category.</returns>
        ...
        ret = GetDllLibPpt().ChartCategoryCollection_Append(self.Ptr, intPtrcellRange)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartCategoryCollection_AppendV.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ChartCategoryCollection_AppendV.restype=c_int
        ret = GetDllLibPpt().ChartCategoryCollection_AppendV(self.Ptr, value)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().ChartCategoryCollection_AppendV1(self.Ptr, value)
        return ret
    ...
    <returns>Index of a new added <see cref="T:Spire.Presentation.Charts.CellRange" />.</returns>
        ...
        ret = GetDllLibPpt().ChartCategoryCollection_AppendV11(self.Ptr, intPtrvalue)
        return ret
    ...
    <returns>The zero-based index of the first occurrence of value within the entire CollectionBase, if found; otherwise, -1.</returns>
        ...
        ret = GetDllLibPpt().ChartCategoryCollection_IndexOf(self.Ptr, intPtrvalue)
        return ret
...
<exception cref="T:System.ArgumentException">The value parameter was not found in the collection.</exception>
        ...
        GetDllLibPpt().ChartCategoryCollection_Remove(self.Ptr, intPtrvalue)
