...
class CommentList (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CommentList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().CommentList_get_Item(self.Ptr, index)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().CommentList_AppendComment.argtypes=[c_void_p ,c_void_p,c_wchar_p,c_float,c_float]
        GetDllLibPpt().CommentList_AppendComment.restype=c_void_p
        intPtr = GetDllLibPpt().CommentList_AppendComment(self.Ptr, intPtrslide,text,x,y)
        ret = None if intPtr==None else Comment(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().CommentList_InsertComment.argtypes=[c_void_p ,c_void_p,c_int,c_wchar_p,c_float,c_float]
        GetDllLibPpt().CommentList_InsertComment.restype=c_void_p
        intPtr = GetDllLibPpt().CommentList_InsertComment(self.Ptr, intPtrslide,Index,text,x,y)
        ret = None if intPtr==None else Comment(intPtr)
        return ret
...
#        intPtrArray = GetDllLibPpt().CommentList_ToArray(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().CommentList_ToArraySC(self.Ptr, startIndex,count)
...
#        return ret
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().CommentList_RemoveAt(self.Ptr, index)
    ...
    <param name="comment">The comment to remove from a collection.</param>
        ...
        GetDllLibPpt().CommentList_Remove(self.Ptr, intPtrcomment)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().CommentList_GetEnumerator(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().CommentList_get_Presentation(self.Ptr)
