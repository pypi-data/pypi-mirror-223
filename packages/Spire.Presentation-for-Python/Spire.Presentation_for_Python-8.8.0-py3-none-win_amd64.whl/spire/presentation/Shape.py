...
class Shape (  PptObject, IActiveSlide, IActivePresentation, IShape) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().Shape_get_Presentation(self.Ptr)
...
#        GetDllLibPpt().Shape_ReplaceTextWithRegex(self.Ptr, intPtrregex,newValue)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().Shape_SaveAsImage(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Shape_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_IsTextBox(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().Shape_RemovePlaceholder(self.Ptr)
    ...
    <param name="filepath">Video file path</param>
        ...
        GetDllLibPpt().Shape_InsertVideo.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Shape_InsertVideo(self.Ptr, filepath)
    ...
    <param name="type">smartArt Type</param>
        ...
        GetDllLibPpt().Shape_InsertSmartArt(self.Ptr, enumsmartArtLayoutType)
    ...
    <param name="type">Chart Type</param>
        ...
        GetDllLibPpt().Shape_InsertChart(self.Ptr, enumtype)
    ...
    <param name="tableRowCount">Tablerow count</param>
        ...
        GetDllLibPpt().Shape_InsertTable(self.Ptr, tableColumnCount,tableRowCount)
    ...
    def InsertPicture(self ,stream:Stream):
        ...
        GetDllLibPpt().Shape_InsertPicture(self.Ptr, intPtrstream)
    ...
    <param name="filepath">Picture file path</param>
        ...
        GetDllLibPpt().Shape_InsertPictureF.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Shape_InsertPictureF(self.Ptr, filepath)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_TagsList(self.Ptr)
    ...
    def DrawIndicatedShape(self)->bool:
        ...
        ret = GetDllLibPpt().Shape_get_DrawIndicatedShape(self.Ptr)
        return ret
    ...
    def DrawIndicatedShape(self, value:bool):
        ...
        GetDllLibPpt().Shape_set_DrawIndicatedShape(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().Shape_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().Shape_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().Shape_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().Shape_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Shape_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Shape_get_Parent(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().Shape_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Shape_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().Shape_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Shape_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().Shape_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Shape_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().Shape_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Shape_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Shape_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().Shape_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Shape_set_Height(self.Ptr, value)
    ...
    def Id(self)->'int':
        ...
        shapeId = GetDllLibPpt().Shape_get_Id(self.Ptr)
        return shapeId
    ...
    <summary>
        ...
        GetDllLibPpt().Shape_SetShapeAlignment(self.Ptr, enumshapeAlignment)
    ...
    <summary>
        ...
        GetDllLibPpt().Shape_SetShapeArrange(self.Ptr, enumshapeArrange)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Shape_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().Shape_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Shape_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Shape_get_AlternativeTitle(self.Ptr))
        return ret


    @AlternativeTitle.setter
    def AlternativeTitle(self, value:str):
        GetDllLibPpt().Shape_set_AlternativeTitle.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Shape_set_AlternativeTitle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Shape_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().Shape_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Shape_set_Name(self.Ptr, value)
