...
class PictureShape (  IActiveSlide) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureShape_get_EmbedImage(self.Ptr)
    ...
    def EmbedImage(self, value:'IImageData'):
        ...
        GetDllLibPpt().PictureShape_set_EmbedImage(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().PictureShape_get_Url(self.Ptr))
        return ret


    @Url.setter
    def Url(self, value:str):
        GetDllLibPpt().PictureShape_set_Url.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().PictureShape_set_Url(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().PictureShape_get_Transparency(self.Ptr)
        return ret

    @Transparency.setter
    def Transparency(self, value:int):
        GetDllLibPpt().PictureShape_set_Transparency.argtypes=[c_void_p, c_int]
        GetDllLibPpt().PictureShape_set_Transparency(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().PictureShape_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().PictureShape_get_Presentation(self.Ptr)
