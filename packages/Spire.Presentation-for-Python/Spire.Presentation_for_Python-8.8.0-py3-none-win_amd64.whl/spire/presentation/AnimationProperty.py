...
class AnimationProperty (  CommonBehavior) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().AnimationProperty_get_From(self.Ptr))
        return ret


    @From.setter
    def From(self, value:str):
        GetDllLibPpt().AnimationProperty_set_From.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().AnimationProperty_set_From(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().AnimationProperty_get_To(self.Ptr))
        return ret


    @To.setter
    def To(self, value:str):
        GetDllLibPpt().AnimationProperty_set_To.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().AnimationProperty_set_To(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().AnimationProperty_get_By(self.Ptr))
        return ret


    @By.setter
    def By(self, value:str):
        GetDllLibPpt().AnimationProperty_set_By.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().AnimationProperty_set_By(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationProperty_get_ValueType(self.Ptr)
    ...
    def ValueType(self, value:'PropertyValueType'):
        ...
        GetDllLibPpt().AnimationProperty_set_ValueType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationProperty_get_CalcMode(self.Ptr)
    ...
    def CalcMode(self, value:'AnimationCalculationMode'):
        ...
        GetDllLibPpt().AnimationProperty_set_CalcMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationProperty_get_TimeAnimationValueCollection(self.Ptr)
    ...
    def TimeAnimationValueCollection(self, value:'TimeAnimationValueCollection'):
        ...
        GetDllLibPpt().AnimationProperty_set_TimeAnimationValueCollection(self.Ptr, value.Ptr)
