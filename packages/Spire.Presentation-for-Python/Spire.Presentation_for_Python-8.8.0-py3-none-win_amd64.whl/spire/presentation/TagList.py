...
class TagList (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TagList_get_Count(self.Ptr)
        return ret
    ...
    <returns>The index of the added tag.</returns>
        ...
        GetDllLibPpt().TagList_Append.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().TagList_Append.restype=c_int
        ret = GetDllLibPpt().TagList_Append(self.Ptr, name,value)
        return ret
    ...
    <param name="name">The name of tag to remove.</param>
        ...
        GetDllLibPpt().TagList_Remove.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().TagList_Remove(self.Ptr, name)
    ...
    <returns>The zero-based index of key, if key is found in the collection; otherwise, -1.</returns>
        ...
        GetDllLibPpt().TagList_IndexOfKey.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().TagList_IndexOfKey.restype=c_int
        ret = GetDllLibPpt().TagList_IndexOfKey(self.Ptr, name)
        return ret
    ...
    <returns>True if the collection contains an tag with the specified key; otherwise, false.</returns>
        ...
        GetDllLibPpt().TagList_Contains.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().TagList_Contains.restype=c_bool
        ret = GetDllLibPpt().TagList_Contains(self.Ptr, name)
        return ret
    ...
    <param name="index">The zero-based index of the tag to remove.</param>
        ...
        GetDllLibPpt().TagList_RemoveAt(self.Ptr, index)
    ...
    <summary>
        ...
        GetDllLibPpt().TagList_Clear(self.Ptr)
    ...
    <returns>Value of a tag.</returns>
        ...
        ret = PtrToStr(GetDllLibPpt().TagList_GetByInd(self.Ptr, index))
        return ret
    ...
    <returns>Key of a tag.</returns>
        ...
        ret = PtrToStr(GetDllLibPpt().TagList_GetKey(self.Ptr, index))
        return ret
    ...
    <returns>Value of a tag.</returns>
        ...
        GetDllLibPpt().TagList_get_Item.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().TagList_get_Item.restype=c_void_p
        ret = PtrToStr(GetDllLibPpt().TagList_get_Item(self.Ptr, name))
        return ret
    ...
    def set_Item(self ,name:str,value:str):
        ...
        GetDllLibPpt().TagList_set_Item.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().TagList_set_Item(self.Ptr, name,value)
