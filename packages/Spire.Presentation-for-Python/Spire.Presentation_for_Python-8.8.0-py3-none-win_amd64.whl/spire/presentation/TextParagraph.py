...
class TextParagraph (  ParagraphProperties) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().TextParagraph_Creat()
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraph_get_FirstTextRange(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraph_get_TextRanges(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextParagraph_get_ParagraphProperties(self.Ptr)
...
<value>
        ...
        ret = PtrToStr(GetDllLibPpt().TextParagraph_get_Text(self.Ptr))
        return ret


    @Text.setter
    def Text(self, value:str):
        GetDllLibPpt().TextParagraph_set_Text.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextParagraph_set_Text(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextParagraph_Equals(self.Ptr, intPtrobj)
        return ret
