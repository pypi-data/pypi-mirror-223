...
class TextFont (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().Creat_TextFont('Arail')
    ...
    def __init__(self,fontName:str):
        GetDllLibPpt().Creat_TextFont.argtypes=[c_wchar_p]
        GetDllLibPpt().Creat_TextFont.restype = c_void_p
        intPtr = GetDllLibPpt().Creat_TextFont(fontName)
        super(TextFont, self).__init__(intPtr)
    """
    <summary>
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TextFont_get_FontName(self.Ptr))
        return ret


    @FontName.setter
    def FontName(self, value:str):
        GetDllLibPpt().TextFont_set_FontName.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextFont_set_FontName(self.Ptr, value)
    ...
    <returns>Font name.</returns>
        ...
        ret = PtrToStr(GetDllLibPpt().TextFont_GetFontName(self.Ptr, intPtrtheme))
        return ret
  ...
  <b>true</b> if the specified FontData is equal to the current FontData; otherwise, <b>false</b>.</returns>
        ...
        ret = GetDllLibPpt().TextFont_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().TextFont_GetHashCode(self.Ptr)
        return ret
