...
class DefaultTextRangeProperties (  IActiveSlide) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_TextLineFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_HighlightColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_UnderlineFormat(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_UnderlineFill(self.Ptr)
        ret = None if intPtr==None else FillFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().DefaultTextRangeProperties_get_BookmarkId(self.Ptr))
        return ret


    @BookmarkId.setter
    def BookmarkId(self, value:str):
        GetDllLibPpt().DefaultTextRangeProperties_set_BookmarkId.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().DefaultTextRangeProperties_set_BookmarkId(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_IsBold(self.Ptr)
    ...
    def IsBold(self, value:'TriState'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_IsBold(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_IsItalic(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def IsItalic(self, value:'TriState'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_IsItalic(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_Kumimoji(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def Kumimoji(self, value:'TriState'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_Kumimoji(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_NormaliseHeight(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def NormaliseHeight(self, value:'TriState'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_NormaliseHeight(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_NoProofing(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def NoProofing(self, value:'TriState'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_NoProofing(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_TextUnderlineType(self.Ptr)
    ...
    def TextUnderlineType(self, value:'TextUnderlineType'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_TextUnderlineType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_TextCapType(self.Ptr)
    ...
    def TextCapType(self, value:'TextCapType'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_TextCapType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_TextStrikethroughType(self.Ptr)
    ...
    def TextStrikethroughType(self, value:'TextStrikethroughType'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_TextStrikethroughType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_SmartTagClean(self.Ptr)
        return ret
    ...
    def SmartTagClean(self, value:bool):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_SmartTagClean(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_FontHeight(self.Ptr)
        return ret

    @FontHeight.setter
    def FontHeight(self, value:float):
        GetDllLibPpt().DefaultTextRangeProperties_set_FontHeight.argtypes=[c_void_p, c_float]
        GetDllLibPpt().DefaultTextRangeProperties_set_FontHeight(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_LatinFont(self.Ptr)
    ...
    def LatinFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_LatinFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_EastAsianFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def EastAsianFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_EastAsianFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_ComplexScriptFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def ComplexScriptFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_ComplexScriptFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().DefaultTextRangeProperties_get_SymbolFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def SymbolFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_SymbolFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_ScriptDistance(self.Ptr)
        return ret
    ...
    def ScriptDistance(self, value:float):
        ...
        GetDllLibPpt().DefaultTextRangeProperties_set_ScriptDistance(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_FontMinSize(self.Ptr)
        return ret

    @FontMinSize.setter
    def FontMinSize(self, value:float):
        GetDllLibPpt().DefaultTextRangeProperties_set_FontMinSize.argtypes=[c_void_p, c_float]
        GetDllLibPpt().DefaultTextRangeProperties_set_FontMinSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().DefaultTextRangeProperties_get_Language(self.Ptr))
        return ret


    @Language.setter
    def Language(self, value:str):
        GetDllLibPpt().DefaultTextRangeProperties_set_Language.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().DefaultTextRangeProperties_set_Language(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().DefaultTextRangeProperties_get_AlternativeLanguage(self.Ptr))
        return ret


    @AlternativeLanguage.setter
    def AlternativeLanguage(self, value:str):
        GetDllLibPpt().DefaultTextRangeProperties_set_AlternativeLanguage.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().DefaultTextRangeProperties_set_AlternativeLanguage(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().DefaultTextRangeProperties_get_LineSpacing(self.Ptr)
        return ret

    @LineSpacing.setter
    def LineSpacing(self, value:float):
        GetDllLibPpt().DefaultTextRangeProperties_set_LineSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPpt().DefaultTextRangeProperties_set_LineSpacing(self.Ptr, value)
