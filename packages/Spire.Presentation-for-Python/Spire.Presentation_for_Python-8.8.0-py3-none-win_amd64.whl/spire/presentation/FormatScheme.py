...
class FormatScheme (  PptObject, IActiveSlide, IActivePresentation) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_FillStyles(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_LineStyles(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_EffectStyles(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_BackgroundFillStyles(self.Ptr)
        ret = None if intPtr==None else FillStyleCollection(intPtr)
        return ret
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FormatScheme_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().FormatScheme_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().FormatScheme_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().FormatScheme_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().FormatScheme_set_Name(self.Ptr, value)
