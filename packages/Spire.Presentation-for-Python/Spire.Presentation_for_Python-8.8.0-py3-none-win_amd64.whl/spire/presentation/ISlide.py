...
class ISlide (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_Theme(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ISlide_get_SlideNumber(self.Ptr)
        return ret

    @SlideNumber.setter
    def SlideNumber(self, value:int):
        GetDllLibPpt().ISlide_set_SlideNumber.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ISlide_set_SlideNumber(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ISlide_get_Hidden(self.Ptr)
        return ret

    @Hidden.setter
    def Hidden(self, value:bool):
        GetDllLibPpt().ISlide_set_Hidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ISlide_set_Hidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_NotesSlide(self.Ptr)
    ...
    <summary>
        ...
        intPtrArray = GetDllLibPpt().ISlide_get_Comments(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_Shapes(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ISlide_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().ISlide_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ISlide_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        slideid = GetDllLibPpt().ISlide_get_SlideID(self.Ptr)
        return slideid


    @property

    def MasterSlideID(self)->'UInt32':
        """
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_MasterSlideID(self.Ptr)
    ...
    def MasterSlideID(self, value:'UInt32'):
        ...
        GetDllLibPpt().ISlide_set_MasterSlideID(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_Timeline(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_SlideShowTransition(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_SlideBackground(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_DisplaySlideBackground(self.Ptr)
        ret = None if intPtr==None else SlideBackground(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().ISlide_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ISlide_get_ShowMasterShape(self.Ptr)
        return ret
    ...
    def ShowMasterShape(self, value:bool):
        ...
        GetDllLibPpt().ISlide_set_ShowMasterShape(self.Ptr, value)
    ...
    def GetPlaceholderShapes(self,placeholder:Placeholder):
        ...
        intPtrWithTypeName = GetDllLibPpt().ISlide_GetPlaceholderShapes(self.Ptr,placeholder.Ptr,0)
        ...
        GetDllLibPpt().ISlide_GetPlaceholderShapes.argtypes=[c_void_p,c_void_p,c_int]
        GetDllLibPpt().ISlide_GetPlaceholderShapes.restype= IntPtrWithTypeName
        intPtrWithTypeName = GetDllLibPpt().ISlide_GetPlaceholderShapes(self.Ptr,placeholder.Ptr,1)
        ret = None if intPtrWithTypeName==None else ShapeList._create(intPtrWithTypeName)
        if(ret != None):
            rets.append(ret)
    ...
    def SaveAsImage(self)->'Stream':
        ...
        intPtr = GetDllLibPpt().ISlide_SaveAsImage(self.Ptr)
    ...
    def SaveAsImageByWH(self ,width:int,height:int)->'Stream':
        ...
        intPtr = GetDllLibPpt().ISlide_SaveAsImageWH(self.Ptr, width,height)
        ret = None if intPtr==None else Stream(intPtr)
        return ret
    ...
    #    GetDllLibPpt().ISlide_SaveAsEMF(self.Ptr, filePath)
    ...
    #    intPtr = GetDllLibPpt().ISlide_SaveAsEMF1(self.Ptr)
    ...
    #    GetDllLibPpt().ISlide_SaveAsEMFFWH(self.Ptr, filePath,width,height)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_SaveDisplayBackgroundAsImage(self.Ptr)
        ret = None if intPtr==None else Stream(intPtr)
        return ret
    ...
    <param name="fileFormat">convert to fileFormat.</param>
        ...
        GetDllLibPpt().ISlide_SaveToFile.argtypes=[c_void_p ,c_wchar_p,c_int]
        GetDllLibPpt().ISlide_SaveToFile(self.Ptr, file,enumfileFormat)
    ...
    <returns>A byte array of SVG file-stream.</returns>
        ...
        intPtr = GetDllLibPpt().ISlide_SaveToSVG(self.Ptr)
        ret = None if intPtr==None else Stream(intPtr)
        return ret
  ...
  <see cref="P:Spire.Presentation.Slide.NotesSlide" /> for this slide.</returns>
        ...
        intPtr = GetDllLibPpt().ISlide_AddNotesSlide(self.Ptr)
        ret = None if intPtr==None else NotesSlide(intPtr)
        return ret
    ...
    <param name="dateTime"></param>
        ...
        GetDllLibPpt().ISlide_AddComment.argtypes=[c_void_p ,c_void_p,c_wchar_p,c_void_p,c_void_p]
        GetDllLibPpt().ISlide_AddComment(self.Ptr, intPtrauthor,text,intPtrposition,intPtrdateTime)
    ...
    <param name="comment"></param>
        ...
        GetDllLibPpt().ISlide_AddCommentC(self.Ptr, intPtrcomment)
    ...
    <param name="comment"></param>
        ...
        GetDllLibPpt().ISlide_DeleteComment(self.Ptr, intPtrcomment)
    ...
    <param name="string">text of comments to delete or "" to delete all comments.</param>
        ...
        GetDllLibPpt().ISlide_DeleteCommentAT.argtypes=[c_void_p ,c_void_p,c_wchar_p]
        GetDllLibPpt().ISlide_DeleteCommentAT(self.Ptr, intPtrauthor,text)
    ...
    <param name="string">text of comments to delete or "" to delete all comments.</param>
        ...
        GetDllLibPpt().ISlide_DeleteCommentA(self.Ptr, intPtrauthor)
    ...
    <param name="string">text of comments to delete or "" to delete all comments.</param>
        ...
        GetDllLibPpt().ISlide_DeleteCommentT.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ISlide_DeleteCommentT(self.Ptr, text)
...
#        intPtrArray = GetDllLibPpt().ISlide_GetComments(self.Ptr, intPtrauthor,text)
#        ret = GetObjVectorFromArray(intPtrArray, Comment)
#        return ret
...
#        intPtrArray = GetDllLibPpt().ISlide_GetCommentsA(self.Ptr, intPtrauthor)
#        ret = GetObjVectorFromArray(intPtrArray, Comment)
#        return ret
...
#        intPtrArray = GetDllLibPpt().ISlide_GetCommentsT(self.Ptr, text)
#        ret = GetObjVectorFromArray(intPtrArray, Comment)
#        return ret
    ...
    <param name="scheme"></param>
        ...
        GetDllLibPpt().ISlide_ApplyTheme(self.Ptr, intPtrscheme)
    ...
    <summary>
        ...
        GetDllLibPpt().ISlide_Dispose(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ISlide_get_Layout(self.Ptr)
    ...
    def Layout(self, value:'ILayout'):
        ...
        GetDllLibPpt().ISlide_set_Layout(self.Ptr, value.Ptr)
...
#
    ...
    <param name="shapeList"></param>
        ...
        intPtr = GetDllLibPpt().ISlide_GroupShapes(self.Ptr, arrayrectangles,countShapes)
    ...
    <param name="groupShape">the group shape which needs to ungroup.</param>
        ...
        GetDllLibPpt().ISlide_Ungroup(self.Ptr, intPtrgroupShape)
    ...
    <param name="caseSensitive">case sensitive</param>
        ...
        GetDllLibPpt().ISlide_ReplaceFirstText.argtypes=[c_void_p ,c_wchar_p,c_wchar_p,c_bool]
        GetDllLibPpt().ISlide_ReplaceFirstText(self.Ptr, matchedString,newValue,caseSensitive)
    ...
    <param name="caseSensitive">case sensitive</param>
        ...
        GetDllLibPpt().ISlide_ReplaceAllText.argtypes=[c_void_p ,c_wchar_p,c_wchar_p,c_bool]
        GetDllLibPpt().ISlide_ReplaceAllText(self.Ptr, matchedString,newValue,caseSensitive)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ISlide_get_Title(self.Ptr))
        return ret


    @Title.setter
    def Title(self, value:str):
        GetDllLibPpt().ISlide_set_Title.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ISlide_set_Title(self.Ptr, value)
...
#        intPtrArray = GetDllLibPpt().ISlide_GetPlaceholderShapes(self.Ptr, intPtrplaceholder)
...
#        GetDllLibPpt().ISlide_ReplaceTextWithRegex(self.Ptr, intPtrregex,newValue)


#
#    def GetAllTextFrame(self)->'ArrayList':
#        """
#    <summary>
...
#        GetDllLibPpt().ISlide_GetAllTextFrame.restype=c_void_p
#        intPtr = GetDllLibPpt().ISlide_GetAllTextFrame(self.Ptr)
...
#
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ISlide_FindFirstTextAsRange.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ISlide_FindFirstTextAsRange.restype=c_void_p
        intPtr = GetDllLibPpt().ISlide_FindFirstTextAsRange(self.Ptr, text)
