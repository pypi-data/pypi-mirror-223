...
class IOleObject (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_SubstituteImagePictureFillFormat(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_ObjectName(self.Ptr))
        return ret


    @ObjectName.setter
    def ObjectName(self, value:str):
        GetDllLibPpt().IOleObject_set_ObjectName.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IOleObject_set_ObjectName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_ProgId(self.Ptr))
        return ret


    @ProgId.setter
    def ProgId(self, value:str):
        GetDllLibPpt().IOleObject_set_ProgId.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IOleObject_set_ProgId(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_DataStream(self.Ptr)
    ...
    def Data(self, value:'Stream'):
        ...
        GetDllLibPpt().IOleObject_set_DataStream(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_LinkShortFilePath(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_LinkFilePath(self.Ptr))
        return ret


    @LinkFilePath.setter
    def LinkFilePath(self, value:str):
        GetDllLibPpt().IOleObject_set_LinkFilePath.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IOleObject_set_LinkFilePath(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_IsObjectLink(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_IsTextBox(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IOleObject_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IOleObject_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IOleObject_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IOleObject_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IOleObject_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IOleObject_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IOleObject_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IOleObject_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IOleObject_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IOleObject_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IOleObject_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IOleObject_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IOleObject_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IOleObject_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IOleObject_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IOleObject_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IOleObject_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IOleObject_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IOleObject_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IOleObject_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IOleObject_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IOleObject_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IOleObject_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IOleObject_Dispose(self.Ptr)
