...
class FontScheme (  PptObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FontScheme_get_MinorFont(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().FontScheme_get_MajorFont(self.Ptr)
        ret = None if intPtr==None else LocaleFonts(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().FontScheme_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().FontScheme_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().FontScheme_set_Name(self.Ptr, value)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().FontScheme_Equals(self.Ptr, intPtrobj)
        return ret
