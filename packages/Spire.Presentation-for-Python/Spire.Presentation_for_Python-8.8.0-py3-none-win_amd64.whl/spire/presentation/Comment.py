...
class Comment (  PptObject) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Comment_get_Text(self.Ptr))
        return ret


    @Text.setter
    def Text(self, value:str):
        GetDllLibPpt().Comment_set_Text.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Comment_set_Text(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Comment_get_DateTime(self.Ptr)
    ...
    def DateTime(self, value:'DateTime'):
        ...
        GetDllLibPpt().Comment_set_DateTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Comment_get_Slide(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Comment_get_AuthorName(self.Ptr))
        return ret


    @AuthorName.setter
    def AuthorName(self, value:str):
        GetDllLibPpt().Comment_set_AuthorName.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Comment_set_AuthorName(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Comment_get_AuthorInitials(self.Ptr))
        return ret


    @AuthorInitials.setter
    def AuthorInitials(self, value:str):
        GetDllLibPpt().Comment_set_AuthorInitials.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Comment_set_AuthorInitials(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Comment_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().Comment_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Comment_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Comment_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().Comment_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Comment_set_Top(self.Ptr, value)
    ...
    <param name="time">time.</param>
        ...
        GetDllLibPpt().Comment_Reply.argtypes=[c_void_p ,c_void_p,c_wchar_p,c_void_p]
        GetDllLibPpt().Comment_Reply(self.Ptr, intPtrauthor,reply,intPtrtime)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Comment_get_IsReply(self.Ptr)
        return ret
