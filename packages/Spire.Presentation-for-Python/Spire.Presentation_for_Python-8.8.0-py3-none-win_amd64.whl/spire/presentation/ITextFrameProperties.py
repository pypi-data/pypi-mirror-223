...
class ITextFrameProperties (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_Paragraphs(self.Ptr)
...
<value>
        ...
        ret =PtrToStr(GetDllLibPpt().ITextFrameProperties_get_Text(self.Ptr))
        return ret


    @Text.setter
    def Text(self, value:str):
        GetDllLibPpt().ITextFrameProperties_set_Text.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ITextFrameProperties_set_Text(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_TextStyle(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_MarginLeft(self.Ptr)
        return ret

    @MarginLeft.setter
    def MarginLeft(self, value:float):
        GetDllLibPpt().ITextFrameProperties_set_MarginLeft.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ITextFrameProperties_set_MarginLeft(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_MarginRight(self.Ptr)
        return ret

    @MarginRight.setter
    def MarginRight(self, value:float):
        GetDllLibPpt().ITextFrameProperties_set_MarginRight.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ITextFrameProperties_set_MarginRight(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_MarginTop(self.Ptr)
        return ret

    @MarginTop.setter
    def MarginTop(self, value:float):
        GetDllLibPpt().ITextFrameProperties_set_MarginTop.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ITextFrameProperties_set_MarginTop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_MarginBottom(self.Ptr)
        return ret

    @MarginBottom.setter
    def MarginBottom(self, value:float):
        GetDllLibPpt().ITextFrameProperties_set_MarginBottom.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ITextFrameProperties_set_MarginBottom(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_TextRange(self.Ptr)
...
<summary>
  <b>True</b> if text is wrapped at TextFrame's margins.
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_WordWrap(self.Ptr)
        return ret

    @WordWrap.setter
    def WordWrap(self, value:bool):
        GetDllLibPpt().ITextFrameProperties_set_WordWrap.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITextFrameProperties_set_WordWrap(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_AnchoringType(self.Ptr)
    ...
    def AnchoringType(self, value:'TextAnchorType'):
        ...
        GetDllLibPpt().ITextFrameProperties_set_AnchoringType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_IsCentered(self.Ptr)
        return ret

    @IsCentered.setter
    def IsCentered(self, value:bool):
        GetDllLibPpt().ITextFrameProperties_set_IsCentered.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ITextFrameProperties_set_IsCentered(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_VerticalTextType(self.Ptr)
    ...
    def VerticalTextType(self, value:'VerticalTextType'):
        ...
        GetDllLibPpt().ITextFrameProperties_set_VerticalTextType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_AutofitType(self.Ptr)
    ...
    def AutofitType(self, value:'TextAutofitType'):
        ...
        GetDllLibPpt().ITextFrameProperties_set_AutofitType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_Slide(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().ITextFrameProperties_Dispose(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ITextFrameProperties_get_TextThreeD(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_RotationAngle(self.Ptr)
        return ret

    @RotationAngle.setter
    def RotationAngle(self, value:float):
        GetDllLibPpt().ITextFrameProperties_set_RotationAngle.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ITextFrameProperties_set_RotationAngle(self.Ptr, value)
    ...
    <param name="options">Highlighting options</param>
        ...
        GetDllLibPpt().ITextFrameProperties_HighLightText.argtypes=[c_void_p ,c_wchar_p,c_void_p,c_void_p]
        GetDllLibPpt().ITextFrameProperties_HighLightText(self.Ptr, text,intPtrcolor,intPtroptions)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_RightToLeftColumns(self.Ptr)
        return ret
    ...
    def RightToLeftColumns(self, value:bool):
        ...
        GetDllLibPpt().ITextFrameProperties_set_RightToLeftColumns(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ITextFrameProperties_get_TextShapeType(self.Ptr)
    ...
    def TextShapeType(self, value:'TextShapeType'):
        ...
        GetDllLibPpt().ITextFrameProperties_set_TextShapeType(self.Ptr, value.value)
