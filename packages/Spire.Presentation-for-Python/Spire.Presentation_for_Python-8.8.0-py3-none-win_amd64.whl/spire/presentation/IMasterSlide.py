...
class IMasterSlide (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Theme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_TitleStyle(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_BodyStyle(self.Ptr)
        ret = None if intPtr==None else TextStyle(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_OtherStyle(self.Ptr)
        ret = None if intPtr==None else TextStyle(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Shapes(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IMasterSlide_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IMasterSlide_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IMasterSlide_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_SlideID(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Timeline(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_SlideShowTransition(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_SlideBackground(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Parent(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().IMasterSlide_GetDependingSlides(self.Ptr)
...
#        return ret
    ...
    <param name="scheme"></param>
        ...
        GetDllLibPpt().IMasterSlide_ApplyTheme(self.Ptr, intPtrscheme)
    ...
    <summary>
        ...
        GetDllLibPpt().IMasterSlide_Dispose(self.Ptr)
    ...
    def Layouts(self)->'IMasterLayouts':
        ...
        intPtr = GetDllLibPpt().IMasterSlide_get_Layouts(self.Ptr)
