...
class CommentAuthorList (SpireObject) :
    ...
    def Count(self)->int:
        ...
        ret = GetDllLibPpt().CommentAuthorList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().CommentAuthorList_get_Item(self.Ptr, index)
    ...
    <returns>ICommentAuthor</returns>
        ...
        GetDllLibPpt().CommentAuthorList_AddAuthor.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().CommentAuthorList_AddAuthor.restype=c_void_p
        intPtr = GetDllLibPpt().CommentAuthorList_AddAuthor(self.Ptr, name,initials)
        ret = None if intPtr==None else ICommentAuthor(intPtr)
        return ret
...
#        intPtrArray = GetDllLibPpt().CommentAuthorList_ToArray(self.Ptr)
...
#        """
#        
#        GetDllLibPpt().CommentAuthorList_FindByName.argtypes=[c_void_p ,c_wchar_p]
#        GetDllLibPpt().CommentAuthorList_FindByName.restype=IntPtrArray
#        intPtrArray = GetDllLibPpt().CommentAuthorList_FindByName(self.Ptr, name)
...
#        intPtrArray = GetDllLibPpt().CommentAuthorList_FindByNameAndInitials(self.Ptr, name,initials)
#        ret = GetObjVectorFromArray(intPtrArray, ICommentAuthor)
#        return ret
    ...
    def GetEnumerator(self)->'IEnumerator':
        ...
        intPtr = GetDllLibPpt().CommentAuthorList_GetEnumerator(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().CommentAuthorList_get_Presentation(self.Ptr)
