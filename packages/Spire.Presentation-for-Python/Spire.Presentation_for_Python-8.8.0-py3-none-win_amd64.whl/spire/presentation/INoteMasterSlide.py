...
class INoteMasterSlide (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_Theme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_Shapes(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().INoteMasterSlide_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().INoteMasterSlide_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().INoteMasterSlide_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_SlideID(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_Timeline(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_SlideShowTransition(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_SlideBackground(self.Ptr)
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().INoteMasterSlide_get_Parent(self.Ptr)
    ...
    <param name="scheme"></param>
        ...
        GetDllLibPpt().INoteMasterSlide_ApplyTheme(self.Ptr, intPtrscheme)
    ...
    <summary>
        ...
        GetDllLibPpt().INoteMasterSlide_Dispose(self.Ptr)
