...
class IAudio (  IShape) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Volume(self.Ptr)
    ...
    def Volume(self, value:'AudioVolumeType'):
        ...
        GetDllLibPpt().IAudio_set_Volume(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_PlayMode(self.Ptr)
    ...
    def PlayMode(self, value:'AudioPlayMode'):
        ...
        GetDllLibPpt().IAudio_set_PlayMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_IsLoop(self.Ptr)
        return ret

    @IsLoop.setter
    def IsLoop(self, value:bool):
        GetDllLibPpt().IAudio_set_IsLoop.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IAudio_set_IsLoop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_IsEmbedded(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IAudio_get_FileName(self.Ptr))
        return ret


    @FileName.setter
    def FileName(self, value:str):
        GetDllLibPpt().IAudio_set_FileName.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IAudio_set_FileName(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Data(self.Ptr)
    ...
    def Data(self, value:'IAudioData'):
        ...
        GetDllLibPpt().IAudio_set_Data(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_AudioCd(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ShapeType'):
        ...
        GetDllLibPpt().IAudio_set_ShapeType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_PictureFill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_ShapeStyle(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Adjustments(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IAudio_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IAudio_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IAudio_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IAudio_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IAudio_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_IsPlayinBackground(self.Ptr)
        return ret
    ...
    def IsPlayinBackground(self, value:bool):
        ...
        GetDllLibPpt().IAudio_set_IsPlayinBackground(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IAudio_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IAudio_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IAudio_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IAudio_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IAudio_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IAudio_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IAudio_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IAudio_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IAudio_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IAudio_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IAudio_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IAudio_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IAudio_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IAudio_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IAudio_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IAudio_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IAudio_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudio_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IAudio_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IAudio_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IAudio_Dispose(self.Ptr)
