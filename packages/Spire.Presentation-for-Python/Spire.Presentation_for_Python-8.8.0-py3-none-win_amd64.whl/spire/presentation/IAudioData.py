...
class IAudioData (SpireObject) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IAudioData_get_ContentType(self.Ptr))
        return ret
...
#        intPtrArray = GetDllLibPpt().IAudioData_get_Data(self.Ptr)
...
#        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IAudioData_get_Stream(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().IAudioData_GetStream(self.Ptr)
        ret = None if intPtr==None else Stream(intPtr)
        return ret
    ...
    <param name="fileName"></param>
        ...
        GetDllLibPpt().IAudioData_SaveToFile.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().IAudioData_SaveToFile(self.Ptr, fileName)
