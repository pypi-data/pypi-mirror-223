...
class ChartSeriesFormatCollection (SpireObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartSeriesFormatCollection_get_SeriesLabel(self.Ptr)
    ...
    def SeriesLabel(self, value:'CellRanges'):
        ...
        GetDllLibPpt().ChartSeriesFormatCollection_set_SeriesLabel(self.Ptr, value.Ptr)
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().ChartSeriesFormatCollection_get_Item(self.Ptr, index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_get_Count(self.Ptr)
        return ret

    @dispatch

    def Append(self ,cellRange:'CellRange')->int:
        """
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_Append(self.Ptr, intPtrcellRange)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ChartSeriesFormatCollection_AppendV.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ChartSeriesFormatCollection_AppendV.restype=c_int
        ret = GetDllLibPpt().ChartSeriesFormatCollection_AppendV(self.Ptr, value)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_AppendV1(self.Ptr, value)
        return ret

    @dispatch

    def Append(self ,value:SpireObject)->int:
        """
    <summary>
        Append a value;
    </summary>
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_AppendV11(self.Ptr, intPtrvalue)
        return ret
    ...
    <returns>The zero-based index of the first occurrence of value within the entire CollectionBase, if found; otherwise, -1.</returns>
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_IndexOf(self.Ptr, intPtrvalue)
        return ret
...
<exception cref="T:System.ArgumentException">The value parameter was not found in the collection.</exception>
        ...
        GetDllLibPpt().ChartSeriesFormatCollection_Remove(self.Ptr, intPtrvalue)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartSeriesFormatCollection_get_KeepSeriesFormat(self.Ptr)
        return ret
    ...
    def KeepSeriesFormat(self, value:bool):
        ...
        GetDllLibPpt().ChartSeriesFormatCollection_set_KeepSeriesFormat(self.Ptr, value)
