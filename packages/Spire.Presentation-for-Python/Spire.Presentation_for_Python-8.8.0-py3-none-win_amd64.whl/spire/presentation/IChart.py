...
class IChart (  IShape) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_IsSwitchRowAndColumn(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_PlotAreaWidthOfCalculated(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_PlotVisibleCellsOnly(self.Ptr)
        return ret
    ...
    def PlotVisibleCellsOnly(self, value:bool):
        ...
        GetDllLibPpt().IChart_set_PlotVisibleCellsOnly(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_GapDepth(self.Ptr)
        return ret

    @GapDepth.setter
    def GapDepth(self, value:int):
        GetDllLibPpt().IChart_set_GapDepth.argtypes=[c_void_p, c_int]
        GetDllLibPpt().IChart_set_GapDepth(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_BubbleScale(self.Ptr)
        return ret

    @BubbleScale.setter
    def BubbleScale(self, value:int):
        GetDllLibPpt().IChart_set_BubbleScale.argtypes=[c_void_p, c_int]
        GetDllLibPpt().IChart_set_BubbleScale(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_GapWidth(self.Ptr)
        return ret

    @GapWidth.setter
    def GapWidth(self, value:int):
        GetDllLibPpt().IChart_set_GapWidth.argtypes=[c_void_p, c_int]
        GetDllLibPpt().IChart_set_GapWidth(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_OverLap(self.Ptr)
        return ret

    @OverLap.setter
    def OverLap(self, value:int):
        GetDllLibPpt().IChart_set_OverLap.argtypes=[c_void_p, c_int]
        GetDllLibPpt().IChart_set_OverLap(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_GridLine(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_DisplayBlanksAs(self.Ptr)
    ...
    def DisplayBlanksAs(self, value:'DisplayBlanksAsType'):
        ...
        GetDllLibPpt().IChart_set_DisplayBlanksAs(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Series(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Categories(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_HasTitle(self.Ptr)
        return ret

    @HasTitle.setter
    def HasTitle(self, value:bool):
        GetDllLibPpt().IChart_set_HasTitle.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IChart_set_HasTitle(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ChartTitle(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ChartData(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_HasDataTable(self.Ptr)
        return ret

    @HasDataTable.setter
    def HasDataTable(self, value:bool):
        GetDllLibPpt().IChart_set_HasDataTable.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IChart_set_HasDataTable(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_HasLegend(self.Ptr)
        return ret

    @HasLegend.setter
    def HasLegend(self, value:bool):
        GetDllLibPpt().IChart_set_HasLegend.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IChart_set_HasLegend(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ChartLegend(self.Ptr)
    ...
    def ChartLegend(self, value:'ChartLegend'):
        ...
        GetDllLibPpt().IChart_set_ChartLegend(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ChartDataTable(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_ChartStyle(self.Ptr)
    ...
    def ChartStyle(self, value:'ChartStyle'):
        ...
        GetDllLibPpt().IChart_set_ChartStyle(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Type(self.Ptr)
    ...
    def Type(self, value:'ChartType'):
        ...
        GetDllLibPpt().IChart_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_PlotArea(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_RotationThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_BackWall(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_SideWall(self.Ptr)
        ret = None if intPtr==None else ChartWallsOrFloor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Floor(self.Ptr)
        ret = None if intPtr==None else ChartWallsOrFloor(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_PrimaryCategoryAxis(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_SecondaryCategoryAxis(self.Ptr)
        ret = None if intPtr==None else IChartAxis(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_PrimaryValueAxis(self.Ptr)
        ret = None if intPtr==None else IChartAxis(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_SecondaryValueAxis(self.Ptr)
        ret = None if intPtr==None else IChartAxis(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IChart_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_ThreeD(self.Ptr)
        ret = None if intPtr==None else FormatThreeD(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_EffectDag(self.Ptr)
        ret = None if intPtr==None else EffectDag(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IChart_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IChart_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IChart_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IChart_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IChart_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChart_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IChart_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChart_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IChart_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChart_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IChart_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChart_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IChart_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IChart_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IChart_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IChart_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IChart_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IChart_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IChart_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IChart_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IChart_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IChart_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IChart_Dispose(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IChart_get_BorderRoundedCorners(self.Ptr)
        return ret
    ...
    def BorderRoundedCorners(self, value:bool):
        ...
        GetDllLibPpt().IChart_set_BorderRoundedCorners(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IChart_get_SeriesLine(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().IChart_SwitchRowAndColumn(self.Ptr)
