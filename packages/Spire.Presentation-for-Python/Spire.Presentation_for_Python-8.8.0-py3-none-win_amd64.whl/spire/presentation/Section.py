...
#        intPtr = GetDllLibPpt().Section_get_SlideIdList(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().Section_GetSlides(self.Ptr)
...
#        return ret
    ...
    <param name="slide">the slide which needs moved.</param>
        ...
        GetDllLibPpt().Section_Move(self.Ptr, index,intPtrslide)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().Section_Insert(self.Ptr, index,intPtrslide)
        ret = None if intPtr==None else ISlide(intPtr)
        return ret


#
#    def AddRange(self ,slides:'IEnumerable1'):
#        """
#    <summary>
#        add a range of slides.
#    </summary>
#    <param name="slides">the target slide.</param>
#        """
#        intPtrslides:c_void_p = slides.Ptr
#
#        GetDllLibPpt().Section_AddRange.argtypes=[c_void_p ,c_void_p]
#        GetDllLibPpt().Section_AddRange(self.Ptr, intPtrslides)
    ...
    <param name="index">the target position.</param>
        ...
        GetDllLibPpt().Section_RemoveAt(self.Ptr, index)
    ...
    <param name="slide">target slide.</param>
        ...
        GetDllLibPpt().Section_Remove(self.Ptr, intPtrslide)
    ...
    <param name="count">the count of slides.</param>
        ...
        GetDllLibPpt().Section_RemoveRange(self.Ptr, startIndex,count)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Section_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().Section_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Section_set_Name(self.Ptr, value)
    ...
    def Id(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().Section_get_Id(self.Ptr))
        return ret


    @Id.setter
    def Id(self, value:str):
        GetDllLibPpt().Section_set_Id.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Section_set_Id(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Section_get_Index(self.Ptr)
        return ret
