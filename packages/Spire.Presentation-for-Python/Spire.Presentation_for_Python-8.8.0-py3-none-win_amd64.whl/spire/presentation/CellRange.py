...
class CellRange (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellRange_get_Row(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellRange_get_Column(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellRange_get_NumberValue(self.Ptr)
        return ret

    @NumberValue.setter
    def NumberValue(self, value:float):
        GetDllLibPpt().CellRange_set_NumberValue.argtypes=[c_void_p, c_double]
        GetDllLibPpt().CellRange_set_NumberValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().CellRange_get_Text(self.Ptr))
        return ret


    @Text.setter
    def Text(self, value:str):
        GetDllLibPpt().CellRange_set_Text.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().CellRange_set_Text(self.Ptr, value)
...
<value>
        ...
        intPtr = GetDllLibPpt().CellRange_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibPpt().CellRange_set_Value(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().CellRange_get_WorksheetName(self.Ptr))
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().CellRange_get_WorksheetIndex(self.Ptr)
        return ret
    ...
    <returns></returns>
        ...
        ret = GetDllLibPpt().CellRange_Equals(self.Ptr, intPtrcellRange)
        return ret
...
<exception cref="T:System.NullReferenceException">
        ...
        ret = GetDllLibPpt().CellRange_EqualsO(self.Ptr, intPtrobj)
        return ret
    ...
    <returns>
        ...
        ret = GetDllLibPpt().CellRange_GetHashCode(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().CellRange_get_NumberFormat(self.Ptr))
        return ret


    @NumberFormat.setter
    def NumberFormat(self, value:str):
        GetDllLibPpt().CellRange_set_NumberFormat.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().CellRange_set_NumberFormat(self.Ptr, value)
