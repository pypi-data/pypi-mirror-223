...
class ICommentAuthor (SpireObject) :
    ...
    def Initials(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().ICommentAuthor_get_Initials(self.Ptr))
        return ret


    @Initials.setter
    def Initials(self, value:str):
        GetDllLibPpt().ICommentAuthor_set_Initials.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ICommentAuthor_set_Initials(self.Ptr, value)
    ...
    def Name(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().ICommentAuthor_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().ICommentAuthor_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ICommentAuthor_set_Name(self.Ptr, value)
    ...
    def CommentsList(self)->'CommentCollection':
        ...
        intPtr = GetDllLibPpt().ICommentAuthor_get_CommentsList(self.Ptr)
    ...
    def LastIndex(self)->int:
        ...
        ret = GetDllLibPpt().ICommentAuthor_get_LastIndex(self.Ptr)
        return ret
    ...
    def ColorIndex(self)->int:
        ...
        ret = GetDllLibPpt().ICommentAuthor_get_ColorIndex(self.Ptr)
        return ret
    ...
    def Id(self)->'UInt32':
        ...
        intPtr = GetDllLibPpt().ICommentAuthor_get_Id(self.Ptr)
    ...
    def ExtensionList(self)->'ExtensionList':
        ...
        intPtr = GetDllLibPpt().ICommentAuthor_get_ExtensionList(self.Ptr)
