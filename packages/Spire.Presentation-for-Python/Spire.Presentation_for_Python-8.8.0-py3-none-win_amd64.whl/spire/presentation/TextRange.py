...
class TextRange (  TextCharacterProperties) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().TextRange_Create(None)
    ...
    def __init__(self,value:str):
        GetDllLibPpt().TextRange_Create.argtypes=[c_wchar_p]
        GetDllLibPpt().TextRange_Create.restype = c_void_p
        intPtr = GetDllLibPpt().TextRange_Create(value)
        super(TextRange, self).__init__(intPtr)
    """
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextRange_get_Format(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextRange_get_Paragraph(self.Ptr)
    ...
    def Text(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().TextRange_get_Text(self.Ptr))
        return ret


    @Text.setter
    def Text(self, value:str):
        GetDllLibPpt().TextRange_set_Text.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextRange_set_Text(self.Ptr, value)
    ...
    def Field(self)->'Field':
        ...
        intPtr = GetDllLibPpt().TextRange_get_Field(self.Ptr)
    ...
    def AddField(self ,fieldType:'FieldType'):
        ...
        GetDllLibPpt().TextRange_AddField(self.Ptr, intPtrfieldType)
    ...
    def RemoveField(self):
        ...
        GetDllLibPpt().TextRange_RemoveField(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextRange_Equals(self.Ptr, intPtrobj)
        return ret
