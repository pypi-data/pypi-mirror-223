...
class Theme (  IActivePresentation) :
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().Theme_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().Theme_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().Theme_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Theme_get_ColorScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Theme_get_FontScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Theme_get_FormatScheme(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Theme_get_Presentation(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().Theme_Equals(self.Ptr, intPtrobj)
        return ret
