...
class ClickHyperlink (SpireObject) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_Create()
        super(ClickHyperlink, self).__init__(intPtr)

    @dispatch
    def __init__(self,hyperlinkUrl:str):
        GetDllLibPpt().ClickHyperlink_Create.argtypes=[c_wchar_p]
        GetDllLibPpt().ClickHyperlink_Create.restype = c_void_p
        intPtr = GetDllLibPpt().ClickHyperlink_Create(hyperlinkUrl)
        super(ClickHyperlink, self).__init__(intPtr)
    ...
    def __init__(self,targetSlide:'ISlide'):
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_Create_Slide(targetSlide.Ptr)
        super(ClickHyperlink, self).__init__(intPtr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_NoAction()
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_NextSlide()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_PreviousSlide()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_FirstSlide()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_LastSlide()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_LastVievedSlide()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_EndShow()
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ClickHyperlink_GetOtherPowerPointPresentation.argtypes=[ c_wchar_p]
        GetDllLibPpt().ClickHyperlink_GetOtherPowerPointPresentation.restype=c_void_p
        intPtr = GetDllLibPpt().ClickHyperlink_GetOtherPowerPointPresentation( filePath)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ClickHyperlink_GetOtherFiles.argtypes=[ c_wchar_p]
        GetDllLibPpt().ClickHyperlink_GetOtherFiles.restype=c_void_p
        intPtr = GetDllLibPpt().ClickHyperlink_GetOtherFiles( filePath)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ClickHyperlink_get_Address(self.Ptr))
        return ret


    @Address.setter
    def Address(self, value:str):
        GetDllLibPpt().ClickHyperlink_set_Address.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ClickHyperlink_set_Address(self.Ptr, value)
    ...
    def InvalidUrl(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().ClickHyperlink_get_InvalidUrl(self.Ptr))
        return ret


    @InvalidUrl.setter
    def InvalidUrl(self, value:str):
        GetDllLibPpt().ClickHyperlink_set_InvalidUrl.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ClickHyperlink_set_InvalidUrl(self.Ptr, value)
    ...
    def Action(self)->str:
        ...
        ret = PtrToStr(GetDllLibPpt().ClickHyperlink_get_Action(self.Ptr))
        return ret


    @Action.setter
    def Action(self, value:str):
        GetDllLibPpt().ClickHyperlink_set_Action.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ClickHyperlink_set_Action(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ClickHyperlink_get_ActionType(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ClickHyperlink_get_TargetSlide(self.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ClickHyperlink_get_TargetFrame(self.Ptr))
        return ret


    @TargetFrame.setter
    def TargetFrame(self, value:str):
        GetDllLibPpt().ClickHyperlink_set_TargetFrame.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ClickHyperlink_set_TargetFrame(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ClickHyperlink_get_Tooltip(self.Ptr))
        return ret


    @Tooltip.setter
    def Tooltip(self, value:str):
        GetDllLibPpt().ClickHyperlink_set_Tooltip.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ClickHyperlink_set_Tooltip(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ClickHyperlink_get_History(self.Ptr)
        return ret

    @History.setter
    def History(self, value:bool):
        GetDllLibPpt().ClickHyperlink_set_History.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ClickHyperlink_set_History(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ClickHyperlink_get_IsHighlightClick(self.Ptr)
        return ret
    ...
    def IsHighlightClick(self, value:bool):
        ...
        GetDllLibPpt().ClickHyperlink_set_IsHighlightClick(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ClickHyperlink_get_EndSounds(self.Ptr)
        return ret

    @EndSounds.setter
    def EndSounds(self, value:bool):
        GetDllLibPpt().ClickHyperlink_set_EndSounds.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ClickHyperlink_set_EndSounds(self.Ptr, value)
    ...
    <param name="obj">The Hyperlink to compare with the current Hyperlink.</param>
        ...
        ret = GetDllLibPpt().ClickHyperlink_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <param name="hlink">The Hyperlink to compare with the current Hyperlink.</param>
        ...
        ret = GetDllLibPpt().ClickHyperlink_EqualsH(self.Ptr, intPtrhlink)
        return ret
    ...
    def op_Equality(hlink1:'ClickHyperlink',hlink2:'ClickHyperlink')->bool:
        ...
        ret = GetDllLibPpt().ClickHyperlink_op_Equality( intPtrhlink1,intPtrhlink2)
        return ret
    ...
    def op_Inequality(hlink1:'ClickHyperlink',hlink2:'ClickHyperlink')->bool:
        ...
        ret = GetDllLibPpt().ClickHyperlink_op_Inequality( intPtrhlink1,intPtrhlink2)
        return ret
    ...
    def GetHashCode(self)->int:
        ...
        ret = GetDllLibPpt().ClickHyperlink_GetHashCode(self.Ptr)
        return ret
