...
class Presentation (_Presentation) :
    ...
    def __init__(self):
        ...
        intPtr = GetDllLibPpt().Presentation_CreatePresentation()
        super(Presentation, self).__init__(intPtr)
    def __del__(self):
        GetDllLibPpt().Presentation_Dispose.argtypes = [c_void_p]
        GetDllLibPpt().Presentation_Dispose(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_SlideSize(self.Ptr)
    ...
    def SectionList(self)->'SectionList':
        ...
        intPtr = GetDllLibPpt().Presentation_get_SectionList(self.Ptr)
    ...
    <param name="IsRation">Is ratio</param>
        ...
        GetDllLibPpt().Presentation_SetPageSize(self.Ptr, w,h,IsRatio)
    ...
    def StrictFirstAndLastCharacters(self)->bool:
        ...
        ret = GetDllLibPpt().Presentation_get_StrictFirstAndLastCharacters(self.Ptr)
        return ret
    ...
    def StrictFirstAndLastCharacters(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_StrictFirstAndLastCharacters(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_WavAudios(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_Videos(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_Images(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_DocumentProperty(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_CommentAuthors(self.Ptr)
    ...
    def DFlag(self)->bool:
        ...
        ret = GetDllLibPpt().Presentation_get_DFlag(self.Ptr)
        return ret

    @DFlag.setter
    def DFlag(self, value:bool):
        GetDllLibPpt().Presentation_set_DFlag.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Presentation_set_DFlag(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_FormatAndVersion(self.Ptr)
...
#        intPtr = GetDllLibPpt().Presentation_AddDigitalSignature(self.Ptr, intPtrcertificate,comments,intPtrsignTime)
...
#
    ...
    <returns>Collection of DigitalSignature</returns>
        ...
        intPtr = GetDllLibPpt().Presentation_GetDigitalSignatures(self.Ptr)
        ret = None if intPtr==None else IDigitalSignatures(intPtr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_RemoveAllDigitalSignatures(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_IsDigitallySigned(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_SetCustomFontsFolder.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_SetCustomFontsFolder(self.Ptr, fontsFolder)
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_IsPasswordProtected.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_IsPasswordProtected.restype=c_bool
        ret = GetDllLibPpt().Presentation_IsPasswordProtected(self.Ptr, fileName)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_IsPasswordProtectedS(self.Ptr, intPtrstream)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_HighQualityImage(self.Ptr)
        return ret
    ...
    def HighQualityImage(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_HighQualityImage(self.Ptr, value)

    
    def SlideSizeAutoFit(self, value:bool):
        GetDllLibPpt().Presentation_set_SlideSizeAutoFit.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Presentation_set_SlideSizeAutoFit(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_SaveToPdfOption(self.Ptr)
    ...
    def SaveToPdfOption(self, value:'SaveToPdfOption'):
        ...
        GetDllLibPpt().Presentation_set_SaveToPdfOption(self.Ptr, value.Ptr)
    ...
    def SaveToHtmlOption(self)->'SaveToHtmlOption':
        ...
        intPtr = GetDllLibPpt().Presentation_get_SaveToHtmlOption(self.Ptr)
    ...
    def SaveToHtmlOption(self, value:'SaveToHtmlOption'):
        ...
        GetDllLibPpt().Presentation_set_SaveToHtmlOption(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_SaveToPptxOption(self.Ptr)
    ...
    def SaveToPptxOption(self, value:'SaveToPptxOption'):
        ...
        GetDllLibPpt().Presentation_set_SaveToPptxOption(self.Ptr, value.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().Presentation_FindSlide(self.Ptr, id)
...
#        intPtrArray = GetDllLibPpt().Presentation_GetBytes(self.Ptr)
...
#        return ret
    ...
    <returns>A <see cref="T:System.IO.Stream" /> to read from.</returns>
        ...
        intPtr = GetDllLibPpt().Presentation_GetStream(self.Ptr)
    ...
    <param name="stream">The document stream.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromStream(self.Ptr, intPtrstream,enumfileFormat)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromStreamSFP.argtypes=[c_void_p ,c_void_p,c_int,c_wchar_p]
        GetDllLibPpt().Presentation_LoadFromStreamSFP(self.Ptr, intPtrstream,enumfileFormat,password)
    ...
    <param name="file">The document file path.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromFile.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_LoadFromFile(self.Ptr, file)
    ...
    <param name="file">The document file path.</param>
        ...
        GetDllLibPpt().Presentation_LoadFromFileFP.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().Presentation_LoadFromFileFP(self.Ptr, file,password)
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat):
        ...
        GetDllLibPpt().Presentation_LoadFromFileFF.argtypes=[c_void_p ,c_wchar_p,c_int]
        GetDllLibPpt().Presentation_LoadFromFileFF(self.Ptr, file,enumfileFormat)
    ...
    def LoadFromFile(self ,file:str,fileFormat:FileFormat,password:str):
        ...
        GetDllLibPpt().Presentation_LoadFromFileFFP.argtypes=[c_void_p ,c_wchar_p,c_int,c_wchar_p]
        GetDllLibPpt().Presentation_LoadFromFileFFP(self.Ptr, file,enumfileFormat,password)
    ...
    <param name="stream">The <see cref="T:System.IO.Stream" /> where the document will be saved.</param>
        ...
        GetDllLibPpt().Presentation_SaveToFile(self.Ptr, intPtrstream,enumfileFormat)
...
#        GetDllLibPpt().Presentation_SaveToSVG.restype=c_void_p
#        intPtr = GetDllLibPpt().Presentation_SaveToSVG(self.Ptr)
...
#
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_OnlineSaveToFile.argtypes=[c_void_p ,c_wchar_p,c_int]
        GetDllLibPpt().Presentation_OnlineSaveToFile.restype=c_bool
        ret = GetDllLibPpt().Presentation_OnlineSaveToFile(self.Ptr, file,enumfileFormat)
        return ret
    ...
    <param name="fileFormat">convert to fileFormat.</param>
        ...
        GetDllLibPpt().Presentation_SaveToFileFF.argtypes=[c_void_p ,c_wchar_p,c_int]
        GetDllLibPpt().Presentation_SaveToFileFF(self.Ptr, file,enumfileFormat)
...
#        GetDllLibPpt().Presentation_SaveToHttpResponse(self.Ptr, FileName,enumfileFormat,intPtrresponse)
...
#        GetDllLibPpt().Presentation_SaveToHttpResponseFFRI(self.Ptr, FileName,enumfileFormat,intPtrresponse,isInlineMode)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_Encrypt.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_Encrypt(self.Ptr, password)
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_RemoveEncryption(self.Ptr)
    ...
    <param name="password">The password.</param>
        ...
        GetDllLibPpt().Presentation_Protect.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_Protect(self.Ptr, password)
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_RemoveProtect(self.Ptr)
    ...
    #    GetDllLibPpt().Presentation_Print(self.Ptr, intPtrpresentationPrintDocument)
...
#        GetDllLibPpt().Presentation_PrintP(self.Ptr, intPtrprinterSettings)
...
#        GetDllLibPpt().Presentation_PrintPP(self.Ptr, intPtrprinterSettings,presName)
    ...
    #    GetDllLibPpt().Presentation_PrintN(self.Ptr, Name)
    ...
    def SetFooterText(self ,text:str):
        ...
        GetDllLibPpt().Presentation_SetFooterText.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().Presentation_SetFooterText(self.Ptr, text)
    ...
    def SetDateTime(self ,dateTime:DateTime):
        ...
        GetDllLibPpt().Presentation_SetDateTime(self.Ptr, intPtrdateTime)
    ...
    def SetDateTime(self ,dateTime:DateTime,format:str):
        ...
        GetDllLibPpt().Presentation_SetDateTimeDF.argtypes=[c_void_p ,c_void_p,c_wchar_p]
        GetDllLibPpt().Presentation_SetDateTimeDF(self.Ptr, intPtrdateTime,format)
    ...
    def SetFooterVisible(self ,visible:bool):
        ...
        GetDllLibPpt().Presentation_SetFooterVisible(self.Ptr, visible)
    ...
    def SetDateTimeVisible(self ,visible:bool):
        ...
        GetDllLibPpt().Presentation_SetDateTimeVisible(self.Ptr, visible)
    ...
    def SetSlideNoVisible(self ,visible:bool):
        ...
        GetDllLibPpt().Presentation_SetSlideNoVisible(self.Ptr, visible)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_SlideNumberVisible(self.Ptr)
        return ret
    ...
    def SlideNumberVisible(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_SlideNumberVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_DateTimeVisible(self.Ptr)
        return ret
    ...
    def DateTimeVisible(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_DateTimeVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_FooterVisible(self.Ptr)
        return ret
    ...
    def FooterVisible(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_FooterVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_AutoCompressPictures(self.Ptr)
        return ret
    ...
    def AutoCompressPictures(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_AutoCompressPictures(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_BookmarkIdSeed(self.Ptr)
        return ret
    ...
    def BookmarkIdSeed(self, value:int):
        ...
        GetDllLibPpt().Presentation_set_BookmarkIdSeed(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_DefaultTextStyle(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_ShowNarration(self.Ptr)
        return ret
    ...
    def ShowNarration(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_ShowNarration(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_ShowAnimation(self.Ptr)
        return ret
    ...
    def ShowAnimation(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_ShowAnimation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_ShowLoop(self.Ptr)
        return ret

    @ShowLoop.setter
    def ShowLoop(self, value:bool):
        GetDllLibPpt().Presentation_set_ShowLoop.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Presentation_set_ShowLoop(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_HasMacros(self.Ptr)
        return ret
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_DeleteMacros(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_ShowType(self.Ptr)
    ...
    def ShowType(self, value:'SlideShowType'):
        ...
        GetDllLibPpt().Presentation_set_ShowType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_UseTimings(self.Ptr)
        return ret

    @UseTimings.setter
    def UseTimings(self, value:bool):
        GetDllLibPpt().Presentation_set_UseTimings.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().Presentation_set_UseTimings(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_EmbedTrueTypeFonts(self.Ptr)
        return ret
    ...
    def EmbedTrueTypeFonts(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_EmbedTrueTypeFonts(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_FirstSlideNumber(self.Ptr)
        return ret
    ...
    def FirstSlideNumber(self, value:int):
        ...
        GetDllLibPpt().Presentation_set_FirstSlideNumber(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_HandoutMaster(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_NotesMaster(self.Ptr)
        ret = None if intPtr==None else INoteMasterSlide(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_NotesSlideSize(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_SaveSubsetFonts(self.Ptr)
        return ret
    ...
    def SaveSubsetFonts(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_SaveSubsetFonts(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_ServerZoom(self.Ptr)
        return ret

    @ServerZoom.setter
    def ServerZoom(self, value:float):
        GetDllLibPpt().Presentation_set_ServerZoom.argtypes=[c_void_p, c_float]
        GetDllLibPpt().Presentation_set_ServerZoom(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_Masters(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().Presentation_get_Slides(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_SlideCountPerPageForPrint(self.Ptr)
    ...
    def SlideCountPerPageForPrint(self, value:'PageSlideCount'):
        ...
        GetDllLibPpt().Presentation_set_SlideCountPerPageForPrint(self.Ptr, value.value)
    ...
    <summary>
        ...
        GetDllLibPpt().Presentation_SelectSlidesForPrint(self.Ptr, arrayselectSlidesForPrint)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_OrderForPrint(self.Ptr)
        objwraped = Order(ret)
        return objwraped
    ...
    def OrderForPrint(self, value:'Order'):
        ...
        GetDllLibPpt().Presentation_set_OrderForPrint(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_SlideFrameForPrint(self.Ptr)
        return ret
    ...
    def SlideFrameForPrint(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_SlideFrameForPrint(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().Presentation_get_GrayLevelForPrint(self.Ptr)
        return ret
    ...
    def GrayLevelForPrint(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_GrayLevelForPrint(self.Ptr, value)
    ...
    def IsNoteRetained(self)->bool:
        ...
        ret = GetDllLibPpt().Presentation_get_IsNoteRetained(self.Ptr)
        return ret
    ...
    def IsNoteRetained(self, value:bool):
        ...
        GetDllLibPpt().Presentation_set_IsNoteRetained(self.Ptr, value)
