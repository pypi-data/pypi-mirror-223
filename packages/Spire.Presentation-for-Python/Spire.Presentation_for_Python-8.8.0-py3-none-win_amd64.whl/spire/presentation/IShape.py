...
class IShape (SpireObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_IsTextBox(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IShape_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IShape_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IShape_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IShape_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IShape_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IShape_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IShape_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IShape_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IShape_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IShape_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IShape_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IShape_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IShape_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IShape_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IShape_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IShape_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IShape_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IShape_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IShape_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IShape_get_AlternativeTitle(self.Ptr))
        return ret


    @AlternativeTitle.setter
    def AlternativeTitle(self, value:str):
        GetDllLibPpt().IShape_set_AlternativeTitle.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IShape_set_AlternativeTitle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IShape_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IShape_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IShape_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IShape_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IShape_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_Dispose(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_SetShapeAlignment(self.Ptr, enumshapeAlignment)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_SetShapeArrange(self.Ptr, enumshapeArrange)
    ...
    <param name="filepath">Video file path</param>
        ...
        GetDllLibPpt().IShape_InsertVideo.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().IShape_InsertVideo(self.Ptr, filepath)
    ...
    <param name="type">smartArt Type</param>
        ...
        GetDllLibPpt().IShape_InsertSmartArt(self.Ptr, enumsmartArtLayoutType)
    ...
    <param name="type">Chart Type</param>
        ...
        GetDllLibPpt().IShape_InsertChart(self.Ptr, enumtype)
    ...
    <param name="tableRowCount">Tablerow count</param>
        ...
        GetDllLibPpt().IShape_InsertTable(self.Ptr, tableColumnCount,tableRowCount)
    ...
    <param name="stream">the picture stream</param>
        ...
        GetDllLibPpt().IShape_InsertPicture(self.Ptr, intPtrstream)
    ...
    <param name="filepath">Picture file path</param>
        ...
        GetDllLibPpt().IShape_InsertPictureF.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().IShape_InsertPictureF(self.Ptr, filepath)
    ...
    def Id(self)->'int':
        ...
        shapeId = GetDllLibPpt().IShape_get_Id(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IShape_ReplaceTextWithRegex.argtypes=[c_void_p ,c_void_p,c_wchar_p]
        GetDllLibPpt().IShape_ReplaceTextWithRegex(self.Ptr, intPtrregex,newValue)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().IShape_SaveAsImage(self.Ptr)
