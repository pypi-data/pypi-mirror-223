...
class ChartAxis (  PptObject, IChartAxis) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsCrossCategories(self.Ptr)
        return ret
    ...
    def IsCrossCategories(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_IsCrossCategories(self.Ptr, value)
...
<remarks>The number should be a integer when it applies to category axis.
        ...
        ret = GetDllLibPpt().ChartAxis_get_CrossAt(self.Ptr)
        return ret

    @CrossAt.setter
    def CrossAt(self, value:float):
        GetDllLibPpt().ChartAxis_set_CrossAt.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartAxis_set_CrossAt(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_DisplayUnit(self.Ptr)
    ...
    def DisplayUnit(self, value:'ChartDisplayUnitType'):
        ...
        GetDllLibPpt().ChartAxis_set_DisplayUnit(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutoMax(self.Ptr)
        return ret

    @IsAutoMax.setter
    def IsAutoMax(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsAutoMax.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsAutoMax(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MaxValue(self.Ptr)
        return ret

    @MaxValue.setter
    def MaxValue(self, value:float):
        GetDllLibPpt().ChartAxis_set_MaxValue.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartAxis_set_MaxValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MinorUnit(self.Ptr)
        return ret

    @MinorUnit.setter
    def MinorUnit(self, value:float):
        GetDllLibPpt().ChartAxis_set_MinorUnit.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartAxis_set_MinorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutoMinor(self.Ptr)
        return ret

    @IsAutoMinor.setter
    def IsAutoMinor(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsAutoMinor.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsAutoMinor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MajorUnit(self.Ptr)
        return ret

    @MajorUnit.setter
    def MajorUnit(self, value:float):
        GetDllLibPpt().ChartAxis_set_MajorUnit.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartAxis_set_MajorUnit(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutoMajor(self.Ptr)
        return ret

    @IsAutoMajor.setter
    def IsAutoMajor(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsAutoMajor.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsAutoMajor(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutoMin(self.Ptr)
        return ret

    @IsAutoMin.setter
    def IsAutoMin(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsAutoMin.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsAutoMin(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MinValue(self.Ptr)
        return ret

    @MinValue.setter
    def MinValue(self, value:float):
        GetDllLibPpt().ChartAxis_set_MinValue.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartAxis_set_MinValue(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsLogScale(self.Ptr)
        return ret

    @IsLogScale.setter
    def IsLogScale(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsLogScale.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsLogScale(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_LogScale(self.Ptr)
        return ret

    @LogScale.setter
    def LogScale(self, value:int):
        GetDllLibPpt().ChartAxis_set_LogScale.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartAxis_set_LogScale(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsReversed(self.Ptr)
        return ret

    @IsReversed.setter
    def IsReversed(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsReversed.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsReversed(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsVisible(self.Ptr)
        return ret

    @IsVisible.setter
    def IsVisible(self, value:bool):
        GetDllLibPpt().ChartAxis_set_IsVisible.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_IsVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MajorTickMark(self.Ptr)
    ...
    def MajorTickMark(self, value:'TickMarkType'):
        ...
        GetDllLibPpt().ChartAxis_set_MajorTickMark(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MinorTickMark(self.Ptr)
        objwraped = TickMarkType(ret)
        return objwraped
    ...
    def MinorTickMark(self, value:'TickMarkType'):
        ...
        GetDllLibPpt().ChartAxis_set_MinorTickMark(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_TickLabelPosition(self.Ptr)
    ...
    def TickLabelPosition(self, value:'TickLabelPositionType'):
        ...
        GetDllLibPpt().ChartAxis_set_TickLabelPosition(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MajorUnitScale(self.Ptr)
    ...
    def MajorUnitScale(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibPpt().ChartAxis_set_MajorUnitScale(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_MinorUnitScale(self.Ptr)
        objwraped = ChartBaseUnitType(ret)
        return objwraped
    ...
    def MinorUnitScale(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibPpt().ChartAxis_set_MinorUnitScale(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_BaseUnitScale(self.Ptr)
        objwraped = ChartBaseUnitType(ret)
        return objwraped
    ...
    def BaseUnitScale(self, value:'ChartBaseUnitType'):
        ...
        GetDllLibPpt().ChartAxis_set_BaseUnitScale(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_MinorGridLines(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_MajorGridTextLines(self.Ptr)
        ret = None if intPtr==None else IChartGridLine(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_ChartEffectFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_TextProperties(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_Title(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_ChartCrossType(self.Ptr)
    ...
    def ChartCrossType(self, value:'ChartCrossesType'):
        ...
        GetDllLibPpt().ChartAxis_set_ChartCrossType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_Position(self.Ptr)
    ...
    def Position(self, value:'AxisPositionType'):
        ...
        GetDllLibPpt().ChartAxis_set_Position(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_HasTitle(self.Ptr)
        return ret

    @HasTitle.setter
    def HasTitle(self, value:bool):
        GetDllLibPpt().ChartAxis_set_HasTitle.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartAxis_set_HasTitle(self.Ptr, value)
    ...
    def CrossBetweenType(self)->'CrossBetweenType':
        ...
        ret = GetDllLibPpt().ChartAxis_get_CrossBetweenType(self.Ptr)
    ...
    def CrossBetweenType(self, value:'CrossBetweenType'):
        ...
        GetDllLibPpt().ChartAxis_set_CrossBetweenType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartAxis_get_NumberFormat(self.Ptr))
        return ret


    @NumberFormat.setter
    def NumberFormat(self, value:str):
        GetDllLibPpt().ChartAxis_set_NumberFormat.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ChartAxis_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_TextRotationAngle(self.Ptr)
        return ret
    ...
    def TextRotationAngle(self, value:float):
        ...
        GetDllLibPpt().ChartAxis_set_TextRotationAngle(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_TickLabelSpacing(self.Ptr)
    ...
    def TickLabelSpacing(self, value:'UInt32'):
        ...
        GetDllLibPpt().ChartAxis_set_TickLabelSpacing(self.Ptr, value.Ptr)
    ...
    def IsAutomaticTickLabelSpacing(self)->bool:
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutomaticTickLabelSpacing(self.Ptr)
        return ret
    ...
    def IsAutomaticTickLabelSpacing(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_IsAutomaticTickLabelSpacing(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartAxis_get_TickMarkSpacing(self.Ptr)
        ret = None if intPtr==None else UInt32(intPtr)
        return ret
    ...
    def TickMarkSpacing(self, value:'UInt32'):
        ...
        GetDllLibPpt().ChartAxis_set_TickMarkSpacing(self.Ptr, value.Ptr)
    ...
    def IsAutomaticTickMarkSpacing(self)->bool:
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsAutomaticTickMarkSpacing(self.Ptr)
        return ret
    ...
    def IsAutomaticTickMarkSpacing(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_IsAutomaticTickMarkSpacing(self.Ptr, value)
    ...
    def LblOffset(self)->int:
        ...
        ret = GetDllLibPpt().ChartAxis_get_LblOffset(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_HasMultiLvlLbl(self.Ptr)
        return ret
    ...
    def HasMultiLvlLbl(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_HasMultiLvlLbl(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsMergeSameLabel(self.Ptr)
        return ret
    ...
    def IsMergeSameLabel(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_IsMergeSameLabel(self.Ptr, value)
    ...
    def AxisType(self)->'AxisType':
        ...
        ret = GetDllLibPpt().ChartAxis_get_AxisType(self.Ptr)
    ...
    def AxisType(self, value:'AxisType'):
        ...
        GetDllLibPpt().ChartAxis_set_AxisType(self.Ptr, value.value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_IsBinningByCategory(self.Ptr)
        return ret
    ...
    def IsBinningByCategory(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_IsBinningByCategory(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_HasAutomaticBins(self.Ptr)
        return ret
    ...
    def HasAutomaticBins(self, value:bool):
        ...
        GetDllLibPpt().ChartAxis_set_HasAutomaticBins(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.Can be a value from 1 through 31999.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_NumberOfBins(self.Ptr)
        return ret

    @NumberOfBins.setter
    def NumberOfBins(self, value:int):
        GetDllLibPpt().ChartAxis_set_NumberOfBins.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartAxis_set_NumberOfBins(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_BinWidth(self.Ptr)
        return ret

    @BinWidth.setter
    def BinWidth(self, value:float):
        GetDllLibPpt().ChartAxis_set_BinWidth.argtypes=[c_void_p, c_double]
        GetDllLibPpt().ChartAxis_set_BinWidth(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_UnderflowBinValue(self.Ptr)
        return ret
    ...
    def UnderflowBinValue(self, value:float):
        ...
        GetDllLibPpt().ChartAxis_set_UnderflowBinValue(self.Ptr, value)
...
<remarks>Applies only to Histogram and Pareto charts.</remarks>
        ...
        ret = GetDllLibPpt().ChartAxis_get_OverflowBinValue(self.Ptr)
        return ret
    ...
    def OverflowBinValue(self, value:float):
        ...
        GetDllLibPpt().ChartAxis_set_OverflowBinValue(self.Ptr, value)
    ...
    def GapWidth(self)->int:
        ...
        ret = GetDllLibPpt().ChartAxis_get_GapWidth(self.Ptr)
        return ret

    @GapWidth.setter
    def GapWidth(self, value:int):
        GetDllLibPpt().ChartAxis_set_GapWidth.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartAxis_set_GapWidth(self.Ptr, value)
