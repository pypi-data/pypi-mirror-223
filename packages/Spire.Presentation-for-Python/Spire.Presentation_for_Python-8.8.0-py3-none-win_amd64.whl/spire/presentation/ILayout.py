...
class ILayout (ActiveSlide) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ILayout_get_LayoutType(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().ILayout_GetDependingSlides(self.Ptr)
...
#        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ILayout_get_Name(self.Ptr))
        return ret
