...
class TimeAnimationValue (  PptObject) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TimeAnimationValue_get_Time(self.Ptr)
        return ret

    @Time.setter
    def Time(self, value:float):
        GetDllLibPpt().TimeAnimationValue_set_Time.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TimeAnimationValue_set_Time(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TimeAnimationValue_get_Value(self.Ptr)
    ...
    def Value(self, value:'SpireObject'):
        ...
        GetDllLibPpt().TimeAnimationValue_set_Value(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TimeAnimationValue_get_Formula(self.Ptr))
        return ret


    @Formula.setter
    def Formula(self, value:str):
        GetDllLibPpt().TimeAnimationValue_set_Formula.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TimeAnimationValue_set_Formula(self.Ptr, value)
