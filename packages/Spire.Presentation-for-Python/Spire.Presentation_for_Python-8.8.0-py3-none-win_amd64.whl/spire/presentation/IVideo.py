...
class IVideo (  IShape) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_EmbedImage(self.Ptr)
    ...
    def EmbedImage(self, value:'IImageData'):
        ...
        GetDllLibPpt().IVideo_set_EmbedImage(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_RewindVideo(self.Ptr)
        return ret

    @RewindVideo.setter
    def RewindVideo(self, value:bool):
        GetDllLibPpt().IVideo_set_RewindVideo.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IVideo_set_RewindVideo(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_PlayLoopMode(self.Ptr)
        return ret

    @PlayLoopMode.setter
    def PlayLoopMode(self, value:bool):
        GetDllLibPpt().IVideo_set_PlayLoopMode.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IVideo_set_PlayLoopMode(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Volume(self.Ptr)
    ...
    def Volume(self, value:'AudioVolumeType'):
        ...
        GetDllLibPpt().IVideo_set_Volume(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_PlayMode(self.Ptr)
    ...
    def PlayMode(self, value:'VideoPlayMode'):
        ...
        GetDllLibPpt().IVideo_set_PlayMode(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IVideo_get_LinkPathLong(self.Ptr))
        return ret


    @LinkPathLong.setter
    def LinkPathLong(self, value:str):
        GetDllLibPpt().IVideo_set_LinkPathLong.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IVideo_set_LinkPathLong(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_EmbeddedVideoData(self.Ptr)
    ...
    def EmbeddedVideoData(self, value:'VideoData'):
        ...
        GetDllLibPpt().IVideo_set_EmbeddedVideoData(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_ShapeLocking(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ShapeType'):
        ...
        GetDllLibPpt().IVideo_set_ShapeType(self.Ptr, value.value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_PictureFill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_ShapeStyle(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Adjustments(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IVideo_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IVideo_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IVideo_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IVideo_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IVideo_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IVideo_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IVideo_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IVideo_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IVideo_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IVideo_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IVideo_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IVideo_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IVideo_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IVideo_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IVideo_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IVideo_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IVideo_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IVideo_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IVideo_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IVideo_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IVideo_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IVideo_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IVideo_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IVideo_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IVideo_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IVideo_Dispose(self.Ptr)
