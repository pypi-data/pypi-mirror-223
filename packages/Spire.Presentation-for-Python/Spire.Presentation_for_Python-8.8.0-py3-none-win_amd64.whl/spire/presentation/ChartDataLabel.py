...
class ChartDataLabel (  PptObject) :
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_DataLabelSize(self.Ptr)
    ...
    def DataLabelSize(self, value:'SizeF'):
        ...
        GetDllLibPpt().ChartDataLabel_set_DataLabelSize(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_IsDelete(self.Ptr)
        return ret

    @IsDelete.setter
    def IsDelete(self, value:bool):
        GetDllLibPpt().ChartDataLabel_set_IsDelete.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().ChartDataLabel_set_IsDelete(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_ID(self.Ptr)
        return ret

    @ID.setter
    def ID(self, value:int):
        GetDllLibPpt().ChartDataLabel_set_ID.argtypes=[c_void_p, c_int]
        GetDllLibPpt().ChartDataLabel_set_ID(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_HasDataSource(self.Ptr)
        return ret
    ...
    def HasDataSource(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_HasDataSource(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartDataLabel_get_NumberFormat(self.Ptr))
        return ret


    @NumberFormat.setter
    def NumberFormat(self, value:str):
        GetDllLibPpt().ChartDataLabel_set_NumberFormat.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ChartDataLabel_set_NumberFormat(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_TextFrame(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_TextProperties(self.Ptr)
        ret = None if intPtr==None else ITextFrameProperties(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_Effect(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ChartDataLabel_get_Effect3D(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_Position(self.Ptr)
    ...
    def Position(self, value:'ChartDataLabelPosition'):
        ...
        GetDllLibPpt().ChartDataLabel_set_Position(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_LegendKeyVisible(self.Ptr)
        return ret
    ...
    def LegendKeyVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_LegendKeyVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_CategoryNameVisible(self.Ptr)
        return ret
    ...
    def CategoryNameVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_CategoryNameVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_LabelValueVisible(self.Ptr)
        return ret
    ...
    def LabelValueVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_LabelValueVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_PercentageVisible(self.Ptr)
        return ret
    ...
    def PercentageVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_PercentageVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_SeriesNameVisible(self.Ptr)
        return ret
    ...
    def SeriesNameVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_SeriesNameVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_BubbleSizeVisible(self.Ptr)
        return ret
    ...
    def BubbleSizeVisible(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_BubbleSizeVisible(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartDataLabel_get_Separator(self.Ptr))
        return ret


    @Separator.setter
    def Separator(self, value:str):
        GetDllLibPpt().ChartDataLabel_set_Separator.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().ChartDataLabel_set_Separator(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_X(self.Ptr)
        return ret

    @X.setter
    def X(self, value:float):
        GetDllLibPpt().ChartDataLabel_set_X.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartDataLabel_set_X(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_Y(self.Ptr)
        return ret

    @Y.setter
    def Y(self, value:float):
        GetDllLibPpt().ChartDataLabel_set_Y.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartDataLabel_set_Y(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_RotationAngle(self.Ptr)
        return ret

    @RotationAngle.setter
    def RotationAngle(self, value:float):
        GetDllLibPpt().ChartDataLabel_set_RotationAngle.argtypes=[c_void_p, c_float]
        GetDllLibPpt().ChartDataLabel_set_RotationAngle(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_DataLabelShapeType(self.Ptr)
    ...
    def DataLabelShapeType(self, value:'DataLabelShapeType'):
        ...
        GetDllLibPpt().ChartDataLabel_set_DataLabelShapeType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_ShowDataLabelsRange(self.Ptr)
        return ret
    ...
    def ShowDataLabelsRange(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_ShowDataLabelsRange(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ChartDataLabel_get_UseValuePlaceholder(self.Ptr)
        return ret
    ...
    def UseValuePlaceholder(self, value:bool):
        ...
        GetDllLibPpt().ChartDataLabel_set_UseValuePlaceholder(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().ChartDataLabel_ValuePlaceholder())
        return ret
