...
class ShapeList (SpireObject) :
    ...
    def __getitem__(self, key):
        ...
        intPtrWithType = GetDllLibPpt().ShapeList_get_Item(self.Ptr, key)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_GetEnumerator(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeList_get_Parent(self.Ptr)
    ...
    <param name="htmlText">HTML text.</param>
        ...
        GetDllLibPpt().ShapeList_AddFromHtml.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ShapeList_AddFromHtml(self.Ptr, htmlText)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ShapeList_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ShapeList_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().ShapeList_get_Item(self.Ptr, index)
        ret = None if intPtr==None else IShape(intPtr)
        return ret

    def SaveAsImage(self ,shapeIndex:int)->'Stream':
        """
    <summary>
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_SaveAsImage.argtypes=[c_void_p ,c_int]
        GetDllLibPpt().ShapeList_SaveAsImage.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_SaveAsImage(self.Ptr, shapeIndex)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_SaveAsEMF.argtypes=[c_void_p ,c_int,c_wchar_p]
        GetDllLibPpt().ShapeList_SaveAsEMF(self.Ptr, shapeIndex,filePath)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_CreateChart(self.Ptr, intPtrbaseChart,intPtrrectangle,nIndex)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendChart(self.Ptr, enumtype,intPtrrectangle,init)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendChartTR(self.Ptr, enumtype,intPtrrectangle)
        ret = None if intPtr==None else IChart(intPtr)
        return ret
    ...
    def AppendSmartArt(self ,x:float,y:float,width:float,height:float,layoutType:'SmartArtLayoutType')->'ISmartArt':
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendSmartArt(self.Ptr, x,y,width,height,enumlayoutType)
    ...
    <param name="rectangle">Rectangle should inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertChart(self.Ptr, index,enumtype,intPtrrectangle,init)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendOleObject.argtypes=[c_void_p ,c_wchar_p,c_void_p,c_void_p]
        GetDllLibPpt().ShapeList_AppendOleObject.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendOleObject(self.Ptr, objectName,intPtrobjectData,intPtrrectangle)
...
#        intPtr = GetDllLibPpt().ShapeList_AppendOleObjectOOR(self.Ptr, objectName,arrayobjectData,intPtrrectangle)
#        ret = None if intPtr==None else IOleObject(intPtr)
#        return ret
#
    ...
    <param name="rectangle">Rectangle should be inserted</param>
        ...
        GetDllLibPpt().ShapeList_InsertOleObject.argtypes=[c_void_p ,c_int,c_wchar_p,c_void_p,c_void_p]
        GetDllLibPpt().ShapeList_InsertOleObject(self.Ptr, index,objectName,intPtrobjectData,intPtrrectangle)
...
#        GetDllLibPpt().ShapeList_InsertOleObjectIOOR(self.Ptr, index,objectName,arrayobjectData,intPtrrectangle)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendVideoMedia.argtypes=[c_void_p ,c_wchar_p,c_void_p]
        GetDllLibPpt().ShapeList_AppendVideoMedia.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendVideoMedia(self.Ptr, filePath,intPtrrectangle)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendVideoMediaFRI.argtypes=[c_void_p ,c_wchar_p,c_void_p,c_bool]
        GetDllLibPpt().ShapeList_AppendVideoMediaFRI.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendVideoMediaFRI(self.Ptr, filePath,intPtrrectangle,isInnerLink)
        ret = None if intPtr==None else IVideo(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendVideoMediaSR(self.Ptr, intPtrstream,intPtrrectangle)
        ret = None if intPtr==None else IVideo(intPtr)
        return ret
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertVideoMedia.argtypes=[c_void_p ,c_int,c_wchar_p,c_void_p]
        GetDllLibPpt().ShapeList_InsertVideoMedia(self.Ptr, index,filePath,intPtrrectangle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMedia(self.Ptr, intPtrrectangle)
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMedia(self.Ptr, index,intPtrrectangle)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendAudioMediaFXYI.argtypes=[c_void_p ,c_wchar_p,c_float,c_float,c_bool]
        GetDllLibPpt().ShapeList_AppendAudioMediaFXYI.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFXYI(self.Ptr, filePath,X,Y,isEmbed)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendAudioMediaFXY.argtypes=[c_void_p ,c_wchar_p,c_float,c_float]
        GetDllLibPpt().ShapeList_AppendAudioMediaFXY.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFXY(self.Ptr, filePath,X,Y)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendAudioMediaFRI.argtypes=[c_void_p ,c_wchar_p,c_void_p,c_bool]
        GetDllLibPpt().ShapeList_AppendAudioMediaFRI.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFRI(self.Ptr, filePath,intPtrrectangle,isEmbed)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendAudioMediaFR.argtypes=[c_void_p ,c_wchar_p,c_void_p]
        GetDllLibPpt().ShapeList_AppendAudioMediaFR.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaFR(self.Ptr, filePath,intPtrrectangle)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <param name="isEmbed">Whether embed or not,default not</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFRI.argtypes=[c_void_p ,c_int,c_wchar_p,c_void_p,c_bool]
        GetDllLibPpt().ShapeList_InsertAudioMediaIFRI(self.Ptr, index,filePath,intPtrrectangle,isEmbed)
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFR.argtypes=[c_void_p ,c_int,c_wchar_p,c_void_p]
        GetDllLibPpt().ShapeList_InsertAudioMediaIFR(self.Ptr, index,filePath,intPtrrectangle)
    ...
    <param name="isEmbed">Whether embed or not,default not</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXYI.argtypes=[c_void_p ,c_int,c_wchar_p,c_float,c_float,c_bool]
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXYI(self.Ptr, index,filePath,X,Y,isEmbed)
    ...
    <param name="Y">Y Position</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXY.argtypes=[c_void_p ,c_int,c_wchar_p,c_float,c_float]
        GetDllLibPpt().ShapeList_InsertAudioMediaIFXY(self.Ptr, index,filePath,X,Y)

    @dispatch

    def AppendAudioMediaByStream(self ,stream:Stream,rectangle:RectangleF)->'IAudio':
        """
    <summary>
        Adds a new audio to list.
    </summary>
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaSR(self.Ptr, intPtrstream,intPtrrectangle)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    def AppendAudioMediaByStream(self ,stream:Stream,X:float,Y:float)->'IAudio':
        """
    <summary>
        Adds a new audio to list.
    </summary>
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendAudioMediaSXY(self.Ptr, intPtrstream,X,Y)
        ret = None if intPtr==None else IAudio(intPtr)
        return ret
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertAudioMediaISR(self.Ptr, index,intPtrstream,intPtrrectangle)
    ...
    <returns>Index of the first occurrence of shape </returns>
        ...
        ret = GetDllLibPpt().ShapeList_IndexOf(self.Ptr, intPtrshape)
        return ret
...
#        intPtrArray = GetDllLibPpt().ShapeList_ToArray(self.Ptr)
...
#        intPtrArray = GetDllLibPpt().ShapeList_ToArraySC(self.Ptr, startIndex,count)
...
#        return ret
    ...
    <param name="shape">Shape to move.</param>
        ...
        GetDllLibPpt().ShapeList_ZOrder(self.Ptr, index,intPtrshape)
...
#        GetDllLibPpt().ShapeList_ZOrderIS(self.Ptr, index,arrayshapes)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendShape(self.Ptr, enumshapeType,intPtrrectangle)
   ...
   # @dispatch
    ...
    def AppendShapeByPoint(self ,shapeType:ShapeType,start:PointF,end:PointF)->'IAutoShape':
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendShapeSSE(self.Ptr, enumshapeType,intPtrstart,intPtrend)
        ret = None if intPtr==None else IAutoShape(intPtr)
        return ret
    ...
    <param name="radius">Radius of rectangle</param>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendRoundRectangle(self.Ptr, x,y,width,height,radius)
        ret = None if intPtr==None else IAutoShape(intPtr)
        return ret
    ...
    <param name="rectangle">Rectangle shoud be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertShape(self.Ptr, index,enumshapeType,intPtrrectangle)
    ...
    <param name="radius">Radius of rectangle</param>
        ...
        GetDllLibPpt().ShapeList_InsertRoundRectangle(self.Ptr, index,x,y,width,height,radius)
    ...
    <returns>Created shape</returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendShapeConnector(self.Ptr, enumshapeType,intPtrrectangle)
        ret = None if intPtr==None else IShape(intPtr)
        return ret
    ...
    <param name="rectangle">Rectangle should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_InsertShapeConnector(self.Ptr, index,enumshapeType,intPtrrectangle)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendEmbedImage(self.Ptr, enumshapeType,intPtrembedImage,intPtrrectangle)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().ShapeList_AppendEmbedImageSFR.argtypes=[c_void_p ,c_int,c_wchar_p,c_void_p]
        GetDllLibPpt().ShapeList_AppendEmbedImageSFR.restype=c_void_p
        intPtr = GetDllLibPpt().ShapeList_AppendEmbedImageSFR(self.Ptr, enumshapeType,fileName,intPtrrectangle)
        ret = None if intPtr==None else IEmbedImage(intPtr)
        return ret
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendEmbedImageSSR(self.Ptr, enumshapeType,intPtrstream,intPtrrectangle)
        ret = None if intPtr==None else IEmbedImage(intPtr)
        return ret
    ...
    <param name="embedImage">Embed image object.</param>
        ...
        GetDllLibPpt().ShapeList_InsertEmbedImage(self.Ptr, index,enumshapeType,intPtrrectangle,intPtrembedImage)
    ...
    <param name="index">shape should be inserted.</param>
        ...
        GetDllLibPpt().ShapeList_AddShape(self.Ptr, intPtrshape)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().ShapeList_AppendTable(self.Ptr, x,y,arraywidths,countwidths,arrayheights,countheights)
    ...
    <param name="rowHeights">Heights of rows in the table.</param>
        ...
        GetDllLibPpt().ShapeList_InsertTable(self.Ptr, index,x,y,arraycolumnWidths,arrayrowHeights)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().ShapeList_RemoveAt(self.Ptr, index)
    ...
    <param name="shape">The shape to remove from the collection.</param>
        ...
        GetDllLibPpt().ShapeList_Remove(self.Ptr, intPtrshape)
