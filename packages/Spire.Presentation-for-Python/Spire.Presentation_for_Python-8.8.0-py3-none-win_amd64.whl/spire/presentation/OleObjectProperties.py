...
class OleObjectProperties (  ICollection, IEnumerable) :
    ...
    <param name="value">The alue of the property.</param>
        ...
        GetDllLibPpt().OleObjectProperties_Add.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().OleObjectProperties_Add(self.Ptr, name,value)
    ...
    <param name="name">The name of property to remove.</param>
        ...
        GetDllLibPpt().OleObjectProperties_Remove.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().OleObjectProperties_Remove(self.Ptr, name)
    ...
    <returns></returns>
        ...
        GetDllLibPpt().OleObjectProperties_get_Item.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().OleObjectProperties_get_Item.restype=c_void_p
        ret = PtrToStr(GetDllLibPpt().OleObjectProperties_get_Item(self.Ptr, name))
        return ret
    ...
    def set_Item(self ,name:str,value:str):
        ...
        GetDllLibPpt().OleObjectProperties_set_Item.argtypes=[c_void_p ,c_wchar_p,c_wchar_p]
        GetDllLibPpt().OleObjectProperties_set_Item(self.Ptr, name,value)
    ...
    <summary>
        ...
        GetDllLibPpt().OleObjectProperties_Clear(self.Ptr)
...
#        GetDllLibPpt().OleObjectProperties_CopyTo(self.Ptr, intPtrarray,index)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OleObjectProperties_get_Count(self.Ptr)
        return ret
    ...
    <summary>
        ...
        ret = GetDllLibPpt().OleObjectProperties_get_IsSynchronized(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().OleObjectProperties_get_SyncRoot(self.Ptr)
    ...
    <returns></returns>
        ...
        intPtr = GetDllLibPpt().OleObjectProperties_GetEnumerator(self.Ptr)
