...
class AnimationCommandBehavior (  CommonBehavior) :
    ...
    <summary>
        ...
        ret = GetDllLibPpt().AnimationCommandBehavior_get_Type(self.Ptr)
    ...
    def Type(self, value:'AnimationCommandType'):
        ...
        GetDllLibPpt().AnimationCommandBehavior_set_Type(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().AnimationCommandBehavior_get_Value(self.Ptr))
        return ret


    @Value.setter
    def Value(self, value:str):
        GetDllLibPpt().AnimationCommandBehavior_set_Value.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().AnimationCommandBehavior_set_Value(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().AnimationCommandBehavior_get_Target(self.Ptr)
