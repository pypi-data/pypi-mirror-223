...
class ParagraphList (  IActiveSlide) :
    ...
    <param name="htmlText">HTML text.</param>
        ...
        GetDllLibPpt().ParagraphList_AddFromHtml.argtypes=[c_void_p ,c_wchar_p]
        GetDllLibPpt().ParagraphList_AddFromHtml(self.Ptr, htmlText)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().ParagraphList_get_Count(self.Ptr)
        return ret
    ...
    def __getitem__(self, index):
        ...
        intPtr = GetDllLibPpt().ParagraphList_get_Item(self.Ptr, index)
    ...
    <returns>The index at which the Paragraph has been added.</returns>
        ...
        ret = GetDllLibPpt().ParagraphList_Append(self.Ptr, intPtrvalue)
        return ret
    ...
    <returns>The index at which the Paragraph has been added or -1 if there are nothing to add.</returns>
        ...
        ret = GetDllLibPpt().ParagraphList_AppendV(self.Ptr, intPtrvalue)
        return ret
    ...
    <param name="value">The Paragraph to insert.</param>
        ...
        GetDllLibPpt().ParagraphList_Insert(self.Ptr, index,intPtrvalue)
    ...
    <param name="value">The paragraphs to insert.</param>
        ...
        GetDllLibPpt().ParagraphList_InsertIV(self.Ptr, index,intPtrvalue)
    ...
    <summary>
        ...
        GetDllLibPpt().ParagraphList_Clear(self.Ptr)
    ...
    <param name="index">The zero-based index of the element to remove.</param>
        ...
        GetDllLibPpt().ParagraphList_RemoveAt(self.Ptr, index)
    ...
    <returns>An <see cref="T:System.Collections.IEnumerator" /> for the entire collection.</returns>
        ...
        intPtr = GetDllLibPpt().ParagraphList_GetEnumerator(self.Ptr)
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().ParagraphList_Equals(self.Ptr, intPtrobj)
        return ret
