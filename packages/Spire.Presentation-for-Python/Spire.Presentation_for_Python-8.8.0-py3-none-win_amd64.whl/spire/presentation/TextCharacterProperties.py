...
class TextCharacterProperties (  IActiveSlide) :
    ...
    def Equals(self ,obj:'SpireObject')->bool:
        ...
        ret = GetDllLibPpt().TextCharacterProperties_Equals(self.Ptr, intPtrobj)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_Format(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_TextLineFormat(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_DisplayFill(self.Ptr)
        ret = None if intPtr==None else FillFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_HighlightColor(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_UnderlineFormat(self.Ptr)
        ret = None if intPtr==None else TextLineFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_UnderlineFillFormat(self.Ptr)
        ret = None if intPtr==None else FillFormat(intPtr)
        return ret
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TextCharacterProperties_get_BookmarkId(self.Ptr))
        return ret


    @BookmarkId.setter
    def BookmarkId(self, value:str):
        GetDllLibPpt().TextCharacterProperties_set_BookmarkId.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextCharacterProperties_set_BookmarkId(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_HasClickAction(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_ClickAction(self.Ptr)
    ...
    def ClickAction(self, value:'ClickHyperlink'):
        ...
        if(value == None):
            GetDllLibPpt().TextCharacterProperties_set_ClickAction(self.Ptr, None)
        else:
            GetDllLibPpt().TextCharacterProperties_set_ClickAction(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_MouseOverAction(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOverAction(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_MouseOverAction(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_IsBold(self.Ptr)
    ...
    def IsBold(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_IsBold(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_IsItalic(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def IsItalic(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_IsItalic(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_Kumimoji(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def Kumimoji(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_Kumimoji(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_NormalizeHeights(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def NormalizeHeights(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_NormalizeHeights(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_NoProofing(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def NoProofing(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_NoProofing(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_TextUnderlineType(self.Ptr)
    ...
    def TextUnderlineType(self, value:'TextUnderlineType'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_TextUnderlineType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_TextCapType(self.Ptr)
    ...
    def TextCapType(self, value:'TextCapType'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_TextCapType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_TextStrikethroughType(self.Ptr)
    ...
    def TextStrikethroughType(self, value:'TextStrikethroughType'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_TextStrikethroughType(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_SmartTagClean(self.Ptr)
        return ret
    ...
    def SmartTagClean(self, value:bool):
        ...
        GetDllLibPpt().TextCharacterProperties_set_SmartTagClean(self.Ptr, value)
    ...
    def IsInheritUnderlineFill(self)->'TriState':
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_IsInheritUnderlineFill(self.Ptr)
        objwraped = TriState(ret)
        return objwraped
    ...
    def IsInheritUnderlineFill(self, value:'TriState'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_IsInheritUnderlineFill(self.Ptr, value.value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_FontHeight(self.Ptr)
        return ret

    @FontHeight.setter
    def FontHeight(self, value:float):
        GetDllLibPpt().TextCharacterProperties_set_FontHeight.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextCharacterProperties_set_FontHeight(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_LatinFont(self.Ptr)
    ...
    def LatinFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_LatinFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_DefaultLatinFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def DefaultLatinFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_DefaultLatinFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_EastAsianFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def EastAsianFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_EastAsianFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_ComplexScriptFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def ComplexScriptFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_ComplexScriptFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().TextCharacterProperties_get_SymbolFont(self.Ptr)
        ret = None if intPtr==None else TextFont(intPtr)
        return ret
    ...
    def SymbolFont(self, value:'TextFont'):
        ...
        GetDllLibPpt().TextCharacterProperties_set_SymbolFont(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_ScriptDistance(self.Ptr)
        return ret
    ...
    def ScriptDistance(self, value:float):
        ...
        GetDllLibPpt().TextCharacterProperties_set_ScriptDistance(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_FontMinSize(self.Ptr)
        return ret

    @FontMinSize.setter
    def FontMinSize(self, value:float):
        GetDllLibPpt().TextCharacterProperties_set_FontMinSize.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextCharacterProperties_set_FontMinSize(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TextCharacterProperties_get_Language(self.Ptr))
        return ret


    @Language.setter
    def Language(self, value:str):
        GetDllLibPpt().TextCharacterProperties_set_Language.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextCharacterProperties_set_Language(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().TextCharacterProperties_get_AlternativeLanguage(self.Ptr))
        return ret


    @AlternativeLanguage.setter
    def AlternativeLanguage(self, value:str):
        GetDllLibPpt().TextCharacterProperties_set_AlternativeLanguage.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().TextCharacterProperties_set_AlternativeLanguage(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().TextCharacterProperties_get_LineSpacing(self.Ptr)
        return ret

    @LineSpacing.setter
    def LineSpacing(self, value:float):
        GetDllLibPpt().TextCharacterProperties_set_LineSpacing.argtypes=[c_void_p, c_float]
        GetDllLibPpt().TextCharacterProperties_set_LineSpacing(self.Ptr, value)
