...
#        intPtr = GetDllLibPpt().IDigitalSignature_get_Certificate(self.Ptr)
...
#        GetDllLibPpt().IDigitalSignature_set_Certificate(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IDigitalSignature_get_Comments(self.Ptr))
        return ret


    @Comments.setter
    def Comments(self, value:str):
        GetDllLibPpt().IDigitalSignature_set_Comments.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IDigitalSignature_set_Comments(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IDigitalSignature_get_SignTime(self.Ptr)
    ...
    def SignTime(self, value:'DateTime'):
        ...
        GetDllLibPpt().IDigitalSignature_set_SignTime(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IDigitalSignature_get_IsValid(self.Ptr)
        return ret

    @IsValid.setter
    def IsValid(self, value:bool):
        GetDllLibPpt().IDigitalSignature_set_IsValid.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IDigitalSignature_set_IsValid(self.Ptr, value)
