...
class IEmbedImage (  IShape) :
    ...
    def ShapeLocking(self)->'SlidePictureLocking':
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_ShapeLocking(self.Ptr)
    ...
    def ShapeType(self)->'ShapeType':
        ...
        ret = GetDllLibPpt().IEmbedImage_get_ShapeType(self.Ptr)
    ...
    def ShapeType(self, value:'ShapeType'):
        ...
        GetDllLibPpt().IEmbedImage_set_ShapeType(self.Ptr, value.value)
    ...
    def PictureFill(self)->'PictureFillFormat':
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_PictureFill(self.Ptr)
    ...
    def ShapeStyle(self)->'ShapeStyle':
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_ShapeStyle(self.Ptr)
    ...
    def Adjustments(self)->'ShapeAdjustCollection':
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Adjustments(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_IsPlaceholder(self.Ptr)
        return ret
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Placeholder(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_TagsList(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Frame(self.Ptr)
    ...
    def Frame(self, value:'GraphicFrame'):
        ...
        GetDllLibPpt().IEmbedImage_set_Frame(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Line(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_ThreeD(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_EffectDag(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Fill(self.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Click(self.Ptr)
    ...
    def Click(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IEmbedImage_set_Click(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_MouseOver(self.Ptr)
        ret = None if intPtr==None else ClickHyperlink(intPtr)
        return ret
    ...
    def MouseOver(self, value:'ClickHyperlink'):
        ...
        GetDllLibPpt().IEmbedImage_set_MouseOver(self.Ptr, value.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_IsHidden(self.Ptr)
        return ret

    @IsHidden.setter
    def IsHidden(self, value:bool):
        GetDllLibPpt().IEmbedImage_set_IsHidden.argtypes=[c_void_p, c_bool]
        GetDllLibPpt().IEmbedImage_set_IsHidden(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Parent(self.Ptr)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_ZOrderPosition(self.Ptr)
        return ret
    ...
    def ZOrderPosition(self, value:int):
        ...
        GetDllLibPpt().IEmbedImage_set_ZOrderPosition(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_Rotation(self.Ptr)
        return ret

    @Rotation.setter
    def Rotation(self, value:float):
        GetDllLibPpt().IEmbedImage_set_Rotation.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IEmbedImage_set_Rotation(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_Left(self.Ptr)
        return ret

    @Left.setter
    def Left(self, value:float):
        GetDllLibPpt().IEmbedImage_set_Left.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IEmbedImage_set_Left(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_Top(self.Ptr)
        return ret

    @Top.setter
    def Top(self, value:float):
        GetDllLibPpt().IEmbedImage_set_Top.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IEmbedImage_set_Top(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_Width(self.Ptr)
        return ret

    @Width.setter
    def Width(self, value:float):
        GetDllLibPpt().IEmbedImage_set_Width.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IEmbedImage_set_Width(self.Ptr, value)
    ...
    <summary>
        ...
        ret = GetDllLibPpt().IEmbedImage_get_Height(self.Ptr)
        return ret

    @Height.setter
    def Height(self, value:float):
        GetDllLibPpt().IEmbedImage_set_Height.argtypes=[c_void_p, c_float]
        GetDllLibPpt().IEmbedImage_set_Height(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IEmbedImage_get_AlternativeText(self.Ptr))
        return ret


    @AlternativeText.setter
    def AlternativeText(self, value:str):
        GetDllLibPpt().IEmbedImage_set_AlternativeText.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IEmbedImage_set_AlternativeText(self.Ptr, value)
    ...
    <summary>
        ...
        ret = PtrToStr(GetDllLibPpt().IEmbedImage_get_Name(self.Ptr))
        return ret


    @Name.setter
    def Name(self, value:str):
        GetDllLibPpt().IEmbedImage_set_Name.argtypes=[c_void_p, c_wchar_p]
        GetDllLibPpt().IEmbedImage_set_Name(self.Ptr, value)
    ...
    <summary>
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Slide(self.Ptr)
        ret = None if intPtr==None else ActiveSlide(intPtr)
        return ret
    ...
    def Presentation(self)->'Presentation':
        ...
        intPtr = GetDllLibPpt().IEmbedImage_get_Presentation(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IEmbedImage_RemovePlaceholder(self.Ptr)
    ...
    <summary>
        ...
        GetDllLibPpt().IEmbedImage_Dispose(self.Ptr)
