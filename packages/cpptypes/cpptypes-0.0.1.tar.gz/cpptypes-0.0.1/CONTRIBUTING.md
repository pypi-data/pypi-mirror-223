...
Welcome to `ctypes-wrapper` contributor's guide.
...
If you experience bugs or general issues with `ctypes-wrapper`, please have a look
...
You can help improve `ctypes-wrapper` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`ctypes-wrapper` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `ctypes-wrapper`'s files. While this mechanism can
...
```
conda create -n ctypes-wrapper python=3 six virtualenv pytest pytest-cov
conda activate ctypes-wrapper
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/ctypes-wrapper.git
   cd ctypes-wrapper
   ```
...
5. Install [pre-commit]:
   ...
   `ctypes-wrapper` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/ctypes-wrapper
[issue tracker]: https://github.com/<USERNAME>/ctypes-wrapper/issues
