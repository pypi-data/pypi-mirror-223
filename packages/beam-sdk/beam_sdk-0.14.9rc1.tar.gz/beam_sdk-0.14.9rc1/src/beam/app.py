...
class Autoscaling:
    """
    [DEPRECATED] Configures autoscaling for your functions.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Example:
            ...
            @app.task_queue(autoscaler=QueueDepthAutoscaler(desired_latency=300))
            def tq1():
                pass

            @app.task_queue(autoscaler={"queue_depth": {"desired_latency": 300}})
            def tq2():
                pass
            ```
        """
