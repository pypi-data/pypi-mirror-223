    ...
    def register_app(self, app, prefix=None):
        ...
        def make_handler_for(path, func):
            def handler(msg):
                ...
                param_values = {k: (v if v is not None else parameters[k]) for k, v in param_values.items()}
                ...
                try:
                    ...
                    return self.reply(body=result, address=address)
                except Exception as e:
                    return self.fail(address=address, do_quit=False)
