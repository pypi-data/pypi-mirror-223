...
def setup_tracking_scene(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: typing.Optional[bool] = None):
    ''' Prepare scene for compositing 3D objects into this footage :File: `startup/bl_operators/clip.py\:973 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L973>`__
...
def track_settings_as_default(override_context: typing.
                              ...
                              execution_context: typing.Union[str, int] = None,
                              undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to default settings :File: `startup/bl_operators/clip.py\:1002 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1002>`__
...
def track_settings_to_track(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: typing.Optional[bool] = None):
    ''' Copy tracking settings from active track to selected tracks :File: `startup/bl_operators/clip.py\:1051 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1051>`__
