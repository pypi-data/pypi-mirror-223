...
def add_repeat_zone(override_context: typing.
                    Union[typing.Dict, 'bpy.types.Context'] = None,
                    execution_context: typing.Union[str, int] = None,
                    undo: typing.Optional[bool] = None,
                    *,
...
def new_geometry_node_group_tool(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Create a new geometry node group for an tool :File: `startup/bl_operators/geometry_nodes.py\:271 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L271>`__
...
def panel_add(override_context: typing.Union[typing.
              ...
              execution_context: typing.Union[str, int] = None,
              undo: typing.Optional[bool] = None):
    ''' Add a new panel to the tree :File: `startup/bl_operators/node.py\:280 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L280>`__
...
def panel_move(override_context: typing.
    ...
    ''' Move a panel to another position :File: `startup/bl_operators/node.py\:324 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L324>`__
...
def panel_remove(override_context: typing.
                 ...
                 execution_context: typing.Union[str, int] = None,
                 undo: typing.Optional[bool] = None):
    ''' Remove a panel from the tree :File: `startup/bl_operators/node.py\:300 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L300>`__
...
def repeat_zone_item_add(override_context: typing.
                         ...
                         execution_context: typing.Union[str, int] = None,
                         undo: typing.Optional[bool] = None):
    ''' Add a repeat item to the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:412 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L412>`__
...
def repeat_zone_item_move(override_context: typing.
                          ...
                          *,
                          direction: typing.Optional[typing.Any] = 'UP'):
    ''' Move a repeat item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:462 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L462>`__
...
def repeat_zone_item_remove(override_context: typing.
                            ...
                            execution_context: typing.Union[str, int] = None,
                            undo: typing.Optional[bool] = None):
    ''' Remove a repeat item from the repeat zone :File: `startup/bl_operators/geometry_nodes.py\:439 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L439>`__
...
def simulation_zone_item_add(override_context: typing.
                             ...
                             execution_context: typing.Union[str, int] = None,
                             undo: typing.Optional[bool] = None):
    ''' Add a state item to the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:313 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L313>`__
...
def simulation_zone_item_move(override_context: typing.
                              ...
                              *,
                              direction: typing.Optional[typing.Any] = 'UP'):
    ''' Move a simulation state item up or down in the list :File: `startup/bl_operators/geometry_nodes.py\:363 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L363>`__
...
def simulation_zone_item_remove(
        ...
        execution_context: typing.Union[str, int] = None,
        undo: typing.Optional[bool] = None):
    ''' Remove a state item from the simulation zone :File: `startup/bl_operators/geometry_nodes.py\:340 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L340>`__
