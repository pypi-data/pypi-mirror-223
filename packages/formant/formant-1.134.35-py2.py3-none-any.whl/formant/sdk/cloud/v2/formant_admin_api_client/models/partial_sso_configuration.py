...
from ..models.partial_sso_configuration_authentication_flow import PartialSsoConfigurationAuthenticationFlow
...
class PartialSsoConfiguration:
    ...
    Attributes:
        ...
        default_role_id (Union[Unset, None, str]):
        default_team_id (Union[Unset, None, str]):
    ...
    default_role_id: Union[Unset, None, str] = UNSET
    default_team_id: Union[Unset, None, str] = UNSET
