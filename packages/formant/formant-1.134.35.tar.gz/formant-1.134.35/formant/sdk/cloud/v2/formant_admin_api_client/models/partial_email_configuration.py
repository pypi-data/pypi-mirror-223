...
from ..models.partial_email_configuration_email_type import PartialEmailConfigurationEmailType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PartialEmailConfiguration")


@attr.s(auto_attribs=True)
class PartialEmailConfiguration:
    """
    Attributes:
        ...
        email_type (Union[Unset, PartialEmailConfigurationEmailType]):
    ...
    email_type: Union[Unset, PartialEmailConfigurationEmailType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_email_type, Unset):
            ...
            email_type = PartialEmailConfigurationEmailType(_email_type)
        ...
        partial_email_configuration = cls(
        ...
        partial_email_configuration.additional_properties = d
        return partial_email_configuration
