...
from ..models.partial_stateful_event_severity import PartialStatefulEventSeverity
from ..models.partial_stateful_event_stream_type import PartialStatefulEventStreamType
from ..models.partial_stateful_event_type import PartialStatefulEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.partial_stateful_event_metadata import PartialStatefulEventMetadata
    from ..models.partial_stateful_event_tags import PartialStatefulEventTags


T = TypeVar("T", bound="PartialStatefulEvent")


@attr.s(auto_attribs=True)
class PartialStatefulEvent:
    """
    Attributes:
        type (Union[Unset, PartialStatefulEventType]):
        severity (Union[Unset, PartialStatefulEventSeverity]):
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, PartialStatefulEventTags]):
        organization_id (Union[Unset, str]):
        time (Union[Unset, datetime.datetime]):
        end_time (Union[Unset, None, datetime.datetime]):
        parent_id (Union[Unset, str]):
        metadata (Union[Unset, PartialStatefulEventMetadata]):
        message (Union[Unset, str]):
        viewed (Union[Unset, bool]):
        device_id (Union[Unset, None, str]):
        stream_name (Union[Unset, None, str]):
        stream_type (Union[Unset, None, PartialStatefulEventStreamType]):
        event_trigger_id (Union[Unset, None, str]):
        notification_enabled (Union[Unset, bool]):
    """

    type: Union[Unset, PartialStatefulEventType] = UNSET
    severity: Union[Unset, PartialStatefulEventSeverity] = UNSET
    id: Union[Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    tags: Union[Unset, "PartialStatefulEventTags"] = UNSET
    organization_id: Union[Unset, str] = UNSET
    time: Union[Unset, datetime.datetime] = UNSET
    end_time: Union[Unset, None, datetime.datetime] = UNSET
    parent_id: Union[Unset, str] = UNSET
    metadata: Union[Unset, "PartialStatefulEventMetadata"] = UNSET
    message: Union[Unset, str] = UNSET
    viewed: Union[Unset, bool] = UNSET
    device_id: Union[Unset, None, str] = UNSET
    stream_name: Union[Unset, None, str] = UNSET
    stream_type: Union[Unset, None, PartialStatefulEventStreamType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = PartialStatefulEventType(_type)
        ...
        if isinstance(_severity, Unset):
            ...
            severity = PartialStatefulEventSeverity(_severity)
        ...
        if isinstance(_tags, Unset):
            ...
            tags = PartialStatefulEventTags.from_dict(_tags)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = PartialStatefulEventMetadata.from_dict(_metadata)
        ...
        partial_stateful_event.additional_properties = d
        return partial_stateful_event
