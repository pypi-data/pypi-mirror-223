...
def gen_gx_v2_voice(texts, output_dir, server_url=None, voice_num=None, wav_type='all', tts_server_name='gx_v2'):
    if not server_url:
...
def gen_voice(texts, output_dir, server_url=None, bridge_server_url=None, voice_num=None, wav_type='all',
    ...
    if tts_server_name == 'gx':
        ...
        return gen_gx_v2_voice(texts, output_dir, server_url, voice_num, wav_type)
    else:
        max_process_num = 1
