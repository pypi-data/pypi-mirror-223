...
[![CI](https://github.com/kpfleming/jinjanator-plugin-format-toml/workflows/CI%20checks/badge.svg)](https://github.com/kpfleming/jinjanator-plugin-format-toml/actions?query=workflow%3ACI%20checks)
