...
class WorkspaceServiceStub(betterproto.ServiceStub):
    ...
    async def get_workspace_revision_history(
        self, *, workspace_id: int = 0
    ) -> GetWorkspaceAuditLogResponse:
        """Get the revision history of a workspace"""

        request = SinglePathParamWorkspaceIdRequest()
        request.workspace_id = workspace_id

        return await self._unary_unary(
            "/com.bigeye.models.generated.WorkspaceService/GetWorkspaceRevisionHistory",
            request,
            GetWorkspaceAuditLogResponse,
        )
