...
class DeviceStateSyncDataEventsResponse(JsonApiResponsePayload):
...
#         ).check().payload_raw    # type: ignore
    ...
    def get_events_to_sync_api_user_data(
        ...
        if offset is not None:
            q['offset'] = offset
        return self._api_device.request_get(f'/device-state-sync-offsets/{device_state_sync_offset_id}/events', q=q).typed(List[DeviceStateSyncDataResponse]).check()
