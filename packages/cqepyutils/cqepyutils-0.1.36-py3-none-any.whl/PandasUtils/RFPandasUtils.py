...
@keyword("Compare All File Contents In Directories")
def df_diff1(actual_file_path_name: str, expected_file_path_name: str, report_type: str = 'all',
            delimiter: str = ',', has_header: bool = True, width: list = None, colspecs: list = None,
            column_names: list = None, dtypes: dict = None, encoding: str = 'ISO-8859-1', on_bad_lines: str = 'warn',
            skiprows: int = 0, skipfooter: int = 0, key_columns: list = None, ignore_columns: list = None):
    """
    Compare the difference between two files' contents and generate a detailed mismatch report.
    ...
    # (existing function code as it is)

    # Step-07: Create the summary report based on count diff, duplicate rows and key mismatches
    ...
    # Step-09 to Step-12: Continue with the comparison steps as before
