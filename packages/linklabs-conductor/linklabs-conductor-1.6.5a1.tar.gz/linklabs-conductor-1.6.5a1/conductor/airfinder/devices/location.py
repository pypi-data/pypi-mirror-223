...
class LocationDownlinkMessageSpecV1(DownlinkMessageSpec):
    ...
    header = {"def": ["msg_type", "msg_spec_vers"], "struct": ">BB", "defaults": [0x00, 0x01]}
    ...
    msg_types = {
        ...
        "Reset": {"def": ["reset_code"], "struct": ">I", "defaults": [0xD5837ED6]},
    }
...
class LocationDownlinkMessageSpecV4(LocationDownlinkMessageSpecV3):
    ...
    def __init__(self):
        ...
        self.msg_types.update(
            {
                "MakeTestTag": {"def": ["code"], "struct": ">I", "defaults": [0x66363538]},
                "ChangeNetToken": {
...
class Location(Node):
    ...
    @classmethod
    def multicast_configure(cls, vers, gws, ttl_s=60, access_point=None, ap_vers=None, **kwargs):
    ...
    def factory_reset(self, ttl_s, access_point=None):
        ...
        """
        vers = self.msg_spec_version
        pld = self._get_spec(vers).build_message(
            "Configuration",
            mask=0x0,
            adv_en=0x19,
            schedule=b"\xeb\x73\x0c\x54\x02\xce\x64\xc8\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00\x00\x00\x00",
            heartbeat=0x0,
        )
        return self._send_message(pld, ttl_s, access_point)

    @classmethod
    def multicast_factory_reset(cls, vers, gws, ttl_s=60, access_point=None, ap_vers=None):
        ...
        Returns:
            ...
            :class:`.DownlinkMessage` when sent to an individual AP.
        """
        pld = cls._get_spec(vers).build_message(
            "Configuration",
            mask=0x0,
            adv_en=0x19,
            schedule=b"\xeb\x73\x0c\x54\x02\xce\x64\xc8\x00\x00\x00\x00\x00\x00" b"\x00\x00\x00\x00\x00\x00\x00",
    ...
    @classmethod
    def multicast_reset(cls, vers, gws, ttl_s=60, access_point=None, ap_vers=None):
