...
class ArcVectorClient(ArcVectorBase):
    ...
    .. note::
        ...
        - :meth:`ArcVectorClient.grpc_points`
        - :meth:`ArcVectorClient.grpc_collections`
        - :meth:`ArcVectorClient.rest`

    .. note::
        If you need to use async versions of API, please consider using raw implementations of clients directly:

        - For REST: :class:`~arc_vector_client.http.api_client.AsyncApis`
        - For gRPC: :class:`~arc_vector_client.grpc.PointsStub` and :class:`~arc_vector_client.grpc.CollectionsStub`
    ...
    Args:
        ...
        prefix:
            ...
            Example: `service/v1` will result in `http://localhost:6333/service/v1/{arc-vector-endpoint}` for REST API.
            Default: `None`
        timeout:
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            positive:
                ...
                If there are more than one IDs, ArcVector will attempt to search for similar to all of them.
