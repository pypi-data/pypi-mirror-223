...
class ArcVectorLocal(ArcVectorBase):
    """
    ...
    def _load(self) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                f"Storage folder {self.location} is already accessed by another instance of ArcVector client."
                f" If you require concurrent access, use ArcVector server instead."
            )
