...
* Google Credentials
  ...
  * Activate the Google Calendar API ([details here](https://developers.google.com/workspace/guides/enable-apis))
...
[![First Automation](https://developers.botcity.dev/github/readme/python-plugins/googlecalendar-plugin.png)](https://documentation.botcity.dev/plugins/)
