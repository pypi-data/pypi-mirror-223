...
class PathValues(str, enum.Enum):
    ...
    PROJECTS_ID_EVALUATIONTESTSETS = "/projects/{id}/evaluation-testsets"
    PROJECTS_ID_EVALUATIONRUNS = "/projects/{id}/evaluation-runs"
    ...
    TRACES = "/traces"
    EVALUATIONRUNS_ID = "/evaluation-runs/{id}"
    EVALUATIONRUNS_ID_TESTCASES = "/evaluation-runs/{id}/testcases"
