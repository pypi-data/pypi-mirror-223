...
if __name__ == '__main__':
    print(read_json('test_data.json', key='names'))
    print(read_yaml('test_data.yml', key='names'))
    print(read_csv('test_data.csv', row=1))
    print(read_excel('test_data.xlsx', row=1))
