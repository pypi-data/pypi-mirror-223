...
class TestParameter(kuto.Case):
    ...
    @kuto.file_data(file='test_data/data.json')
    def test_json(self, param):
        print(param)

    @kuto.file_data(file='test_data/data.yml', key='names')
    def test_yaml(self, param):
        print(param)

    @kuto.file_data(file='test_data/data.csv')
    def test_csv(self, param):
        print(param)

    @kuto.file_data(file='test_data/data.xlsx', row=1)
