...
# region web
async def region_web(BOT_TID, POST_ID, POST_TYPE, POST_TEXT, POST_LNK, POST_BUTTON, MEDIA_D, BASE_D, bot_username):
    result = None
    try:
        ...
        data_views = await db_select(sql, (POST_ID, 'PST',), BASE_BOT)
        msg_views = len(ast.literal_eval(data_views[0][0])) if data_views and data_views[0][0] else '0'
