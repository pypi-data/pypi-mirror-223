...
<head>
    ...
    <style>
        ...
        *,*::before, *::after {{ box-sizing: inherit; font-family: Arial, sans-serif; color: rgba(40, 40, 40, 0.99);}}
        ...
        .container-wrapper {{ max-width: 1270px; height: 100vh;  padding: 0 4px; margin: 0 auto; display: flex; flex-direction: column; justify-content: space-between; gap: 4px; }}
        .container {{ display: flex; flex-direction: column; align-items: center; justify-content: flex-start; font-size: 14px; gap: 4px; }}
        
        .media-wrapper {{ position: relative; width: 100%; min-height: 33vh; display: flex; justify-content: center; align-items: flex-start; }}
...
<body>
    <div class="container-wrapper">
        ...
        <div class="footer">
            <div style="color: rgba(140, 150, 160, 0.99);">👁 {3}</div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", async () => {{
            ...
            async function updateMedia() {{
                ...
                const mediaNumber = document.getElementById('media-number');
        ...
        for (let i = 0; i < buttonsClass.length; i++) {{
            buttonsClass[i].addEventListener('click', async () => {{
                await handleButtonClick(buttonsClass[i]);
            }});
        }}
    </script>
</body>
    ...
    try:
        ...
        cur.execute('''CREATE TABLE IF NOT EXISTS VIEW ( 
            VIEW_ID         INTEGER     PRIMARY KEY AUTOINCREMENT
                                        UNIQUE
                                        NOT NULL,
            ENT_VID         VARCHAR     UNIQUE NOT NULL,
