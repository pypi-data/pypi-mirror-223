...
<head>
    ...
    <style>
        ...
        *,*::before, *::after {{ box-sizing: inherit; font-family: Arial, sans-serif; color: rgba(40, 40, 40, 0.99);}}
        ...
        .media-wrapper {{ width: 100%; min-height: 33vh; display: flex; justify-content: center; align-items: flex-start; }}
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", async () => {{
            let roundedMedia = document.querySelectorAll('.rounded-media')
