...
latex_documents = [
    (master_doc, "Loafer.tex", "Loafer Documentation", "George Y. Kussumoto", "manual"),
]
...
man_pages = [(master_doc, "loafer", "Loafer Documentation", [author], 1)]
