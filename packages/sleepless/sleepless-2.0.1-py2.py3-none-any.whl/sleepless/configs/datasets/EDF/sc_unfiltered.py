...
dataset = raw.subsets("sc-unfiltered")

dataset_as_test = {
    "edf_sc_unfil_train": dataset["train"],
    "edf_sc_unfil_validation": dataset["validation"],
    "edf_sc_unfil_test": dataset["test"],
}
