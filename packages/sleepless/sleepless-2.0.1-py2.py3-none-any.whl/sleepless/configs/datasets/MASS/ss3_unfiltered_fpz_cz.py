...
In this protocol Fpz-LER and Cz-LER have been computed respectively using the mean of (Fp1-LER and Fp2-LER), (C3-LER and C4-LER).
Then 2 Bipolar reference have been computed Fpz-Cz (Fpz-LER and Cz-LER) and Pz-Oz (Fpz-LER and Cz-LER)


* Reference: [MASS-2014]_
* Protocol ``ss3-unfiltered-fpz-cz``:
...
dataset = raw.subsets("ss3-unfiltered-fpz-cz-100Hz")

dataset_as_test = {
    "mass_ss3_unfil_train": dataset["train"],
    "mass_ss3_unfil_validation": dataset["validation"],
    "mass_ss3_unfil_test": dataset["test"],
}
