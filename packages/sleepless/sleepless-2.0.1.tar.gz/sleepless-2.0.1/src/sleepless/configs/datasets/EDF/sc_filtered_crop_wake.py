...
In this protocol all the raw data have been filtered with a pass band filter [0.3,30] Hz. Only 30 minutes
 of the wake times have been kept before and after the night.

* Reference: [SLEEP_EDF-2018]_
* Protocol ``sc-filtered-crop-wake``:
...
dataset = raw.subsets("sc-filtered-crop-wake")

dataset_as_test = {
    "edf_sc_crop_train": dataset["train"],
    "edf_sc_crop_validation": dataset["validation"],
    "edf_sc_crop_test": dataset["test"],
}
