...
Train split = train split edf_st, train split edf_sc

Validation split = validation split edf_st, validation split edf_sc

Test split = test split edf_st, test split edf_sc train,
             split mass_ss3, validation split mass_ss3, test split mass_SS3,
...
dataset = mix_st_sc | ss3_dataset | sc_dataset_crop
