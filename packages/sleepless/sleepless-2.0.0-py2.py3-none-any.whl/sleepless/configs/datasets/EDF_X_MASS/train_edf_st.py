...
Train split = train split edf_st,

Validation split = validation split edf_st

Test split = test split edf_st, train split mass_ss3, validation split mass_ss3, test split mass_SS3,
             train split edf_sc, validation split edf_sc, test split edf_sc,
"""
...
dataset = st_dataset | sc_dataset | ss3_dataset
