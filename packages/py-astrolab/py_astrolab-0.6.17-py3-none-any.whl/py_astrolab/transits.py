...
class Transits():
    def __init__(self, 
        ...
        self.user = user
        self.tz_str = timezone(tz_str)
        local_start = self.tz_str.localize(start, is_dst=None)
        local_end = self.tz_str.localize(end, is_dst=None)
        self.start = local_start.astimezone(utc)
        self.end = local_end.astimezone(utc)
