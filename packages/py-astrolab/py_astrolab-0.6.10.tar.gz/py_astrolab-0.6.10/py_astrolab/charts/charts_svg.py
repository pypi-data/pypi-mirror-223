...
class MakeSvgInstance:
    ...
    def __transitRing(self, r):
        ...
        outer_ring = '<circle cx="%s" cy="%s" r="%s" style="fill: none; stroke: black; stroke-width: 35px; stroke-opacity: .1; filter: url(#%s);"/>' % (
            r, r, r, filter_id)
        ...
        inner_ring += '<circle cx="%s" cy="%s" r="%s" style="fill: none; stroke: %s; stroke-width: 1px; stroke-opacity: .6;"/>' % (
    ...
    def __drawAspect(self, r, ar, aspect_dict, aspect_id: str, isAxis=False, cut_by=8.4):
    ...
    def __makeHouses(self, r):
        ...
        for i in range(xr):
            ...
            if i+1 == 1:
                ...
                house_number = i+1
            if self.chart_type == 'Transit' or self.chart_type == 'Natal':
                text_k = 90
    ...
    def __makeAxis(self, r, ar, source, cut_by):
        out = ''
        axis_stroke_opacity = '.7'
        for axis in source:
            if axis.name in {'Ascendant', 'Midheaven'}:
                ...
                if axis_data:
                    ...
                    out += arrow_top + self.__drawAspect(r, ar, aspect_dict, axis_id, True, cut_by)
    ...
    def makeTemplate(self):
        ...
        if self.chart_type == "Transit" or self.chart_type == "Composite":
            ...
            td['transitRingAxes'] = self.__makeAxis(r, (r-self.c1+18.4), self.t_user.axis_list, 9.7)
            ...
            td['makePatterns'] = ''
            td['makeAxis'] = self.__makeAxis(r, (r-self.c1-18), self.user.axis_list, 8.4)
            ...
            td['makeAxis'] = self.__makeAxis(r, (r-self.c1+30), self.user.axis_list, 8.4)
