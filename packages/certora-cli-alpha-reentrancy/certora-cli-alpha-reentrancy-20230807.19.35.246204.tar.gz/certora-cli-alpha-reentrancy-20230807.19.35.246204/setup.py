...
if __name__ == "__main__":
    setuptools.setup(
        name="certora-cli-alpha-reentrancy",
        version="20230807.19.35.246204",
        author="Certora",
        author_email="support@certora.com",
        description="Runner for the Certora Prover",
        long_description="Commit 6bd8bf8. Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
        long_description_content_type="text/markdown",
        url="https://pypi.org/project/certora-cli-alpha-reentrancy",
