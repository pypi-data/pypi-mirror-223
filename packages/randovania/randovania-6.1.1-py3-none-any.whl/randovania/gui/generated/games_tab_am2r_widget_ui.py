...
class Ui_AM2RGameTabWidget(object):
    def setupUi(self, AM2RGameTabWidget):
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 529, 1812))
    ...
    def retranslateUi(self, AM2RGameTabWidget):
        ...
        self.differences_label.setText(QCoreApplication.translate("AM2RGameTabWidget", u"<html><head/><body><p>Randovania makes some changes to the original game in order to improve the game experience or to simply fix bugs in the original game.<br/>Many changes are optional and can be disabled in the options Randovania provides, but the following are <span style=\" font-weight:600;\">always</span> there:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The game will now use a different save directory.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The lava progression system has been changed. There is no lava in the game tied to Metroids anymore, which means you can access any area. However, in order to reach the Queen, you now have to collect 46 total DNA, with Randovania having an option on how much DNA you want to start with / stil"
                        ...
                        ":12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The stats on the map screen have been revamped. They now show your current Health/Ammo and total Health / Ammo, instead of the amount of expansions you collected / total amount of expansions. A current DNA / total DNA counter has also been added.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">An option has been added to the pause menu that allows loading your last save, but spawning at your starting location instead of at the save station.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The final Chozo log entry in the Genetics Laboratory has been changed to give an Ice Beam hint.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Hints have been placed to reveal the location of DNA. These Hints a"
                        "re given by Wisdom Septoggs. They can be found in &quot;Main Caves - Research Site Storage&quot;, &quot;Golden Temple - Breeding Grounds Hub&quot;, &quot;Hydro Station - Breeding Grounds Lobby&quot;, &quot;Industrial Complex - Breeding Grounds Fly Stadium&quot;, &quot;The Tower - Tower Exterior North&quot;, &quot;Distribution Center - Distribution Facility Tower East&quot; and &quot;The Nest - Depths Shinespark Cave&quot;.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">All Doors have been changed to use the look they have in Distribution Center. Their sprites have also been changed for accessibility reasons.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Normal Game, New Game+ and Random Game+ have all been replaced with a &quot;Randovania&quot; mode.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-li"
                        "st-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Higher Difficulties don't reduce the amount of ammo per expansion. If you want that functionality, use Randovania's built-in feature to reduce the amount of ammo per expansion.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Fusion Mode has been slightly revamped. The in-game difficulty has been changed to only deal 4x damage and is now named &quot;Brutal&quot;. The option to add the X Parasites and play with the Fusion Suit has been moved to a Randovania setting. This means, it is now possible to play with a 4x damage multiplier without the X Parasites, or to play with the X Parasites on Normal.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Brutal difficulty, the extra settings, and the ability to show the ammo s"
                        "tats on the pause screen don't require you to finish the game once, but instead are all unlocked by default.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The &quot;Varia Suit obtained&quot; cutscene was missing a visual effect; this has been restored.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">When going through a Missile /Super Missile / Power Bomb door from behind, you automatically clear that door, without needing to hit it with the appropriate weapon.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Fighting the Tester before activating the Tower now enlightens the room during the fight.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Proboscums will be active without needing to activa"
                        "te the Tower.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Defeating Tester does not automatically enable the Tower anymore.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">EMP puzzles don't unlock all doors in the room anymore, but only relevant ones.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The door to Plasma Chamber will now be blue after defeating Tester, instead of of red.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Larva Metroids will now always give ammo drops when necessary, instead of having a small chance to drop nothing.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The file selection screen"
                        " will now show a hash of the current seed.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The Item in Gravity Chamber will now always be in the open, with the Gravity Pod cutscene being disabled.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The bomb blocks in &quot;The Tower - Tower Exterior North&quot; will now always be gone if you come from the bottom room.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">When going down the Elevator from GFS Thoth, the Power Bomb Blocks will be automatically gone if you haven't cleared them before, as otherwise you'd be stuck.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Long Range Activation has been enabled for every room, allowing for more Zip strats"
                        ".</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">In GFS Thoth, both sides on the &quot;Thoth Bridge&quot; now have doors added for better Door Lock Randomizer compatibility.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">In Hydro Station, the connection from &quot;Water Turbine Station&quot; to &quot;Hydro Station Exterior&quot; now has a door for better Door Lock Randomizer compatibility.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The Geothermal Power Plant is always in its exploded state. The Power Bomb Expansion that was located there has been moved to &quot;Power Plant Destroyed Shaft&quot;.</li></ul></body></html>", None))
