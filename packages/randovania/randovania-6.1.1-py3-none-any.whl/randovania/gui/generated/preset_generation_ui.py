...
class Ui_PresetGeneration(object):
    def setupUi(self, PresetGeneration):
        ...
        self.scroll_contents.setGeometry(QRect(0, -112, 542, 907))
        ...
        self.single_set_for_pickups_that_solve_check = QCheckBox(self.logic_group)
        self.single_set_for_pickups_that_solve_check.setObjectName(u"single_set_for_pickups_that_solve_check")

        self.verticalLayout_4.addWidget(self.single_set_for_pickups_that_solve_check)

        self.staggered_multi_pickup_placement_check = QCheckBox(self.logic_group)
        self.staggered_multi_pickup_placement_check.setObjectName(u"staggered_multi_pickup_placement_check")

        self.verticalLayout_4.addWidget(self.staggered_multi_pickup_placement_check)
    ...
    def retranslateUi(self, PresetGeneration):
        ...
        self.single_set_for_pickups_that_solve_check.setText(QCoreApplication.translate("PresetGeneration", u"[Experimental] Attempt to remove redundant pickup alternatives as actions for the generator", None))
        self.staggered_multi_pickup_placement_check.setText(QCoreApplication.translate("PresetGeneration", u"[Experimental] Stagger placement of pickups across actions", None))
