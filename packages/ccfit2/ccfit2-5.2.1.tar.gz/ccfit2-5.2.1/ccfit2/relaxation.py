...
class FitWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, dataset: TauTDataset | TauHDataset, usel: object,
        ...
        gui.convert_log_ticks_to_lin(ax, np.log10(self.exp_xvals), shift=self.logshift)
    ...
    def calculate_residual_value(self) -> float:
        ...
        -------
        float
            Residual sum of squares. Defined as sum((log10(exp) - log10(calc))**2)
        '''
...
def _plot_fitted_times(dataset: TauTDataset | TauHDataset,
    ...
    for logmodel in logmodels:
        ...
        # Discard model rates slower than threshold, else these dominate the plot
        thresh = 1E-10
