...
class PoseMeasure:
    ...
    def getEyeNosePlane(self, dimension, direction):
    ...
    def getEyeNoseMinusPlane(self, dimension, sDimension, standard):
    ...
    def getNoseShoulderHipMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getNoseShoulderCenterPlane(self, dimension):
    ...
    def getNoseHipMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getNoseShoulderMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getNoseShoulderPlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderPlusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderDistance(self, dimension):
        return self.getDistance(self.leftShoulder, self.rightShoulder, dimension)        


    def getShoulderHipDistance(self, dimension, direction):
    ...
    def getNoseShoulderDistance(self, dimension, direction):
    ...
    def getNoseShoulderPlusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getNoseShoulderMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderKneeDistance(self, dimension, direction):
    ...
    def getShoulderWristDistance(self, dimension, direction):
    ...
    def getShoulderElbowDistance(self, dimension, direction):
    ...
    def getShoulderHipPlusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderHipMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderKneeMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderElbowMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderNoseHipAngle(self, dimension, direction):
    ...
    def getShoulderElbowHipAngle(self, dimension, direction):
    ...
    def getShoulderWristHipAngle(self, dimension, direction):
    ...
    def getShoulderWristHipMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderNoseHipMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderElbowHipPlusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderWristShoulderAngle(self, dimension, direction):
    ...
    def getShoulderElbowShoulderAngle(self, dimension, direction):
    ...
    def getShoulderElbowHipMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderPlane(self, dimension):
        return self.getPlane(self.leftShoulder, self.rightShoulder, dimension)            


    def getShoulderHipPlane(self, dimension, direction):
    ...
    def getShoulderElbowPlane(self, dimension, direction):
    ...
    def getShoulderHipMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderElbowMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderHipPlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderHipMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderElbowPlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderElbowMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderPlusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getShoulderMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowPlusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowDistance(self, dimension):
        return self.getDistance(self.leftElbow, self.rightElbow, dimension)        


    def getElbowWristDistance(self, dimension, direction):
    ...
    def getElbowShoulderDistance(self, dimension, direction):
    ...
    def getElbowWristShoulderAngle(self, dimension, direction):
    ...
    def getElbowWristShoulderPlusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowWristShoulderMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowWristPlane(self, dimension, direction):
    ...
    def getElbowWristMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowWristMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowPlusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getElbowMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipDistance(self, dimension):
        return self.getDistance(self.leftHip, self.rightHip, dimension)        


    def getHipKneeDistance(self, dimension, direction):
    ...
    def getHipWristDistance(self, dimension, direction):
    ...
    def getHipAnkleDistance(self, dimension, direction):
    ...
    def getHipKneePlusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneeMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipAnkleMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneeHipAngle(self, dimension, direction):
    ...
    def getHipKneeKneeAngle(self, dimension, direction):
    ...
    def getHipKneeShoulderAngle(self, dimension, direction):
    ...
    def getHipKneeHipMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneeKneeMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipAnkleShoulderAngle(self, dimension, direction):
    ...
    def getHipKneeShoulderPlusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneeShoulderMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipAnkleShoulderMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipPlane(self, dimension):
        return self.getPlane(self.leftHip, self.rightHip, dimension)            


    def getHipKneePlane(self, dimension, direction):
    ...
    def getHipKneeMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneePlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipKneeMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipAnklePlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipAnkleMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getHipMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristDistance(self, dimension):
        return self.getDistance(self.leftWrist, self.rightWrist, dimension)        


    def getWristHipDistance(self, dimension, direction):
    ...
    def getWristKneeDistance(self, dimension, direction):
    ...
    def getWristIndexDistance(self, dimension, direction):
    ...
    def getWristShoulderDistance(self, dimension, direction):
    ...
    def getWristHipMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristKneePlusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristKneeMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristShoulderMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristElbowIndexAngle(self, dimension, direction):
    ...
    def getWristElbowPinkyAngle(self, dimension, direction):
    ...
    def getWristElbowIndexPlusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristElbowPinkyMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristElbowIndexMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristThumbPlane(self, dimension, direction):
    ...
    def getWristPinkyPlane(self, dimension, direction):
    ...
    def getWristPinkyMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristThumbMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristPlusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getWristMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getPinkyMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeDistance(self, dimension):
        return self.getDistance(self.leftKnee, self.rightKnee, dimension)        


    def getKneeAnkleDistance(self, dimension, direction):
    ...
    def getKneeAnkleMinusDistance(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeHipAnkleAngle(self, dimension, direction):
    ...
    def getKneeHipAnklePlusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeHipAnkleMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeAnklePlane(self, dimension, direction):
    ...
    def getKneeAnkleMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeAnklePlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeAnkleMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getKneeMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleMinusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnklePlusPoint(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleDistance(self, dimension):
        return self.getDistance(self.leftAnkle, self.rightAnkle, dimension)        


    def getAnkleKneeFootIndexAngle(self, dimension, direction):
    ...
    def getAnkleFootIndexAnkleAngle(self, dimension, direction):
    ...
    def getAnkleKneeFootIndexMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleFootIndexHeelAngle(self, dimension, direction):
    ...
    def getAnkleFootIndexHeelMinusAngle(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnklePlane(self, dimension):
        return self.getPlane(self.leftAnkle, self.rightAnkle, dimension)            


    def getAnkleFootIndexPlane(self, dimension, direction):
    ...
    def getAnkleFootIndexMinusPlane(self, dimension, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleFootIndexMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleFootIndexPlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnklePlusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getAnkleMinusNumber(self, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getFootIndexHeelMinusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getFootIndexHeelPlusLine(self, dimension, line, sDimension, standard):
        standard = int(standard)
        left = self.pose[standard-1] if standard % 2 == 0 else self.pose[standard]
        right = self.pose[standard] if standard % 2 == 0 else self.pose[standard+1]
    ...
    def getOnlyForDumbbellFlySide (self):
        pass

        
    def getOnlyForStandingBandRowShoulder (self):
        elbowShoulderDistance = self.getShoulderElbowMinusDistance(XY, Z, LEFT_HIP)
    ...
    def getOnlyForDumbbellFly (self):
        shoulderWristDistance = self.getShoulderWristMinusDistance(XY, Z, LEFT_HIP)
        shoulderHipDistance = self.getShoulderHipMinusDistance(XY, Z, LEFT_HIP)
