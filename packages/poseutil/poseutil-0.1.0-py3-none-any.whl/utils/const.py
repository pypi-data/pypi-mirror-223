...
LSTM_PATH = "/Volumes/FrameData/lstmData"
LINUX_LSTM_PATH = "/home/jinwoo/jinwoo/lstmData"

POSE_MEASURE_SAVE_PATH = DIR_PATH + "/utils/poseMeasure.py"
#------------------------------------------------------------------------
# list view Setup
EMBEDDINGLIST = ["UPPER", "BODYNOSE", "LOWER","FULL", "HAND"]
