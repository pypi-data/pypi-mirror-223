...
def _arith_binary_func(lhs, rhs, c_func):
    ...
    if not (is_left_array or is_right_array):
        raise TypeError("Atleast one input needs to be of type flarepy.array")
...
def cast(a, dtype):
    ...
    """
    out=Array()
    safe_call(backend.get().flare_cast(c_pointer(out.arr), a.arr, dtype.value))
    return out
...
def minof(lhs, rhs):
    ...
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_minof)
...
def maxof(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_maxof)
...
def clamp(val, low, high):
    ...
    safe_call(backend.get().flare_clamp(c_pointer(out.arr), val.arr, low_arr, high_arr, _bcast_var.get()))
...
def mod(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_mod)
...
def rem(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_rem)
...
def abs(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_abs)
...
def arg(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_arg)
...
def sign(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_sign)
...
def round(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_round)
...
def trunc(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_trunc)
...
def floor(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_floor)
...
def ceil(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_ceil)
...
def hypot(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_hypot)
...
def sin(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_sin)
...
def cos(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_cos)
...
def tan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_tan)
...
def asin(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_asin)
...
def acos(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_acos)
...
def atan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_atan)
...
def atan2(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_atan2)
...
def cplx(lhs, rhs=None):
    ...
    """
    if rhs is None:
        return _arith_unary_func(lhs, backend.get().flare_cplx)
    else:
        return _arith_binary_func(lhs, rhs, backend.get().flare_cplx2)
...
def real(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_real)
...
def imag(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_imag)
...
def conjg(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_conjg)
...
def sinh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_sinh)
...
def cosh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_cosh)
...
def tanh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_tanh)
...
def asinh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_asinh)
...
def acosh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_acosh)
...
def atanh(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_atanh)
...
def root(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_root)
...
def pow(lhs, rhs):
    ...
    - If `lhs` and `rhs` are both fly.Array, they must be of same size.
    """
    return _arith_binary_func(lhs, rhs, backend.get().flare_pow)
...
def pow2(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_pow2)
...
def sigmoid(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_sigmoid)
...
def exp(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_exp)
...
def expm1(a):
    ...
    """
    return _arith_unary_func(a, backend.get().flare_expm1)
...
def erf(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_erf)
...
def erfc(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_erfc)
...
def log(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_log)
...
def log1p(a):
    ...
    - This function provides a more stable result for small values of `a`.
    """
    return _arith_unary_func(a, backend.get().flare_log1p)
...
def log10(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_log10)
...
def log2(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_log2)
...
def sqrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_sqrt)
...
def rsqrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_rsqrt)
...
def cbrt(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_cbrt)
...
def factorial(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_factorial)
...
def tgamma(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_tgamma)
...
def lgamma(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_lgamma)
...
def iszero(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_iszero)
...
def isinf(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_isinf)
...
def isnan(a):
    ...
    `a` must not be complex.
    """
    return _arith_unary_func(a, backend.get().flare_isnan)
