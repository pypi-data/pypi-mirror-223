...
#   target_link_library(mybinary PRIVATE flare::flare_cuda)
#
...
####### The input file was flareConfig.cmake.in                            ########
...
set_and_check(flare_INCLUDE_DIRS ${PROJECT_SOURCE_DIR})
...
foreach(backend Unified CPU CUDA)
  ...
  if(NOT TARGET flare::flare_${lowerbackend} AND NOT TARGET flare_${lowerbackend})
    # Either we are not in the flare project or the target was not built
    if(EXISTS ${PACKAGE_PREFIX_DIR}/flarepy/cmake/flare${backend}Targets.cmake)
      include(${PACKAGE_PREFIX_DIR}/flarepy/cmake/flare${backend}Targets.cmake)
    endif()
  endif()
  if(TARGET flare::flare_${lowerbackend})
    get_property(all_config TARGET flare::flare_${lowerbackend} PROPERTY IMPORTED_CONFIGURATIONS)
    foreach(config IN LISTS all_config)
      if(NOT all_config)
        set(all_config "NOCONFIG")
      endif()
      get_property(loc TARGET flare::flare_${lowerbackend} PROPERTY IMPORTED_LOCATION_${config})
  ...
  if((TARGET flare::flare_${lowerbackend} AND flare_${backend}_BINARY_EXISTS) OR TARGET flare_${lowerbackend})
      set(flare_${backend}_FOUND ON)
      set(flare_${backend}_LIBRARIES flare::flare_${lowerbackend})
      set(flare_LIBRARIES flare::flare_${lowerbackend})
  else()
  ...
  # the Binary exists.
  if(DEFINED FLARE_BUILD_${upperbackend} AND NOT FLARE_BUILD_${upperbackend})
    set(flare_${backend}_FOUND OFF)
  endif()
endforeach()
