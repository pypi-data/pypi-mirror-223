...
def _create_array(buf, numdims, idims, dtype, is_device):
    ...
    if (not is_device):
        safe_call(backend.get().flare_create_array(c_pointer(out_arr), c_void_ptr_t(buf),
                                                numdims, c_pointer(c_dims), dtype.value))
    else:
        safe_call(backend.get().flare_device_array(c_pointer(out_arr), c_void_ptr_t(buf),
                                                numdims, c_pointer(c_dims), dtype.value))
    return out_arr
...
def _create_strided_array(buf, numdims, idims, dtype, is_device, offset, strides):
    ...
    safe_call(backend.get().flare_create_strided_array(c_pointer(out_arr), c_void_ptr_t(buf),
...
def _create_empty_array(numdims, idims, dtype):
    ...
    c_dims = dim4(idims[0], idims[1], idims[2], idims[3])
    safe_call(backend.get().flare_create_handle(c_pointer(out_arr),
                                             numdims, c_pointer(c_dims), dtype.value))
    return out_arr
...
def constant_array(val, d0, d1=None, d2=None, d3=None, dtype=Dtype.f32):
    ...
    if isinstance(val, complex):
        ...
        safe_call(backend.get().flare_constant_complex(c_pointer(out), c_real, c_imag,
                                                    4, c_pointer(dims), dtype))
    elif dtype.value == Dtype.s64.value:
        c_val = c_longlong_t(val.real)
        safe_call(backend.get().flare_constant_long(c_pointer(out), c_val, 4, c_pointer(dims)))
    elif dtype.value == Dtype.u64.value:
        c_val = c_ulonglong_t(val.real)
        safe_call(backend.get().flare_constant_ulong(c_pointer(out), c_val, 4, c_pointer(dims)))
    else:
        c_val = c_double_t(val)
        safe_call(backend.get().flare_constant(c_pointer(out), c_val, 4, c_pointer(dims), dtype))
    ...
    if _is_number(key):
        ...
        for n in range(n_inds):
            if (_is_number(key[n])):
                ...
                raise IndexError("Invalid type while assigning to flarepy.array")
...
def transpose(a, conj=False):
    ...
    """
    out = Array()
    safe_call(backend.get().flare_transpose(c_pointer(out.arr), a.arr, conj))
    return out
...
def transpose_inplace(a, conj=False):
    ...
    """
    safe_call(backend.get().flare_transpose_inplace(a.arr, conj))
...
class Array(BaseArray):
    ...
    dtype: optional: str or flare.Dtype. default: None.
           ...
           - if flare.Dtype, must be one of the following:
               - Dtype.f32 for float
    ...
    -----------
    arr: ctypes.c_void_p
         ctypes variable containing flare_array from flare library.
    ...
    - flare.Array() uses column major format.
    ...
    # Setting to such a high value should make sure that flare has priority over
    # other classes, ensuring that e.g. numpy.float32(1)*flare.randu(3) is handled by
    # flare's __radd__() instead of numpy's __add__()
    ...
    def __init__(self, src=None, dims=None, dtype=None, is_device=False, offset=None, strides=None):
        ...
        if src is not None:
            ...
            if (isinstance(src, Array)):
                safe_call(backend.get().flare_retain_array(c_pointer(self.arr), src.arr))
                return
    ...
    def copy(self):
        ...
        """
        out = Array()
        safe_call(backend.get().flare_copy_array(c_pointer(out.arr), self.arr))
        return out
    ...
    def __del__(self):
        ...
        """
        if self.arr.value:
            backend.get().flare_release_array(self.arr)
            self.arr.value = 0
    ...
    def device_ptr(self):
        ...
        """
        ptr = c_void_ptr_t(0)
        backend.get().flare_get_device_ptr(c_pointer(ptr), self.arr)
        return ptr.value
    ...
    def raw_ptr(self):
        ...
        """
        ptr = c_void_ptr_t(0)
        backend.get().flare_get_raw_ptr(c_pointer(ptr), self.arr)
        return ptr.value
    ...
    def offset(self):
        ...
        """
        offset = c_dim_t(0)
        safe_call(backend.get().flare_get_offset(c_pointer(offset), self.arr))
        return offset.value
    ...
    def strides(self):
        ...
        s2 = c_dim_t(0)
        s3 = c_dim_t(0)
        safe_call(backend.get().flare_get_strides(c_pointer(s0), c_pointer(s1),
    ...
    def elements(self):
        ...
        """
        num = c_dim_t(0)
        safe_call(backend.get().flare_get_elements(c_pointer(num), self.arr))
        return num.value
    ...
    def allocated(self):
        ...
        """
        num = c_size_t(0)
        safe_call(backend.get().flare_get_allocated_bytes(c_pointer(num), self.arr))
        return num.value

    def dtype(self):
        """
        Return the data type as a flare.Dtype enum value.
        """
        dty = c_int_t(Dtype.f32.value)
        safe_call(backend.get().flare_get_type(c_pointer(dty), self.arr))
    ...
    def dims(self):
        ...
        d2 = c_dim_t(0)
        d3 = c_dim_t(0)
        safe_call(backend.get().flare_get_dims(c_pointer(d0), c_pointer(d1),
    ...
    def numdims(self):
        ...
        """
        nd = c_uint_t(0)
        safe_call(backend.get().flare_get_numdims(c_pointer(nd), self.arr))
        return nd.value
    ...
    def is_empty(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_empty(c_pointer(res), self.arr))
        return res.value
    ...
    def is_scalar(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_scalar(c_pointer(res), self.arr))
        return res.value
    ...
    def is_row(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_row(c_pointer(res), self.arr))
        return res.value
    ...
    def is_column(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_column(c_pointer(res), self.arr))
        return res.value
    ...
    def is_vector(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_vector(c_pointer(res), self.arr))
        return res.value
    ...
    def is_sparse(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_sparse(c_pointer(res), self.arr))
        return res.value
    ...
    def is_complex(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_complex(c_pointer(res), self.arr))
        return res.value
    ...
    def is_real(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_real(c_pointer(res), self.arr))
        return res.value
    ...
    def is_double(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_double(c_pointer(res), self.arr))
        return res.value
    ...
    def is_single(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_single(c_pointer(res), self.arr))
        return res.value
    ...
    def is_half(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_half(c_pointer(res), self.arr))
        return res.value
    ...
    def is_real_floating(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_realfloating(c_pointer(res), self.arr))
        return res.value
    ...
    def is_floating(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_floating(c_pointer(res), self.arr))
        return res.value
    ...
    def is_integer(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_integer(c_pointer(res), self.arr))
        return res.value
    ...
    def is_bool(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_bool(c_pointer(res), self.arr))
        return res.value
    ...
    def is_linear(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_linear(c_pointer(res), self.arr))
        return res.value
    ...
    def is_owner(self):
        ...
        """
        res = c_bool_t(False)
        safe_call(backend.get().flare_is_owner(c_pointer(res), self.arr))
        return res.value
    ...
    def __add__(self, other):
        ...
        Return self + other.
        """
        return _binary_func(self, other, backend.get().flare_add)

    def __iadd__(self, other):
        """
        Perform self += other.
        """
        self = _binary_func(self, other, backend.get().flare_add)
        return self
    ...
    def __radd__(self, other):
        ...
        Return other + self.
        """
        return _binary_funcr(other, self, backend.get().flare_add)

    def __sub__(self, other):
        """
        Return self - other.
        """
        return _binary_func(self, other, backend.get().flare_sub)

    def __isub__(self, other):
        """
        Perform self -= other.
        """
        self = _binary_func(self, other, backend.get().flare_sub)
        return self
    ...
    def __rsub__(self, other):
        ...
        Return other - self.
        """
        return _binary_funcr(other, self, backend.get().flare_sub)

    def __mul__(self, other):
        """
        Return self * other.
        """
        return _binary_func(self, other, backend.get().flare_mul)

    def __imul__(self, other):
        """
        Perform self *= other.
        """
        self = _binary_func(self, other, backend.get().flare_mul)
        return self
    ...
    def __rmul__(self, other):
        ...
        Return other * self.
        """
        return _binary_funcr(other, self, backend.get().flare_mul)

    def __truediv__(self, other):
        """
        Return self / other.
        """
        return _binary_func(self, other, backend.get().flare_div)

    def __itruediv__(self, other):
        """
        Perform self /= other.
        """
        self =  _binary_func(self, other, backend.get().flare_div)
        return self
    ...
    def __rtruediv__(self, other):
        ...
        Return other / self.
        """
        return _binary_funcr(other, self, backend.get().flare_div)
    ...
    def __mod__(self, other):
        ...
        Return self % other.
        """
        return _binary_func(self, other, backend.get().flare_mod)

    def __imod__(self, other):
        """
        Perform self %= other.
        """
        self =  _binary_func(self, other, backend.get().flare_mod)
        return self
    ...
    def __rmod__(self, other):
        ...
        Return other % self.
        """
        return _binary_funcr(other, self, backend.get().flare_mod)

    def __pow__(self, other):
        """
        Return self ** other.
        """
        return _binary_func(self, other, backend.get().flare_pow)

    def __ipow__(self, other):
        """
        Perform self **= other.
        """
        self =  _binary_func(self, other, backend.get().flare_pow)
        return self
    ...
    def __rpow__(self, other):
        ...
        Return other ** self.
        """
        return _binary_funcr(other, self, backend.get().flare_pow)

    def __lt__(self, other):
        """
        Return self < other.
        """
        return _binary_func(self, other, backend.get().flare_lt)

    def __gt__(self, other):
        """
        Return self > other.
        """
        return _binary_func(self, other, backend.get().flare_gt)

    def __le__(self, other):
        """
        Return self <= other.
        """
        return _binary_func(self, other, backend.get().flare_le)

    def __ge__(self, other):
        """
        Return self >= other.
        """
        return _binary_func(self, other, backend.get().flare_ge)

    def __eq__(self, other):
        """
        Return self == other.
        """
        return _binary_func(self, other, backend.get().flare_eq)

    def __ne__(self, other):
        """
        Return self != other.
        """
        return _binary_func(self, other, backend.get().flare_neq)

    def __and__(self, other):
        """
        Return self & other.
        """
        return _binary_func(self, other, backend.get().flare_bitand)

    def __iand__(self, other):
        """
        Perform self &= other.
        """
        self = _binary_func(self, other, backend.get().flare_bitand)
        return self
    ...
    def __or__(self, other):
        ...
        Return self | other.
        """
        return _binary_func(self, other, backend.get().flare_bitor)

    def __ior__(self, other):
        """
        Perform self |= other.
        """
        self = _binary_func(self, other, backend.get().flare_bitor)
        return self
    ...
    def __xor__(self, other):
        ...
        Return self ^ other.
        """
        return _binary_func(self, other, backend.get().flare_bitxor)

    def __ixor__(self, other):
        """
        Perform self ^= other.
        """
        self = _binary_func(self, other, backend.get().flare_bitxor)
        return self
    ...
    def __lshift__(self, other):
        ...
        Return self << other.
        """
        return _binary_func(self, other, backend.get().flare_bitshiftl)

    def __ilshift__(self, other):
        """
        Perform self <<= other.
        """
        self = _binary_func(self, other, backend.get().flare_bitshiftl)
        return self
    ...
    def __rshift__(self, other):
        ...
        Return self >> other.
        """
        return _binary_func(self, other, backend.get().flare_bitshiftr)

    def __irshift__(self, other):
        """
        Perform self >>= other.
        """
        self = _binary_func(self, other, backend.get().flare_bitshiftr)
        return self
    ...
    def __invert__(self):
        ...
        """
        out = Array()
        safe_call(backend.get().flare_bitnot(c_pointer(out.arr), self.arr))
        return out
    ...
    def logical_not(self):
        ...
        """
        out = Array()
        safe_call(backend.get().flare_not(c_pointer(out.arr), self.arr))
        return out
    ...
    def logical_and(self, other):
        ...
        """
        out = Array()
        safe_call(backend.get().flare_and(c_pointer(out.arr), self.arr, other.arr)) #TODO: bcast var?
        return out
    ...
    def logical_or(self, other):
        ...
        """
        out = Array()
        safe_call(backend.get().flare_or(c_pointer(out.arr), self.arr, other.arr)) #TODO: bcast var?
        return out
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            safe_call(backend.get().flare_index_gen(c_pointer(out.arr),
    ...
    def __setitem__(self, key, val):
        ...
        try:
            ...
            safe_call(backend.get().flare_assign_gen(c_pointer(out_arr),
                                                  self.arr, c_dim_t(n_dims), inds.pointer,
                                                  other_arr))
            safe_call(backend.get().flare_release_array(self.arr))
            if del_other:
                safe_call(backend.get().flare_release_array(other_arr))
            self.arr = out_arr
    ...
    def _reorder(self):
        ...
        out = Array()
        safe_call(backend.get().flare_reorder(c_pointer(out.arr), self.arr, *rdims))
        return out
    ...
    def to_ctype(self, row_major=False, return_shape=False):
        ...
        safe_call(backend.get().flare_get_data_ptr(c_pointer(res), self.arr))
        if (return_shape):
    ...
    def scalar(self):
        ...
        res = ctype_type()
        safe_call(backend.get().flare_get_scalar(c_pointer(res), self.arr))
        return res.value

    def __str__(self):
        """
        Converts the flare array to string showing its meta data and contents.
    ...
    def __repr__(self):
        """
        Displays the meta data of the flare array.
    ...
    def _get_metadata_str(self, dims=True):
        return 'flarepy.Array()\nType: {}\n{}' \
            .format(to_typename[self.type()], 'Dims: {}'.format(str(self.dims())) if dims else '')

    def _as_str(self):
        arr_str = c_char_ptr_t(0)
        be = backend.get()
        safe_call(be.flare_array_to_string(c_pointer(arr_str), "", self.arr, 4, True))
        py_str = to_str(arr_str)
        safe_call(be.flare_free_host(arr_str))
        return py_str

    def __array__(self):
        """
        Constructs a numpy.array from flare.Array
        """
        import numpy as np
        res = np.empty(self.dims(), dtype=np.dtype(to_typecode[self.type()]), order='F')
        safe_call(backend.get().flare_get_data_ptr(c_void_ptr_t(res.ctypes.data), self.arr))
        return res
    ...
    def to_ndarray(self, output=None):
        ...
        safe_call(backend.get().flare_get_data_ptr(c_void_ptr_t(output.ctypes.data), tmp.arr))
        return output
...
def display(a, precision=4):
    ...
    safe_call(backend.get().flare_print_array_gen(name.encode('utf-8'),
...
def save_array(key, a, filename, append=False):
    ...
    """
    index = c_int_t(-1)
    safe_call(backend.get().flare_save_array(c_pointer(index),
                                          key.encode('utf-8'),
                                          a.arr,
...
def read_array(filename, index=None, key=None):
    ...
    if (index is not None):
        safe_call(backend.get().flare_read_array_index(c_pointer(out.arr),
                                                    filename.encode('utf-8'),
                                                    index))
    elif (key is not None):
        safe_call(backend.get().flare_read_array_key(c_pointer(out.arr),
                                                  filename.encode('utf-8'),
                                                  key.encode('utf-8')))
