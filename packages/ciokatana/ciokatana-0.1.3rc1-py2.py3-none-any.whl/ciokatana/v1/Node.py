...
class ConductorRenderNode(NodegraphAPI.SuperTool):
    ...
    def singleton_factory(cls):
        ...
        if existing:
            ...
            conductor_node = NodegraphAPI.CreateNode(k.CONDUCTOR_RENDER_NODE_TYPE, rootNode)
    ...
    def get_submissions(cls, node):
        ...
        for render_node_payload in jobs_model.resolve(node):
            ...
            ordered_payload = {key: payload[key] for key in PAYLOAD_KEY_ORDER if key in payload}
