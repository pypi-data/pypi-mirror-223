...
class Device:
    def __init__(self, id: str, name: str, aliases: list[str], room: str, external_id: str, skill_id: str, device_type: str, groups: list[Group], capabilities: list[dict], properties: list[dict], household: Household, token: str):
