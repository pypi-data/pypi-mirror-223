...
class Device:
    ...
    def __str__(self) -> str:
        if self.groups:
            return f'<Device id={self.id} name={self.name} avaible_properties={self.avaible_properties} aliases={self.aliases} room={self.room} external_id={self.external_id} skill_id={self.skill_id} type={self.type} groups={self.groups} capabilities={self.capabilities} properties={self.properties} household_id={self.household_id}>'
        else:
            return f'<Device id={self.id} name={self.name} avaible_properties={self.avaible_properties} aliases={self.aliases} room={self.room} external_id={self.external_id} skill_id={self.skill_id} type={self.type} capabilities={self.capabilities} properties={self.properties} household_id={self.household_id}>'
