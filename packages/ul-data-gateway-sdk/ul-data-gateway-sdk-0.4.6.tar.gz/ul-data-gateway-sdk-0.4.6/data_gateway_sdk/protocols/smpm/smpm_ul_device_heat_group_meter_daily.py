            ...
            IntegrationV0MessageData(
                ...
                events=[
                    ...
                    *([IntegrationV0MessageEvent.DEVICE__ALARM_POWER_HIGH_DIGITAL_INPUT_2] if self.event_device_alarm_power_high_digital_input2 else []),
                    # *([IntegrationV0MessageEvent.DEVICE__ALARM_POWER_LOW_DIGITAL_INPUT_1] if self.event_device_alarm_power_low_digital_input1 else []),  # ToDo: add aggregator migration
                    # *([IntegrationV0MessageEvent.DEVICE__ALARM_POWER_LOW_DIGITAL_INPUT_2] if self.event_device_alarm_power_low_digital_input2 else []),  # ToDo: add aggregator migration
