...
__all__ = [
    ...
    "perimeter",
    "year",
    "liste_des_variables_revenus_2021",
    "pote",
    "aggregates_from_csv",
    "agm",
    "pote_var_to_dict",
...
csv_pote_extractions_folder = (
    "/mnt/data-in/casd_extract/pote/20230719-POTE2021-ERFS2019/"
)
calib_copulas_and_quantile_folder = (
...
liste_des_variables_revenus_2021 = pd.read_csv(
    csv_pote_extractions_folder + "/agregats_POTE_revenus_rici_2021.csv"
)

pote = {
    "2021": [liste_des_variables_revenus_2021],
