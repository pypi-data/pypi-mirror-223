...
async def inference(request: Request):
    ...
    try:
        ...
        results = getattr(inference_ai_module, inference_dataframe_function)(test_data, model_info_dict)
...
async def inference_file(files: List[UploadFile] = File(...)):
    ...
    results = getattr(inference_ai_module, inference_file_function)(files, model_info_dict)
...
inference_dataframe_function = os.getenv('inference_dataframe_function', 'inference_dataframe')
