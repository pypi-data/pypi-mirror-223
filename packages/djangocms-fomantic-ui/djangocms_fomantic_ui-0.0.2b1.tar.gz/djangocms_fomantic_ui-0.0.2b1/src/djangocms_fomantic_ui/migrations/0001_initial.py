    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.CharField(blank=True, choices=[('_self', '_self'), ('_blank', '_blank'), ('_parent', '_parent'), ('_top', '_top')], max_length=7)),
                ('colour', models.CharField(blank=True, choices=[('primary', 'Primary'), ('secondary', 'Secondary'), ('red', 'Red'), ('orange', 'Orange'), ('yellow', 'Yellow'), ('olive', 'Olive'), ('green', 'Green'), ('teal', 'Teal'), ('blue', 'Blue'), ('violet', 'Violet'), ('purple', 'Purple'), ('pink', 'Pink'), ('brown', 'Brown'), ('grey', 'Grey'), ('black', 'Black')], default='', max_length=9, verbose_name='colour')),
                ...
                ('size', models.CharField(blank=True, choices=[('mini', 'mini'), ('tiny', 'tiny'), ('small', 'small'), ('medium', 'medium'), ('large', 'large'), ('big', 'big'), ('huge', 'huge'), ('massive', 'massive')], max_length=7, verbose_name='size')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_padding', models.BooleanField(default=False, verbose_name='no padding')),
                ('hide_on_mobile', models.BooleanField(default=False, verbose_name='Hide on mobile devices')),
            ],
            options={
                'verbose_name': 'column',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flipped', models.CharField(blank=True, choices=[('', 'none'), ('horizontally', 'horizontally'), ('vertically', 'vertically')], max_length=12, verbose_name='flipped')),
                ('rotated', models.CharField(blank=True, choices=[('', 'none'), ('clockwise', 'clockwise'), ('counterclockwise', 'counterclockwise')], max_length=17, verbose_name='rotated')),
                ...
                ('colour', models.CharField(blank=True, choices=[('primary', 'Primary'), ('secondary', 'Secondary'), ('red', 'Red'), ('orange', 'Orange'), ('yellow', 'Yellow'), ('olive', 'Olive'), ('green', 'Green'), ('teal', 'Teal'), ('blue', 'Blue'), ('violet', 'Violet'), ('purple', 'Purple'), ('pink', 'Pink'), ('brown', 'Brown'), ('grey', 'Grey'), ('black', 'Black')], max_length=9, verbose_name='colour')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attached', models.CharField(blank=True, choices=[('top attached', 'top attached'), ('attached', 'attached'), ('bottom attached', 'bottom attached')], max_length=15, verbose_name='attached')),
                ...
                ('emphasis', models.CharField(blank=True, choices=[('secondary', 'secondary'), ('tertiary', 'tertiary')], max_length=9, verbose_name='emphasis')),
                ('circular', models.BooleanField(default=False, verbose_name='circular')),
                ('clearing', models.BooleanField(default=False, help_text='clear floated content', verbose_name='clearing')),
                ('floated', models.CharField(blank=True, choices=[('left', 'left'), ('right', 'right')], max_length=5)),
                ('text_alignment', models.CharField(blank=True, choices=[('left', 'left'), ('center', 'centre'), ('right', 'right')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disabled', models.BooleanField(default=False, verbose_name='disabled')),
                ('tab_text', djangocms_text_ckeditor.fields.HTMLField(blank=True, default='')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tablet_stackable', models.BooleanField(default=False, verbose_name='tablet stackable')),
                ...
                ('attached', models.CharField(blank=True, choices=[('', 'none'), ('top', 'top'), ('bottom', 'bottom')], max_length=6)),
                ('size', models.CharField(blank=True, choices=[('mini', 'mini'), ('tiny', 'tiny'), ('small', 'small'), ('medium', 'medium'), ('large', 'large'), ('big', 'big'), ('huge', 'huge'), ('massive', 'massive')], max_length=7, verbose_name='size')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='%(app_label)s_%(class)s', serialize=False, to='cms.cmsplugin')),
                ('colour', models.CharField(blank=True, choices=[('primary', 'Primary'), ('secondary', 'Secondary'), ('red', 'Red'), ('orange', 'Orange'), ('yellow', 'Yellow'), ('olive', 'Olive'), ('green', 'Green'), ('teal', 'Teal'), ('blue', 'Blue'), ('violet', 'Violet'), ('purple', 'Purple'), ('pink', 'Pink'), ('brown', 'Brown'), ('grey', 'Grey'), ('black', 'Black')], default='primary', max_length=9, verbose_name='Background colour')),
                ('inverted', models.BooleanField(default=True, help_text='coloured background', verbose_name='inverted')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, related_name='%(app_label)s_%(class)s', serialize=False, to='cms.cmsplugin')),
                ('image_size', models.CharField(blank=True, choices=[('mini', 'mini'), ('tiny', 'tiny'), ('small', 'small'), ('medium', 'medium'), ('large', 'large'), ('big', 'big'), ('huge', 'huge'), ('massive', 'massive')], default='medium', max_length=7, verbose_name='size')),
                ('effect', models.CharField(choices=[('fade', 'fade'), ('move', 'move left'), ('move right', 'move right'), ('move up', 'move up'), ('move down', 'move down'), ('circular rotate', 'circular rotate right'), ('circular rotate left', 'circular rotate left')], default='fade', max_length=20, verbose_name='effect')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hash', models.CharField(blank=True, help_text='Hash for Vimeo, 10 hex digits after “h=”', max_length=10, verbose_name='hash')),
                ('external_url', models.URLField(blank=True, help_text='Fill in unless you choose a predefined data source.', verbose_name='URL to be embedded')),
                ('use_placeholder', models.BooleanField(default=True, help_text='A placeholder image is shown until users click on it to load the code.', verbose_name='Show placeholder image instead of loading code immediately')),
                ('icon', models.CharField(blank=True, help_text='Choose name from https://semantic-ui.com/elements/icon.html or leave empty for standard play circle icon.', max_length=50, verbose_name='play icon')),
                ...
                ('placeholder_image', filer.fields.image.FilerImageField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='placeholder_image_embed', to=settings.FILER_IMAGE_MODEL, verbose_name='placeholder image')),
                ('video_file', filer.fields.file.FilerFileField(blank=True, help_text='You can upload a video file instead of linking an external resource', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='video_file_embed', to='filer.file', verbose_name='video file')),
            ],
            options={
                'abstract': False,
            },
