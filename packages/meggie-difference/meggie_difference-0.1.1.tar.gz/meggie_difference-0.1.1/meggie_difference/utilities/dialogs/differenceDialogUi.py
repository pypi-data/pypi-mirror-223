...
class Ui_differenceDialog(object):
    def setupUi(self, differenceDialog):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.labelCondition1)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.comboBoxCondition1)
        self.labelCondition2 = QtWidgets.QLabel(self.groupBoxDifference)
        self.labelCondition2.setObjectName("labelCondition2")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.labelCondition2)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.comboBoxCondition2)
        self.pushButtonAdd = QtWidgets.QPushButton(self.groupBoxDifference)
        self.pushButtonAdd.setObjectName("pushButtonAdd")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.SpanningRole, self.pushButtonAdd)
        self.listWidgetDifferences = QtWidgets.QListWidget(self.groupBoxDifference)
        self.listWidgetDifferences.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.listWidgetDifferences.setObjectName("listWidgetDifferences")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.SpanningRole, self.listWidgetDifferences)
        self.pushButtonClear = QtWidgets.QPushButton(self.groupBoxDifference)
        self.pushButtonClear.setObjectName("pushButtonClear")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.pushButtonClear)
