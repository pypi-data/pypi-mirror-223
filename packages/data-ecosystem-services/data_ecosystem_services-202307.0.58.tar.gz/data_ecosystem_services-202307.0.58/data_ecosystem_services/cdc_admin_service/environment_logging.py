...
class LoggerSingleton:
    ...
    def __init__(self, calling_namespace_name, calling_service_name):
        ...
        connection_string = os.environ.get("APPLICATIONINSIGHTS_CONNECTION_STRING", default_connection_string)
        ...
        try:
            ...
            logger.warning(f"Failed to connect with connection_string: {connection_string}, Error: {e}")
