...
def RzAnalysis_esil_mem_read(esil, addr, buf):
    return _rizin.RzAnalysis_esil_mem_read(esil, addr, buf)

def RzAnalysis_esil_mem_write(esil, addr, buf):
    return _rizin.RzAnalysis_esil_mem_write(esil, addr, buf)
...
def RzAnalysis_var_init(var):
    return _rizin.RzAnalysis_var_init(var)

def RzAnalysis_var_fini(var):
    return _rizin.RzAnalysis_var_fini(var)

def RzAnalysis_var_new():
    return _rizin.RzAnalysis_var_new()

def RzAnalysis_var_free(var):
    return _rizin.RzAnalysis_var_free(var)
...
def RzAnalysis_data_new(addr, type, n, buf):
    return _rizin.RzAnalysis_data_new(addr, type, n, buf)
...
class RzBin(object):
    ...
    @staticmethod
    def object_process_plugin_data(bf, o):
        return _rizin.RzBin_object_process_plugin_data(bf, o)
...
def RzBin_class_field_new(vaddr, paddr, name, classname, libname, type):
    return _rizin.RzBin_class_field_new(vaddr, paddr, name, classname, libname, type)

def RzBin_class_field_free(field):
    return _rizin.RzBin_class_field_free(field)

def RzBin_class_free(k):
    return _rizin.RzBin_class_free(k)
...
def RzBin_object_process_plugin_data(bf, o):
    return _rizin.RzBin_object_process_plugin_data(bf, o)
...
def RzBin_object_find_class(o, name):
    return _rizin.RzBin_object_find_class(o, name)

def RzBin_object_find_method(o, klass, method):
    return _rizin.RzBin_object_find_method(o, klass, method)

def RzBin_object_find_method_by_vaddr(o, vaddr):
    return _rizin.RzBin_object_find_method_by_vaddr(o, vaddr)

def RzBin_object_find_field(o, klass, field):
    return _rizin.RzBin_object_find_field(o, klass, field)

def RzBin_object_add_class(o, name, super, vaddr):
    return _rizin.RzBin_object_add_class(o, name, super, vaddr)

def RzBin_object_add_method(o, klass, method, paddr, vaddr):
    return _rizin.RzBin_object_add_method(o, klass, method, paddr, vaddr)

def RzBin_object_add_field(o, klass, field, paddr, vaddr):
    return _rizin.RzBin_object_add_field(o, klass, field, paddr, vaddr)
...
class RzBuffer(object):
    ...
    def fwd_scan(self, start, amount, fwd_scan, user):
        return _rizin.RzBuffer_fwd_scan(self, start, amount, fwd_scan, user)
...
class RzCore(object):
    ...
    def analysis_bytes(self, buf, nops):
        return _rizin.RzCore_analysis_bytes(self, buf, nops)
    ...
    def cmd_show_analysis_help(self):
        return _rizin.RzCore_cmd_show_analysis_help(self)
...
def RzCore_sym_name_init(names, symbol, demangle):
    return _rizin.RzCore_sym_name_init(names, symbol, demangle)

def RzCore_sym_name_fini(names):
    return _rizin.RzCore_sym_name_fini(names)
...
def RzNum_rand32(max):
    return _rizin.RzNum_rand32(max)

def RzNum_rand64(max):
    return _rizin.RzNum_rand64(max)
...
def RzType_db_update_base_type(typedb, type):
    return _rizin.RzType_db_update_base_type(typedb, type)
...
def RzType_func_update(typedb, callable):
    return _rizin.RzType_func_update(typedb, callable)
