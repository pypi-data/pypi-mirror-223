...
def get_setupapi_functions(setupapi):
    ...
    setupapi_restypes[CM_Get_Parent] = c_ulong
    setupapi_argtypes[CM_Get_Parent] = [POINTER(DWORD), DWORD, c_ulong]
    ...
    setupapi_restypes[CM_Get_Device_IDW] = c_ulong
    setupapi_argtypes[CM_Get_Device_IDW] = [DWORD, c_void_p, c_ulong, c_ulong]
