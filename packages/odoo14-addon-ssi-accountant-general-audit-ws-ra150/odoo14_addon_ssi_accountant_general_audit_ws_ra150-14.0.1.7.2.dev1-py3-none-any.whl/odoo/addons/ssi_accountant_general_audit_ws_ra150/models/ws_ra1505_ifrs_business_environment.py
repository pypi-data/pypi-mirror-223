...
class WSAuditRA1505IfrsBusinessEnvironment(models.Model):
    _name = "ws_ra1505.ifrs_business_environment"
    _description = "RA.150.5 Financial Accounting Standard Amendment Understanding"
