...
class WSAuditRA1505RegulationBusinessEnvironment(models.Model):
    _name = "ws_ra1505.regulation_business_environment"
    _description = "RA.150.5 Regulation Change Understanding"
