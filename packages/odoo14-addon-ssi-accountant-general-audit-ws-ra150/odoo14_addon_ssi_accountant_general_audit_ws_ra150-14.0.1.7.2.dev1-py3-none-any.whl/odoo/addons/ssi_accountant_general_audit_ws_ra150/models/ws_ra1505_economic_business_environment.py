...
class WSAuditRA1505EconomicBusinessEnvironment(models.Model):
    _name = "ws_ra1505.economic_business_environment"
    _description = "RA.150.5 National Economic Understanding"
