...
class WSAuditRA1503OtherSignificantInformation(models.Model):
    _name = "ws_ra1503.other_significant_information"
    _description = "RA.150.3 Other Significant Information"
