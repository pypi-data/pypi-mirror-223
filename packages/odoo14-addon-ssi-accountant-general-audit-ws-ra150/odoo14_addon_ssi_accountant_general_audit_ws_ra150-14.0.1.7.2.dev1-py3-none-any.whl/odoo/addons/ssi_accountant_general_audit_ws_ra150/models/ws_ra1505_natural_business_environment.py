...
class WSAuditRA1505NaturalBusinessEnvironment(models.Model):
    _name = "ws_ra1505.natural_business_environment"
    _description = "RA.150.5 Natural Cycle Understanding"
