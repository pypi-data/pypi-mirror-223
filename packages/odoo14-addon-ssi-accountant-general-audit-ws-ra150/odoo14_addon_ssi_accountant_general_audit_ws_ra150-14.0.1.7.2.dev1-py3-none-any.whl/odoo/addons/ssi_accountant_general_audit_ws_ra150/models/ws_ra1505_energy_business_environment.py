...
class WSAuditRA1505EnergyBusinessEnvironment(models.Model):
    _name = "ws_ra1505.energy_business_environment"
    _description = "RA.150.5 Energy Availability & Cost Understanding"
