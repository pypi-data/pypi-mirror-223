...
class Importer:
    ...
    def insert_record_data_source(self, data_source_id: int, location_id: int, entity_type_id: int, entity_id: int, url: str, user_id: int):
        ...
        try:
            ...
            cursor.execute(
                "SELECT country_id FROM location.country_table WHERE name = '{}'".format(location_id))
            ...
            cursor.execute(
                query_importer, (data_source_id, country_id[0], entity_type_id, entity_id, url, user_id, user_id))
