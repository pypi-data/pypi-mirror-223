...
from contrast_vendor.ruamel.yaml.loader import Loader as UnsafeLoader
...
class YAML:
    ...
    def official_plug_ins(self):
        ...
        and you can explicitly provide it during instantiation:
            yaml = yaml.YAML(plug_ins=['ruamel/yaml/jinja2/__plug_in__'])
        """
        try:
...
def warn_deprecation(fun, method, arg=''):
    ...
    from contrast_vendor.ruamel.yaml.compat import _F
