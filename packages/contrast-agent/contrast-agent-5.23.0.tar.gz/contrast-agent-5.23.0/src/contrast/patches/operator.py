...
from contrast_vendor.wrapt import function_wrapper, register_post_import_hook
...
from contrast.utils.patch_utils import add_watermark, build_and_apply_patch
...
def build_add_hook(original_func, patch_policy):
    ...
    return add_watermark(add(original_func))
...
def build_mod_hook(original_func, patch_policy):
    ...
    return add_watermark(mod(original_func))
