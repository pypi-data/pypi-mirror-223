...
DESC = """
    Agent "Hopper" from myjoco environment. For details, see
...
class BmAgentHopper(Agent):
    def __init__(self, d=None, n=3, name='AgentHopper', desc=DESC,
...
if __name__ == '__main__':
    ...
    bm = BmAgentHopper(steps=250).prep()
    print(bm.info())
    ...
    bm = BmAgentHopper(steps=250, policy='direct').prep()
    ...
    bm = BmAgentHopper(steps=250, policy='toeplitz').prep()
