...
def embed_established(incursion: Incursion) -> Embed:
    ...
    embed.add_field(name="Region", value=incursion.constellation.eve_region.name, inline=True)
    embed.add_field(name="Constellation", value=incursion.constellation.name, inline=True)
    # newline
    embed.add_field(name="Headquarters",
                    value=incursion_constellations[incursion.constellation.name]["Headquarter"])
    embed.add_field(name="Assault",
                    value=incursion_constellations[incursion.constellation.name]["Assaults"], inline=True)
    embed.add_field(name="Vanguard",
                    value=incursion_constellations[incursion.constellation.name]["Vanguards"], inline=True)
    # newline
    ...
    embed.add_field(name="HS Island?", value=f"{incursion.is_island}", inline=True)
    embed.add_field(name="Jumps from last HQ", value="69420lmao", inline=True)
    # newline
    embed.add_field(name="Suggested Dockup", value="Not Implemented", inline=True)
    embed.add_field(name="Edencom In Spawn", value="Not Implemented", inline=True)
    embed.add_field(name="Trigs In Spawn", value="Not Implemented", inline=True)
    return embed
...
def embed_established_addendum(incursion: Incursion) -> Embed:
    ...
    embed.add_field(name="Edencom In Route", value="Not Implemented", inline=True)
    embed.add_field(name="Edencom In Route", value="Not Implemented", inline=True)
    return embed
