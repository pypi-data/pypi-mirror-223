...
class AplSqlArtifactsRecorder:
    ...
    def __call__(self, model_method, apl_function, input_tables, output_tables, filled_table_names=None):
        ...
        if model_method == 'fit':
            ...
            self._fit_call = sqlgen.call_statement
            ...
            self._predict_call = sqlgen.call_statement
            ...
            self._fit_predict_call = sqlgen.call_statement
            ...
            self._score_call = sqlgen.call_statement
