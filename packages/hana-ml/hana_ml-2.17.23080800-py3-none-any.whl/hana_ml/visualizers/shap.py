    ...
    def __init__(self, feature_value_df: dataframe.DataFrame, reason_code_df: dataframe.DataFrame):
        ...
        for sum_order in np.argsort(existed_feature_sums):
            ...
            try:
                ...
                min_feature_value = 0
                max_feature_value = 0
            self.existed_feature_details.append((feature_name, existed_feature_sums[sum_order], min_feature_value, max_feature_value, feature_value_df.is_numeric(feature_name)))
