...
from telemedbasics.s3_logging.aws_logging_handler import AWSLoggingHandler
...
project_path = os.path.split(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0])[0]
logger = AWSLoggingHandler(logs_parent_directory_path=project_path, s3_enabled=False)