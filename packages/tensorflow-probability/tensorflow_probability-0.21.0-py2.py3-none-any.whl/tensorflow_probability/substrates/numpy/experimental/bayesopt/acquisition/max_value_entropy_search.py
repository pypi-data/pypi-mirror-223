...
from tensorflow_probability.substrates.numpy.mcmc import sample_halton_sequence
...
#   `tensorflow_probability/substrates/numpy/experimental/bayesopt/acquisition/max_value_entropy_search.py`
