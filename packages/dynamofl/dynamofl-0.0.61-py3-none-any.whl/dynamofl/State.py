...
class _State:
    ...
    def create_model(
        self, key, model_file_path: str, dataset_file_path: str, name: str, config
    ):
        params = {
            "key": key,
            "name": name,
        ...
        res = self.request._make_request("POST", "/model", params=params)
        return res

    def get_model(self, model_key: str):
        res = self.request._make_request("GET", f"/model/{model_key}")
        return res["data"]
    ...
    def create_test(self, name: str, model_key: str, attack: str, config: list):
        ...
        res = self.request._make_request("POST", "/test", params=params)
        return res
