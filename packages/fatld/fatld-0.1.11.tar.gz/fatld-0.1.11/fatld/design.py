...
class Design:
    ...
    def w2_wlp(
        self, treatment: bool = False
    ) -> tuple[list[int], str] | tuple[list[int], str, oa.array_link]:
        """
        ...
        ----------
        treatment: bool
            Return the treatment design as well
        ...
        treatment_design: oa.array_link
            The treatment design obtained when blocking the design
        ...
        if treatment:
            trmt_design = design_oa.deleteColumn(ord(best_factor) - 65)
            return best_w2_vector, best_factor, trmt_design
