...
def plot_posix_io_pattern(report: darshan.DarshanReport) -> Any:
    """
    Generates a bar chart summary of the POSIX read/write pattern,
    in terms of total sequential vs consecutive operations.
    ...
    Returns
    -------
    io_pattern_fig: a ``matplotlib.pyplot.figure`` object containing a
    bar graph of the total, sequential, and consecutive counts of POSIX
