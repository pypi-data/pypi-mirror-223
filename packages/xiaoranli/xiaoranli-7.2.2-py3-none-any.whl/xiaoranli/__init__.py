...
def install_zsh_extensions():
    zsh_extension_path = os.path.join(pkg_installed_path, "scripts/install_zsh_extensions.sh")
    os.system(f"bash {zsh_extension_path}")
    ...
    fire.Fire(
        {
            ...
            "zsh": install_zsh,
            "setup_ls":setup_ls,
            "zsh_extensions": install_zsh_extensions,
        }
    )
