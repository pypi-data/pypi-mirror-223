...
from h2o_engine_manager.gen.h2o_engine_service.api_client import ApiClient, Endpoint as _Endpoint
...
class H2OEngineServiceApi(object):
    ...
    def h2_o_engine_service_delete_h2_o_engine(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_service_delete_h2_o_engine(name, async_req=True)
        >>> result = thread.get()

        Args:
            name (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngines/{h2o_engine}
    ...
    def h2_o_engine_service_download_logs(
        ...
        **kwargs
        ...
        Args:
            h2o_engine (str): H2OEngine resource name. Format: workspaces/{workspace}/h2oEngines/{h2o_engine}
    ...
    def h2_o_engine_service_get_h2_o_engine(
        ...
        **kwargs
        ...
        >>> thread = api.h2_o_engine_service_get_h2_o_engine(name, async_req=True)
        >>> result = thread.get()
