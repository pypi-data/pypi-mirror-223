...
class WriteRequest(IRequest):
    ...
    def __init__(self, nadr: int, address: int, data: List[int], hwpid: int = dpa_constants.HWPID_MAX,
        ...
        super().__init__(
            ...
            pcmd=EEEPROMRequestCommands.WRITE,
    ...
    def _validate_data(data: List[int]):
        if len(data) > 56:
            raise RequestParameterInvalidValueError('Data should be at most 56 bytes long.')
    ...
    def to_dpa(self, mutable: bool = False) -> Union[bytes, bytearray]:
        self._pdata = [self._address & 0xFF, (self._address >> 8) & 0xFF] + self._data
