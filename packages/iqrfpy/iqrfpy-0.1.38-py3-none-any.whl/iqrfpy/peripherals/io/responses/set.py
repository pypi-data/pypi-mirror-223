...
class SetResponse(IResponseGetterMixin):
    ...
    @staticmethod
    def from_dpa(dpa: bytes) -> SetResponse:
        ...
        return SetResponse(nadr=nadr, hwpid=hwpid, rcode=rcode, dpa_value=dpa_value, result=None)

    @staticmethod
    def from_json(json: dict) -> SetResponse:
        ...
        return SetResponse(nadr=nadr, msgid=msgid, hwpid=hwpid, dpa_value=dpa_value, rcode=rcode, result=None)
