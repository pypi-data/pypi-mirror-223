...
class FrcParser:
    ...
    def values_from_data(data: List[int], extra_data: List[int], frc_command: Union[int, FrcCommands]) -> List[int]:
        ...
        Returns:
            List[int]: Values from collected FRC data
        ...
        if FrcCommands.FRC_2BIT_FROM <= frc_command <= FrcCommands.FRC_2BIT_TO:
            ...
            for i in range(0, 240):
                ...
                values.append(val)
            return values
        elif FrcCommands.FRC_1BYTE_FROM <= frc_command <= FrcCommands.FRC_1BYTE_TO:
            return aux
        elif FrcCommands.FRC_2BYTE_FROM <= frc_command <= FrcCommands.FRC_2BYTE_TO:
