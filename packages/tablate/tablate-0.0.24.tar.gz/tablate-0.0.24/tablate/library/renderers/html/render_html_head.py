...
def render_html_head(global_options: Globals) -> str:
    ...
    # global_options.html.styler.table.add_style_attribute("background-color", "initial", sub_selector=" *")
    global_options.html.styler.table.add_style_attribute("background-color", "transparent", sub_selector=" *")

    # global_options.html.styler.table.add_style_attribute("background-color", "rgba(50,123,200,0.25)", sub_selector=" tr:hover")
