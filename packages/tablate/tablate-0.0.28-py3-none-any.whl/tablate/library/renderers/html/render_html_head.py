...
def render_html_head(global_options: Globals) -> str:
    ...
    global_options.html.styler.add_global_style_attribute("background-color", "transparent")
    ...
    global_options.html.styler.table.add_style_attribute("background-color", "transparent", " *")
    global_options.html.styler.table.add_style_attribute("background-color", "rgba(200,0,0,0.25)", " tr:hover")
