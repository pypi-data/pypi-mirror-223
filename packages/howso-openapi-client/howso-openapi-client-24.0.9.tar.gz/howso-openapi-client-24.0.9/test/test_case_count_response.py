...
from howso.openapi.models.case_count_response import CaseCountResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestCaseCountResponse(unittest.TestCase):
    """CaseCountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test CaseCountResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.case_count_response.CaseCountResponse()  # noqa: E501
        if include_optional :
    ...
    def testCaseCountResponse(self):
        """Test CaseCountResponse"""
