...
from howso.openapi.models.react_action_output import ReactActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactActionOutput(unittest.TestCase):
    """ReactActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_action_output.ReactActionOutput()  # noqa: E501
        if include_optional :
            return ReactActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.react_response.ReactResponse(
                    warnings = [
    ...
    def testReactActionOutput(self):
        """Test ReactActionOutput"""
