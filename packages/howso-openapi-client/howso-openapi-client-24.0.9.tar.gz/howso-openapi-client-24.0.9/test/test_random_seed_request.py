...
from howso.openapi.models.random_seed_request import RandomSeedRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestRandomSeedRequest(unittest.TestCase):
    """RandomSeedRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test RandomSeedRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.random_seed_request.RandomSeedRequest()  # noqa: E501
        if include_optional :
            return RandomSeedRequest(
                seed = 'myseed1',
    ...
    def testRandomSeedRequest(self):
        """Test RandomSeedRequest"""
