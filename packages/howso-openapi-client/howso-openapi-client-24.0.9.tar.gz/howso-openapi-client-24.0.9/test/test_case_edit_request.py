...
from howso.openapi.models.case_edit_request import CaseEditRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestCaseEditRequest(unittest.TestCase):
    """CaseEditRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test CaseEditRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.case_edit_request.CaseEditRequest()  # noqa: E501
        if include_optional :
