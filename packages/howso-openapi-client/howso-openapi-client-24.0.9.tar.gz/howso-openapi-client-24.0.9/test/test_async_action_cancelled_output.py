...
from howso.openapi.models.async_action_cancelled_output import AsyncActionCancelledOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionCancelledOutput(unittest.TestCase):
    """AsyncActionCancelledOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionCancelledOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_cancelled_output.AsyncActionCancelledOutput()  # noqa: E501
        if include_optional :
            return AsyncActionCancelledOutput(
    ...
    def testAsyncActionCancelledOutput(self):
        """Test AsyncActionCancelledOutput"""
