...
from howso.openapi.models.react_series_request import ReactSeriesRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactSeriesRequest(unittest.TestCase):
    """ReactSeriesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactSeriesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_series_request.ReactSeriesRequest()  # noqa: E501
        if include_optional :
            return ReactSeriesRequest(
                ...
                series_stop_maps = [{"class":{"values":["versicolor"]},"sepal_length":{"min":1,"max":10}}],
                max_series_lengths = [10000,0],
                initial_features = ["sepal_length","class"],
                initial_values = [[5.2,4.1],[6.3,2.9]],
                series_context_values = [[[1,2,"kitten"]]],
                series_context_features = ["height","weight","kind"],
                final_time_steps = [1,2,3],
                init_time_steps = [1,2,3],
    ...
    def testReactSeriesRequest(self):
        """Test ReactSeriesRequest"""
