...
from howso.openapi.models.feature_add_request import FeatureAddRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureAddRequest(unittest.TestCase):
    """FeatureAddRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureAddRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_add_request.FeatureAddRequest()  # noqa: E501
        if include_optional :
            return FeatureAddRequest(
                feature = 'year',
                condition = {"year":"16","end_of_month_revenue":["0","100000"]},
                condition_session = 'session1',
                feature_value = 35.6,
                feature_attributes = howso.openapi.models.feature_attributes.FeatureAttributes(
                    type = 'continuous', 
    ...
    def testFeatureAddRequest(self):
        """Test FeatureAddRequest"""
