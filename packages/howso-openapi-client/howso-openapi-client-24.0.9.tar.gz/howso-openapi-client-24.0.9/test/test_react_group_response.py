...
from howso.openapi.models.react_group_response import ReactGroupResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactGroupResponse(unittest.TestCase):
    """ReactGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactGroupResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_group_response.ReactGroupResponse()  # noqa: E501
        if include_optional :
            return ReactGroupResponse(
                warnings = [
    ...
    def testReactGroupResponse(self):
        """Test ReactGroupResponse"""
