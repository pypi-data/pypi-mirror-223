...
from howso.openapi.models.case_remove_request import CaseRemoveRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestCaseRemoveRequest(unittest.TestCase):
    """CaseRemoveRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test CaseRemoveRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.case_remove_request.CaseRemoveRequest()  # noqa: E501
        if include_optional :
            return CaseRemoveRequest(
                num_cases = 1,
    ...
    def testCaseRemoveRequest(self):
        """Test CaseRemoveRequest"""
