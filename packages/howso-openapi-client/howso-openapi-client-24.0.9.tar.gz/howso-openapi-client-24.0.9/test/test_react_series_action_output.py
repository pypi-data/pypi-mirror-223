...
from howso.openapi.models.react_series_action_output import ReactSeriesActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactSeriesActionOutput(unittest.TestCase):
    """ReactSeriesActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactSeriesActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_series_action_output.ReactSeriesActionOutput()  # noqa: E501
        if include_optional :
            return ReactSeriesActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.react_series_response.ReactSeriesResponse(
                    warnings = [
                        {"detail":"Results may be inaccurate because trainee has not been analyzed with case weights."}
                        ], 
                    content = {"action_features":["class"],"series":[[["virginica"]],[["versicolor"]]]}, ),
    ...
    def testReactSeriesActionOutput(self):
        """Test ReactSeriesActionOutput"""
