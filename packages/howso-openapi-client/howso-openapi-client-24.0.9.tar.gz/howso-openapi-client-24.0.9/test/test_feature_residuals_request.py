...
from howso.openapi.models.feature_residuals_request import FeatureResidualsRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureResidualsRequest(unittest.TestCase):
    """FeatureResidualsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureResidualsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_residuals_request.FeatureResidualsRequest()  # noqa: E501
        if include_optional :
            return FeatureResidualsRequest(
                action_feature = 'age',
                robust = True,
    ...
    def testFeatureResidualsRequest(self):
        """Test FeatureResidualsRequest"""
