...
from howso.openapi.models.destruct_trainee_response import DestructTraineeResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestDestructTraineeResponse(unittest.TestCase):
    """DestructTraineeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test DestructTraineeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.destruct_trainee_response.DestructTraineeResponse()  # noqa: E501
        if include_optional :
            return DestructTraineeResponse(
                message = '',
    ...
    def testDestructTraineeResponse(self):
        """Test DestructTraineeResponse"""
