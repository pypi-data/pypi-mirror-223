...
from howso.openapi.models.extreme_cases_request import ExtremeCasesRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestExtremeCasesRequest(unittest.TestCase):
    """ExtremeCasesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ExtremeCasesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.extreme_cases_request.ExtremeCasesRequest()  # noqa: E501
        if include_optional :
            return ExtremeCasesRequest(
                num = 3,
                sort_feature = 'weight',
    ...
    def testExtremeCasesRequest(self):
        """Test ExtremeCasesRequest"""
