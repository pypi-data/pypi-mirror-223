...
from howso.openapi.models.memory_limits import MemoryLimits  # noqa: E501
from howso.openapi.configuration import Configuration


class TestMemoryLimits(unittest.TestCase):
    """MemoryLimits unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.memory_limits.MemoryLimits()  # noqa: E501
        if include_optional :
            return MemoryLimits(
                minimum = 56,
                maximum = 56,
