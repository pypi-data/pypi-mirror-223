...
from howso.openapi.models.feature_auto_derive_on_train_custom import FeatureAutoDeriveOnTrainCustom  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureAutoDeriveOnTrainCustom(unittest.TestCase):
    """FeatureAutoDeriveOnTrainCustom unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureAutoDeriveOnTrainCustom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_auto_derive_on_train_custom.FeatureAutoDeriveOnTrainCustom()  # noqa: E501
        if include_optional :
            return FeatureAutoDeriveOnTrainCustom(
                derive_type = 'custom',
                code = '(- #y 0 #x 1)',
    ...
    def testFeatureAutoDeriveOnTrainCustom(self):
        """Test FeatureAutoDeriveOnTrainCustom"""
