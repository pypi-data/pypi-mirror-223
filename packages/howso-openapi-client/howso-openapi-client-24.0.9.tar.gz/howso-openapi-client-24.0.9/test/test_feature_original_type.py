...
from howso.openapi.models.feature_original_type import FeatureOriginalType  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureOriginalType(unittest.TestCase):
    """FeatureOriginalType unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureOriginalType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_original_type.FeatureOriginalType()  # noqa: E501
        if include_optional :
            return FeatureOriginalType(
                data_type = 'timedelta',
                length = 255,
                encoding = 'UTF-8',
                format = 'decimal',
    ...
    def testFeatureOriginalType(self):
        """Test FeatureOriginalType"""
