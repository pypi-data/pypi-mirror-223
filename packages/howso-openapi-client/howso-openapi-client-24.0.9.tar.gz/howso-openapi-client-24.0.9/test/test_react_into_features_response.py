...
from howso.openapi.models.react_into_features_response import ReactIntoFeaturesResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactIntoFeaturesResponse(unittest.TestCase):
    """ReactIntoFeaturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactIntoFeaturesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_into_features_response.ReactIntoFeaturesResponse()  # noqa: E501
        if include_optional :
            return ReactIntoFeaturesResponse(
                warnings = [
    ...
    def testReactIntoFeaturesResponse(self):
        """Test ReactIntoFeaturesResponse"""
