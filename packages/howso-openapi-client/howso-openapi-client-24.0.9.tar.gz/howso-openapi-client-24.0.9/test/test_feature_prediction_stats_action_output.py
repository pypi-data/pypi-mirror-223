...
from howso.openapi.models.feature_prediction_stats_action_output import FeaturePredictionStatsActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeaturePredictionStatsActionOutput(unittest.TestCase):
    """FeaturePredictionStatsActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeaturePredictionStatsActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_prediction_stats_action_output.FeaturePredictionStatsActionOutput()  # noqa: E501
        if include_optional :
            return FeaturePredictionStatsActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.feature_prediction_stats.FeaturePredictionStats(
                    warnings = [
    ...
    def testFeaturePredictionStatsActionOutput(self):
        """Test FeaturePredictionStatsActionOutput"""
