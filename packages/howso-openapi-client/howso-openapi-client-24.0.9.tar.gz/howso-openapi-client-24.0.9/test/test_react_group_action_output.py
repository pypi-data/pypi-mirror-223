...
from howso.openapi.models.react_group_action_output import ReactGroupActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactGroupActionOutput(unittest.TestCase):
    """ReactGroupActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactGroupActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_group_action_output.ReactGroupActionOutput()  # noqa: E501
        if include_optional :
            return ReactGroupActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.react_group_response.ReactGroupResponse(
                    warnings = [
                        {"detail":"Results may be inaccurate because trainee has not been analyzed with case weights."}
                        ], 
                    content = {"familiarity_conviction_addition":[2.3,0.5]}, ),
    ...
    def testReactGroupActionOutput(self):
        """Test ReactGroupActionOutput"""
