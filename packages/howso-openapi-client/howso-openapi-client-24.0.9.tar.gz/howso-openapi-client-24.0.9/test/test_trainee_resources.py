...
from howso.openapi.models.trainee_resources import TraineeResources  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeResources(unittest.TestCase):
    """TraineeResources unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TraineeResources
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.trainee_resources.TraineeResources()  # noqa: E501
        if include_optional :
            return TraineeResources(
