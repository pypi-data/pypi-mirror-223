...
from howso.openapi.models.trainee_create_request import TraineeCreateRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeCreateRequest(unittest.TestCase):
    """TraineeCreateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TraineeCreateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.trainee_create_request.TraineeCreateRequest()  # noqa: E501
        if include_optional :
            return TraineeCreateRequest(
                library_type = 'st',
                timeout = 0,
    ...
    def testTraineeCreateRequest(self):
        """Test TraineeCreateRequest"""
