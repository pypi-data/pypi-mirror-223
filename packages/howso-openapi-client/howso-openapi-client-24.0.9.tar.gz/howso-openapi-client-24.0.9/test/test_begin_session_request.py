...
from howso.openapi.models.begin_session_request import BeginSessionRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestBeginSessionRequest(unittest.TestCase):
    """BeginSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test BeginSessionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.begin_session_request.BeginSessionRequest()  # noqa: E501
        if include_optional :
    ...
    def testBeginSessionRequest(self):
        """Test BeginSessionRequest"""
