...
from howso.openapi.models.generic_action_output import GenericActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestGenericActionOutput(unittest.TestCase):
    """GenericActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test GenericActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.generic_action_output.GenericActionOutput()  # noqa: E501
        if include_optional :
    ...
    def testGenericActionOutput(self):
        """Test GenericActionOutput"""
