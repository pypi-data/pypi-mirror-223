...
from howso.openapi.models.async_action_cancel import AsyncActionCancel  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionCancel(unittest.TestCase):
    """AsyncActionCancel unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionCancel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_cancel.AsyncActionCancel()  # noqa: E501
        if include_optional :
            return AsyncActionCancel(
    ...
    def testAsyncActionCancel(self):
        """Test AsyncActionCancel"""
