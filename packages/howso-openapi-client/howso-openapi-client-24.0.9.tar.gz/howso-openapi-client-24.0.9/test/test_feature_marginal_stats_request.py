...
from howso.openapi.models.feature_marginal_stats_request import FeatureMarginalStatsRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureMarginalStatsRequest(unittest.TestCase):
    """FeatureMarginalStatsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureMarginalStatsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_marginal_stats_request.FeatureMarginalStatsRequest()  # noqa: E501
        if include_optional :
            return FeatureMarginalStatsRequest(
    ...
    def testFeatureMarginalStatsRequest(self):
        """Test FeatureMarginalStatsRequest"""
