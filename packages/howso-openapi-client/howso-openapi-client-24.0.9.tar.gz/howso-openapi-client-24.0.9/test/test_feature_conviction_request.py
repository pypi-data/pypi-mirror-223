...
from howso.openapi.models.feature_conviction_request import FeatureConvictionRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureConvictionRequest(unittest.TestCase):
    """FeatureConvictionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureConvictionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_conviction_request.FeatureConvictionRequest()  # noqa: E501
        if include_optional :
            return FeatureConvictionRequest(
    ...
    def testFeatureConvictionRequest(self):
        """Test FeatureConvictionRequest"""
