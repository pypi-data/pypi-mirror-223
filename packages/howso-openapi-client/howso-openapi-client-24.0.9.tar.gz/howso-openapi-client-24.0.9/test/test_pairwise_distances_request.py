...
from howso.openapi.models.pairwise_distances_request import PairwiseDistancesRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestPairwiseDistancesRequest(unittest.TestCase):
    """PairwiseDistancesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test PairwiseDistancesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.pairwise_distances_request.PairwiseDistancesRequest()  # noqa: E501
        if include_optional :
            return PairwiseDistancesRequest(
    ...
    def testPairwiseDistancesRequest(self):
        """Test PairwiseDistancesRequest"""
