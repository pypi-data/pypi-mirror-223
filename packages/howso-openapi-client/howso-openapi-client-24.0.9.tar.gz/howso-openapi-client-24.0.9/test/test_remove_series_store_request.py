...
from howso.openapi.models.remove_series_store_request import RemoveSeriesStoreRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestRemoveSeriesStoreRequest(unittest.TestCase):
    """RemoveSeriesStoreRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test RemoveSeriesStoreRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.remove_series_store_request.RemoveSeriesStoreRequest()  # noqa: E501
        if include_optional :
            return RemoveSeriesStoreRequest(
                series = '',
    ...
    def testRemoveSeriesStoreRequest(self):
        """Test RemoveSeriesStoreRequest"""
