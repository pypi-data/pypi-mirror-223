...
from howso.openapi.models.train_action_output import TrainActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTrainActionOutput(unittest.TestCase):
    """TrainActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TrainActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.train_action_output.TrainActionOutput()  # noqa: E501
        if include_optional :
            return TrainActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.train_response.TrainResponse(
                    ablated_indices = [100,104,115], 
                    num_trained = 120, 
                    status = 'analyze', ),
    ...
    def testTrainActionOutput(self):
        """Test TrainActionOutput"""
