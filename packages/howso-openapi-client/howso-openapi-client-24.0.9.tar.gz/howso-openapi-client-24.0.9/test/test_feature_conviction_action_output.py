...
from howso.openapi.models.feature_conviction_action_output import FeatureConvictionActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureConvictionActionOutput(unittest.TestCase):
    """FeatureConvictionActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureConvictionActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_conviction_action_output.FeatureConvictionActionOutput()  # noqa: E501
        if include_optional :
            return FeatureConvictionActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.feature_conviction.FeatureConviction(
    ...
    def testFeatureConvictionActionOutput(self):
        """Test FeatureConvictionActionOutput"""
