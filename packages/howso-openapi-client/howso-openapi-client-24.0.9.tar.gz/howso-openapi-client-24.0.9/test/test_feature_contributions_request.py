...
from howso.openapi.models.feature_contributions_request import FeatureContributionsRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureContributionsRequest(unittest.TestCase):
    """FeatureContributionsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureContributionsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_contributions_request.FeatureContributionsRequest()  # noqa: E501
        if include_optional :
            return FeatureContributionsRequest(
                action_feature = 'age',
                robust = True,
    ...
    def testFeatureContributionsRequest(self):
        """Test FeatureContributionsRequest"""
