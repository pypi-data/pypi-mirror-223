...
from howso.openapi.models.trainee_version import TraineeVersion  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeVersion(unittest.TestCase):
    """TraineeVersion unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.trainee_version.TraineeVersion()  # noqa: E501
        if include_optional :
            return TraineeVersion(
                container = '1.0.0',
                trainee = '1.0.0',
                core = '1.0.0',
                amalgam = '1.0.0',
