...
from howso.openapi.models.react_into_trainee_response import ReactIntoTraineeResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactIntoTraineeResponse(unittest.TestCase):
    """ReactIntoTraineeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactIntoTraineeResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_into_trainee_response.ReactIntoTraineeResponse()  # noqa: E501
        if include_optional :
            return ReactIntoTraineeResponse(
                warnings = [
    ...
    def testReactIntoTraineeResponse(self):
        """Test ReactIntoTraineeResponse"""
