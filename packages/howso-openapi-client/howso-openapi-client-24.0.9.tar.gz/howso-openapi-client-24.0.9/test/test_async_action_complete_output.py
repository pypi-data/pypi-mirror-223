...
from howso.openapi.models.async_action_complete_output import AsyncActionCompleteOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionCompleteOutput(unittest.TestCase):
    """AsyncActionCompleteOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionCompleteOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_complete_output.AsyncActionCompleteOutput()  # noqa: E501
        if include_optional :
            return AsyncActionCompleteOutput(
    ...
    def testAsyncActionCompleteOutput(self):
        """Test AsyncActionCompleteOutput"""
