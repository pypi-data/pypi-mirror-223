...
from howso.openapi.models.string_type import StringType  # noqa: E501
from howso.openapi.configuration import Configuration


class TestStringType(unittest.TestCase):
    """StringType unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.string_type.StringType()  # noqa: E501
        if include_optional :
            return StringType(
                data_type = 'string',
                length = 255,
