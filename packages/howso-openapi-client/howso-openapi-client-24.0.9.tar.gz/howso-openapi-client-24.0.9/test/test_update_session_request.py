...
from howso.openapi.models.update_session_request import UpdateSessionRequest  # noqa: E501
...
class TestUpdateSessionRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.update_session_request.UpdateSessionRequest()  # noqa: E501
        if include_optional :
