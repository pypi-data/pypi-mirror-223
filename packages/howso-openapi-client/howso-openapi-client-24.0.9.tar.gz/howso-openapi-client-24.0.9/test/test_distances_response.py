...
from howso.openapi.models.distances_response import DistancesResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestDistancesResponse(unittest.TestCase):
    """DistancesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test DistancesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.distances_response.DistancesResponse()  # noqa: E501
        if include_optional :
            return DistancesResponse(
                row_case_indices = [["session1",2]],
                column_case_indices = [["session1",2]],
                distances = [[42.3,2.2]],
    ...
    def testDistancesResponse(self):
        """Test DistancesResponse"""
