...
from howso.openapi.models.react_series_response_content import ReactSeriesResponseContent  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactSeriesResponseContent(unittest.TestCase):
    """ReactSeriesResponseContent unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactSeriesResponseContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_series_response_content.ReactSeriesResponseContent()  # noqa: E501
        if include_optional :
            return ReactSeriesResponseContent(
                action_features = ["class"],
                series = [[["virginica"]],[["versicolor"]]],
    ...
    def testReactSeriesResponseContent(self):
        """Test ReactSeriesResponseContent"""
