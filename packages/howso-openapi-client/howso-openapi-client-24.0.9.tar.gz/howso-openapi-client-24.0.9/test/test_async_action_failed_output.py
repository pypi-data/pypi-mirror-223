...
from howso.openapi.models.async_action_failed_output import AsyncActionFailedOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionFailedOutput(unittest.TestCase):
    """AsyncActionFailedOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionFailedOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_failed_output.AsyncActionFailedOutput()  # noqa: E501
        if include_optional :
            return AsyncActionFailedOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = {"status":400,"title":"Bad Request","detail":"A parameter was invalid"},
    ...
    def testAsyncActionFailedOutput(self):
        """Test AsyncActionFailedOutput"""
