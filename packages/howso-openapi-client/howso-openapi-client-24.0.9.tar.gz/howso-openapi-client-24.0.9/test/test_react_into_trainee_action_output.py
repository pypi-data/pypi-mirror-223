...
from howso.openapi.models.react_into_trainee_action_output import ReactIntoTraineeActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactIntoTraineeActionOutput(unittest.TestCase):
    """ReactIntoTraineeActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactIntoTraineeActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_into_trainee_action_output.ReactIntoTraineeActionOutput()  # noqa: E501
        if include_optional :
            return ReactIntoTraineeActionOutput(
                action_id = '7271bc67-c563-45cd-9258-7e4c3958c170',
                status = 'complete',
                operation_type = 'react',
                output = howso.openapi.models.react_into_trainee_response.ReactIntoTraineeResponse(
                    warnings = [
    ...
    def testReactIntoTraineeActionOutput(self):
        """Test ReactIntoTraineeActionOutput"""
