...
from howso.openapi.models.feature_conviction import FeatureConviction  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureConviction(unittest.TestCase):
    """FeatureConviction unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureConviction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_conviction.FeatureConviction()  # noqa: E501
        if include_optional :
            return FeatureConviction(
    ...
    def testFeatureConviction(self):
        """Test FeatureConviction"""
