...
from howso.openapi.models.trainee import Trainee  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTrainee(unittest.TestCase):
    """Trainee unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.trainee.Trainee()  # noqa: E501
        if include_optional :
            return Trainee(
                name = 'My Trainee',
