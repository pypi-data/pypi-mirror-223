...
from howso.openapi.models.trainee_identity import TraineeIdentity  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeIdentity(unittest.TestCase):
    """TraineeIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TraineeIdentity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.trainee_identity.TraineeIdentity()  # noqa: E501
        if include_optional :
            return TraineeIdentity(
                id = '',
                name = '',
                project = howso.openapi.models.project_identity.ProjectIdentity(
