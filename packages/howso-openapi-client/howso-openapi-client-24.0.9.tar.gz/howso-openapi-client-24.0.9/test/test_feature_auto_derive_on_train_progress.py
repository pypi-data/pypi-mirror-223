...
from howso.openapi.models.feature_auto_derive_on_train_progress import FeatureAutoDeriveOnTrainProgress  # noqa: E501
from howso.openapi.configuration import Configuration


class TestFeatureAutoDeriveOnTrainProgress(unittest.TestCase):
    """FeatureAutoDeriveOnTrainProgress unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test FeatureAutoDeriveOnTrainProgress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.feature_auto_derive_on_train_progress.FeatureAutoDeriveOnTrainProgress()  # noqa: E501
        if include_optional :
            return FeatureAutoDeriveOnTrainProgress(
    ...
    def testFeatureAutoDeriveOnTrainProgress(self):
        """Test FeatureAutoDeriveOnTrainProgress"""
