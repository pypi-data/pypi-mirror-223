...
from howso.openapi.models.trainee_acquire_resources_request import TraineeAcquireResourcesRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeAcquireResourcesRequest(unittest.TestCase):
    """TraineeAcquireResourcesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TraineeAcquireResourcesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.trainee_acquire_resources_request.TraineeAcquireResourcesRequest()  # noqa: E501
        if include_optional :
            return TraineeAcquireResourcesRequest(
                timeout = 0,
    ...
    def testTraineeAcquireResourcesRequest(self):
        """Test TraineeAcquireResourcesRequest"""
