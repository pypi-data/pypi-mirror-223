...
from howso.openapi.models.pairwise_distances_action_output import PairwiseDistancesActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestPairwiseDistancesActionOutput(unittest.TestCase):
    """PairwiseDistancesActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test PairwiseDistancesActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.pairwise_distances_action_output.PairwiseDistancesActionOutput()  # noqa: E501
        if include_optional :
            return PairwiseDistancesActionOutput(
    ...
    def testPairwiseDistancesActionOutput(self):
        """Test PairwiseDistancesActionOutput"""
