...
from howso.openapi.models.async_action_output import AsyncActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionOutput(unittest.TestCase):
    """AsyncActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_output.AsyncActionOutput()  # noqa: E501
        if include_optional :
            return AsyncActionOutput(
    ...
    def testAsyncActionOutput(self):
        """Test AsyncActionOutput"""
