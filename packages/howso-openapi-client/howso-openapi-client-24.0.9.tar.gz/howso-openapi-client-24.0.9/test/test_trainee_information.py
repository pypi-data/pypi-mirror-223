...
from howso.openapi.models.trainee_information import TraineeInformation  # noqa: E501
from howso.openapi.configuration import Configuration


class TestTraineeInformation(unittest.TestCase):
    """TraineeInformation unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test TraineeInformation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.trainee_information.TraineeInformation()  # noqa: E501
        if include_optional :
            return TraineeInformation(
                library_type = 'st',
                version = howso.openapi.models.trainee_version.TraineeVersion(
                    container = '1.0.0', 
                    trainee = '1.0.0', 
                    core = '1.0.0', 
                    amalgam = '1.0.0', ),
    ...
    def testTraineeInformation(self):
        """Test TraineeInformation"""
