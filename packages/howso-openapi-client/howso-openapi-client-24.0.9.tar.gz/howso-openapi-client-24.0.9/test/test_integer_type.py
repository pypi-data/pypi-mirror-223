...
from howso.openapi.models.integer_type import IntegerType  # noqa: E501
from howso.openapi.configuration import Configuration


class TestIntegerType(unittest.TestCase):
    """IntegerType unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.integer_type.IntegerType()  # noqa: E501
        if include_optional :
            return IntegerType(
                data_type = 'integer',
                size = 8,
