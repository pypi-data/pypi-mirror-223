...
from howso.openapi.models.base_async_action_output import BaseAsyncActionOutput  # noqa: E501
from howso.openapi.configuration import Configuration


class TestBaseAsyncActionOutput(unittest.TestCase):
    """BaseAsyncActionOutput unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test BaseAsyncActionOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.base_async_action_output.BaseAsyncActionOutput()  # noqa: E501
        if include_optional :
            return BaseAsyncActionOutput(
    ...
    def testBaseAsyncActionOutput(self):
        """Test BaseAsyncActionOutput"""
