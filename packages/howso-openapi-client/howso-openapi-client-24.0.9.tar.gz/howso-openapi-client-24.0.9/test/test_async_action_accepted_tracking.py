...
from howso.openapi.models.async_action_accepted_tracking import AsyncActionAcceptedTracking  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionAcceptedTracking(unittest.TestCase):
    """AsyncActionAcceptedTracking unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionAcceptedTracking
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_accepted_tracking.AsyncActionAcceptedTracking()  # noqa: E501
        if include_optional :
            return AsyncActionAcceptedTracking(
                url = '',
    ...
    def testAsyncActionAcceptedTracking(self):
        """Test AsyncActionAcceptedTracking"""
