...
from howso.openapi.models.async_action_status import AsyncActionStatus  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionStatus(unittest.TestCase):
    """AsyncActionStatus unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_status.AsyncActionStatus()  # noqa: E501
        if include_optional :
    ...
    def testAsyncActionStatus(self):
        """Test AsyncActionStatus"""
