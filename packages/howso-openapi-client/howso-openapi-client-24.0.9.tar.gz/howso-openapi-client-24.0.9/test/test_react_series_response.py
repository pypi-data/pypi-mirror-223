...
from howso.openapi.models.react_series_response import ReactSeriesResponse  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactSeriesResponse(unittest.TestCase):
    """ReactSeriesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactSeriesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_series_response.ReactSeriesResponse()  # noqa: E501
        if include_optional :
            return ReactSeriesResponse(
                warnings = [
    ...
    def testReactSeriesResponse(self):
        """Test ReactSeriesResponse"""
