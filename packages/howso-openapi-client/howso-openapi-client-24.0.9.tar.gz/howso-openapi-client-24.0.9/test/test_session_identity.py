...
from howso.openapi.models.session_identity import SessionIdentity  # noqa: E501
from howso.openapi.configuration import Configuration


class TestSessionIdentity(unittest.TestCase):
    """SessionIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test SessionIdentity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.session_identity.SessionIdentity()  # noqa: E501
        if include_optional :
