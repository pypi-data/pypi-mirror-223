...
from howso.openapi.models.base_react_request import BaseReactRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestBaseReactRequest(unittest.TestCase):
    """BaseReactRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test BaseReactRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.base_react_request.BaseReactRequest()  # noqa: E501
        if include_optional :
            return BaseReactRequest(
