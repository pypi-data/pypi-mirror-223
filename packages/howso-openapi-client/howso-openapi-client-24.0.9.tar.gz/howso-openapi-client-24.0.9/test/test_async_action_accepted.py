...
from howso.openapi.models.async_action_accepted import AsyncActionAccepted  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAsyncActionAccepted(unittest.TestCase):
    """AsyncActionAccepted unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AsyncActionAccepted
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.async_action_accepted.AsyncActionAccepted()  # noqa: E501
        if include_optional :
            return AsyncActionAccepted(
                action_id = '',
    ...
    def testAsyncActionAccepted(self):
        """Test AsyncActionAccepted"""
