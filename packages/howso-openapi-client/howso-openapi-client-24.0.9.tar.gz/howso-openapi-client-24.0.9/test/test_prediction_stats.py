...
from howso.openapi.models.prediction_stats import PredictionStats  # noqa: E501
from howso.openapi.configuration import Configuration


class TestPredictionStats(unittest.TestCase):
    """PredictionStats unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test PredictionStats
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.prediction_stats.PredictionStats()  # noqa: E501
        if include_optional :
