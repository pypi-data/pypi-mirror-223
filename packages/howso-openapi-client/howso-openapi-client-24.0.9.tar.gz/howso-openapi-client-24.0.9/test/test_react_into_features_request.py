...
from howso.openapi.models.react_into_features_request import ReactIntoFeaturesRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestReactIntoFeaturesRequest(unittest.TestCase):
    """ReactIntoFeaturesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test ReactIntoFeaturesRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.react_into_features_request.ReactIntoFeaturesRequest()  # noqa: E501
        if include_optional :
            return ReactIntoFeaturesRequest(
    ...
    def testReactIntoFeaturesRequest(self):
        """Test ReactIntoFeaturesRequest"""
