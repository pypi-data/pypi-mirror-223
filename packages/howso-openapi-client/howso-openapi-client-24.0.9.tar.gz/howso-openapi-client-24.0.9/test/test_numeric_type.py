...
from howso.openapi.models.numeric_type import NumericType  # noqa: E501
from howso.openapi.configuration import Configuration


class TestNumericType(unittest.TestCase):
    """NumericType unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        ...
        # model = howso.openapi.models.numeric_type.NumericType()  # noqa: E501
        if include_optional :
            return NumericType(
                data_type = 'numeric',
                format = 'decimal',
