...
from howso.openapi.models.append_to_series_store_request import AppendToSeriesStoreRequest  # noqa: E501
from howso.openapi.configuration import Configuration


class TestAppendToSeriesStoreRequest(unittest.TestCase):
    """AppendToSeriesStoreRequest unit test stubs"""
    ...
    def make_instance(self, include_optional, local_vars_configuration=None):
        """Test AppendToSeriesStoreRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = howso.openapi.models.append_to_series_store_request.AppendToSeriesStoreRequest()  # noqa: E501
        if include_optional :
            return AppendToSeriesStoreRequest(
                series = '',
    ...
    def testAppendToSeriesStoreRequest(self):
        """Test AppendToSeriesStoreRequest"""
