...
def create_groundedness_prompt(context: str, question: str, prediction: str) -> str:
    ...
    """
    prompt = 'Given the context and question, score the answer between one to five stars, where one star means ' \
             '"inconsistency" and five stars means "perfect consistency". Note that consistency measures whether ' \
             'the facts in the answer are consistent with the facts in the context. Consider whether the answer ' \
             'does reproduce facts accurately and does not make up untrue information.\ncontext: {}\nquestion: ' \
             '{}\nanswer: {}\nstars:'.format(context, question, prediction)
