...
data_files_spec = [
    ('share/jupyter/nbextensions/symphony_duplicates',
     'symphony_duplicates/nbextension', '**'),
    ('share/jupyter/labextensions/symphony-duplicates',
     'symphony_duplicates/labextension', '**'),
    ('share/jupyter/labextensions/symphony-duplicates',
     '.', 'install.json'),
    ('etc/jupyter/nbconfig/notebook.d', '.',
     'symphony_duplicates.json'),
]
