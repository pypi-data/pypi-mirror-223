...
class LoadRequest:
    ...
    variables: Optional[List[str]] = None
    geographical_parameters: GeographicalParameters = GeographicalParameters(
        latitude_parameters=LatitudeParameters(
            minimal_latitude=None, maximal_latitude=None
        ),
        longitude_parameters=LongitudeParameters(
            minimal_longitude=None, maximal_longitude=None
        ),
    )
    temporal_parameters: TemporalParameters = TemporalParameters(
        start_datetime=None, end_datetime=None
    )
    depth_parameters: DepthParameters = DepthParameters(
