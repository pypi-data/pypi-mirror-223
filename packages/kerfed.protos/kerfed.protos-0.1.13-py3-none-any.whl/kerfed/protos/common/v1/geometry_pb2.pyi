...
class Mesh(google.protobuf.message.Message):
    ...
    def vertices(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]:
        """Flattened (n, 3) vertices"""
    @property
    def faces(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        """Flattened (m, 3) triangular faces."""
    def __init__(
        self,
        *,
        vertices: collections.abc.Iterable[builtins.float] | None = ...,
        faces: collections.abc.Iterable[builtins.int] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["faces", b"faces", "vertices", b"vertices"]) -> None: ...
