...
class Ui_Dialog_DOS(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "态密度参数输入"))
        self.groupBox_2.setTitle(_translate("Dialog", "数据选择"))
        self.groupBox_5.setTitle(_translate("Dialog", "X轴"))
        self.checkBox.setText(_translate("Dialog", "能量"))
        self.groupBox_6.setTitle(_translate("Dialog", "Y轴"))
        ...
        self.label.setText(_translate("Dialog", "X轴最小值"))
        self.lineEdit.setText(_translate("Dialog", "默认不输入"))
        self.label_2.setText(_translate("Dialog", "X轴最大值"))
        self.lineEdit_2.setText(_translate("Dialog", "默认不输入"))
        self.label_3.setText(_translate("Dialog", "Y轴最小值"))
        self.lineEdit_3.setText(_translate("Dialog", "默认不输入"))
        self.label_4.setText(_translate("Dialog", "Y轴最大值"))
        self.lineEdit_4.setText(_translate("Dialog", "默认不输入"))
        self.label_5.setText(_translate("Dialog", "X轴标签"))
        self.lineEdit_5.setText(_translate("Dialog", "X轴"))
        self.label_6.setText(_translate("Dialog", "Y轴最大值"))
        self.lineEdit_6.setText(_translate("Dialog", "Y轴"))
        self.label_7.setText(_translate("Dialog", "标题"))
        self.lineEdit_7.setText(_translate("Dialog", "Density of states diagram"))
