...
"")
        ...
        self.lineEdit_3.setCursorPosition(10)
    ...
    def retranslateUi(self, Form):
        ...
        self.lineEdit_6.setText(_translate("Form", "202.197.234.194"))
        self.label_8.setText(_translate("Form", "Node username："))
        self.lineEdit_8.setText(_translate("Form", "zhoupan"))
        self.label_7.setText(_translate("Form", "Node password："))
        self.lineEdit_7.setText(_translate("Form", "zhoupan123"))
        self.groupBox.setTitle(_translate("Form", "Remote Node Info"))
        self.label.setText(_translate("Form", "Node IP："))
        self.lineEdit.setText(_translate("Form", "192.168.1.4"))
        self.label_2.setText(_translate("Form", "Node username："))
        self.lineEdit_2.setText(_translate("Form", "zhoupan"))
        self.label_3.setText(_translate("Form", "Node password："))
        self.lineEdit_3.setText(_translate("Form", "zhoupan123"))
        self.groupBox_3.setTitle(_translate("Form", "Path"))
        self.label_4.setText(_translate("Form", "Node path："))
        self.lineEdit_4.setText(_translate("Form", "/home/zhoupan/vaspwork/test"))
        self.label_5.setText(_translate("Form", "Local path."))
        self.lineEdit_5.setText(_translate("Form", "C:\\Users\\Administrator\\Desktop\\VASP_files"))
