...
from ia.scripts.spawn_general import spawn_container, kill_container, connect_networks_container
...
class AgentManager:
    ...
    def update_current_agents(self):
        ...
        self.current_comcoms = [Path(p) for p in os.listdir(
            self.comcom_dir) if not os.path.isdir(os.path.realpath(p))]
