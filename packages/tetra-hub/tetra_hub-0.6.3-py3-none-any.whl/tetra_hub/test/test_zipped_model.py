...
from tetra_hub.util.zipped_model import (
...
@pytest.mark.parametrize("asset_suffix", list(SUPPORTED_ZIPPED_MODEL_ASSETS))
...
def test_make_zipped_model_compatible_raises_one_asset_expected():
    ...
    supported_assets = list(SUPPORTED_ZIPPED_MODEL_ASSETS)
    with tempfile.TemporaryDirectory() as tempdir:
